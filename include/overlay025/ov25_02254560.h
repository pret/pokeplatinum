...
BOOL ov25_02254560(Ov25_560_TaskData **param0, const Ov25_560_TaskData_1 *param1, NNSG2dOamManagerInstance *param2, PoketchSystem *poketchSys);
...
void ov25_560_StartTask(Ov25_560_TaskData *param0, u32 param1);
