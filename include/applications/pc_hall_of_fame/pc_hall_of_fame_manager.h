...
int PCHallOfFameManager_Init(ApplicationManager *appMan, int *state);
int PCHallOfFameManager_Exit(ApplicationManager *appMan, int *state);
int PCHallOfFameManager_Main(ApplicationManager *appMan, int *state);
