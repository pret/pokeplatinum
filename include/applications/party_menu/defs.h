...
enum MenuSelectionFieldMove {
    MENU_SELECTION_UNK0 = 0,
    MENU_SELECTION_UNK1,
    MENU_SELECTION_ITEM_GIVE = 3,
    MENU_SELECTION_ITEM_TAKE = 4,
    MENU_SELECTION_MAIL_READ = 7,
    MENU_SELECTION_FIELD_MOVE_CUT = 11,
    MENU_SELECTION_FIELD_MOVE_FLY,
    MENU_SELECTION_FIELD_MOVE_SURF,
    MENU_SELECTION_FIELD_MOVE_STRENGTH,
    MENU_SELECTION_FIELD_MOVE_DEFOG,
    MENU_SELECTION_FIELD_MOVE_ROCK_SMASH,
    MENU_SELECTION_FIELD_MOVE_WATERFALL,
    MENU_SELECTION_FIELD_MOVE_ROCK_CLIMB,
    MENU_SELECTION_FIELD_MOVE_FLASH,
    MENU_SELECTION_FIELD_MOVE_TELEPORT,
    MENU_SELECTION_FIELD_MOVE_DIG,
    MENU_SELECTION_FIELD_MOVE_SWEET_SCENT,
    MENU_SELECTION_FIELD_MOVE_CHATTER,
};
