...
int ov58_021D0D80(OverlayManager *overlayMan, int *param1);
int ov58_021D0F08(OverlayManager *overlayMan, int *param1);
int ov58_021D1018(OverlayManager *overlayMan, int *param1);
