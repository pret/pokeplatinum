...
WonderCard *MysteryGift_TryGetWonderCard(MysteryGift *param0, int param1);
BOOL MysteryGift_TrySavePgt(MysteryGift *param0, const PGT *param1, int param2);
BOOL MysteryGift_TrySaveWondercard(MysteryGift *param0, const WonderCard *param1);
BOOL MysteryGift_FreeWcErasePgt(MysteryGift *param0, int param1);
BOOL MysteryGift_FreeWcSlot(MysteryGift *param0, int param1);
BOOL MysteryGift_CheckFreePgtSlotExists(MysteryGift *param0);
BOOL MysteryGift_CheckFreeWcSlotExists(MysteryGift *param0);
BOOL MysteryGift_CheckIsWcSlotOccupied(const MysteryGift *param0, int param1);
BOOL MysteryGift_CheckHasWonderCards(const MysteryGift *param0);
BOOL MysteryGift_CheckWcHasPgtSaved(const MysteryGift *param0, int param1);
BOOL MysteryGift_GetWcIDReceived(MysteryGift *param0, int param1);
void MysteryGift_SetWcIDReceived(MysteryGift *param0, int param1);
BOOL MysteryGift_GetLastWcIDReceived(MysteryGift *param0);
void MysteryGift_SetLastWcIDReceived(MysteryGift *param0);
void MysteryGift_Load(SaveData *param0, int param1);
void MysteryGift_Unload(SaveData *param0, int param1);
int MysteryGift_TryGetFirstValidPgtSlot(void);
int MysteryGift_TryGetPgtType(int param0);
GiftData *MysteryGift_TryGetPgtData(int param0);
void MysteryGift_FreePgtSlot(int param0);
