...
void sub_02023D28(Strbuf *param0, const Charcode *param1);
void sub_02023D8C(Strbuf *param0, const Charcode *param1, u32 param2);
void sub_02023DF0(const Strbuf *param0, Charcode *param1, u32 param2);
const Charcode* sub_02023E2C(const Strbuf *param0);
void sub_02023E4C(Strbuf *param0, const Strbuf *param1);
void sub_02023EB0(Strbuf *param0, Charcode param1);
