...
#define SPECIES_EGG_MANAPHY     495

#define MAX_SPECIES             SPECIES_EGG_MANAPHY

// Forms
enum {
    DEOXYS_FORM_NORMAL,  // Ruby/Sapphire
    DEOXYS_FORM_ATTACK,  // Fire Red
    DEOXYS_FORM_DEFENSE, // Leaf Green
    DEOXYS_FORM_SPEED,   // Emerald
    DEOXYS_FORM_COUNT,
};
enum {
    UNOWN_FORM_A,
...
enum {
    BURMY_FORM_PLANT_CLOAK,
    BURMY_FORM_SANDY_CLOAK,
    BURMY_FORM_TRASH_CLOAK,
    BURMY_FORM_COUNT,
};
enum {
    WORMADAM_FORM_PLANT_CLOAK,
    WORMADAM_FORM_SANDY_CLOAK,
    WORMADAM_FORM_TRASH_CLOAK,
    WORMADAM_FORM_COUNT,
};
enum {
    SHELLOS_FORM_WEST_SEA,
    SHELLOS_FORM_EAST_SEA,
    SHELLOS_FORM_COUNT,
};
enum {
    GASTRODON_FORM_WEST_SEA,
    GASTRODON_FORM_EAST_SEA,
    GASTRODON_FORM_COUNT,
};
enum {
    GIRATINA_FORM_ALTERED,
    GIRATINA_FORM_ORIGIN,
    GIRATINA_FORM_COUNT,
};
enum {
    SHAYMIN_FORM_LAND,
...
#define SPECIES_DEOXYS_ATTACK       (MAX_SPECIES + DEOXYS_FORM_ATTACK)
#define SPECIES_DEOXYS_DEFENSE      (MAX_SPECIES + DEOXYS_FORM_DEFENSE)
#define SPECIES_DEOXYS_SPEED        (MAX_SPECIES + DEOXYS_FORM_SPEED)

#define SPECIES_UNOWN_B             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_B)
#define SPECIES_UNOWN_C             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_C)
#define SPECIES_UNOWN_D             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_D)
#define SPECIES_UNOWN_E             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_E)
#define SPECIES_UNOWN_F             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_F)
#define SPECIES_UNOWN_G             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_G)
#define SPECIES_UNOWN_H             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_H)
#define SPECIES_UNOWN_I             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_I)
#define SPECIES_UNOWN_J             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_J)
#define SPECIES_UNOWN_K             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_K)
#define SPECIES_UNOWN_L             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_L)
#define SPECIES_UNOWN_M             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_M)
#define SPECIES_UNOWN_N             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_N)
#define SPECIES_UNOWN_O             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_O)
#define SPECIES_UNOWN_P             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_P)
#define SPECIES_UNOWN_Q             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_Q)
#define SPECIES_UNOWN_R             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_R)
#define SPECIES_UNOWN_S             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_S)
#define SPECIES_UNOWN_T             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_T)
#define SPECIES_UNOWN_U             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_U)
#define SPECIES_UNOWN_V             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_V)
#define SPECIES_UNOWN_W             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_W)
#define SPECIES_UNOWN_X             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_X)
#define SPECIES_UNOWN_Y             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_Y)
#define SPECIES_UNOWN_Z             (SPECIES_DEOXYS_SPEED + UNOWN_FORM_Z)
#define SPECIES_UNOWN_EMARK         (SPECIES_DEOXYS_SPEED + UNOWN_FORM_EMARK)
#define SPECIES_UNOWN_QMARK         (SPECIES_DEOXYS_SPEED + UNOWN_FORM_QMARK)

#define SPECIES_BURMY_SANDY_CLOAK   (SPECIES_UNOWN_QMARK + BURMY_FORM_SANDY_CLOAK)
#define SPECIES_BURMY_TRASH_CLOAK   (SPECIES_UNOWN_QMARK + BURMY_FORM_TRASH_CLOAK)
