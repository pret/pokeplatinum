...
enum BattleCommand {
    ...
    BATTLE_COMMAND_SHOW_MOVE_SELECT_SCREEN,
    BATTLE_COMMAND_SHOW_TARGET_SELECTION,
    BATTLE_COMMAND_SHOW_BAG_SCREEN,
    BATTLE_COMMAND_SHOW_PARTY_SCREEN,
    BATTLE_COMMAND_SHOW_YES_NO_SCREEN,
    BATTLE_COMMAND_PRINT_ATTACK_MESSAGE, //20
    BATTLE_COMMAND_PRINT_MESSAGE,
    BATTLE_COMMAND_22,
    BATTLE_COMMAND_FLCIKER_BATTLER,
