...
int Underground_TryAddMiningSpot(Underground *underground, int param1, int param2);
void Underground_RemoveMiningSpotAtIndex(Underground *underground, int param1);
int Underground_GetMiningSpotXCoordAtIndex(Underground *underground, int param1);
int Underground_GetMiningSpotZCoordAtIndex(Underground *underground, int param1);
...
void Underground_AddNumNonFossilsDug(UndergroundRecord *param0, int param1);
