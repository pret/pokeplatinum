...
enum BillboardModel {
    ...
    BILLBOARD_MODEL_SENTINEL_ID = 0xFFFF,
};
...
enum BillboardFrameSequence {
    ...
    BILLBOARD_FRAME_SEQ_SENTINEL_ID = 0xFFFF,
};
...
typedef struct ObjectEventGfxModelAnimEntry {
    enum ObjectEventGfx graphicsID;
    enum BillboardModel modelID;
    enum BillboardFrameSequence frameSeqID;
    const BillboardAnim *animations;
} ObjectEventGfxModelAnimEntry;

typedef struct ObjectEventGfxRenderDetailsEntry {
    enum ObjectEventGfx graphicsID;
    u32 modelType : 4;
    u32 hasShadow : 2;
    u32 trackType : 4;
...
typedef struct ObjectEventGfxFieldAnimsInitialPosEntry {
    enum ObjectEventGfx graphicsID;
    VecFx32 initialPos;
