...
typedef struct {
    ...
    UnkStruct_0200D0F4 * unk_20[3];
    UnkStruct_0200D0F4 * unk_24[3];
    UnkStruct_0200D0F4 * unk_28[36];
    UnkStruct_0200D0F4 * unk_B8[4];
    UnkStruct_0200D0F4 * unk_C8[2];
    UnkStruct_0200D0F4 * unk_D0[2];
    UnkStruct_0200D0F4 * unk_D8;
    u16 unk_DC[4];
    u8 padding_E4[12];
    int unk_F0;
    int unk_F4;
