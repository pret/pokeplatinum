...
#define POKETCH_TASK_SETUP_BACKGROUND    0
#define POKETCH_TASK_UPDATE_WATCH_DIGITS 1
#define POKETCH_TASK_TOGGLE_BACKLIGHT    2
#define POKETCH_TASK_FREE_BACKGROUND     3
