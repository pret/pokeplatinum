...
void GraphicElementManager_Update(const GraphicElementManager * param0);
...
u32 GraphicElementData_GetAnimCount(const GraphicElementData * param0);
void GraphicElementData_SetAnim(GraphicElementData * param0, u32 param1);
void GraphicElementData_SetAnimNoRestart(GraphicElementData * param0, u32 param1);
void GraphicElementData_RestartAnim(GraphicElementData * param0);
u32 GraphicElementData_GetActiveAnim(const GraphicElementData * param0);
...
u16 GraphicElementData_GetAnimFrame(const GraphicElementData * param0);
...
BOOL GraphicElementData_IsAnimated(GraphicElementData * param0);
void GraphicElementData_SetExplicitOAMMode(GraphicElementData * param0, GXOamMode param1);
void Utility_Clear2DMainOAM(enum HeapId param0);
void Utility_Clear2DSubOAM(enum HeapId param0);
u32 GraphicElementData_GetUserAttrForAnimFrame(const GraphicElementData * param0, u32 param1, u32 param2);
u32 GraphicElementData_GetUserAttrForCurrentAnimFrame(const GraphicElementData * param0);
