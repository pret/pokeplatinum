...
typedef struct BattleBag {
    ...
    u16 menuPocketButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MENU_POCKET_BUTTON_SIZE];
    u16 useItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_CONFIRM_BUTTON_SIZE];
    u16 cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][BATTLE_SUB_MENU_CANCEL_BUTTON_SIZE];
    u16 pocketItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][POCKET_ITEM_BUTTON_SIZE];
    u16 pocketPrevPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_PREV_NEXT_BUTTON_SIZE];
    u16 pocketNextPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_PREV_NEXT_BUTTON_SIZE];
    u16 menuScreenRecoverHPPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MENU_POCKET_ICON_SIZE];
    u16 menuScreenRecoverStatusPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MENU_POCKET_ICON_SIZE];
    u16 menuScreenPokeBallsPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MENU_POCKET_ICON_SIZE];
    u16 menuScreenBattleItemsIconData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MENU_POCKET_ICON_SIZE];
