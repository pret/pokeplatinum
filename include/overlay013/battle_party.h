...
#define PARTY_POKEMON_BUTTON_WIDTH  16
#define PARTY_POKEMON_BUTTON_HEIGHT 6
#define PARTY_POKEMON_BUTTON_SIZE   (PARTY_POKEMON_BUTTON_WIDTH * PARTY_POKEMON_BUTTON_HEIGHT)

#define SHIFT_POKEMON_BUTTON_WIDTH  30
#define SHIFT_POKEMON_BUTTON_HEIGHT 17
#define SHIFT_POKEMON_BUTTON_SIZE   (SHIFT_POKEMON_BUTTON_WIDTH * SHIFT_POKEMON_BUTTON_HEIGHT)

#define SUMMARY_CHECK_MOVES_BUTTON_WIDTH  13
#define SUMMARY_CHECK_MOVES_BUTTON_HEIGHT 5
#define SUMMARY_CHECK_MOVES_BUTTON_SIZE   (SUMMARY_CHECK_MOVES_BUTTON_WIDTH * SUMMARY_CHECK_MOVES_BUTTON_HEIGHT)

#define MOVE_BUTTON_WIDTH  16
#define MOVE_BUTTON_HEIGHT 6
#define MOVE_BUTTON_SIZE   (MOVE_BUTTON_WIDTH * MOVE_BUTTON_HEIGHT)

#define CONTEST_STATS_BUTTON_WIDTH  9
#define CONTEST_STATS_BUTTON_HEIGHT 4
#define CONTEST_STATS_BUTTON_SIZE   (CONTEST_STATS_BUTTON_WIDTH * CONTEST_STATS_BUTTON_HEIGHT)

#define MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH  5
#define MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT 2
#define MOVE_SUMMARY_SCREEN_MOVE_BUTTON_SIZE   (MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH * MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT)
...
typedef struct BattleParty {
    ...
    BgConfig *background;
    PaletteData *palette;
    u16 partyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][PARTY_POKEMON_BUTTON_SIZE];
    u16 altPartyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][PARTY_POKEMON_BUTTON_SIZE];
    u16 summaryCheckMovesButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][SUMMARY_CHECK_MOVES_BUTTON_SIZE];
    u16 prevPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_PREV_NEXT_BUTTON_SIZE];
    u16 nextPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_PREV_NEXT_BUTTON_SIZE];
    u16 cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][BATTLE_SUB_MENU_CANCEL_BUTTON_SIZE];
    u16 shiftPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][SHIFT_POKEMON_BUTTON_SIZE];
    u16 moveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX][MOVE_BUTTON_SIZE];
    u16 learnMoveConfirmButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][BATTLE_SUB_MENU_CONFIRM_BUTTON_SIZE];
    u16 contestStatsButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][CONTEST_STATS_BUTTON_SIZE];
    u16 moveSummaryScreenMoveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_MAX_CANNOT_DISABLE][MOVE_SUMMARY_SCREEN_MOVE_BUTTON_SIZE];
