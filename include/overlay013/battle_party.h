...
enum BattlePartyPokemonPartyScreenButton {
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_1 = 0,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_2,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_3,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_4,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_5,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_POKEMON_6,
    BATTLE_PARTY_POKEMON_PARTY_SCREEN_BUTTON_CANCEL,
};

enum BattlePartySelectPokemonScreenButton {
    BATTLE_PARTY_POKEMON_SELECT_POKEMON_SCREEN_BUTTON_SHIFT = 0,
    BATTLE_PARTY_POKEMON_SELECT_POKEMON_SCREEN_BUTTON_SUMMARY,
    BATTLE_PARTY_POKEMON_SELECT_POKEMON_SCREEN_BUTTON_CHECK_MOVES,
    BATTLE_PARTY_POKEMON_SELECT_POKEMON_SCREEN_BUTTON_CANCEL,
};
...
enum BattlePartyPokemonMovesScreenButton {
    ...
    BATTLE_PARTY_POKEMON_MOVES_SCREEN_BUTTON_SUMMARY,
...
enum BattlePartyRestoreMovePPScreenButton {
    BATTLE_PARTY_RESTORE_MOVE_PP_SCREEN_BUTTON_MOVE_1 = 0,
    BATTLE_PARTY_RESTORE_MOVE_PP_SCREEN_BUTTON_MOVE_2,
    BATTLE_PARTY_RESTORE_MOVE_PP_SCREEN_BUTTON_MOVE_3,
    BATTLE_PARTY_RESTORE_MOVE_PP_SCREEN_BUTTON_MOVE_4,
    BATTLE_PARTY_RESTORE_MOVE_PP_SCREEN_BUTTON_CANCEL,
};
...
enum BattlePartyLearnMoveScreenButton {
    ...
    BATTLE_PARTY_LEARN_MOVE_SCREEN_BUTTON_CONTEST_STATS,
    BATTLE_PARTY_LEARN_MOVE_SCREEN_BUTTON_CANCEL,
};

enum BattlePartyConfirmLearnMoveScreenButton {
    BATTLE_PARTY_CONFIRM_LEARN_MOVE_SCREEN_BUTTON_CONFIRM = 0,
    BATTLE_PARTY_CONFIRM_LEARN_MOVE_SCREEN_BUTTON_CONTEST_STATS,
    BATTLE_PARTY_CONFIRM_LEARN_MOVE_SCREEN_BUTTON_CANCEL,
};
