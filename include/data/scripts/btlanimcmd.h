...
ScriptCommand(BTLANIMCMD_JUMPIFEFFECTCHANCEODD,             BattleAnimScriptCmd_JumpIfEffectChanceOdd)
ScriptCommand(BTLANIMCMD_JUMPIFEFFECTCHANCE,                BattleAnimScriptCmd_JumpIfEffectChance)
...
ScriptCommand(BTLANIMCMD_JUMPIFUNK_01,                      BattleAnimScriptCmd_JumpIfUnk_01)
...
ScriptCommand(BTLANIMCMD_STARTBATTLERSLIDEIN,               BattleAnimScriptCmd_StartBattlerSlideIn)
ScriptCommand(BTLANIMCMD_STARTBATTLERSLIDEOUT,              BattleAnimScriptCmd_StartBattlerSlideOut)
...
ScriptCommand(BTLANIMCMD_STARTPOKEMONSPRITEDRAWTASK,        BattleAnimScriptCmd_StartPokemonSpriteDrawTask)
ScriptCommand(BTLANIMCMD_STOPPOKEMONSPRITEDRAWTASK,         BattleAnimScriptCmd_StopPokemonSpriteDrawTask)
