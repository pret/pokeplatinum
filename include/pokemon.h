...
enum FriendshipEvents {
    ...
    FRIENDSHIP_EVENT_WALK_128_STEPS,
    FRIENDSHIP_EVENT_FAINTING_TO_LESS_THAN_30LVL_HIGHER_FOE,
    FRIENDSHIP_EVENT_POISON_1HP,
    FRIENDSHIP_EVENT_FAINTING_TO_30LVL_HIGHER_FOE,
