...
enum EndCreditsMemory {
    END_CREDITS_MEMORY_1 = 0,
    END_CREDITS_MEMORY_2,
    END_CREDITS_MEMORY_3,
    END_CREDITS_MEMORY_4,
    END_CREDITS_MEMORY_5,
    END_CREDITS_MEMORY_6,
    END_CREDITS_MEMORY_7,

    END_CREDITS_MEMORY_8,
    END_CREDITS_MEMORY_9,
    END_CREDITS_MEMORY_10,
