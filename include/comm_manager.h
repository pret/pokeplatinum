...
void CommCmd_ValidateConfirmationMessage(int netID, int unused_1, void *confirmationMessage, void *unused_3);
void CommCmd_ValidateConfirmationResponseMessage(int unused_0, int unused_1, void *confirmationMessage, void *unused_3);
