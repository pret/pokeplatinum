...
typedef void (*DWCi_LobbyChannelMessageReceivedCallback)(const char *channelName, s32 userId, const char *message, void *param);
typedef void (*DWCi_LobbyUserMessageReceivedCallback)(s32 userId, const char *message, void *param);
...
typedef struct DWCi_LobbyGlobalCallbacks {
    DWCi_LobbyUserMessageReceivedCallback lobbyUserMessageReceivedCallback;
...
typedef struct DWCi_LobbyChannelCallbacks {
    ...
    DWCi_LobbyChannelMessageReceivedCallback lobbyChannelMessageReceivedCallback;
