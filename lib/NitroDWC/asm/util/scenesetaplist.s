	...
	.include "include/scenesetaplist.inc"
...
_02233858:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022338E4: .word Unk_ov18_02253318
...
_02233938:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02233A28: .word Unk_ov18_022491BF
_02233A2C: .word Unk_ov18_022491A9
_02233A30: .word Unk_ov18_0224A138
_02233A34: .word 0x020C05AC
_02233A38: .word Unk_ov18_02253318
...
_02233AC8:
	...
	ldmia sp!, {r3, r4, pc}
	; .align 2, 0
_02233AE8: .word Unk_ov18_02253318
...
_02233C08:
	...
	; .align 2, 0
_02233C50: .word Unk_ov18_02253318
_02233C54: .word Unk_ov18_02249228
_02233C58: .word 0x000003FF
_02233C5C: .word Unk_ov18_0224922C
...
_02233F50:
	...
	ldmia sp!, {r3, r4, r5, pc}
	; .align 2, 0
_02233F74: .word Unk_ov18_02253318
_02233F78: .word Unk_ov18_02249734
_02233F7C: .word Unk_ov18_022491D8
...
_022341D0:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022341E4: .word Unk_ov18_02253318
...
_022342E4:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022342F0: .word Unk_ov18_02253318
...
_02234350:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234384: .word Unk_ov18_02253318
...
_02234560:
	...
	ldmia sp!, {r3, r4, r5, pc}
	; .align 2, 0
_0223456C: .word Unk_ov18_02253318
...
_02234584: .word Unk_ov18_0225331C
...
_02234614:
	...
	; .align 2, 0
_0223462C: .word Unk_ov18_02253318
...
_0223476C:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, pc}
	; .align 2, 0
_022347A4: .word Unk_ov18_02253318
...
ov18_022347A8: ; 0x022347A8
	...
	ldmia sp!, {r4, pc}
	; .align 2, 0
_02234830: .word Unk_ov18_02253318
...
_022348D4:
	...
	; .align 2, 0
_022348E8: .word Unk_ov18_02253318
...
_02234958:
	...
	ldmia sp!, {r3, r4, r5, pc}
	; .align 2, 0
_022349A8: .word Unk_ov18_02253318
...
_022349E8:
	...
	ldmia sp!, {r4, pc}
	; .align 2, 0
_02234A40: .word Unk_ov18_02253318
...
ov18_02234A44: ; 0x02234A44
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234A94: .word Unk_ov18_02253318
...
ov18_02234AA0: ; 0x02234AA0
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234ADC: .word Unk_ov18_02253318
_02234AE0: .word Unk_ov18_02249200
...
_02234C20:
	...
	ldmia sp!, {r4, pc}
	; .align 2, 0
_02234C30: .word Unk_ov18_02253318
...
_02234C78:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234CA4: .word Unk_ov18_02253318
...
_02234CFC:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234D28: .word Unk_ov18_02253318
...
ov18_02234D30: ; 0x02234D30
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02234D58: .word Unk_ov18_022491A8
_02234D5C: .word Unk_ov18_02253318
