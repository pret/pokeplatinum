	...
	.include "include/dwc_moveid.inc"
...
ov18_022425E8: ; 0x022425E8
	...
	ldmia sp!, {r4, pc}
	; .align 2, 0
_022426D4: .word Unk_ov18_022533A8
...
_02242794:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022427B0: .word Unk_ov18_022533A8
...
ov18_022427B4: ; 0x022427B4
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02242830: .word Unk_ov18_022533A8
...
ov18_02242834: ; 0x02242834
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02242878: .word Unk_ov18_022533A8
...
ov18_0224287C: ; 0x0224287C
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022428AC: .word Unk_ov18_022533A8
...
_02242C24:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02242C2C: .word Unk_ov18_022533A8
...
ov18_02242C34: ; 0x02242C34
	...
	bx lr
	; .align 2, 0
_02242C74: .word Unk_ov18_022533A8
...
_02242D24:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02242D2C: .word Unk_ov18_022533A8
...
ov18_02242D30: ; 0x02242D30
	...
	bx ip
	; .align 2, 0
_02242D4C: .word Unk_ov18_022533A8
...
_02242EF4:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02242F08: .word Unk_ov18_022533A8
...
_02242F34: .word Unk_ov18_022533A8
...
_022430FC:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02243110: .word Unk_ov18_022533A8
...
ov18_02243114: ; 0x02243114
	...
	bx lr
	; .align 2, 0
_02243128: .word Unk_ov18_022533A8
...
ov18_0224312C: ; 0x0224312C
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_02243158: .word Unk_ov18_022533A8
...
ov18_0224315C: ; 0x0224315C
	...
	ldmia sp!, {r4, pc}
	; .align 2, 0
_02243194: .word Unk_ov18_022533A8
...
ov18_02243198: ; 0x02243198
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_022431D8: .word Unk_ov18_022533A8
...
_02243328:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, r8, sb, pc}
	; .align 2, 0
_02243340: .word Unk_ov18_022533A8
...
_02243414:
	...
	; .align 2, 0
_02243424: .word Unk_ov18_022533A8
...
ov18_02243428: ; 0x02243428
	...
	bx lr
	; .align 2, 0
_0224343C: .word Unk_ov18_022533A8
