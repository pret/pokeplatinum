	...
	.include "include/stream_nnssnd.inc"
...
NNS_SndStrmInit: ; 0x020B8934
	...
	str r1, [r0, #0]
_020B8964:
	ldr r1, _020B89A4 ; =BeginSleep_dup2
	ldr r0, _020B89A8 ; =EndSleep_dup2
	str r1, [r4, #8]
	str r4, [r4, #0xc]
	str r0, [r4, #0x14]
	str r4, [r4, #0x18]
...
NNS_SndStrmAllocChannel: ; 0x020B89AC
...
NNS_SndStrmFreeChannel: ; 0x020B8A0C
	stmfd sp!, {r4, lr}
	mov r4, r0
	ldr r0, [r4, #0x44]
	cmp r0, #0
...
_020B8B3C:
	...
	ldr r1, [sp, #0x18]
	ldr r0, [sl, #0x40]
	ldr r3, _020B8BCC ; =AlarmCallback_dup1
	mov r2, r1
	bl SND_SetupAlarm
...
NNS_SndStrmStop: ; 0x020B8C28
	stmfd sp!, {r3, lr}
	ldr r1, [r0, #0x24]
	mov r1, r1, lsl #0x1f
	movs r1, r1, asr #0x1f
	ldmeqia sp!, {r3, pc}
	bl ForceStopStrm_dup1
	ldmia sp!, {r3, pc}
	arm_func_end NNS_SndStrmStop

	arm_func_start NNS_SndStrmSetVolume
NNS_SndStrmSetVolume: ; 0x020B8C44
...
_020B8D18:
	...
	arm_func_end ForceStopStrm_dup1

	arm_func_start ShutdownStrm
ShutdownStrm: ; 0x020B8D24
	stmfd sp!, {r4, lr}
	mov r4, r0
	ldr r0, [r4, #0x40]
	bl NNS_SndFreeAlarm
...
AlarmCallback_dup1: ; 0x020B8D54
	ldr ip, _020B8D60 ; =StrmCallback
	mov r1, #1
	bx ip
	; .align 2, 0
_020B8D60: .word StrmCallback
	arm_func_end AlarmCallback_dup1

	arm_func_start StrmCallback
StrmCallback: ; 0x020B8D64
	stmfd sp!, {r3, r4, r5, lr}
	sub sp, sp, #8
	mov r5, r0
	mov r4, r1
...
BeginSleep_dup2: ; 0x020B8E14
	...
	bl SND_WaitForCommandProc
	ldmia sp!, {r4, pc}
	arm_func_end BeginSleep_dup2

	arm_func_start EndSleep_dup2
EndSleep_dup2: ; 0x020B8E60
	stmfd sp!, {r4, r5, r6, lr}
	mov r4, r0
	ldr r0, [r4, #0x24]
	mov r0, r0, lsl #0x1e
