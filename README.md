...
* Take everything in that newly created **root** folder (note, not the **root** folder itself, just its contents) and copy it into the folder with your Platinum ROM.
