...
_0046:
    Message 2
    InitGlobalTextMenu 31, 13, 0, TRUE, 0x800C
    SetMenuHorizAnchor FIELD_MENU_ANCHOR_RIGHT
    AddMenuEntryImmediate 153, 0
    AddMenuEntryImmediate 154, 1
    ShowMenu
...
_04C7:
    InitLocalTextMenu 31, 11, 0, TRUE, 0x800C
    SetMenuHorizAnchor FIELD_MENU_ANCHOR_RIGHT
    AddMenuEntryImmediate 22, 0
    AddMenuEntryImmediate 23, 1
    AddMenuEntryImmediate 24, 2
    ShowMenu
    SetVar 0x8008, 0x800C
