...
_0178:
    ...
    AddMenuEntryImmediate 188, 0
    AddMenuEntryImmediate 189, 1
    AddMenuEntryImmediate 190, 2
    AddMenuEntryImmediate 191, 3
    AddMenuEntryImmediate 192, 4
    ShowMenu
    CloseMessage
...
_030C:
    ...
    Message 3
    InitGlobalTextMenu 1, 1, 0, TRUE, 0x800C
    AddMenuEntryImmediate 186, 0
    AddMenuEntryImmediate 187, 1
    AddMenuEntryImmediate 190, 2
    AddMenuEntryImmediate 191, 3
    AddMenuEntryImmediate 192, 4
    ShowMenu
...
_04A0:
    ...
    AddMenuEntryImmediate 186, 0
    AddMenuEntryImmediate 187, 1
    AddMenuEntryImmediate 188, 2
    AddMenuEntryImmediate 189, 3
    AddMenuEntryImmediate 192, 4
    ShowMenu
    CloseMessage
    GoToIfEq 0x800C, 4, _06C2
