...
_012C:
    Message 1
    InitGlobalTextListMenu 1, 1, 1, TRUE, 0x800C
    AddListMenuEntry 163, 250
    AddListMenuEntry 6, 0
    AddListMenuEntry 7, 1
    AddListMenuEntry 8, 2
    AddListMenuEntry 164, 250
...
_0565:
    ...
    AddMenuEntryImmediate 41, 0
    AddMenuEntryImmediate 42, 1
    AddMenuEntryImmediate 10, 2
    ShowMenu
    SetVar 0x8008, 0x800C
