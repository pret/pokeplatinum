...
_00D0:
    ...
    GoToIfEq VAR_0x800C, 0, _00AF
    ScrCmd_1D8 VAR_0x800C
    GoToIfEq VAR_0x800C, 1, _00BA
    GoToIfEq VAR_0x800C, 2, _00C5
...
_01B7:
    ...
    GoToIfEq VAR_0x800C, MENU_NO, _0173
    CloseMessage
    ScrCmd_0F2 6, 0, 0, VAR_0x800C
    GoToIfEq VAR_0x800C, 1, _01F9
    GoToIfEq VAR_0x800C, 3, _0203
    GoTo _0263
    End
...
_020D:
    ...
    GoToIfEq VAR_0x800C, MENU_NO, _0173
    CloseMessage
    ScrCmd_0F3 6, 0, 0, VAR_0x800C
    GoToIfEq VAR_0x800C, 1, _024F
    GoToIfEq VAR_0x800C, 3, _0259
    GoTo _0263
    End
