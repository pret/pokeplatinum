...
_0127:
    ...
    AddMenuEntryImmediate 129, 0
    AddMenuEntryImmediate 128, 1
    AddMenuEntryImmediate 130, 2
    ShowMenu
...
_017D:
    InitGlobalTextMenu 1, 1, 0, TRUE, 0x800C
    AddMenuEntryImmediate 131, 0
    AddMenuEntryImmediate 132, 1
    AddMenuEntryImmediate 133, 2
    ShowMenu
    SetVar 0x8008, 0x800C
...
_0420:
    ...
    AddMenuEntryImmediate 38, 0
    AddMenuEntryImmediate 39, 1
    AddMenuEntryImmediate 40, 2
    ShowMenu
    SetVar 0x8008, 0x800C
