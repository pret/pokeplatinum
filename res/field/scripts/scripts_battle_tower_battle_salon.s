...
BattleTowerBattleSalon_OnTransition:
    ...
    CallBattleTowerFunction BT_FUNC_GET_PARTNER_PARAM, BT_PARAM_PARTNER_ID, VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, BT_PARTNER_CHERYL, BattleTowerBattleSalon_HideCheryl
...
BattleTowerBattleSalon_CheckShowMira:
    ...
    CallBattleTowerFunction BT_FUNC_GET_PARTNER_PARAM, BT_PARAM_PARTNER_ID, VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, BT_PARTNER_MIRA, BattleTowerBattleSalon_HideMira
...
BattleTowerBattleSalon_CheckShowRiley:
    ...
    CallBattleTowerFunction BT_FUNC_GET_PARTNER_PARAM, BT_PARAM_PARTNER_ID, VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, BT_PARTNER_RILEY, BattleTowerBattleSalon_HideRiley
...
BattleTowerBattleSalon_CheckShowMarley:
    ...
    CallBattleTowerFunction BT_FUNC_GET_PARTNER_PARAM, BT_PARAM_PARTNER_ID, VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, BT_PARTNER_MARLEY, BattleTowerBattleSalon_HideMarley
...
BattleTowerBattleSalon_CheckShowBuck:
    ...
    CallBattleTowerFunction BT_FUNC_GET_PARTNER_PARAM, BT_PARAM_PARTNER_ID, VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, BT_PARTNER_BUCK, BattleTowerBattleSalon_HideBuck
...
BattleTowerBattleSalon_BufferSpeciesAndMoveNames:
    GetBattleTowerPartnerSpeciesAndMove VAR_MAP_LOCAL_0x9, 0, VAR_0x8004, VAR_0x8005
    BufferSpeciesNameFromVar 0, VAR_0x8004, 0, 0
    BufferMoveName 1, VAR_0x8005
    GetBattleTowerPartnerSpeciesAndMove VAR_MAP_LOCAL_0x9, 1, VAR_0x8004, VAR_0x8005
...
BattleTowerBattleSalon_Cheryl:
    ...
    SetVar VAR_MAP_LOCAL_0x9, BT_PARTNER_CHERYL
    GetBattleTowerPartnerSpeciesAndMove VAR_MAP_LOCAL_0x9, 0, VAR_0x8004, VAR_0x8005
...
BattleTowerBattleSalon_CherylTeamUp:
    CallBattleTowerFunction BT_FUNC_SET_PARTNER_ID, VAR_MAP_LOCAL_0x9, 0
...
BattleTowerBattleSalon_Mira:
    ...
    SetVar VAR_MAP_LOCAL_0x9, BT_PARTNER_MIRA
...
BattleTowerBattleSalon_Riley:
    ...
    SetVar VAR_MAP_LOCAL_0x9, BT_PARTNER_RILEY
    Call BattleTowerBattleSalon_BufferSpeciesAndMoveNames
...
BattleTowerBattleSalon_Marley:
    ...
    SetVar VAR_MAP_LOCAL_0x9, BT_PARTNER_MARLEY
    Call BattleTowerBattleSalon_BufferSpeciesAndMoveNames
...
BattleTowerBattleSalon_Buck:
    ...
    SetVar VAR_MAP_LOCAL_0x9, BT_PARTNER_BUCK
    Call BattleTowerBattleSalon_BufferSpeciesAndMoveNames
...
BattleTowerBattleSalon_PartnerEnterBattleRoom:
    ApplyMovement VAR_MAP_LOCAL_0x0, BattleTowerBattleSalon_Movement_PartnerFaceNorth
    WaitMovement
    ApplyMovement LOCALID_TEALA, BattleTowerBattleSalon_Movement_AttendantMoveAway
    WaitMovement
    Call BattleTowerBattleSalon_PlayOpenDoorAnimation
    ApplyMovement VAR_MAP_LOCAL_0x0, BattleTowerBattleSalon_Movement_PartnerEnterBattleRoom
    WaitMovement
    Call BattleTowerBattleSalon_PlayCloseDoorAnimation
...
BattleTowerBattleSalon_CherylWalkToAttendant:
    SetVar VAR_MAP_LOCAL_0x0, LOCALID_CHERYL
...
BattleTowerBattleSalon_MiraWalkToAttendant:
    SetVar VAR_MAP_LOCAL_0x0, LOCALID_MIRA
    GetPlayerMapPos VAR_0x8000, VAR_0x8001
...
BattleTowerBattleSalon_RileyWalkToAttendant:
    SetVar VAR_MAP_LOCAL_0x0, LOCALID_RILEY
    GetPlayerMapPos VAR_0x8000, VAR_0x8001
...
BattleTowerBattleSalon_MarleyWalkToAttendant:
    SetVar VAR_MAP_LOCAL_0x0, LOCALID_MARLEY
    GetPlayerMapPos VAR_0x8000, VAR_0x8001
...
BattleTowerBattleSalon_BuckWalkToAttendant:
    SetVar VAR_MAP_LOCAL_0x0, LOCALID_BUCK
    GetPlayerMapPos VAR_0x8000, VAR_0x8001
