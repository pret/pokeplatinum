...
Contests_LobbyOnTransition:
    ...
    CheckTVInterviewEligible TV_PROGRAM_SEGMENT_CONTEST_HALL, VAR_MAP_LOCAL_0x0
    GoToIfEq VAR_MAP_LOCAL_0x0, FALSE, ContestHallLobby_HideReporter
...
Contests_ReceptionistOfficialContest:
    ...
    LockAll
    FacePlayer
    SetVar VAR_MAP_LOCAL_0x3, CONTEST_MODE_OFFICIAL
...
Contests_ReceptionistLinkContest:
    ...
    LockAll
    FacePlayer
    SetVar VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK
    SetVar VAR_0x8007, CONTEST_COMPETITION_LINK_OR_OFFICIAL
...
Contests_AskEnterContest:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_AskEnterLinkContest
...
Contests_EnterContest:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_EnterLinkContest
...
Contests_EnterLinkContest:
    ...
    ClearFlag FLAG_COMMUNICATION_CLUB_ACCESSIBLE
    Common_SaveGame
    SetVar VAR_RESULT, VAR_MAP_LOCAL_0x0  @ VAR_MAP_LOCAL_0x0 is set in CommonScript_SaveGame
...
Contests_ContestInfo:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_LinkContestInfo
...
Contests_OfficialContestRegisterMon:
    ...
    FadeScreenOut
    WaitFadeScreen
    CallIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_OFFICIAL, Contests_UseSelectedContestRank
    CallIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_UseDefaultContestRank
    SetVar VAR_RESULT, 0
Contests_OfficialContestTryRegisterMon:
    OpenPartyMenuForContest VAR_RESULT, VAR_0x8004, VAR_0x8005, VAR_MAP_LOCAL_0x4
    GetContestPartyMenuResult VAR_MAP_LOCAL_0x2, VAR_RESULT
    GoToIfEq VAR_RESULT, 0, Contests_OfficialContestRegisterMonDone
    SetMonSummary VAR_MAP_LOCAL_0x2
...
Contests_OfficialContestRegisterMonDone:
    ...
    FadeScreenIn
    WaitFadeScreen
    GoToIfEq VAR_MAP_LOCAL_0x2, PARTY_SLOT_NONE, Contests_OfficialContestAskCancel
...
Contests_UseSelectedContestRank:
    SetVar VAR_MAP_LOCAL_0x4, FALSE
    Return

Contests_UseDefaultContestRank:
    SetVar VAR_MAP_LOCAL_0x4, TRUE
    Return

Contests_OfficialContestStart:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_LinkContestEstablishGroup
...
Contests_StartContest:
    NewContest VAR_0x8004, VAR_0x8005, VAR_0x8007, VAR_MAP_LOCAL_0x2
    CallIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_SetupLinkContest
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_PRACTICE, Contests_RegisteredForPractice
...
Contests_SelectContestDoor:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_OFFICIAL, Contests_OfficialContestDoor
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_LINK, Contests_LinkContestDoor
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_PRACTICE, Contests_PracticeContestDoor
    End
...
Contests_ChangeIntoContestAttire:
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_PRACTICE, Contests_StartPracticeContest
...
Contests_StartPracticeContest:
    ...
    GetContestInfo VAR_0x8004, VAR_0x8005, VAR_0x8007, VAR_MAP_LOCAL_0x2
    SetVar VAR_ONGOING_CONTEST, FALSE
    Warp MAP_HEADER_CONTEST_HALL_LOBBY, 28, 3, DIR_SOUTH
    LockAll
    FadeScreenIn
    WaitFadeScreen
    GetContestMode VAR_MAP_LOCAL_0x3
    GetContestInfo VAR_0x8004, VAR_0x8005, VAR_0x8007, VAR_MAP_LOCAL_0x2
    GetPlayerContestPlacement VAR_0x8004
    LockTextSpeed
    EndContest VAR_MAP_LOCAL_0x2
...
Contests_EndContest:
    ...
    EndContest VAR_MAP_LOCAL_0x2
    SetVar VAR_ONGOING_CONTEST, FALSE
    GoToIfEq VAR_MAP_LOCAL_0x3, CONTEST_MODE_OFFICIAL, Contests_OfficialContestReturnToReceptionist
...
Contests_PresentWinner:
    ...
    GetWinningContestantEntryNum VAR_MAP_LOCAL_0x0
    GoToIfEq VAR_MAP_LOCAL_0x0, 0, Contests_HideContestant1
    GoToIfEq VAR_MAP_LOCAL_0x0, 1, Contests_HideContestant2
    GoToIfEq VAR_MAP_LOCAL_0x0, 2, Contests_HideContestant3
    GoToIfEq VAR_MAP_LOCAL_0x0, 3, Contests_HideContestant4
    Return
...
Contests_ReceptionistPracticeContest:
    ...
    LockAll
    FacePlayer
    SetVar VAR_MAP_LOCAL_0x3, CONTEST_MODE_PRACTICE
    SetVar VAR_0x8004, CONTEST_RANK_NORMAL
...
Contests_PracticeContestCategorySelected:
    GoToIfEq VAR_MAP_LOCAL_0x4, TRUE, Contests_PracticeContestRegisterMon
...
Contests_PracticeContestRegisterMonDone:
    ...
    FadeScreenIn
    WaitFadeScreen
    GoToIfEq VAR_MAP_LOCAL_0x2, PARTY_SLOT_NONE, Contests_PracticeContestTypeOrRegisterExit
    GoTo Contests_StartContest
    End
