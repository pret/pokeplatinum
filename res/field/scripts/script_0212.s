...
_008B:
    ...
    CallIf 1, _00C8
    CompareVarToValue 0x8007, 5
    CallIf 1, _00DF
    CompareVarToValue 0x8007, 7
    CallIf 1, _00F6
    ScrCmd_028 0x8004, 0
    ScrCmd_03E 0x800C
    Return
