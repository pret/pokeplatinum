...
Villa_OnTransition:
    ...
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_SetCounterpartGraphicsDawn
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_SetCounterpartGraphicsLucas
    ...
    SetVar VAR_MAP_LOCAL_0xF, VAR_RESORT_VILLA_VISITOR
...
Villa_CounterpartMessage0:
    GetPlayerGender VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_DawnMessage0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_LucasMessage0
    Return

Villa_CounterpartMessage1:
    GetPlayerGender VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_DawnMessage1
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_LucasMessage1
    Return

Villa_CounterpartMessage2:
    GetPlayerGender VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_DawnMessage2
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_LucasMessage2
    Return

Villa_CounterpartMessage3:
    GetPlayerGender VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_DawnMessage3
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_LucasMessage3
    Return

Villa_CounterpartMessage4:
    GetPlayerGender VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, Villa_DawnMessage4
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, Villa_LucasMessage4
    Return
