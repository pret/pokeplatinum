...
BattleTower_OnTransition:
    ...
    CallIfEq VAR_MAP_LOCAL_0x0, FALSE, BattleTower_HideBattleFrontierReporter
    CallIfNe VAR_MAP_LOCAL_0x0, FALSE, BattleTower_ShowBattleFrontierReporter
    ScrCmd_1E0 VAR_MAP_LOCAL_0x0
    GoToIfNe VAR_MAP_LOCAL_0x0, 0, BattleTower_ShowTealaTryShowReporter
    SetFlag FLAG_HIDE_BATTLE_TOWER_TEALA
    GoTo BattleTower_TryShowBattleTowerReporter
    End

BattleTower_TryShowBattleTowerReporter:
    CheckTVInterviewEligible TV_PROGRAM_SEGMENT_BATTLE_TOWER_CORNER, VAR_MAP_LOCAL_0x0
    GoToIfNe VAR_MAP_LOCAL_0x0, FALSE, BattleTower_ShowReporter
...
BattleTower_OnResume:
    ...
    ScrCmd_1E0 VAR_MAP_LOCAL_0x0
    GoToIfNe VAR_MAP_LOCAL_0x0, 0, BattleTower_SetTealaDirectionWest
    GoToIfEq VAR_MAP_LOCAL_0x0, 1, BattleTower_SetTealaDirectionWest
    GoToIfEq VAR_MAP_LOCAL_0x0, 2, BattleTower_SetTealaDirectionWest
    GoToIfEq VAR_MAP_LOCAL_0x0, 3, BattleTower_SetTealaDirectionWest
...
BattleTower_Teala:
    ...
    ScrCmd_1DF VAR_MAP_LOCAL_0x2
    GoTo BattleTower_TryGiveTrophy
    End

BattleTower_TryGiveTrophy:
    SetVar VAR_0x8008, VAR_MAP_LOCAL_0x2
...
BattleTower_TealaEnd:
    WaitABPress
    GoToIfEq VAR_MAP_LOCAL_0x1, 1, BattleTower_TealaClearCommunication
    CloseMessage
    ReleaseAll
    End
...
BattleTower_HealAndSaveBeforeEnteringMultiBattleRoom:
    ...
    SetVar VAR_MAP_LOCAL_0x9, VAR_RESULT
...
BattleTower_EnterBattleRoomAnimation:
    ApplyMovement VAR_MAP_LOCAL_0x2, BattleTower_Movement_AttendantWalkToDoor
    ApplyMovement LOCALID_PLAYER, BattleTower_Movement_PlayerWalkToDoor
    WaitMovement
    LoadDoorAnimation 0, 0, VAR_MAP_LOCAL_0x3, 2, ANIMATION_TAG_DOOR_1
    PlayDoorOpenAnimation ANIMATION_TAG_DOOR_1
    WaitForAnimation ANIMATION_TAG_DOOR_1
    ApplyMovement VAR_MAP_LOCAL_0x2, BattleTower_Movement_AttendantEnterBattleRoom
...
BattleTower_TrySendPreviousResults:
    FadeScreenOut
    WaitFadeScreen
    ScrCmd_0B3 VAR_MAP_LOCAL_0x0
    CallBattleTowerFunction BT_FUNC_UNK_16, VAR_MAP_LOCAL_0x1, VAR_MAP_LOCAL_0x0
    SetVar VAR_MAP_LOCAL_0x1, VAR_MAP_LOCAL_0x0
    ReturnToField
    FadeScreenIn
    WaitFadeScreen
    SetVar VAR_RESULT, VAR_MAP_LOCAL_0x1
    Return
...
BattleTower_SelectAndValidatePokemonMultiChallenge:
    ...
    TryRevertPokemonForm VAR_RESULT, VAR_RESULT
    GoToIfEq VAR_RESULT, 0xFF, BattleTower_GriseousOrbCouldNotBeRemoved
    GoToIfEq VAR_MAP_LOCAL_0x1, 1, BattleTower_HealAndSaveBeforeCommunicating
...
_0D72:
    ...
    ScrCmd_1E2 0, VAR_MAP_LOCAL_0x0
    SetVar VAR_0x8008, VAR_MAP_LOCAL_0x0
    ...
    ScrCmd_1E2 1, VAR_MAP_LOCAL_0x0
    GoTo _0E58
    End
...
BattleTower_SaveAndEnd:
    ...
    Call BattleTower_TrySaveGame
    CloseMessage
    GoToIfEq VAR_MAP_LOCAL_0x0, 0, _118A
    GoTo BattleTower_ClearCommunicationAndEnd
    End
...
_0F7E:
    CallBattleTowerFunction BT_FUNC_GET_CHALLENGE_MODE, 0, VAR_RESULT
    SetVar VAR_MAP_LOCAL_0x0, VAR_RESULT
    GoToIfEq VAR_MAP_LOCAL_0x0, BATTLE_TOWER_MODE_5, BattleTower_BeatenAllSevenTrainersSave
    GoToIfEq VAR_MAP_LOCAL_0x0, BATTLE_TOWER_MODE_SINGLE, _1091
    GoToIfEq VAR_MAP_LOCAL_0x0, BATTLE_TOWER_MODE_WIFI, _0FEA
    CallBattleTowerFunction BT_FUNC_UNK_49, 0, VAR_RESULT
...
_100A:
    ...
    SetVar VAR_MAP_LOCAL_0x0, VAR_RESULT
    BufferPlayerName 0
    BufferNumber 1, VAR_MAP_LOCAL_0x0
...
_1048:
    BufferNumber 0, VAR_MAP_LOCAL_0x0
...
_10BC:
    ...
    CloseMessage
    SetVar VAR_MAP_LOCAL_0x2, VAR_RESULT
    SetVar VAR_MAP_LOCAL_0x1, 1
