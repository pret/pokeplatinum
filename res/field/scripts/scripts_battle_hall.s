...
BattleHall_OnResume:
    GetNumSpeciesWithBattleHallRecords VAR_MAP_LOCAL_0x0
    CallIfGe VAR_MAP_LOCAL_0x0, 11, BattleHall_SerenaWinstonMoveCloser
    CallIfGe VAR_MAP_LOCAL_0x0, 101, BattleHall_SerenaWinstonMoveEvenCloser
    End
...
BattleHall_UpdateConditionalNPCs:
    ...
    GetRandom VAR_MAP_LOCAL_0x7, 100
    CallIfUnset FLAG_HIDE_BATTLE_HALL_MAJOR_NPC, BattleHall_HideMajorNPC
    GoToIfLt VAR_MAP_LOCAL_0x7, 30, BattleHall_TryPickMajorNPC
    End
...
BattleHall_PickMajorNPC:
    ...
    GetBattleHallTotalSinglesRecord VAR_MAP_LOCAL_0x8
    GoToIfGe VAR_MAP_LOCAL_0x8, 10000, BattleHall_PickMajorNPCAfter10000Record
    GoToIfGe VAR_MAP_LOCAL_0x8, 1000, BattleHall_PickMajorNPCAfter1000Record
    GoToIfGe VAR_MAP_LOCAL_0x8, 500, BattleHall_PickMajorNPCAfter500Record
    End
...
BattleHall_UpdateReporter:
    ...
    CheckTVInterviewEligible TV_PROGRAM_SEGMENT_BATTLE_FRONTIER_FRONTLINE_NEWS_SINGLE, VAR_MAP_LOCAL_0x0
    GoToIfEq VAR_MAP_LOCAL_0x0, FALSE, BattleHall_HideReporter
    ScrCmd_32A VAR_MAP_LOCAL_0x0
    GoToIfEq VAR_MAP_LOCAL_0x0, 0, BattleHall_HideReporter
...
BattleHall_OnTransition:
    ...
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_MALE, BattleHall_SetSerenaAsFan
    CallIfEq VAR_MAP_LOCAL_0x0, GENDER_FEMALE, BattleHall_SetWinstonAsFan
    Call BattleHall_UpdateMajorNPC_GFX
    CheckTVInterviewEligible TV_PROGRAM_SEGMENT_BATTLE_FRONTIER_FRONTLINE_NEWS_SINGLE, VAR_MAP_LOCAL_0x0
    CallIfEq VAR_MAP_LOCAL_0x0, 0, BattleHall_HideReporter
    End
...
BattleHall_SetCounterpartAsMajorNPC:
    GetPlayerGender VAR_MAP_LOCAL_0x9
    GoToIfEq VAR_MAP_LOCAL_0x9, GENDER_MALE, BattleHall_SetDawnAsMajorNPC
    GoToIfEq VAR_MAP_LOCAL_0x9, GENDER_FEMALE, BattleHall_SetLucasAsMajorNPC
    Return
...
BattleHall_WelcomeToChallenge:
    RecordHeapMemory
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleHall_WelcomeToSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleHall_WelcomeToMultiChallenge
    GoTo BattleHall_SelectChallenge
    End

BattleHall_SelectChallenge:
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleHall_InitMenuSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleHall_InitMenuMultiChallenge
...
BattleHall_ExplainChallenge:
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleHall_ExplainSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleHall_ExplainMultiChallenge
    GoTo BattleHall_SelectChallenge
    End
...
BattleHall_SelectPokemon:
    ...
    GetBattleHallSelectedSlots VAR_MAP_LOCAL_0x2, VAR_MAP_LOCAL_0x5
    ReturnToField
    FadeScreenIn
    WaitFadeScreen
    GoToIfEq VAR_MAP_LOCAL_0x2, 0xFF, BattleHall_EndChallenge
    ...
    GoToIfEq VAR_MAP_LOCAL_0x1, 0, BattleHall_EndChallenge
    ...
    GoToIfEq VAR_RESULT, VAR_MAP_LOCAL_0x1, BattleHall_TryStartSingleDoubleChallenge
    GoTo BattleHall_AskDeleteOngoingStreak
    End

BattleHall_AskDeleteOngoingStreak:
    BufferSpeciesNameFromVar 1, VAR_MAP_LOCAL_0x1, 0, 0
...
BattleHall_StartMultiChallenge:
    ...
    ScrCmd_135 108
    CheckBattleHallPartnerUsesDifferentSpecies VAR_MAP_LOCAL_0x1, VAR_RESULT
...
BattleHall_MajorNPC:
    ...
    GoToIfEq VAR_MAP_LOCAL_0x1, OBJ_EVENT_GFX_PLAYER_M, BattleHall_Lucas
    GoToIfEq VAR_MAP_LOCAL_0x1, OBJ_EVENT_GFX_PLAYER_F, BattleHall_Dawn
    GoToIfEq VAR_MAP_LOCAL_0x1, OBJ_EVENT_GFX_MOM, BattleHall_Mom
    GoToIfEq VAR_MAP_LOCAL_0x1, OBJ_EVENT_GFX_PROF_OAK, BattleHall_Oak
    GoToIfEq VAR_MAP_LOCAL_0x1, OBJ_EVENT_GFX_JASMINE, BattleHall_Jasmine
    End
