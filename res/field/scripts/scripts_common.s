...
_0C1C:
    BufferPlayerName 0
    Message 33
    InitGlobalTextMenu 1, 1, 0, TRUE, 0x8006
    CallIfUnset 0x97E, _0C7B
    CallIfSet 0x97E, _0C81
    AddMenuEntryImmediate 60, 1
    ScrCmd_22D 2, 0x800C
...
_0C7B:
    AddMenuEntryImmediate 58, 0
    Return

_0C81:
    AddMenuEntryImmediate 59, 0
    Return

_0C87:
    AddMenuEntryImmediate 63, 2
    Return

_0C8D:
    AddMenuEntryImmediate 62, 2
    Return

_0C93:
    AddMenuEntryImmediate 61, 3
    AddMenuEntryImmediate 64, 4
    ShowMenu
