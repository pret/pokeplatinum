...
BattleCastle_OnTransition:
    ...
    GoToIfEq VAR_MAP_LOCAL_0x0, FALSE, BattleCastle_HideBattleFrontierReporter
...
BattleCastle_Attendant:
    RecordHeapMemory
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleCastle_WelcomeToSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleCastle_WelcomeToMultiChallenge
    GoTo BattleCastle_SelectChallenge
    End

BattleCastle_SelectChallenge:
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleCastle_InitMenuSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleCastle_InitMenuMultiChallenge
...
BattleCastle_ExplainChallenge:
    CallIfEq VAR_MAP_LOCAL_0x4, 0, BattleCastle_ExplainSingleDoubleChallenge
    CallIfEq VAR_MAP_LOCAL_0x4, 1, BattleCastle_ExplainMultiChallenge
    GoTo BattleCastle_SelectChallenge
    End
...
BattleCastle_SelectPokemon:
    ...
    ScrCmd_2D4 VAR_MAP_LOCAL_0x2, VAR_MAP_LOCAL_0x5, VAR_MAP_LOCAL_0x6
    ReturnToField
    FadeScreenIn
    WaitFadeScreen
    GoToIfEq VAR_MAP_LOCAL_0x2, 0xFF, BattleCastle_EndChallenge
    ...
    GoToIfEq VAR_MAP_LOCAL_0x1, 0, BattleCastle_EndChallenge
