...
_002E:
    ...
    GoToIfEq VAR_0x800C, GENDER_MALE, _00EE
    GoTo _00F9
    End
...
_01EC:
    ...
    LockAll
    ScrCmd_12F 0, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _031D
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    ScrCmd_0A8 0, VAR_0x800C
    ReturnToField
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    ReleaseAll
...
_0229:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    ScrCmd_12F 1, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _031D
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    ScrCmd_0A8 1, VAR_0x800C
    ReturnToField
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    ReleaseAll
...
_0266:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    ScrCmd_12F 2, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _031D
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    ScrCmd_0A8 2, VAR_0x800C
    ReturnToField
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    ReleaseAll
...
_02A3:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    ScrCmd_12F 3, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _031D
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    ScrCmd_0A8 3, VAR_0x800C
    ReturnToField
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    ReleaseAll
...
_02E0:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    ScrCmd_12F 4, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _031D
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    ScrCmd_0A8 4, VAR_0x800C
    ReturnToField
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    ReleaseAll
...
_038A:
    ...
    GoToIfEq VAR_0x800C, 0, _037F
    Message 13
    ScrCmd_28A VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _03C8
    Call _0437
...
_03D3:
    ...
    CheckItem ITEM_POFFIN_CASE, 1, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _0428
    Message 13
    ScrCmd_28A VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _0419
    Call _0437
    SetFlag FLAG_UNK_0x015A
    Message 16
    CloseMessage
...
_0437:
    ScrCmd_289 VAR_0x800C, 60, 30, 30, 30, 30, 40
    PlaySound SEQ_FANFA4
    BufferPlayerName 0
    Message 14
    WaitSound
...
_04A4:
    ...
    GetPlayerDir VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _052B
    GoToIfEq VAR_0x800C, 1, _053D
    GoToIfEq VAR_0x800C, 2, _054F
    GoToIfEq VAR_0x800C, 3, _0561
    End
