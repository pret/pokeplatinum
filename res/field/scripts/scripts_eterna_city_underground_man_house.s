...
_02D9:
    ...
    ClearFlag FLAG_UNK_0x0111
    Message 18
    SetVar VAR_0x8004, GOOD_PLAIN_TABLE
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    SetVar VAR_0x8004, GOOD_WOODEN_CHAIR
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    SetVar VAR_0x8004, GOOD_SMALL_BOOKSHELF
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    SetVar VAR_0x8004, GOOD_BUNEARY_DOLL
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    Message 19
    WaitABXPadPress
...
_03A3:
    SetVar VAR_0x8004, GOOD_CHIMCHAR_DOLL
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    Return

_03B5:
    SetVar VAR_0x8004, GOOD_TURTWIG_DOLL
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    Return

_03C7:
    SetVar VAR_0x8004, GOOD_PIPLUP_DOLL
    SetVar VAR_0x8005, 1
    CallCommonScript 0x7FE
    Return
...
_03D9:
    ...
    SetVar VAR_0x8004, GOOD_PRETTY_GEM
    SetVar VAR_0x8005, 1
...
_0448:
    ...
    SetVar VAR_0x8004, GOOD_SHINY_GEM
    SetVar VAR_0x8005, 1
    CheckHasRoomForGoodsInPC VAR_0x8004, VAR_0x8005, VAR_RESULT
    GoToIfEq VAR_RESULT, 0, _056B
...
_04A9:
    ...
    SetVar VAR_0x8004, GOOD_MYSTIC_GEM
    SetVar VAR_0x8005, 1
    CheckHasRoomForGoodsInPC VAR_0x8004, VAR_0x8005, VAR_RESULT
    GoToIfEq VAR_RESULT, 0, _056B
    CallCommonScript 0x7DC
...
_050A:
    ...
    SetVar VAR_0x8004, GOOD_GLITTER_GEM
    SetVar VAR_0x8005, 1
    CheckHasRoomForGoodsInPC VAR_0x8004, VAR_0x8005, VAR_RESULT
    GoToIfEq VAR_RESULT, 0, _056B
    CallCommonScript 0x7DC
