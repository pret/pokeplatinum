...
_0021:
    ...
    GoToIfEq VAR_0x800C, MENU_YES, _004C
    GoToIfEq VAR_0x800C, MENU_NO, _0232
    End
...
_004C:
    ...
    CheckHasLearnableTutorMoves VAR_0x8000, TUTOR_LOCATION_SURVIVAL_AREA, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _023D
    BufferPartyMonNickname 0, VAR_0x8000
    Message 5
    ShowMoveTutorMoveSelectionMenu VAR_0x8000, TUTOR_LOCATION_SURVIVAL_AREA, VAR_0x800C
    SetVar VAR_0x8003, VAR_0x800C
    GoToIfEq VAR_0x8003, -2, _0232
    CheckCanAffordMove VAR_0x8003, VAR_0x800C
    GoToIfEq VAR_0x800C, 0, _0248
    GetPartyMonMoveCount VAR_0x800C, VAR_0x8000
    SetVar VAR_0x8002, VAR_0x800C
    GoToIfEq VAR_0x800C, 4, _00FD
    GoTo _01F2
    End
...
_00FD:
    ...
    Message 9
    ShowYesNoMenu VAR_0x800C
    GoToIfEq VAR_0x800C, MENU_NO, _01B7
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    CloseMessage
...
_01B7:
    ...
    Message 10
    ShowYesNoMenu VAR_0x800C
    GoToIfEq VAR_0x800C, MENU_YES, _01DD
    GoTo _00FD
    End
