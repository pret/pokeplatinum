...
_152:
    ...
    // {0} was burned!
    PrintMessage BattleStrings_Text_PokemonWasBurned, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _190

_177:
    // {0}’s {1} burned {2}!
    PrintMessage BattleStrings_Text_PokemonsAbilityBurnedPokemon, TAG_NICKNAME_ABILITY_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP, BTLSCR_SIDE_EFFECT_MON
    GoTo _190

_185:
    // {0} got a burn from the {1}!
    PrintMessage BattleStrings_Text_PokemonGotABurnFromTheItem, TAG_NICKNAME_ITEM, BTLSCR_SIDE_EFFECT_MON, BTLSCR_MSG_TEMP
...
_228:
    ...
    PrintMessage BattleStrings_Text_PokemonAlreadyHasABurn, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _305
...
_264:
    ...
    PrintMessage BattleStrings_Text_PokemonsAbilityPreventsBurns, TAG_NICKNAME_ABILITY, BTLSCR_SIDE_EFFECT_MON, BTLSCR_SIDE_EFFECT_MON
    GoTo _305
