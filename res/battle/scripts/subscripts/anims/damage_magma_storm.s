...
L_0:
    ...
    CallFunc 72, 10, 0, 0, 360, 0, 360, 64, 48, 40, 0, 0
    CreateEmitterEx 0, 1, 1, 3
    CallFunc 72, 10, 1, 0, 360, 0, 360, 64, 48, 40, 0, 0
    CreateEmitterEx 0, 2, 2, 3
    CallFunc 72, 10, 2, 0, 360, 0, 360, 64, 48, 40, 0, 0
    Delay 5
    CallFunc 34, 6, 2, 0, 3, 31, 10, 10
    CreateEmitterEx 0, 3, 0, 3
    CallFunc 72, 10, 3, 0, 360, 0, 360, 64, 48, 40, 0, 0
    CreateEmitterEx 0, 4, 1, 3
    CallFunc 72, 10, 4, 0, 360, 0, 360, 64, 48, 40, 0, 0
    CreateEmitterEx 0, 5, 2, 3
    CallFunc 72, 10, 5, 0, 360, 0, 360, 64, 48, 40, 0, 0
    Delay 5
    CreateEmitterEx 1, 0, 0, 3
    CallFunc 72, 10, 0, 0, 360, 0, 360, 64, 48, 40, 0, 1
    CreateEmitterEx 1, 1, 1, 3
    CallFunc 72, 10, 1, 0, 360, 0, 360, 64, 48, 40, 0, 1
    CreateEmitterEx 1, 2, 2, 3
    CallFunc 72, 10, 2, 0, 360, 0, 360, 64, 48, 40, 0, 1
    Delay 5
    CreateEmitterEx 1, 3, 0, 3
    CallFunc 72, 10, 3, 0, 360, 0, 360, 64, 48, 40, 0, 1
    CreateEmitterEx 1, 4, 1, 3
    CallFunc 72, 10, 4, 0, 360, 0, 360, 64, 48, 40, 0, 1
    CreateEmitterEx 1, 5, 2, 3
    CallFunc 72, 10, 5, 0, 360, 0, 360, 64, 48, 40, 0, 1
    Delay 5
    CreateEmitterEx 2, 0, 0, 3
    CallFunc 72, 10, 0, 0, 360, 0, 360, 64, 48, 40, 0, 2
    CreateEmitterEx 2, 1, 1, 3
    CallFunc 72, 10, 1, 0, 360, 0, 360, 64, 48, 40, 0, 2
    CreateEmitterEx 2, 2, 2, 3
    CallFunc 72, 10, 2, 0, 360, 0, 360, 64, 48, 40, 0, 2
    Delay 5
    WaitForAllEmitters
