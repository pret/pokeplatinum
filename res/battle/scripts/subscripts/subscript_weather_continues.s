...
_009:
    ...
    PrintMessage BattleStrings_Text_PokemonIsBuffetedByTheWeather, TAG_MOVE_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_TEMP
    GoTo _062

_045:
    CompareVarToValue OPCODE_EQU, BTLVAR_SCRIPT_TEMP, 2, _057
    // {0} is hurt by its {1}!
    PrintMessage BattleStrings_Text_PokemonIsHurtByItsAbility, TAG_NICKNAME_ABILITY, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP
    GoTo _062

_057:
    // {0} lost some HP because of its {1}!
    PrintMessage BattleStrings_Text_PokemonLostSomeHPBecauseOfItsAbility, TAG_NICKNAME_ABILITY, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP
