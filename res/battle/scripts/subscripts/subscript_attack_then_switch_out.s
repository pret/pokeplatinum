...
_014:
    ...
    PrintMessage BattleStrings_Text_PokemonTookPokemonDownWithIt, TAG_NICKNAME_NICKNAME, BTLSCR_DEFENDER, BTLSCR_ATTACKER
    ...
    // {0} fainted!
    PrintMessage BattleStrings_Text_PokemonFainted, TAG_NICKNAME, BTLSCR_FAINTED_MON
    Wait 
    WaitButtonABTime 30
...
_079:
    ...
    PrintMessage BattleStrings_Text_PokemonsMoveLostAllItsPPDueToTheGrudge, TAG_NICKNAME_MOVE, BTLSCR_ATTACKER, BTLSCR_MSG_TEMP
    Wait 
    WaitButtonABTime 30
...
_103:
    ...
    // {0} went back to {1}!
    PrintMessage BattleStrings_Text_PokemonWentBackToTrainer, TAG_NICKNAME_TRNAME, BTLSCR_SWITCHED_MON, BTLSCR_SWITCHED_MON
    Wait 
    WaitButtonABTime 30
