...
_076:
    ...
    PrintMessage BattleStrings_Text_PokemonIsParalyzedItMayBeUnableToMove, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _102

_096:
    // {0}’s {1} paralyzed {2}! It may be unable to move!
    PrintMessage BattleStrings_Text_PokemonsAbilityParalyzedPokemon, TAG_NICKNAME_ABILITY_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP, BTLSCR_SIDE_EFFECT_MON
...
_139:
    ...
    PrintMessage BattleStrings_Text_PokemonIsAlreadyParalyzed, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _211
    CompareVarToValue OPCODE_EQU, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_INDIRECT, _218
    WaitButtonABTime 30
    // It doesn’t affect {0}...
...
_170:
    ...
    PrintMessage BattleStrings_Text_PokemonsAbilityPreventsParalysis, TAG_NICKNAME_ABILITY, BTLSCR_SIDE_EFFECT_MON, BTLSCR_SIDE_EFFECT_MON
    GoTo _211
