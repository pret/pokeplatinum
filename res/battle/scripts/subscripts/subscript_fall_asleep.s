...
_147:
    ...
    // {0} fell asleep!
    PrintMessage BattleStrings_Text_PokemonFellAsleep, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _176

_170:
    // {0}’s {1} made {2} fall asleep!
    PrintMessage BattleStrings_Text_PokemonsAbilityMadePokemonFallAsleep, TAG_NICKNAME_ABILITY_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP, BTLSCR_SIDE_EFFECT_MON
...
_221:
    ...
    PrintMessage BattleStrings_Text_PokemonStayedAwakeBecauseOfItsAbility, TAG_NICKNAME_ABILITY, BTLSCR_SIDE_EFFECT_MON, BTLSCR_SIDE_EFFECT_MON
    GoTo _330
...
_274:
    ...
    WaitButtonABTime 30
    // {0} is already asleep!
    PrintMessage BattleStrings_Text_PokemonIsAlreadyAsleep, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _330
...
_292:
    ...
    PrintMessage BattleStrings_Text_ButTheUproarKeptPokemonAwake, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _330

_311:
    WaitButtonABTime 30
    // But {0} can’t sleep in an uproar!
    PrintMessage BattleStrings_Text_ButPokemonCantSleepInAnUproar, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _330
