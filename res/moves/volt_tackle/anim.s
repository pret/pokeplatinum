...
L_0:
    ...
    PlayLoopedSoundEffectL SEQ_SE_DP_W120_sseq, 2, 4
    CreateEmitter 0, 0, EMITTER_CB_GENERIC
    SetExtraParams 0, 2, 6, 1, 0, 0
    CreateEmitter 0, 1, EMITTER_CB_GENERIC
    SetExtraParams 0, 2, 6, 1, 0, 0
    Delay 10
    PlayMovingSoundEffectAtkDef SEQ_SE_DP_W085C_sseq, BATTLE_SOUND_PAN_LEFT, BATTLE_SOUND_PAN_RIGHT, 4, 2
    CreateEmitter 0, 3, EMITTER_CB_SET_POS_TO_ATTACKER
    CreateEmitter 0, 4, EMITTER_CB_SET_POS_TO_ATTACKER
    Delay 10
    PlayMovingSoundEffectAtkDef SEQ_SE_DP_W085C_sseq, BATTLE_SOUND_PAN_RIGHT, BATTLE_SOUND_PAN_LEFT, 4, 2
    ...
    PlayLoopedSoundEffectR SEQ_SE_DP_W085B_sseq, 3, 2
    WaitForAllEmitters
