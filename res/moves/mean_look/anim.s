...
L_0:
    ...
    AddSpriteWithFunc 0, SPRITE_FUNC_MEAN_LOOK, mean_look_NCGR_lz, mean_look_NCLR, mean_look_cell_NCER_lz, mean_look_anim_NANR_lz, 0, 0
    BeginLoop 8
    PlaySoundEffectR SEQ_SE_DP_W060_sseq
    Delay 6
    EndLoop
    Delay 6
