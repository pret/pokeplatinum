...
MESON_VER := 1.7.0
MESON_SUB := subprojects/meson-$(MESON_VER)/meson.py
...
$(BUILD)/build.ninja: meson $(ROOT_INI) $(DOT_MWCONFIG) | $(BUILD)
...
subprojects/meson-%/meson.py:
	$(GIT) clone --depth=1 -b $* https://github.com/mesonbuild/meson $(@D)
