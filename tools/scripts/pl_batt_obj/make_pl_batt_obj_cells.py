...
argparser = argparse.ArgumentParser(
    ...
    description='Builds NCER cell files and compresses if requested.'
)
...
if file_props == None:
    raise Exception(f"Input cell file {input_file.name} is not listed in data map {args.datafile}")
...
shutil.copy(tmp_file, output_file.with_suffix(".ncer"))