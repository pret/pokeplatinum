...
argparser = argparse.ArgumentParser(
    prog='pl_batt_obj.narc cell builder and compressor',
    description='Builds NANR anim files and compresses if requested.'
)
...
if file_props == None:
    raise Exception(f"Input anim file {input_file.name} is not listed in data map {args.datafile}")
...
shutil.copy(tmp_file, output_file.with_suffix(".nanr"))