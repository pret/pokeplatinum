	...
	.include "include/scenesettestconfirm.inc"
...
ov18_0223C274: ; 0x0223C274
	...
	ldr r1, _0223C2D4 ; =GX_LoadBG2Scr
	bl ov18_0222B700
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_0223C2D0: .word Unk_ov18_0224A4F8
_0223C2D4: .word GX_LoadBG2Scr
...
ov18_0223C334: ; 0x0223C334
	...
	ldmia sp!, {pc}
	; .align 2, 0
_0223C3B4: .word Unk_ov18_02249560
