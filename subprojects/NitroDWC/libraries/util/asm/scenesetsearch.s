	...
	.include "include/scenesetsearch.inc"
...
ov18_0223A1D0: ; 0x0223A1D0
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_0223A230: .word Unk_ov18_02253348
...
ov18_0223A238: ; 0x0223A238
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_0223A2C0: .word Unk_ov18_0224A3A8
_0223A2C4: .word 0x020C07EC
_0223A2C8: .word Unk_ov18_0224A3C0
_0223A2CC: .word GX_LoadBGPltt
_0223A2D0: .word Unk_ov18_0224A3D8
...
_0223A4A8:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_0223A4CC: .word Unk_ov18_02253348
...
_0223A638:
	...
	ldmia sp!, {r3, pc}
	; .align 2, 0
_0223A65C: .word Unk_ov18_02253348
