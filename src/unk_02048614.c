...
BOOL ScrCmd_0E4 (ScriptContext * param0)
{
    ...
    *v2 = Script_GetTrainerIDFromEventID(*v1);
    return 0;
}
...
BOOL ScrCmd_0E7 (ScriptContext * param0)
{
    ...
    v0 = Script_IsDoubleBattle(Script_GetTrainerIDFromEventID(*v5));
...
BOOL ScrCmd_0E9 (ScriptContext * param0)
{
    ...
    *v1 = Script_IsDoubleBattle(Script_GetTrainerIDFromEventID(*v0));
    return 0;
}
