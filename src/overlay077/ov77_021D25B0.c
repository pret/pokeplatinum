...
static BOOL ov77_021D30D0(UnkStruct_ov77_021D2F38 *param0, const int param1)
{
    ...
    case 4:
        if ((param0->unk_08) && (param1 >= 490)) {
            StartScreenFade(MODE_SUB_THEN_MAIN, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 18, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 5:
...
static BOOL ov77_021D4230(UnkStruct_ov77_021D2E9C *param0, UnkStruct_ov77_021D37C0 *param1, const int param2)
{
    ...
    case 2:
        if (param2 == 785) {
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_WHITE, 4, 1, HEAP_ID_76);
        }
        ...
        if (param2 == (785 + 5)) {
            ...
            param1->unk_247 = (1 << 2);
            param1->unk_248 = (1 << 3);
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_WHITE, 4, 1, HEAP_ID_76);
        }
        ...
        if (param2 >= 975) {
            ...
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_WHITE, 18, 1, HEAP_ID_76);
            param1->unk_08 = 16;
            (*v0)++;
        }
        break;
    case 3:
        if (1) {
            ...
            if (param2 >= 1576) {
                StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_WHITE, 18, 1, HEAP_ID_76);
                (*v0)++;
            }
        }
    ...
    case 4:
        ...
        if (IsScreenFadeDone() && (param2 >= 1600)) {
            ...
            G2_BlendNone();
            G2S_BlendNone();
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_WHITE, 18, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 5:
    ...
    case 6:
        ...
        if (param2 == (64 * 30 - 15 - 15 - 45)) {
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 4, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 7:
        ...
        if (IsScreenFadeDone()) {
            ...
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 4, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 8:
        ...
        if (IsScreenFadeDone()) {
            if (param2 == (65 * 30 - 15 - 15 - 45 - 15)) {
                ...
                StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_WHITE, 4, 1, HEAP_ID_76);
                (*v0)++;
            }
        }
        break;
    case 9:
        ...
        if (IsScreenFadeDone()) {
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_WHITE, 64, 1, HEAP_ID_76);
    ...
    case 10:
        ...
        if (IsScreenFadeDone()) {
            if (param2 >= (1995 + 15)) {
                StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 4, 1, HEAP_ID_76);
                (*v0)++;
            }
        }
        break;
    case 11:
        ...
        if (IsScreenFadeDone()) {
            ...
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 4, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 12:
    ...
    case 15:
        ...
        if (IsScreenFadeDone()) {
            ...
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 16, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 16:
        ...
        if (IsScreenFadeDone()) {
            StartScreenFade(MODE_SUB_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 16, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 17:
        ...
        if (IsScreenFadeDone()) {
            ...
            if (param2 >= ((2200 + 15) + 1)) {
                ...
                StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_WHITE, 6, 1, HEAP_ID_76);
                (*v0)++;
            }
        }
        break;
...
static BOOL ov77_021D5390(UnkStruct_ov77_021D5308 *param0, const int param1)
{
    ...
    case 0:
        if (param1 >= (2285 - 15 - 65)) {
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_WHITE, 30, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 1:
        if (IsScreenFadeDone()) {
            GXLayers_EngineAToggleLayers(GX_PLANEMASK_BG2, 1);
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 90, 1, HEAP_ID_76);
            (*v0)++;
        }
        break;
    case 2:
    ...
    case 3:
        if (param1 >= (2500 - 15 - 65)) {
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 8, 1, HEAP_ID_76);
