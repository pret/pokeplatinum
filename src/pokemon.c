...
static const s8 sFriendshipChangeTable[FRIENDSHIP_EVENT_MAX][3] = {
    ...
    [FRIENDSHIP_EVENT_1] = { 5, 3, 2 },
    [FRIENDSHIP_EVENT_2] = { 1, 1, 0 },
    [FRIENDSHIP_EVENT_BEAT_GYM_LEADER_E4_OR_CHAMPION] = { 3, 2, 1 },
    [FRIENDSHIP_EVENT_LEARN_TMHM] = { 1, 1, 0 },
    [FRIENDSHIP_EVENT_WALK_128_STEPS] = { 1, 1, 1 },
    [FRIENDSHIP_EVENT_FAINTING_TO_LESS_THAN_30LVL_HIGHER_FOE] = { -1, -1, -1 },
    [FRIENDSHIP_EVENT_POISON_1HP] = { -5, -5, -10 },
    [FRIENDSHIP_EVENT_FAINTING_TO_30LVL_HIGHER_FOE] = { -5, -5, -10 },
    [FRIENDSHIP_EVENT_CONTEST_WIN] = { 3, 2, 1 }
};

void Pokemon_UpdateFriendship(Pokemon *mon, u8 friendshipEvent, u16 mapID)
{
    if (friendshipEvent == FRIENDSHIP_EVENT_WALK_128_STEPS) {
        if (LCRNG_Next() & 1) {
            return;
        }
    }
