...
{
    UnkStruct_02001AF4 * v0 = (UnkStruct_02001AF4 *)sub_02018144(param4, sizeof(UnkStruct_02001AF4));
...
void sub_02001BC4 (UnkStruct_02001AF4 * param0, u8 * param1)
{
    ...
    sub_02018238(param0->unk_1C, param0);
}
...
void sub_02002154 (UnkStruct_02001AF4 * param0, u32 param1)
{
    ...
    sub_02018238(param1, param0->unk_00.unk_04);
