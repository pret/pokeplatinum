...
{
    UnkStruct_02097F38 *v0 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_02097F38));

    memset(v0, 0, sizeof(UnkStruct_02097F38));
    v0->saveData = saveData;
    v0->unk_08 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_02097F18));
    memset(v0->unk_08, 0, sizeof(UnkStruct_02097F18));
    v0->unk_08->options = SaveData_GetOptions(saveData);
    v0->unk_08->saveData = saveData;
    v0->unk_0C = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(PartyManagementData));
