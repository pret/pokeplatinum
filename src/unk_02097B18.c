...
static int sub_02097B18(OverlayManager *overlayMan, int *param1);
static int sub_02097D30(OverlayManager *overlayMan, int *param1);
static int sub_02097D88(OverlayManager *overlayMan, int *param1);
...
static int sub_02097B18(OverlayManager *overlayMan, int *param1)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov76_0223DE00), HEAP_ID_53);
...
static int sub_02097D30(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov76_0223DE00 *v0 = OverlayManager_Data(overlayMan);
