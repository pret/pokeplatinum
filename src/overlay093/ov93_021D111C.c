...
static void ov93_021D13C0 (UnkStruct_ov93_021D13C0 * param0)
{
    ...
    v3 = sub_02006C24(156, 72);
    sub_020182CC(&param0->unk_6C, 72, 4);

    param0->unk_5C = sub_02006CB8(v3, Unk_ov93_021D15C8[param0->unk_94].unk_00, 72);
    ...
    for (v0 = 0; v0 < 3; v0++) {
        param0->unk_60[v0] = sub_02006CB8(v3, Unk_ov93_021D15C8[param0->unk_94].unk_02[v0], 72);
