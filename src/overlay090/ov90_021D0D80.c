...
int ov90_021D0D80(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov90_021D0ECC *v0 = NULL;
    UnkStruct_ov90_021D0D80 *v1 = (UnkStruct_ov90_021D0D80 *)OverlayManager_Args(overlayMan);

    Heap_Create(HEAP_ID_APPLICATION, HEAP_ID_74, 0x10000);
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov90_021D0ECC), HEAP_ID_74);
...
int ov90_021D0DE8(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov90_021D0ECC *v0 = OverlayManager_Data(overlayMan);
...
int ov90_021D0E04(OverlayManager *overlayMan, int *param1)
{
    int v0 = 0;
    UnkStruct_ov90_021D0ECC *v1 = OverlayManager_Data(overlayMan);
