...
BOOL ScrCmd_17D (ScriptContext * param0)
{
    ...
    v0 = FieldSystem_GetScriptMember(param0->fieldSystem, 10);
...
{
    MapObject ** v0 = FieldSystem_GetScriptMember(param0->fieldSystem, 10);
    u16 * v1 = ScriptContext_GetVarPointer(param0);
...
BOOL ScrCmd_185 (ScriptContext * param0)
{
    u16 v0;
    GameRecords * v1 = SaveData_GetGameRecordsPtr(param0->fieldSystem->saveData);
    MapObject ** v2 = FieldSystem_GetScriptMember(param0->fieldSystem, 10);
