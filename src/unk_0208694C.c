...
static int sub_0208694C(ApplicationManager *appMan, int *param1)
{
    ...
    case 0:
        ...
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 16, 1, HEAP_ID_18);
        sub_0208732C(1);
...
static int sub_02086B64(ApplicationManager *appMan, int *param1)
{
    ...
    case 2:
        ...
        case 7:
            ...
            if (v0->unk_630 > 30) {
                StartScreenFade(MODE_SUB_THEN_MAIN, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 16, 1, HEAP_ID_18);
                *param1 = 3;
            }
            break;
        }
