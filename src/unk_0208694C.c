...
static int sub_0208694C(ApplicationManager *appMan, int *param1)
{
    ...
    case 0:
        ...
        StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_IN, FADE_TYPE_BRIGHTNESS_IN, FADE_TO_BLACK, 16, 1, HEAP_ID_18);
        sub_0208732C(1);
...
static int sub_02086B64(ApplicationManager *appMan, int *param1)
{
    ...
    case 2:
        ...
        case 7:
            ...
            if (v0->unk_630 > 30) {
                StartScreenFade(FADE_SUB_THEN_MAIN, FADE_TYPE_BRIGHTNESS_OUT, FADE_TYPE_BRIGHTNESS_OUT, FADE_TO_BLACK, 16, 1, HEAP_ID_18);
                *param1 = 3;
            }
            break;
        }
