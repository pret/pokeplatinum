...
int ov22_0225B738(ApplicationManager *appMan, int *param1)
{
    ...
    case 3:
        ...
        break;
    case 4:
        StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_DOWNWARD_OUT, FADE_TYPE_BRIGHTNESS_OUT, COLOR_BLACK, 6, 1, HEAP_ID_13);
        (*param1)++;
        break;
    case 5:
        if (IsScreenFadeDone()) {
...
static void ov22_0225BA40(UnkStruct_ov22_0225B85C *param0)
{
    ...
    Font_LoadTextPalette(PAL_LOAD_MAIN_BG, PLTT_OFFSET(PLTT_5), HEAP_ID_14);
