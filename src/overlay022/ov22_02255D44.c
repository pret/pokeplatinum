...
int ov22_02255E50(ApplicationManager *appMan, int *param1)
{
    ...
    case 0:
    case 1:
        StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_5, FADE_TYPE_UNK_5, FADE_BLACK, 6, 1, HEAP_ID_13);
        (*param1) = 2;
        break;
    case 2:
        if (IsScreenFadeDone()) {
    ...
    case 10:
        ...
        break;
    case 11:
        StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_13);
        (*param1)++;
        break;
    case 12:
        if (IsScreenFadeDone()) {
...
int ov22_022562EC(ApplicationManager *appMan, int *param1)
{
    ...
    case 10:
        ...
        break;
    case 11:
        StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_17, FADE_TYPE_UNK_19, FADE_BLACK, 6, 1, HEAP_ID_13);
        (*param1)++;
        break;
    case 12:
        if (IsScreenFadeDone()) {
    ...
    case 19:
        ...
        StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_26, FADE_TYPE_UNK_26, FADE_BLACK, 6, 1, HEAP_ID_13);
