...
static BOOL ov53_022561D4(void **param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    UnkStruct_ov53_0225621C *v0 = (UnkStruct_ov53_0225621C *)Heap_Alloc(HEAP_ID_POKETCH_APP, sizeof(UnkStruct_ov53_0225621C));
...
static BOOL ov53_0225621C(UnkStruct_ov53_0225621C *param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    ...
    if (ov53_02256420(&(param0->unk_2C), &(param0->unk_04), param2)) {
        ...
        param0->unk_01 = 0;
        param0->unk_02 = 0;
        param0->buttonManager = PoketchButtonManager_New(v0, NELEMS(v0), ov53_02256314, param0, HEAP_ID_POKETCH_APP);
        param0->unk_38 = 0;
        param0->unk_3C = 0;
