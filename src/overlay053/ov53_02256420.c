...
struct UnkStruct_ov53_02256420_t {
    ...
    PoketchAnimation_AnimatedSpriteData *unk_24[16];
    PoketchAnimation_SpriteData unk_64;
    PoketchAnimation_SpriteData unk_78;
    u32 unk_8C[4];
    PoketchAnimation_AnimatedSpriteData *unk_9C;
    fx32 unk_A0;
    fx32 unk_A4;
    fx32 unk_A8;
    u32 unk_AC;
...
static void ov53_022564B0(SysTask *param0, void *param1)
{
    ...
    Graphics_LoadTilesToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 122, v2->unk_04, BG_LAYER_SUB_2, 0, 0, 1, HEAP_ID_POKETCH_APP);
    Graphics_LoadTilemapToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 121, v2->unk_04, BG_LAYER_SUB_2, 0, 0, 1, HEAP_ID_POKETCH_APP);
...
static void ov53_02256568(SysTask *param0, void *param1)
{
    ...
    if (v1->unk_00) {
        ...
        PoketchAnimation_SetCParam(v0->unk_24[0], 1 + PokeIconPaletteIndex(v1->unk_00, 0, 0));
        ov53_02256874(&(v0->unk_24[4]), v1->unk_04);
    } else {
        int v3;

        PoketchAnimation_HideSprite(v0->unk_24[0], 1);

        for (v3 = 0; v3 < 3; v3++) {
            PoketchAnimation_HideSprite(v0->unk_24[4 + v3], 1);
        }
    }
...
static void ov53_022565E0(SysTask *param0, void *param1)
{
    ...
    case 0: {
        ...
        PoketchAnimation_GetSpritePosition(v0->unk_9C, &(v0->unk_A4), &(v0->unk_A0));
    }

        PoketchSystem_PlayCry(v1->unk_08[v1->unk_24], 0);
        PoketchAnimation_UpdateAnimationIdx(v0->unk_9C, 6);
    ...
    default: {
        ...
        PoketchAnimation_SetSpritePosition(v0->unk_9C, v0->unk_A4, v0->unk_A0 - v4);
    }
        PoketchTask_IncrementState(param1);
        break;
    case 16:
        PoketchAnimation_SetSpritePosition(v0->unk_9C, v0->unk_A4, v0->unk_A0);
        PoketchAnimation_UpdateAnimationIdx(v0->unk_9C, 4);
        ov53_0225649C(param1);
        break;
    }
}
...
static void ov53_022566AC(UnkStruct_ov53_02256420 *param0, const UnkStruct_ov53_02256420_1 *param1)
{
    ...
    PoketchAnimation_LoadSpriteFromNARC(&param0->unk_78, 12, 5, 6, 8);
    PoketchAnimation_LoadSpriteFromNARC(&param0->unk_64, 12, 123, 124, 8);
    ...
    for (v3 = 0; v3 < 4; v3++) {
        param0->unk_24[0 + v3] = PoketchAnimation_SetupNewAnimatedSprite(param0->unk_20, &v0[v3], &param0->unk_78);
        PoketchAnimation_SetSpriteCharNo(param0->unk_24[0 + v3], v1 + v3 * 32);

        for (v4 = 0; v4 < 3; v4++) {
            v5 = 4 + v3 * 3 + v4;
            param0->unk_24[v5] = PoketchAnimation_SetupNewAnimatedSprite(param0->unk_20, &v0[v5], &param0->unk_64);
        }

        if (v2[v3] == 0) {
            PoketchAnimation_HideSprite(param0->unk_24[0 + v3], 1);

            for (v4 = 0; v4 < 3; v4++) {
                v5 = 4 + v3 * 3 + v4;
                PoketchAnimation_HideSprite(param0->unk_24[v5], 1);
            }
        } else {
            PoketchAnimation_SetCParam(param0->unk_24[0 + v3], 1 + PokeIconPaletteIndex(v2[v3], 0, 0));
...
static void ov53_02256874(PoketchAnimation_AnimatedSpriteData **param0, u32 param1)
{
    ...
    for (v0 = 0, v2 = 100; v0 < 3; v0++, v2 /= 10) {
        ...
        if ((v3 == 1) || (v1 != 0) || (v0 == 2)) {
            PoketchAnimation_UpdateAnimationIdx(*param0, v1);
            v3 = 1;
        } else {
            PoketchAnimation_HideSprite(*param0, 1);
        }
