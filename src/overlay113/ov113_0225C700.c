...
int ov113_0225C700(ApplicationManager *appMan, int *param1)
{
    ...
    StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_IN, FADE_TYPE_BRIGHTNESS_IN, FADE_TO_BLACK, 6, 1, HEAP_ID_118);
...
int ov113_0225CA04(ApplicationManager *appMan, int *param1)
{
    ...
    case 9:
        ...
        StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_OUT, FADE_TYPE_BRIGHTNESS_OUT, FADE_TO_BLACK, 6, 1, HEAP_ID_118);
        (*param1)++;
        break;
    case 10:
        if (IsScreenFadeDone() == TRUE) {
