...
typedef struct UnkStruct_ov113_0225DBCC_t {
    ...
    UnkStruct_0205AA50 unk_34[8];
    UnkStruct_0205AA50 unk_B4;
    UnkStruct_02023790 * unk_C4;
    u8 unk_C8;
    UnkStruct_020203AC * unk_CC;
    fx32 unk_D0;
    fx32 unk_D4;
    UnkStruct_ov113_0225DBCC_sub1 unk_D8;
    UnkStruct_02006C24 * unk_160;
    UnkStruct_02006C24 * unk_164;
...
static void ov113_0225D160(UnkStruct_ov113_0225DBCC * param0, UnkStruct_02006C24 * param1);
...
static void ov113_0225DAA8(UnkStruct_ov113_0225DBCC * param0, UnkStruct_02006C24 * param1);
...
static void ov113_0225D304(UnkStruct_ov113_0225DBCC * param0, UnkStruct_02006C24 * param1);
static void ov113_0225D630(UnkStruct_ov113_0225DBCC * param0, UnkStruct_02006C24 * param1);
...
static BOOL ov113_0225D938(int param0, int param1, UnkStruct_0200D0F4 * param2, UnkStruct_02006C24 * param3, UnkStruct_02006C24 * param4, NNS_G2D_VRAM_TYPE param5, BOOL param6);
...
static void ov113_0225E15C(UnkStruct_ov113_0225DBCC * param0, UnkStruct_ov113_0225E250 * param1, const UnkStruct_02023790 * param2, int param3, u32 param4, int param5, int param6, int param7, int param8, int param9);
static void ov113_0225E250(UnkStruct_ov113_0225E250 * param0);
static void ov113_0225E264(const UnkStruct_02023790 * param0, int param1, int * param2, int * param3);
...
int ov113_0225C700 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    v0->unk_160 = sub_02006C24(187, 118);
    v0->unk_164 = sub_02006C24(70, 118);
    ...
    v0->unk_C4 = sub_02023790(256, 118);
...
int ov113_0225CA04 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (Unk_021BF67C.unk_60 && (Unk_021BF67C.unk_5E < 160)) {
            if (ov113_0225E318(v0, ((32 << 8) / 6)) == 1) {
                v0->unk_8D8[v0->unk_920].unk_09 = Unk_021BF67C.unk_5C;
                v0->unk_8D8[v0->unk_920].unk_0A = Unk_021BF67C.unk_5E;
...
int ov113_0225CDFC (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    sub_02006CA8(v0->unk_160);
    sub_02006CA8(v0->unk_164);
    sub_02017798(NULL, NULL);
    sub_020177A4();
    sub_0201DC3C();
    sub_0201E530();
...
static void ov113_0225D160 (UnkStruct_ov113_0225DBCC * param0, UnkStruct_02006C24 * param1)
{
    ...
    sub_02003050(param0->unk_0C, 187, 19, 118, 0, 0x200 - 0x40, 0);
    ...
    sub_02003050(param0->unk_0C, 187, 23, 118, 1, 0, 0);
...

    {
        ...
        sub_02003050(param0->unk_0C, 14, 6, 118, 0, 0x20, 13 * 16);

        if (param0->unk_00->unk_04 == 0) {
            sub_02003050(param0->unk_0C, 14, 6, 118, 1, 0x20, 13 * 16);
        } else {
            sub_02003050(param0->unk_0C, 187, 25, 118, 1, 0x20, 13 * 16);
        }
    }
...
static void ov113_0225DBCC (UnkStruct_ov113_0225DBCC * param0)
{
    ...
    sub_0201A7E8(param0->unk_08, &param0->unk_B4, 1, 2, 1, 27, 4, 13, ((1 + (18 + 12)) + (29 * 4)));
    sub_0201ADA4(&param0->unk_B4, 0xf);

    for (v0 = 0; v0 < 8; v0++) {
        sub_0201A7E8(param0->unk_08, &param0->unk_34[v0], 5, Unk_ov113_022608C8[v0][0], Unk_ov113_022608C8[v0][1], 8, 2, 13, (0x4000 / 0x20) + (8 * 2) * v0);
        sub_0201ADA4(&param0->unk_34[v0], 0x0);
    }
}
