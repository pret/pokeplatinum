...
u8 sub_02096420 (Pokemon * param0, u16 param1, u16 param2, u32 param3)
{
    ...
    v1[0] = GetMonData(param0, 160, NULL);
    ...
    v1[0] = GetMonData(param0, 163, NULL);
    ...
    if (((Item_GetAttributeFromStruct(v0, 23) != 0) || (Item_GetAttributeFromStruct(v0, 24) != 0)) && (Item_GetAttributeFromStruct(v0, 25) == 0)) {
        ...
        if ((v1[0] != 0) && (v1[0] < GetMonData(param0, 164, NULL))) {
            Heap_FreeToHeap(v0);
            return 1;
        }
    }
    ...
    if (Item_GetAttributeFromStruct(v0, 25) != 0) {
        if (GetMonData(param0, 161, NULL) < 100) {
            Heap_FreeToHeap(v0);
            return 1;
        }
    }
    ...
    v1[0] = GetMonData(param0, 13, NULL);
    v1[1] = GetMonData(param0, 14, NULL);
    v1[2] = GetMonData(param0, 15, NULL);
    v1[3] = GetMonData(param0, 16, NULL);
    v1[4] = GetMonData(param0, 17, NULL);
    v1[5] = GetMonData(param0, 18, NULL);

    if (GetMonData(param0, 5, NULL) != 292) {
...
u8 sub_02096954 (Pokemon * param0, u16 param1, u16 param2, u16 param3, u32 param4)
{
    ...
    v1[0] = GetMonData(param0, 163, NULL);
    v1[1] = GetMonData(param0, 164, NULL);
    ...
    v1[2] = GetMonData(param0, 161, NULL);
    ...
    if (Item_GetAttributeFromStruct(v0, 25) != 0) {
        if (v1[2] < 100) {
            ...
            if (v1[0] == 0) {
                v1[3] = GetMonData(param0, 164, NULL);
...
static u8 sub_020971D0 (Pokemon * param0, s32 param1, s32 param2, u16 param3, u32 param4)
{
    ...
    if (param2 > 0) {
        if (Item_GetAttribute(GetMonData(param0, 6, NULL), 1, param4) == 53) {
            param2 = param2 * 150 / 100;
        }

        if (GetMonData(param0, 155, NULL) == 11) {
            param2++;
        }

        if (GetMonData(param0, 152, NULL) == param3) {
            param2++;
        }
    }
