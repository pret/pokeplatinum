...
static void ov7_0224B8DC(UnkStruct_ov7_0224B4E8 *param0)
{
    ...
    v0 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 353, HEAP_ID_FIELD);
...
static UnkStruct_ov7_0224B4E8 *ov7_0224BE10(FieldSystem *fieldSystem)
{
    ...
    v0->unk_68 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 221, HEAP_ID_FIELD);
