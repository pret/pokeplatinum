...
static void ov7_0224CD28 (UnkStruct_ov7_0224D008 * param0, u16 * param1)
{
    ...
    param0->unk_294 = v0;
    param0->unk_290 = sub_02018144(11, param0->unk_294 * 2);
...
{
    UnkStruct_ov7_0224D008 * v0 = sub_02018144(11, sizeof(UnkStruct_ov7_0224D008));
...
static void ov7_0224D6BC (UnkStruct_ov7_0224D008 * param0)
{
    ...
    for (v3 = 0; v3 < param0->unk_294; v3++) {
        ...
        if ((v4 <= 420) && (v4 >= 328)) {
            v1 = sub_0200B1EC(v5, sub_0207D268(v4));
...
static u8 ov7_0224E098 (UnkStruct_ov7_0224D008 * param0)
{
    ...
    if ((param0->unk_2AA <= 420) && (param0->unk_2AA >= 328)) {
        u16 v2 = sub_0207D268(param0->unk_2AA);
...
static u8 ov7_0224E3D8 (UnkStruct_ov7_0224D008 * param0)
{
    ...
    case 0:
    {
        ...
        if (param0->unk_2A9 == 0) {
            ...
            sub_0200B7B4(param0->unk_8C, 1, sub_0207CFF0(param0->unk_2AA, 5, 11));
        } else if (param0->unk_2A9 == 3) {
            if (param0->unk_2AC == 1) {
                sub_0200B70C(param0->unk_8C, 0, param0->unk_2AA);
            } else {
...
{
    if (param0->unk_2A9 == 0) {
        return sub_0207CFF0(param1, 0, 11);
    } else if (param0->unk_2A9 == 3) {
