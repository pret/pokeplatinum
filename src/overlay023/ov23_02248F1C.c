...
static void ov23_02249214 (UnkStruct_0205E884 * const param0, int param1[][2], int param2[][3])
{
    ...
    if (sub_02035E38()) {
        if (CommunicationSystem_IsPlayerConnected(CommunicationSystem_GetCurNetId()) == 0) {
            ...
            param1[0][0] = param1[CommunicationSystem_GetCurNetId()][0];
            param1[0][1] = param1[CommunicationSystem_GetCurNetId()][1];
            param1[CommunicationSystem_GetCurNetId()][0] = v1;
            param1[CommunicationSystem_GetCurNetId()][1] = v2;
        }
    }
