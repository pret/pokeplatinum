...
void ov23_02253834(BgConfig *param0, TrainerInfo *param1, UnkFuncPtr_ov23_02253834 param2, void *param3, BOOL param4)
{
    ...
    ListMenuTemplate v2;
    int v3 = 10;
    UnkStruct_ov23_022537D4 *v4 = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_022537D4));
...
void ov23_022538FC(int param0)
{
    ...
    u8 *v2 = Heap_AllocFromHeap(HEAP_ID_FIELD1, undergroundRecordSize + 1);
