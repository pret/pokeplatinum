...
void ov23_0224A3A8 (int param0, int param1, void * param2, void * param3)
{
    ...
    if ((v1->unk_00 == 1) && (v1->unk_01 == CommSys_GetCurNetId())) {
        if (!v0->unk_2B8) {
            v0->unk_2B8 = 1;

            ov23_0224F758(ov23_0224A334, v0->unk_54);
        }
    } else if ((v1->unk_00 == 3) && (v1->unk_01 == CommSys_GetCurNetId())) {
        if (!v0->unk_2B8) {
            v0->unk_2B8 = 1;
...
void ov23_0224A410 (int param0, int param1, void * param2, void * param3)
{
    ...
    if ((v1->unk_00 == 4) && (v1->unk_01 == CommSys_GetCurNetId())) {
        sub_020594FC();
    ...
    if ((v1->unk_00 == 1) && (v1->unk_02 == CommSys_GetCurNetId())) {
        ov23_0224F07C(v1->unk_02, v1->unk_01, v0->unk_54);
    }

    if ((v1->unk_00 == 2) && (v1->unk_01 == CommSys_GetCurNetId())) {
        sub_020594FC();
...
{
    ov23_0224B040(CommSys_GetCurNetId());
...
static void ov23_0224A6E4 (UnkStruct_ov23_0224A570 * param0, BOOL param1, UnkStruct_0202855C * param2)
{
    ...
    ov23_02254068(ov23_022421AC(), CommInfo_GetTrainerInformation(param0->unk_01));

    if (param1) {
        v0->unk_FA[CommSys_GetCurNetId()] = 0;
        ov23_0224B040(CommSys_GetCurNetId());
        ov23_0224B00C(CommSys_GetCurNetId());
...
void ov23_0224A77C (int param0, int param1, void * param2, void * param3)
{
    ...
    case 0:
        if (v0->unk_290[v1->unk_01]) {
            ...
            if (v1->unk_01 == CommSys_GetCurNetId()) {
                sub_020594FC();
        ...
        break;
    case 5:
        if (CommInfo_GetTrainerInformation(v1->unk_01) == NULL) {
        ...
        if (TrainerInfo_Equals(v0->unk_290[v1->unk_02], CommInfo_GetTrainerInformation(v1->unk_01)) == 1) {
            ov23_0224AE60(v1->unk_02);
            ...
            } else if (v1->unk_02 == CommSys_GetCurNetId()) {
            ...
            if (v1->unk_01 == CommSys_GetCurNetId()) {
                sub_0202955C(v4);
                sub_02059464(0x1);
                ov23_02254068(ov23_022421AC(), CommInfo_GetTrainerInformation(v1->unk_02));
    ...
    case 3:
        ...
        if (v0->unk_290[v1->unk_01]) {
            if (TrainerInfo_Equals(v0->unk_290[v1->unk_01], CommInfo_GetTrainerInformation(CommSys_GetCurNetId())) == 1) {
                sub_0206DAD4(v0->unk_54, CommInfo_GetTrainerInformation(v1->unk_01));
            }
        }
...
void ov23_0224AAB0 (void)
{
    ...
    if (v0->unk_290[CommSys_GetCurNetId()]) {
        sub_020360D0(91, v0->unk_290[CommSys_GetCurNetId()]);
    } else {
...
BOOL ov23_0224AEC4 (int param0, int param1)
{
    ...
    if (v0->unk_290[param0] == NULL) {
        TrainerInfo * v1 = CommInfo_GetTrainerInformation(param1);
