...
{
    UnkStruct_ov23_0224A294 * v0 = sub_02057518();
    UnkStruct_ov23_0224A5CC * v1 = sub_02018144(11, sizeof(UnkStruct_ov23_0224A5CC));
...
BOOL ov23_0224AE60 (int param0)
{
    ...
    if (v0->unk_290[param0] != NULL) {
        sub_020181C4(v0->unk_290[param0]);
