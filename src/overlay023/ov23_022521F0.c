...
{
    UnkStruct_ov84_02240FA8 v0;
    int v1 = sub_02058D88(CommunicationSystem_GetCurNetId());
    int v2 = sub_02058DC0(CommunicationSystem_GetCurNetId());
    int v3 = sub_02059328(sub_02058F50(CommunicationSystem_GetCurNetId()));
