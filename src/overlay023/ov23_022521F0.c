...
static void ov23_0225265C (UnkStruct_0200112C * param0, u32 param1, u8 param2)
{
    ...
    MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), 23 + v0->unk_2AB, v0->unk_68);
    ...
    if (param1 != 0xfffffffe) {
        ...
        MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), 25, v0->unk_68);
...
static void ov23_02252754 (UnkStruct_0200112C * param0, u32 param1, u8 param2)
{
    ...
    MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), 23 + v1->unk_2AB, v1->unk_68);
    ...
    if (param1 == 0xfffffffe) {
        ...
        MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), 25, v1->unk_68);
        ...
        MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), 26, v1->unk_68);
...
static void ov23_02252A18 (UnkStruct_ov23_02250CD4 * param0)
{
...

    {
        ...
        if (param0->unk_2AC == 1) {
            v2 = MessageFormatter_Init(0, 26, 630, 4);
            ov23_02253DFC(ov23_022421DC(), 630, 0);
        } else if (param0->unk_2AC == 0) {
            v2 = MessageFormatter_Init(0, 26, 626, 4);
            ov23_02253DFC(ov23_022421DC(), 626, 0);
        } else {
            v2 = MessageFormatter_Init(0, 26, 628, 4);
...
void ov23_02252D74 (UnkStruct_ov23_02250CD4 * param0, int param1)
{
    ...
    MessageFormatter_LoadStrbuf(ov23_02253E3C(ov23_022421BC()), param1, param0->unk_68);
