...
static void ov23_0225437C(UnkStruct_ov23_022542D8 *param0)
{
...

    {
        ...
        v5 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 637, HEAP_ID_FIELD);
...
static void ov23_022546E0(UnkStruct_ov23_02254594 *param0)
{
...

    {
        ...
        v6 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 626, HEAP_ID_FIELD);

        {
            ...
            v12 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 637, HEAP_ID_FIELD);
