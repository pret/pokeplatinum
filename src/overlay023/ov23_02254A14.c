...
static BOOL ov23_02254AD4(FieldTask *param0)
{
    ...
    case 0:
        ...
        break;
    case 1:
        StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_41, FADE_TYPE_UNK_41, FADE_BLACK, 6, 1, HEAP_ID_FIELD);
        ov23_02255EBC(2, v1);
        break;
    case 2:
        if (IsScreenFadeDone()) {
    ...
    case 9:
        ...
        StartScreenFade(MODE_SUB_THEN_MAIN, FADE_TYPE_UNK_40, FADE_TYPE_UNK_40, FADE_BLACK, 6, 1, HEAP_ID_FIELD);
        ov23_02255EBC(10, v1);
        break;
    case 10:
        if (IsScreenFadeDone()) {
