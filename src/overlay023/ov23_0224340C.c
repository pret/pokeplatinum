...
static BOOL ov23_02245064(Coordinates *param0, BgConfig *param1, UnkStruct_ov23_022451BC *param2);
...
static void ov23_02243754(void)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        Unk_ov23_02257764->unk_1D4[1][v0] = SpriteResourceCollection_New(1, v0, HEAP_ID_FIELD1);
    }
...
static Coordinates *ov23_02243864(Coordinates *param0, int param1)
{
    if (Unk_ov23_02257764->unk_828[param1] == NULL) {
        return NULL;
    }

    param0->x = Unk_ov23_02257764->unk_828[param1]->unk_00;
    param0->z = Unk_ov23_02257764->unk_828[param1]->unk_02;
...
static void ov23_02244D80(FieldSystem *fieldSystem, int param1, int param2, BOOL param3)
{
    UnkStruct_ov23_02244C70 *v0 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02244C70));
...
static void ov23_02244EA4(FieldSystem *fieldSystem, BOOL param1, int param2)
{
    UnkStruct_ov23_022451BC *v0 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_022451BC));
...
static BOOL ov23_02245064(Coordinates *param0, BgConfig *param1, UnkStruct_ov23_022451BC *param2)
{
    ...
    if ((param2->unk_08 != 0xffff) && (param2->unk_0A != 0xffff)) {
        ov23_02244EF8(param0->x, param0->z, param2->unk_08, param2->unk_0A, v2);

        Bg_CopyTilemapBufferToVRAM(param1, 2);
    }

    param2->unk_08 = param0->x;
    param2->unk_0A = param0->z;
...
void ov23_02245728(void)
{
    ...
    v0 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02245700));
...
{
    int v0;
    UnkStruct_ov23_0224590C *v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_0224590C));
...
static void ov23_02245ED4(UnkStruct_ov23_02245ED4 *param0)
{
    ...
    for (v0 = 0; v0 < param0->unk_114; v0++) {
        param0->unk_48[v0].x = MATH_Rand32(&v7, v8);
        param0->unk_48[v0].z = MATH_Rand32(&v7, v9);
...
{
    int v0;
    UnkStruct_ov23_02245ED4 *v1 = Heap_Alloc(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02245ED4));
...
static void ov23_02246324(void)
{
    ...
    Unk_ov23_02257764->unk_44 = SpriteList_InitRendering(32, &Unk_ov23_02257764->unk_48, HEAP_ID_FIELD1);
    SetSubScreenViewRect(&Unk_ov23_02257764->unk_48, 0, (192 << FX32_SHIFT) * 2);

    for (v0 = 0; v0 < 4; v0++) {
        Unk_ov23_02257764->unk_1D4[0][v0] = SpriteResourceCollection_New(2, v0, HEAP_ID_FIELD1);
    }
}
...
static void ov23_02246574(int param0, UnkStruct_ov23_02245ED4 *param1, int param2)
{
    ...
    VecFx32 v3;
    fx32 v4, v5;
    int v6 = param1->unk_48[param0].x;
    int v7 = param1->unk_48[param0].z;
...
static BOOL ov23_02246640(BgConfig *param0, UnkStruct_ov23_02245ED4 *param1)
{
    ...
    for (v0 = 0; v0 < param1->unk_114; v0++) {
        if ((param1->unk_48[v0].x <= 0) || (param1->unk_48[v0].x >= 256) || (param1->unk_48[v0].z <= 0) || (param1->unk_48[v0].z >= 192)) {
            ov23_02246548(v0);
            continue;
        }
        ...
        v1 = param1->unk_C8[v5];
        v6 = param1->unk_48[v0].x - 128;
        v7 = param1->unk_48[v0].z - 96;
        v6 *= FX32_ONE;
        v7 *= FX32_ONE;
        ...
        if (v1 == 0) {
            ...
            fx32 v10 = param1->unk_48[v0].z - 96;

            if (v10 == 0) {
                if (v9 < 0) {
                    param1->unk_48[v0].x -= v1;
                } else {
                    param1->unk_48[v0].x += v1;
                }
            } else if (v9 == 0) {
                if (v10 < 0) {
                    param1->unk_48[v0].z -= v1;
                } else {
                    param1->unk_48[v0].z += v1;
                }
            } else {
                {
                    ...
                    param1->unk_48[v0].z = v3 + 96;
                    v3 = FX_Whole(FX_Mul(FX_CosIdx(v11), v8));
                    param1->unk_48[v0].x = v3 + 128;
                }
            }
        }
...
{
    int v0;
    UnkStruct_ov23_022468DC *v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_022468DC));
...
static void ov23_022479F4(UnkStruct_ov23_022471D8 *param0)
{
...

    {
        ...
        v2 = NARC_ctor(NARC_INDEX_DATA__UG_TRAP, HEAP_ID_FIELD1);

        if (v1 < (7 - 1)) {
            param0->unk_F8[v1 + 1] = SpriteResourceCollection_AddTilesFrom(Unk_ov23_02257764->unk_1D4[0][0], v2, v0[v1], 0, v1 + 1, NNS_G2D_VRAM_TYPE_2DMAIN, HEAP_ID_FIELD1);
        }
...
static void ov23_02247A8C(SysTask *param0, void *param1)
{
    ...
    case 0:
...

        {
            ...
            for (v2 = 0; v2 < 4; v2++) {
                Unk_ov23_02257764->unk_1D4[0][v2] = SpriteResourceCollection_New(7 + 1, v2, HEAP_ID_FIELD1);
            }
        }
        v0->unk_00++;
        break;
...
{
    int v0;
    UnkStruct_ov23_022471D8 *v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_022471D8));
...
{
    int v0;
    UnkStruct_ov23_02247E38 *v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02247E38));
...
{
    int v0;
    UnkStruct_ov23_02248418 *v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02248418));
...
void ov23_022489F8(FieldSystem *fieldSystem, int param1, int param2, int param3, int param4, u8 *param5, int param6, u8 *param7, int param8, u8 *param9, int param10)
{
    ...
    v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02248748));
...
static void ov23_02248B3C(int param0, int param1)
{
    ...
    if (Unk_ov23_02257764->unk_00[param0] == NULL) {
        v1 = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(UnkStruct_ov23_02248A6C));
