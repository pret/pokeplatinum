...
static void ov23_02242108 (void)
{
    ...
    sub_020181C4(Unk_ov23_02257748);
...
void ov23_02242BC0 (UnkStruct_0203CDB0 * param0)
{
    ...
    if (Unk_ov23_02257748 == NULL) {
        v0 = sub_02018144(15, sizeof(UnkStruct_ov23_02257748));
        ov23_02241F74(v0, param0);

        v0 = sub_02018144(15, sub_02057C84());
        sub_02057524(v0, param0, 1);

        v0 = sub_02018144(15, ov23_02243858());
        ov23_022434BC(v0, param0);

        v0 = sub_02018144(15, ov23_0224B5C4());
        ov23_0224B144(v0, param0);

        v0 = sub_02018144(15, ov23_022417C4());
        ov23_022416E0(v0, param0);

        v0 = sub_02018144(15, ov23_0223E2E8());
        ov23_0223E1E4(v0, param0);

        v0 = sub_02018144(15, ov23_02253608());
