...
static int ov83_0223BF74 (UnkStruct_ov83_0223C344 * param0, UnkStruct_ov83_0223B784 * param1, int * param2)
{
    ...
    case 4:
        ...
        if ((param1->unk_1C < 0) || (gCoreSys.touchInput) || (gCoreSys.pressedKeys & ((PAD_BUTTON_A | PAD_BUTTON_B)))) {
            (*param2)++;
            break;
        }
    ...
    case 6:
        ...
        if ((gCoreSys.touchInput) || (param1->unk_1C < 0) || (gCoreSys.pressedKeys & ((PAD_BUTTON_A | PAD_BUTTON_B)))) {
            (*param2)++;
        }
        break;
    case 7:
