...
void sub_0205965C (UnkStruct_0203CDB0 * param0)
{
    ...
    Unk_021C084C = (UnkStruct_0205964C *)sub_02018144(15, sizeof(UnkStruct_0205964C));
...
void sub_020596BC (void)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        if (Unk_021C084C->unk_00[v1]) {
            sub_020181C4(Unk_021C084C->unk_00[v1]);
        }
    }

    if (Unk_021C084C->unk_44) {
        sub_020181C4(Unk_021C084C->unk_44);
    }

    sub_020181C4(Unk_021C084C);
    Unk_021C084C = NULL;
}
...

    {
        ...
        for (v0 = 0; v0 < sub_02035E18(); v0++) {
            if (Unk_021C084C->unk_00[v0] == NULL) {
                Unk_021C084C->unk_00[v0] = sub_02018144(0, sizeof(UnkStruct_02072014));
            }
        }
