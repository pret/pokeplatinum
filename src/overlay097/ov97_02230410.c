...
static void ov97_022310FC (UnkStruct_ov97_02230868 * param0)
{
    ...
    for (v1 = 0; v1 < 3; v1++, v0 += 25) {
        ...
        sub_02021E90(param0->unk_2E90[v1], PokeIconPaletteIndex(v2, 0, 0) + 3);
        Heap_FreeToHeap(v3);
    }
}
...
static void ov97_022314FC (UnkStruct_ov97_02230868 * param0, int param1, int * param2)
{
    ...
    if (gCoreSys.padInput & PAD_KEY_RIGHT && (param0->unk_3E10 != 1)) {
        param0->unk_3E10 = 1;
    }

    if (gCoreSys.padInput & PAD_KEY_LEFT && (param0->unk_3E10 != 0)) {
        param0->unk_3E10 = 0;
    }
    ...
    if (gCoreSys.padInput & PAD_BUTTON_B) {
        v0 = 2;
    } else if ((gCoreSys.padInput & PAD_BUTTON_A) && param1 && (param0->unk_3E10 == 0)) {
        v0 = 1;
    } else if ((gCoreSys.padInput & PAD_BUTTON_A) && (param0->unk_3E10 == 1)) {
        v0 = 2;
    } else if ((gCoreSys.padInput & PAD_BUTTON_A) && (param1 == 0)) {
        v0 = 3;
    }
