...
{
    param0->unk_2C0.unk_04 = SpriteRenderer_Create(101);
    {
        ...
        SpriteRenderer_CreateOamCharPlttManagers(param0->unk_2C0.unk_04, &v0, &v1, 16 + 16);
    }

    {
        ...
        param0->unk_2C0.unk_08 = SpriteRenderer_CreateGfxHandler(param0->unk_2C0.unk_04);

        v2 = SpriteRenderer_CreateCellActorList(param0->unk_2C0.unk_04, param0->unk_2C0.unk_08, 64 + 64);
        GF_ASSERT(v2);

        v2 = SpriteRenderer_InitGfxResourceList(param0->unk_2C0.unk_04, param0->unk_2C0.unk_08, &v3);
        GF_ASSERT(v2);
    }
}
...
void sub_0208A490 (UnkStruct_02089688 * param0)
{
    ...
    SpriteRenderer_LoadPaletteFromOpenNarc(v4, 2, v2, v3, v0, 1, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 1000);
    ...
    SpriteRenderer_LoadPaletteFromOpenNarc(v4, 2, v2, v3, v0, 5, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 1001);
    ...
    SpriteRenderer_LoadPaletteFromOpenNarc(v4, 2, v2, v3, v0, 9, 0, 2, NNS_G2D_VRAM_TYPE_2DMAIN, 1002);
...
void sub_0208A6CC (UnkStruct_02089688 * param0)
{
    ...
    for (v0 = 0; v0 < param0->unk_3C0; v0++) {
        CellActorData_Delete(param0->unk_1A0[v0].unk_0C);
    }

    for (v0 = 0; v0 < 2; v0++) {
        CellActorData_Delete(param0->unk_240[v0].unk_0C);
    }

    for (v0 = 0; v0 < 3; v0++) {
        CellActorData_Delete(param0->unk_1F0[v0].unk_0C);
    }
...
asm void sub_0208A758 (UnkStruct_02089688 * param0)
{
 ...
 _0208A7FA:
    ...
    asr r1, r1, #0x10
    mov r2, #0x18
    bl CellActorData_SetPositionXY
    mov r0, #0x73
    lsl r0, r0, #2
    ldr r0, [r4, r0]
    mov r1, #0x16
...
void sub_0208A8A0 (UnkStruct_02089688 * param0)
{
    ...
    param0->unk_1F0[0].unk_0C = CellActor_LoadResources(v1, v2, &v0);
    param0->unk_1F0[1].unk_0C = CellActor_LoadResources(v1, v2, &v0);
    param0->unk_1F0[2].unk_0C = CellActor_LoadResources(v1, v2, &v0);

    sub_0208AAE4(param0, param0->unk_3C4);
    CellActorData_SetAnim(param0->unk_1F0[0].unk_0C, 0);
    CellActorData_UpdateObject(param0->unk_1F0[0].unk_0C);
...
void sub_0208A9BC (UnkStruct_02089688 * param0)
{
    ...
    v0.resources[5] = SPRITE_RESOURCE_NONE;
    v0.plttIdx = 0;
    param0->unk_240[0].unk_0C = CellActor_LoadResources(v1, v2, &v0);
    v0.plttIdx = 1;
    param0->unk_240[1].unk_0C = CellActor_LoadResources(v1, v2, &v0);

    {
        ...
        CellActorData_SetPositionXY(param0->unk_240[0].unk_0C, v4, v5);
        CellActorData_SetAnim(param0->unk_240[0].unk_0C, 0);
        CellActorData_UpdateObject(param0->unk_240[0].unk_0C);
        ...
        CellActorData_SetPositionXY(param0->unk_240[1].unk_0C, v4, v5);
        CellActorData_SetAnim(param0->unk_240[1].unk_0C, 0);
        CellActorData_UpdateObject(param0->unk_240[1].unk_0C);
    }
}
...
{
    if (param2 == 1) {
        CellActorData_DrawSprite(param0->unk_1F0[param1].unk_0C, 1);
    } else {
        CellActorData_DrawSprite(param0->unk_1F0[param1].unk_0C, 0);
    }
}
...
void sub_0208AB2C (UnkStruct_02089688 * param0, int param1)
{
    ...
    CellActorData_SetPositionXY(param0->unk_1F0[1].unk_0C, v0, v1);
}
...
void sub_0208AB6C (UnkStruct_02089688 * param0, int param1, int param2)
{
    ...
    CellActorData_SetPositionXY(param0->unk_1F0[param2].unk_0C, v0, v1);
}
...
void sub_0208ABB4 (UnkStruct_02089688 * param0)
{
...

    {
        ...
        for (v0 = 1; v0 < 3; v0++) {
            v1 = CellActorData_GetActiveAnim(param0->unk_1F0[v0].unk_0C);

            if (v1 == 3) {
                v2 = CellActorData_IsAnimated(param0->unk_1F0[v0].unk_0C);

                if (v2 == 0) {
                    CellActorData_SetAnim(param0->unk_1F0[v0].unk_0C, param0->unk_1F0[v0].unk_00);
                ...
                {
                    v1 = CellActorData_GetActiveAnim(param0->unk_1F0[2].unk_0C);
...
void sub_0208ADE4 (UnkStruct_02089688 * param0, int param1)
{
    ...
    for (v0 = 0; v0 < param0->unk_2A4; v0++) {
        ...
        if ((v0 == param0->unk_1A0[v1].unk_00) && (v1 != param0->unk_3C0)) {
            ...
            if (param1 == 0) {
                CellActorData_SetPositionXY(param0->unk_1A0[v1].unk_0C, v2, v4);
            } else {
...
{
    SpriteRenderer_LoadPalette(param0->unk_2C0.unk_10, 2, param0->unk_2C0.unk_04, param0->unk_2C0.unk_08, 14, 7, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 1003);
}
