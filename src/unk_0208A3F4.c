...
void sub_0208B090(UnkStruct_02089688 *param0, int param1, int param2, int param3, int param4)
{
    ...
    v6 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 212, HEAP_ID_101);
...
void sub_0208B230(Window *param0, int param1)
{
    ...
    v0 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 212, HEAP_ID_101);
