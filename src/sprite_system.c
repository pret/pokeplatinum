...
static BOOL sub_0200D11C(SpriteSystem *param0, SpriteManager *param1, int param2, int param3, int param4, int param5, int param6);
static BOOL sub_0200D18C(SpriteSystem *param0, SpriteManager *param1, NARC *param2, int param3, int param4, int param5, int param6);
...
CellActor *sub_0200CA08(SpriteSystem *param0, SpriteManager *param1, const SpriteTemplateFromResourceHeader *param2)
{
    ...
    v0 = sub_0200CA44(param0, param1, param2->resourceHeaderID, param2->x, param2->y, param2->x, param2->animIdx, param2->priority, param2->plttIdx, param2->vramType, param2->dummy18, param2->dummy1C, param2->dummy20, param2->dummy24);
    return v0;
}
...
BOOL sub_0200CBDC(SpriteSystem *param0, SpriteManager *param1, int param2, int param3, BOOL param4, int param5, int param6)
{
    ...
    if (v0 != NULL) {
        ...
        sub_0200D1FC(param1->unownedResources[0], v0);
...
s8 sub_0200CC9C(SpriteSystem *param0, SpriteManager *param1, int param2, int param3, int param4, int param5, int param6, int param7)
{
    ...
    if (v0 != NULL) {
        ...
        sub_0200D1FC(param1->unownedResources[1], v0);
...
u8 SpriteSystem_LoadPalette(PaletteData *param0, enum PaletteBufferID param1, SpriteSystem *param2, SpriteManager *param3, NARC *param4, int param5, BOOL param6, int param7, int param8, int param9)
{
    int v0;
...
{
    return sub_0200D27C(param0->ownedResources[0], param0->unownedResources[0], param1);
}

BOOL SpriteManager_UnloadPlttObjById(SpriteManager *param0, int param1)
{
    return sub_0200D2D0(param0->ownedResources[1], param0->unownedResources[1], param1);
}

BOOL SpriteManager_UnloadCellObjById(SpriteManager *param0, int param1)
{
    return sub_0200D230(param0->ownedResources[2], param0->unownedResources[2], param1);
}

BOOL SpriteManager_UnloadAnimObjById(SpriteManager *param0, int param1)
{
    return sub_0200D230(param0->ownedResources[3], param0->unownedResources[3], param1);
}
...
static BOOL sub_0200D11C(SpriteSystem *param0, SpriteManager *param1, int param2, int param3, int param4, int param5, int param6)
{
    ...
    if (v0 != NULL) {
        v1 = sub_0200D1FC(param1->unownedResources[param5], v0);
...
{
    SpriteActor_UpdateObject(param0->sprite);
}
...
{
    sub_0200D388(param0->sprite, param1);
}
...
{
    sub_0200D39C(param0->sprite, param1);
}
...
{
    return sub_0200D3B0(param0->sprite);
}
...
{
    sub_0200D3C4(param0->sprite, param1);
}
...
{
    return sub_0200D3D8(param0->sprite);
}
...
{
    SpriteActor_DrawSprite(param0->sprite, param1);
}
...
{
    return sub_0200D400(param0->sprite);
}
...
{
    sub_0200D414(param0->sprite, param1);
}
...
{
    sub_0200D428(param0->sprite, param1);
}
...
{
    sub_0200D448(param0->sprite, param1);
}
...
{
    sub_0200D46C(param0->sprite, param1);
}
...
{
    return sub_0200D480(param0->sprite);
}
...
{
    SpriteActor_SetPositionXY(param0->sprite, param1, param2);
}
...
{
    sub_0200D4D0(param0->sprite, param1, param2, param3);
}
...
{
    sub_0200D50C(param0->sprite, param1, param2);
}
...
{
    sub_0200D55C(param0->sprite, param1, param2, param3);
}
...
{
    sub_0200D5AC(param0->sprite, param1, param2);
}
...
{
    sub_0200D69C(param0->sprite, param1);
}
...
{
    sub_0200D6B0(param0->sprite, param1, param2);
}
...
{
    sub_0200D6F4(param0->sprite, param1, param2);
}
...
{
    sub_0200D758(param0->sprite, param1, param2);
}
...
{
    sub_0200D794(param0->sprite, param1);
}
...
{
    sub_0200D7A8(param0->sprite, param1);
}
...
{
    sub_0200D7CC(param0->sprite, param1);
}
...
{
    sub_0200D808(param0->sprite, param1);
}
