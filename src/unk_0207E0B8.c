...
static const CursorInfo Unk_020F1DB8[] = {
...
static const CursorInfo Unk_020F1CF8[] = {
...
static const CursorInfo Unk_020F1D38[] = {
    { 0x40, 0x19, 0x0, 0x0, 0x7, 0x2, 0x7, 0x1 },
    { 0xC0, 0x21, 0x0, 0x0, 0x7, 0x3, 0x0, 0x2 },
    { 0x40, 0x49, 0x0, 0x0, 0x0, 0x4, 0x1, 0x3 },
    { 0xC0, 0x51, 0x0, 0x0, 0x1, 0x5, 0x2, 0x4 },
...
static const CursorInfo Unk_020F1D78[] = {
...
static void sub_0207F9A0(GameWindowLayout *param0)
{
    ...
    ReadCursorCoords(param0->unk_7F4, &v0, &v1, NULL, NULL, param0->unk_B11, CURSOR_INFO_DIRECTION_NONE);
...
static u8 sub_0207FA24(GameWindowLayout *param0)
{
    ...
    if (v0 == 6) {
        if (v1 == CURSOR_INFO_DIRECTION_UP) {
...
static u8 sub_0207FBE0(GameWindowLayout *param0, u8 *param1, u8 *param2, u8 param3)
{
    ...
    while (TRUE) {
        v0 = ReadCursorCoords(param0->unk_7F4, param1, param2, NULL, NULL, v0, param3);
...
static u8 sub_0207FC30(GameWindowLayout *param0, u8 *param1, u8 *param2, const u8 *param3)
{
    ...
    while (TRUE) {
        ...
        if (sub_0207EF04(param0, param3[v0]) != 0) {
            ReadCursorCoords(param0->unk_7F4, param1, param2, NULL, NULL, param3[v0], CURSOR_INFO_DIRECTION_NONE);
            return param3[v0];
        }
    ...
    ReadCursorCoords(param0->unk_7F4, param1, param2, NULL, NULL, 0, CURSOR_INFO_DIRECTION_NONE);
    return 0;
}
...
static u8 sub_0207FC94(GameWindowLayout *param0)
{
    ...
    if (v0 != 0xffffffff) {
        ...
        ReadCursorCoords(param0->unk_7F4, &v1, &v2, NULL, NULL, param0->unk_B11, CURSOR_INFO_DIRECTION_NONE);
        Sprite_SetAnim(param0->unk_5B0[6], sub_020805D0(param0->unk_5A4->unk_21, param0->unk_B11));
        Sprite_SetDrawFlag(param0->unk_5B0[6], 1);
