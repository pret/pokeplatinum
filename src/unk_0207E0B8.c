...
static int sub_0207E0B8(OverlayManager *overlayMan, int *param1);
static int sub_0207E2A8(OverlayManager *overlayMan, int *param1);
static int sub_0207E7E0(OverlayManager *overlayMan, int *param1);
...
static GameWindowLayout *sub_0207ECC0(OverlayManager *overlayMan);
...
static int sub_0207E2A8(OverlayManager *overlayMan, int *param1)
{
    GameWindowLayout *v0 = OverlayManager_Data(overlayMan);
...
static GameWindowLayout *sub_0207ECC0(OverlayManager *overlayMan)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(GameWindowLayout), HEAP_ID_12);
    memset(v0, 0, sizeof(GameWindowLayout));

    v0->unk_5A4 = OverlayManager_Args(overlayMan);
