...
BOOL ScrCmd_ShowCoinWindow(ScriptContext *param0)
{
    ...
    Window **coinWindow = FieldSystem_GetScriptMemberPtr(fieldSystem, SCRIPT_MANAGER_COIN_BP_WINDOW);
    *coinWindow = FieldMenu_CreateCoinWindow(param0->fieldSystem, tilemapLeft, tilemapTop);
...
BOOL ScrCmd_CloseCoinWindow(ScriptContext *param0)
{
    ...
    FieldMenu_DeleteCoinBPWindow(*coinWindow);
    return FALSE;
}
