...
{
    UnkStruct_0203CDB0 * v0 = param0->unk_34;
    UnkStruct_0205AA50 ** v1 = sub_0203F098(v0, 38);
...
BOOL sub_0204C750 (UnkStruct_0203E724 * param0)
{
    ...
    UnkStruct_02025E50 * v2 = sub_02025E50(v1);
    u16 * v3;

    v3 = inline_0204FCAC(param0);
    *v3 = (u16)sub_0202B5B4(v2);
...
BOOL sub_0204C808 (UnkStruct_0203E724 * param0)
{
    ...
    UnkStruct_02025E50 * v3 = sub_02025E50(v2);
    u32 v4, v5;
