...
static const UnkStruct_02039A58 Unk_020F5A40[] = {
    ...
    {sub_0209610C, sub_02032950},
    {sub_02096110, sub_02032950},
    {sub_020960D8, sub_02032950},
...
void sub_02095FE4 (int param0, int param1, void * param2, void * param3)
{
    ...
    if (param0 != 0) {
        ...
        switch (v2->unk_02) {
        case 0:
            if (v2->unk_00 == CommSys_GetCurNetId()) {
                if (v2->unk_03 == 0) {
...
void sub_020960D8 (int param0, int param1, void * param2, void * param3)
{
    ...
    if ((CommSys_GetCurNetId() == 0) && (v0->unk_364 == 1)) {
        v0->unk_4430 = 0;
        sub_0209617C(v0, v0->unk_4430);
    }
}
...
void sub_0209612C (int param0, int param1, void * param2, void * param3)
{
    ...
    GF_ASSERT(CommSys_GetCurNetId() == 0);
