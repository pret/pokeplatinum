...
static BOOL ov107_02241EC8(UnkStruct_ov107_02241D6C *param0)
{
    ...
    case 3:
        ...
        case 0:
            ...
            if (param0->unk_16 == 0) {
                if (Pokemon_GetData(v7, MON_DATA_HP, NULL) == Pokemon_GetData(v7, MON_DATA_MAX_HP, NULL)) {
                ...
                if ((Pokemon_GetData(v7, MON_DATA_HP, NULL) == Pokemon_GetData(v7, MON_DATA_MAX_HP, NULL)) && (ov107_02245210(v7) == 0)) {
                    param0->unk_0A = ov107_02243918(param0, 37, FONT_MESSAGE);
                    param0->unk_08 = 7;
                    break;
                }
    ...
    case 10:
        ...
        case 0:
            ...
            if (Pokemon_GetData(v7, MON_DATA_HELD_ITEM, NULL) == 0) {
                if (ov104_0223BA14(param0->unk_09) == 0) {
                    ov107_02244120(param0);
                    ov107_02249DBC(&param0->unk_50[6], Options_Frame(param0->options));
...
static void ov107_02242F5C(UnkStruct_ov107_02241D6C *param0)
{
    ...
    for (v15 = 0; v15 < v6; v15++) {
        ...
        if (Pokemon_GetData(v19, MON_DATA_HELD_ITEM, NULL) == 0) {
            ov107_02249BAC(param0->unk_404[v15], 0);
        }

        v2 = Pokemon_GetData(v19, MON_DATA_HP, NULL);
        v3 = Pokemon_GetData(v19, MON_DATA_MAX_HP, NULL);
...
static void ov107_02243950(UnkStruct_ov107_02241D6C *param0, Window *window, Pokemon *mon)
{
    ...
    ov107_02244A74(param0, 0, Pokemon_GetData(mon, MON_DATA_ATK, NULL), 3, 1);
    ov107_02243B5C(param0, window, 76, 0, 56, 0);
    ov107_02243B5C(param0, window, 77, 80, 56, 2);

    ov107_02244A74(param0, 0, Pokemon_GetData(mon, MON_DATA_DEF, NULL), 3, 1);
    ov107_02243B5C(param0, window, 78, 96, 56, 0);
    ov107_02243B5C(param0, window, 79, 176, 56, 2);

    ov107_02244A74(param0, 0, Pokemon_GetData(mon, MON_DATA_SP_ATK, NULL), 3, 1);
    ov107_02243B5C(param0, window, 80, 0, 72, 0);
    ov107_02243B5C(param0, window, 81, 80, 72, 2);

    ov107_02244A74(param0, 0, Pokemon_GetData(mon, MON_DATA_SP_DEF, NULL), 3, 1);
    ov107_02243B5C(param0, window, 82, 96, 72, 0);
    ov107_02243B5C(param0, window, 83, 176, 72, 2);

    ov107_02244A74(param0, 0, Pokemon_GetData(mon, MON_DATA_SPEED, NULL), 3, 1);
...
static void ov107_02243C18(UnkStruct_ov107_02241D6C *param0, Window *param1, u8 param2, u32 param3, u32 param4, Pokemon *param5, u32 param6, u32 param7, u32 param8)
{
    ...
    ov107_02244A74(param0, 4, Pokemon_GetData(param5, param7, NULL), MON_DATA_CHECKSUM_FAILED, 0);
    ov107_02244A74(param0, 5, Pokemon_GetData(param5, param8, NULL), MON_DATA_CHECKSUM_FAILED, 0);
...
static void ov107_02243CFC(UnkStruct_ov107_02241D6C *param0, Window *param1, u8 param2, u8 param3)
{
    ...
    FontSpecialChars_DrawPartyScreenHPText(param0->unk_1C4, Pokemon_GetData(v7, MON_DATA_HP, NULL), 3, 1, param1, v1, v2);
    FontSpecialChars_DrawPartyScreenLevelText(param0->unk_1C4, 0, param1, v5, v6);
    FontSpecialChars_DrawPartyScreenHPText(param0->unk_1C4, Pokemon_GetData(v7, MON_DATA_MAX_HP, NULL), 3, 0, param1, v3, v4);
...
static void ov107_02243DE4(UnkStruct_ov107_02241D6C *param0, Window *param1, u8 param2, u8 param3)
{
    ...
    FontSpecialChars_DrawPartyScreenText(param0->unk_1C4, 1, Pokemon_GetData(v7, MON_DATA_LEVEL, NULL), 3, 0, param1, v1, v2);
    v0 = Pokemon_GetData(v7, MON_DATA_GENDER, NULL);
...
static BOOL ov107_02244E44(UnkStruct_ov107_02241D6C *param0, u8 param1, u8 param2)
{
    ...
    v0 = Pokemon_GetData(v6, MON_DATA_HP, NULL);
    v1 = Pokemon_GetData(v6, MON_DATA_MAX_HP, NULL);
    ...
    case 3:
        ...
        if (param0->unk_414 == NULL) {
            ov107_02243F4C(param0, &param0->unk_50[3], v5, Pokemon_GetData(v6, MON_DATA_HP, NULL));
...
static BOOL ov107_02245210(Pokemon *param0)
{
    ...
    if (Pokemon_GetData(param0, MON_DATA_MOVE1_PP, NULL) != Pokemon_GetData(param0, MON_DATA_MOVE1_MAX_PP, NULL)) {
        v0 = 1;
    }

    if (Pokemon_GetData(param0, MON_DATA_MOVE2_PP, NULL) != Pokemon_GetData(param0, MON_DATA_MOVE2_MAX_PP, NULL)) {
        v0 = 1;
    }

    if (Pokemon_GetData(param0, MON_DATA_MOVE3_PP, NULL) != Pokemon_GetData(param0, MON_DATA_MOVE3_MAX_PP, NULL)) {
        v0 = 1;
    }

    if (Pokemon_GetData(param0, MON_DATA_MOVE4_PP, NULL) != Pokemon_GetData(param0, MON_DATA_MOVE4_MAX_PP, NULL)) {
        v0 = 1;
    }
