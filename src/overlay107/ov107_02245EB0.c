...
static BOOL ov107_02246170 (UnkStruct_ov107_02246170 * param0)
{
    ...
    case 2:
        if (ov104_0223BA14(param0->unk_09) == 1) {
            ...
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1 * 3, HEAP_ID_100);
            param0->unk_08++;
        }
        break;
    case 3:
...
static BOOL ov107_02246D3C (UnkStruct_ov107_02246170 * param0)
{
    ...
    switch (param0->unk_08) {
    case 0:
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_100);
        param0->unk_08++;
        break;
    case 1:
        if (IsScreenFadeDone() == TRUE) {
