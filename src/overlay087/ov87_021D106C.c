...
static BOOL ov87_021D1210(UnkStruct_ov87_021D106C *param0, int *param1)
{
    ...
    case 0:
        ...
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_61);
        (*param1)++;
        break;
    case 1:
        if (IsScreenFadeDone()) {
...
static BOOL ov87_021D1260(UnkStruct_ov87_021D106C *param0, int *param1)
{
    ...
    case 0:
        ...
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_61);
        (*param1)++;
        break;
    case 1:
        if (IsScreenFadeDone()) {
