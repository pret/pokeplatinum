...
UnkStruct_ov87_021D106C * ov87_021D106C (UnkStruct_ov87_021D0D80 * param0, const UnkStruct_ov87_021D12C0 * param1)
{
    ...
    if (v0) {
        ...
        v0->unk_1F4 = PLString_AllocFromHeap(256, 61);
        v0->unk_1F8 = PLString_AllocFromHeap(256, 61);
...
void ov87_021D1140 (UnkStruct_ov87_021D106C * param0)
{
    if (param0) {
        ...
        PLString_FreeToHeap(param0->unk_1F8);
        PLString_FreeToHeap(param0->unk_1F4);
