...
{
    UnkStruct_ov87_021D106C *v0 = Heap_Alloc(HEAP_ID_61, sizeof(UnkStruct_ov87_021D106C));
...
static void ov87_021D1970(UnkStruct_ov87_021D106C *param0)
{
    ...
    for (v3 = 0; v3 < v2->unk_14; v3++) {
        ...
        CharacterSprite_GetPokemonSpriteRegion(v1.narcID, v1.character, HEAP_ID_61, &v0, param0->unk_200, v2->unk_20[v3].unk_08, FALSE, FACE_FRONT, v2->unk_20[v3].unk_10);
