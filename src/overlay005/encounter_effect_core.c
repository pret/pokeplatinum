...
void EncounterEffect_Grass_HigherLevel(SysTask *task, void *param)
{
    ...
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(GrassEncounterEffect));
...
void EncounterEffect_Water_LowerLevel(SysTask *task, void *param)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(WaterEncounterEffect));
    ...
    case 3:
        ...
        break;
    case 4:
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_30, FADE_TYPE_UNK_0, FADE_TO_BLACK, 8, 1, HEAP_ID_FIELD1);
        encEffect->state++;
        break;
    case 5:
        if (IsScreenFadeDone()) {
...
void EncounterEffect_Cave_LowerLevel(SysTask *task, void *param)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(CaveEncounterEffect));
    ...
    case 3:
        HBlankSystem_Stop(encEffect->fieldSystem->unk_04->hBlankSystem);
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_16, FADE_TYPE_UNK_16, FADE_TO_BLACK, 12, 1, HEAP_ID_FIELD1);
...
void EncounterEffect_Trainer_Grass_LowerLevel(SysTask *task, void *param)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(TrainerGrassEncounterEffect));
...
void EncounterEffect_Trainer_Grass_HigherLevel(SysTask *param0, void *param1)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E2EB0));
...
void EncounterEffect_Trainer_Water_LowerLevel(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E31A4));
    ...
    case 5:
        ...
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_24, FADE_TYPE_UNK_0, FADE_TO_BLACK, 8, 1, HEAP_ID_FIELD1);
        v0->state++;
        break;
...
void EncounterEffect_Trainer_Water_HigherLevel(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E3560));
...
void EncounterEffect_Trainer_Cave_LowerLevel(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E3AD0));
    ...
    case 5:
        ...
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_18, FADE_TYPE_UNK_0, FADE_TO_BLACK, 8, 1, HEAP_ID_FIELD1);
        v0->state++;
        break;
...
void EncounterEffect_Trainer_Cave_HigherLevel(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E3D8C));
...
void EncounterEffect_Frontier(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E4260));
    ...
    case 5:
        ...
        HBlankSystem_Stop(v0->fieldSystem->unk_04->hBlankSystem);
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_16, FADE_TYPE_UNK_0, FADE_TO_BLACK, 6, 1, HEAP_ID_FIELD1);
        v0->state++;
        break;
...
void EncounterEffect_Double(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E44C0));
    ...
    case 5:
        ...
        HBlankSystem_Stop(v0->fieldSystem->unk_04->hBlankSystem);
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_34, FADE_TYPE_UNK_0, FADE_TO_BLACK, 8, 1, HEAP_ID_FIELD1);
        v0->state++;
        break;
...
void EncounterEffect_GalacticGrunt(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E4738));
    ...
    case 5:
        ...
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_34, FADE_TYPE_UNK_0, FADE_TO_BLACK, 12, 1, HEAP_ID_FIELD1);
        v0->state++;
        break;
...
void EncounterEffect_GalacticBoss(SysTask *param0, void *param1)
{
    ...
    switch (v0->state) {
    case 0:
        v0->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_ov5_021E4B3C));
...
void EncounterEffect_Mythical(SysTask *task, void *param)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(MythicalEncounterEffect));
    ...
    case 5:
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_TO_WHITE, 10, 1, HEAP_ID_FIELD1);
        encEffect->state++;
        break;
...
void EncounterEffect_Legendary(SysTask *task, void *param)
{
    ...
    switch (encEffect->state) {
    case 0:
        encEffect->param = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(LegendaryEncounterEffect));
    ...
    case 7:
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_TO_WHITE, 60, 1, HEAP_ID_FIELD1);
        encEffect->state++;
        break;
...
static BOOL EncounterEffect_GymLeader(EncounterEffect *encEffect, enum HeapId heapID, const GymLeaderEncounterParam *param)
{
    ...
    case 13:
        ...
        StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_TO_WHITE, 15, 1, HEAP_ID_FIELD1);
        encEffect->state++;
        break;
...
static BOOL EncounterEffect_EliteFourChampion(EncounterEffect *encEffect, enum HeapId heapID, const EliterFourChampionEncounterParam *param)
{
    ...
    case 12:
        ...
        if (v1) {
            ...
            StartScreenFade(FADE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_TO_WHITE, 8, 1, HEAP_ID_FIELD1);
        }
