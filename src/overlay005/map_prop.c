...
static void MapPropManager_InitRenderObj(const int loadedPropId, AreaDataManager *const areaDataManager, NNSG3dRenderObj *renderObj, NNSG3dResMdl **resMdl);
static void MapPropManager_RenderUsing1Mat1Shp(const NNSG3dResMdl *resMdl, VecFx32 *position, MtxFx33 *rotation, VecFx32 *scale, const MapPropMaterialShape *propMatShp, const int modelID);
...
static void MapPropManager_InitRenderObj(const int loadedPropId, AreaDataManager *const areaDataManager, NNSG3dRenderObj *renderObj, NNSG3dResMdl **resMdl)
{
    NNSG3dResFileHeader **nsbmdFile = AreaDataManager_GetMapPropModelFile(loadedPropId, areaDataManager);
