...
typedef struct {
    ...
    const UnkStruct_02061AB4 * unk_0C;
...
static int ov5_021F4AB4(const UnkStruct_02061AB4 * param0, int param1, VecFx32 * param2);
...
UnkStruct_ov101_021D5D90 * ov5_021F4840 (UnkStruct_ov5_021DF47C * param0, const UnkStruct_02061AB4 * param1, int param2, int param3)
{
    int v0;
...
static void ov5_021F4908 (UnkStruct_ov101_021D5D90 * param0, void * param1)
{
    ...
    const UnkStruct_02061AB4 * v5 = v4->unk_24.unk_0C;
...
{
    VecFx32 v0;
    const UnkStruct_02061AB4 * v1 = param1->unk_24.unk_0C;
