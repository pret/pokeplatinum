...
{
    int i;
    MapPropAnimationManager *manager = Heap_Alloc(HEAP_ID_FIELD1, sizeof(MapPropAnimationManager));
    ...
    HeapExp_FndInitAllocator(&manager->allocator, HEAP_ID_FIELD1, 4);
...
MapPropOneShotAnimationManager *MapPropOneShotAnimationManager_New(void)
{
    ...
    MapPropOneShotAnimationManager *oneShotAnimMan = Heap_Alloc(HEAP_ID_FIELD1, oneShotAnimationManagerSize);
