...
static u32 ov5_021D53D4 (u32 param0, UnkStruct_ov5_021D52F4 ** param1)
{
    ...
    do {
        v3 = StringUtil_CopyToTerminator(v3, v5, 0xd);
    ...
    *param1 = Heap_AllocFromHeap(4, sizeof(UnkStruct_ov5_021D52F4) * v2);
    ...
    for (v0 = 0; v0 < v2; v0++) {
        ...
        v3 = StringUtil_CopyToTerminator(v3, v5, 0xd);
        v6 = v5;
        v6 = StringUtil_CopyToTerminator(v6, v7, ',');
        v8->unk_00 = StringUtil_ConvertToInt(v7);
...
static char * ov5_021D5570 (char * param0, GXRgb * param1, VecFx16 * param2)
{
    ...
    param0 = StringUtil_CopyToTerminator(param0, v0, 0xd);

    v2 = v0;
    v2 = StringUtil_CopyToTerminator(v2, v1, ',');
    v3 = StringUtil_ConvertToInt(v1);

    if (v3 == 1) {
        for (v4 = 0; v4 < 3; v4++) {
            v2 = StringUtil_CopyToTerminator(v2, v1, ',');
            v5[v4] = StringUtil_ConvertToInt(v1);
        }
        ...
        *param1 = GX_RGB(v5[0], v5[1], v5[2]);
        ...
        for (v4 = 0; v4 < 3; v4++) {
            v2 = StringUtil_CopyToTerminator(v2, v1, ',');
            v6[v4] = StringUtil_ConvertToInt(v1);
        }
...
static char * ov5_021D5660 (char * param0, GXRgb * param1)
{
    ...
    for (v3 = 0; v3 < 3; v3++) {
        v2 = StringUtil_CopyToTerminator(v2, v1, ',');
        v4[v3] = StringUtil_ConvertToInt(v1);
    }
