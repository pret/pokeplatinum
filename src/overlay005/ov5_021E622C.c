...
{
    int v0;
    UnkStruct_02073C74 * v1 = sub_0207A0FC(param0, param1);
    const u16 * v2;
    u16 v3[10 + 1];
...
static void ov5_021E6948 (UnkStruct_02073C74 * param0, UnkStruct_02073C74_sub1 * param1, UnkStruct_02073C74_sub1 * param2)
{
    ...
    UnkStruct_ov5_021E6948 * v7 = sub_02018144(4, sizeof(UnkStruct_ov5_021E6948));
...
static int ov5_021E6F6C (UnkStruct_02079FF4 * param0)
{
    ...
    for (v0 = 0; v0 < v2; v0++) {
        if (sub_02074470(sub_0207A0FC(param0, v0), 173, NULL) == 0) {
            v1 = sub_02074470(sub_0207A0FC(param0, v0), 10, NULL);
...
BOOL ov5_021E7154 (UnkStruct_02026310 * param0, UnkStruct_02079FF4 * param1, UnkStruct_0203CDB0 * param2)
{
    ...
    if (v6 == ov5_021E7110(param2)) {
        ...
        for (v0 = 0; v0 < sub_0207A0F8(param1); v0++) {
            UnkStruct_02073C74 * v9 = sub_0207A0FC(param1, v0);
...
u16 ov5_021E73A0 (UnkStruct_02079FF4 * param0, int param1, UnkStruct_0200B358 * param2)
{
    UnkStruct_02073C74 * v0 = sub_0207A0FC(param0, param1);
