...
BDHC *BDHC_New(void)
{
    BDHC *bdhc = Heap_Alloc(HEAP_ID_FIELD1, sizeof(BDHC));
...
{
    BDHCHeader *bdhcHeader = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(BDHCHeader));
...
{
    BDHCLoaderTaskContext *ctx = Heap_AllocAtEnd(HEAP_ID_FIELD1, sizeof(BDHCLoaderTaskContext));
