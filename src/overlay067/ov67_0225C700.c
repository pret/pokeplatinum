...
static const GraphicsModes Unk_ov67_0225D400 = {
...
static const BgTemplate Unk_ov67_0225D438[3] = {
    {
        .x = 0x0,
        .y = 0x0,
        .bufferSize = 0x800,
...
int ov67_0225C700(ApplicationManager *appMan, int *param1)
{
    ...
    v0 = ApplicationManager_NewData(appMan, sizeof(UnkStruct_ov67_0225D154), HEAP_ID_112);
...
static void ov67_0225D188(UnkStruct_ov67_0225D210 *param0, BgConfig *param1, u32 param2, u32 param3, u32 param4, u32 param5, u32 param6, u32 param7, u32 param8, SaveData *saveData, u32 _heapID)
{
