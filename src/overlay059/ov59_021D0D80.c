...
int ov59_021D0F00 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    if ((CommunicationSystem_GetCurNetId() == 0) && (v0->unk_4AB4 != 0)) {
...
static void ov59_021D1598 (UnkStruct_020961E8 * param0)
{
...

    {
        ...
        for (v0 = 0; v0 < 5; v0++) {
            ...
            SpriteActor_SetSpriteAnimActive(param0->unk_28C[v0 + 1], 27 + (v0 - 1) * 2);
...
static void ov59_021D1864 (UnkStruct_020961E8 * param0)
{
    if (gCoreSys.pressedKeys & PAD_BUTTON_A) {
        ...
        if (CommunicationSystem_GetCurNetId()) {
        ...
        if (param0->unk_4AB0 == 0) {
            if ((CommunicationSystem_GetCurNetId() == 0) && (sub_02035E18() == param0->unk_4AAC)) {
                u8 v2 = 0;
    ...
    if (v1 != 0xffffffff) {
        if (v1 == 0xfffffffe) {
            ...
            if (CommunicationSystem_GetCurNetId() == 0) {
                ...
                v3.unk_02 = 0;
                v3.unk_00 = CommunicationSystem_GetCurNetId();
...
static int ov59_021D1B8C (UnkStruct_020961E8 * param0, int param1)
{
    ...
    if (param0->unk_4AC2 > 30) {
        ...
        v0.unk_02 = 1;
        v0.unk_00 = CommunicationSystem_GetCurNetId();
...
void ov59_021D1D40 (UnkStruct_020961E8 * param0)
{
    ...
    ov59_021D1784(&param0->unk_36C, param0->unk_48, 0);
    SpriteActor_SetSpriteAnimActive(param0->unk_28C[0], 37);
...
static int ov59_021D1D70 (UnkStruct_020961E8 * param0, int param1)
{
    ...
    if ((CommunicationSystem_GetCurNetId() == 0) && (sub_02035E18() != param0->unk_4ABA)) {
        (void)0;
    }
...
static int ov59_021D1E0C (UnkStruct_020961E8 * param0, int param1)
{
    ...
    if (sub_02038EDC(param0->unk_08->unk_00, 2, &param0->unk_404)) {
        ...
        SpriteActor_SetSpriteAnimActive(param0->unk_28C[0], 0);
...
static int ov59_021D1F24 (UnkStruct_020961E8 * param0, int param1)
{
    ...
    if (v0 != 0xffffffff) {
        if (v0 == 0xfffffffe) {
            ...
            sub_0200B498(param0->unk_24, 0, CommunicationInformation_GetTrainerInformation(0));
        }
...
void ov59_021D2204 (UnkStruct_020961E8 * param0, int param1, u8 param2)
{
    ...
    case 19:
        ...
        sub_0200B498(param0->unk_24, 0, CommunicationInformation_GetTrainerInformation(param2));
...
static BOOL ov59_021D254C (UnkStruct_020961E8 * param0)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        param0->unk_3C8[v0][0] = CommunicationInformation_GetTrainerInformation(v0);
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        case 1:
        {
            ...
            if (CommunicationSystem_GetCurNetId() == v0) {
                SpriteActor_SetSpriteAnimActive(param0->unk_28C[v0 + 1], 38 + v3 * 2);
            } else {
        ...
        case 3:
            if (CommunicationSystem_GetCurNetId() == v0) {
                ...
                SpriteActor_SetSpriteAnimActive(param0->unk_28C[v0 + 1], 38 + v4 * 2 + 1);
            } else {
                SpriteActor_SetSpriteAnimActive(param0->unk_28C[v0 + 1], 27 + v0 * 2 + 1);
            }
