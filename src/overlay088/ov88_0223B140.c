...
static void ov88_0223CE74 (UnkStruct_02095E80 * param0)
{
    ...
    if (v2 != 0xffffffff) {
        ...
        if (v0 == 441) {
            ProcessChatotCryStructWithAudioParams(GetChatotCryFromSave(param0->unk_04), 0, 100, 0);
        } else {
            sub_02005844(v0, v1);
        }
...
static void ov88_0223E694 (Party * param0, Party * param1, int param2, int param3, UnkStruct_ov88_0223C370 * param4)
{
    ...
    if (Party_HasSpecies(param0, 441) == 0) {
        ChatotCry * v4 = GetChatotCryFromSave(param4->unk_10);
        ResetChatotCryStatus(v4);
    }
