...
void ov111_021D2F80(UnkStruct_ov111_021D2F80 *param0)
{
    ...
    VramTransfer_New(32, HEAP_ID_115);
    ov111_021D3378();

    NNS_G2dInitOamManagerModule();

    RenderOam_Init(0, 128, 0, 32, 0, 128, 0, 32, 115);
    param0->unk_00 = SpriteList_InitRendering(40, &param0->unk_04, HEAP_ID_115);
    SetSubScreenViewRect(&param0->unk_04, 0, (512 * FX32_ONE));

    for (v0 = 0; v0 < 4; v0++) {
        param0->unk_190[v0] = SpriteResourceCollection_New(Unk_ov111_021D3820[v0], v0, HEAP_ID_115);
    }
...
static void ov111_021D304C(UnkStruct_ov111_021D2F80 *param0, int param1)
{
    ...
    param0->unk_1A0[2][3] = SpriteResourceCollection_Add(param0->unk_190[3], 184, 10, 0, 2, 3, HEAP_ID_115);
...
static void ov111_021D30D8(UnkStruct_ov111_021D2F80 *param0, int param1, int param2, int param3)
{
    ...
    param0->unk_1A0[param1][3] = SpriteResourceCollection_Add(param0->unk_190[3], 184, 30, 0, param2, 3, HEAP_ID_115);
...
static void ov111_021D3168(UnkStruct_ov111_021D2F80 *param0, int param1)
{
    ...
    param0->unk_1A0[3][3] = SpriteResourceCollection_Add(param0->unk_190[3], 184, 14, 0, 3, 3, HEAP_ID_115);
...
static void ov111_021D31F4(UnkStruct_ov111_021D2F80 *param0, int param1)
{
    ...
    param0->unk_1A0[4][3] = SpriteResourceCollection_Add(param0->unk_190[3], 184, 18, 0, 4, 3, HEAP_ID_115);
...
static void ov111_021D3378(void)
{
    ...
    PlttTransfer_Init(14, HEAP_ID_115);
...
void ov111_021D33B0(UnkStruct_ov111_021D2F80 *param0, int param1)
{
    ...
    SpriteResourceCollection_ModifyPalette(param0->unk_190[1], v0, 184, Unk_ov111_021D3940[param1], 0, HEAP_ID_115);
