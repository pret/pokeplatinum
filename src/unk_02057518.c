...
{
    Unk_021C0848->unk_08[CommSys_GetCurNetId()] = Unk_021C0848->unk_54->unk_3C;
    Unk_021C0848->unk_48[CommSys_GetCurNetId()] = 1;
    Unk_021C0848->unk_A2[CommSys_GetCurNetId()].unk_00 = sub_0205EABC(Unk_021C0848->unk_54->unk_3C);
    Unk_021C0848->unk_A2[CommSys_GetCurNetId()].unk_02 = sub_0205EAC8(Unk_021C0848->unk_54->unk_3C);
    Unk_021C0848->unk_A2[CommSys_GetCurNetId()].unk_04 = sub_0205EA78(Unk_021C0848->unk_54->unk_3C);
    Unk_021C0848->unk_62[CommSys_GetCurNetId()].unk_00 = sub_0205EABC(Unk_021C0848->unk_54->unk_3C);
    Unk_021C0848->unk_62[CommSys_GetCurNetId()].unk_02 = sub_0205EAC8(Unk_021C0848->unk_54->unk_3C);
    Unk_021C0848->unk_62[CommSys_GetCurNetId()].unk_04 = sub_0205EA78(Unk_021C0848->unk_54->unk_3C);
}
...
{
    int v0 = Unk_021C0848->unk_62[CommSys_GetCurNetId()].unk_00;
    int v1 = Unk_021C0848->unk_62[CommSys_GetCurNetId()].unk_02;
...
void sub_02057BC4 (void * param0)
{
    ...
    if ((0 == v0) && CommSys_IsPlayerConnected(CommSys_GetCurNetId())) {
...
static void sub_02057C8C (u8 param0)
{
    ...
    {
        TrainerInfo * v3 = CommInfo_GetTrainerInformation(param0);
    ...
    for (v0 = 0; v0 < (7 + 1); v0++) {
        if (!CommSys_IsPlayerConnected(v0)) {
            if (!(sub_02036180() && (v0 == 0))) {
                if ((CommSys_GetCurNetId() == 0) && (Unk_021C0848->unk_2BE)) {
                    ov23_0224D898(v0);
                }
            }
        }
...
void sub_0205805C (UnkStruct_0203CDB0 * param0, BOOL param1)
{
    ...
    if (param0->unk_3C) {
        Unk_021C0848->unk_08[CommSys_GetCurNetId()] = param0->unk_3C;
    }

    if (sub_02035E38() && (CommSys_GetCurNetId() == 0)) {
...
void sub_020585A8 (int param0, int param1, void * param2, void * param3)
{
    ...
    if ((param0 == CommSys_GetCurNetId()) && Unk_021C0848->unk_2C3) {
        return;
    }
...
static void sub_020587C0 (int param0)
{
    ...
    if (v4) {
...

        {
            ...
            if (Unk_021C0848->unk_2C0 && (param0 == CommSys_GetCurNetId())) {
                Unk_021C0848->unk_2C0--;
            } else if (!sub_02035EE0() && Unk_021C0848->unk_2BE && (param0 == CommSys_GetCurNetId())) {
                v9 = sub_0206147C(
                    v4, v2, v2, v10, 1, 0);
...
int sub_02058CA0 (int param0)
{
    if (!Unk_021C0848) {
        return 0xffff;
    } else if (CommSys_GetCurNetId() == param0) {
...
void sub_020593F4 (int param0)
{
    ...
    Unk_021C0848->unk_A2[CommSys_GetCurNetId()].unk_04 = param0;
    sub_02057AE4(0);
}
...
void sub_02059524 (void)
{
    if (Unk_021C0848->unk_2BF == 0) {
        ...
        } else if (ov23_02243298(CommSys_GetCurNetId())) {
            sub_02059514();
            Unk_021C0848->unk_2BF = 1;
        } else {
            (void)0;
...
void sub_02059570 (void)
{
    if (Unk_021C0848->unk_2BF == 0) {
        if (Unk_021C0848->unk_2BE) {
            if (!ov23_02243298(CommSys_GetCurNetId())) {
                sub_02057FC4(0);
            }
        }
    }
