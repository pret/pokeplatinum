...
static void sub_0203ADFC (UnkStruct_020508D4 * param0)
{
    ...
    v2 = MessageFormatter_Init(0, 26, 367, 11);
    ...
    for (v4 = 0; v4 < v5; v4++) {
        if (v1->unk_30[v4] == 3) {
            ...
            v6 = sub_0200B358(11);
            v7 = Strbuf_Init(8, 11);
            v8 = MessageFormatter_AllocStrbuf(v2, Unk_020EA05C[v1->unk_30[v4]][0]);
...
static void sub_0203B094 (UnkStruct_020508D4 * param0)
{
    ...
    if (v6 == 0) {
        v5 = MessageFormatter_AllocStrbuf(v2, 9);
    } else {
        v5 = MessageFormatter_AllocStrbuf(v2, 10);
    }
    ...
    v5 = MessageFormatter_AllocStrbuf(v2, 11);
