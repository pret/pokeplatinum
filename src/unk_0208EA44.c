...
static void sub_0208EF0C (UnkStruct_0208D7BC * param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        ...
        sub_0208F194(param0, 13 + v0, 5 + v0, MoveTable_LoadAttribute(param0->unk_250.unk_34[v0], 3));
    }
...
void sub_0208EF58 (UnkStruct_0208D7BC * param0)
{
    ...
    case 3:
        ...
        if (param0->unk_24C->unk_18 != 0) {
            sub_0208F194(param0, 13 + 4, 5 + 4, MoveTable_LoadAttribute(param0->unk_24C->unk_18, 3));
    ...
    case 5:
        for (v0 = 0; v0 < 4; v0++) {
            ...
            sub_0208F194(param0, 13 + v0, 5 + v0, MoveTable_LoadAttribute(param0->unk_250.unk_34[v0], 11) + 18);
            sub_0200D3EC(param0->unk_41C[13 + v0], 1);
            sub_0200D494(param0->unk_41C[13 + v0], 151, 42 + v0 * 32);
        }

        if (param0->unk_24C->unk_18 != 0) {
            sub_0208F194(param0, 13 + 4, 5 + 4, MoveTable_LoadAttribute(param0->unk_24C->unk_18, 11) + 18);
            sub_0200D3EC(param0->unk_41C[13 + 4], 1);
            sub_0200D494(param0->unk_41C[13 + 4], 151, 42 + 4 * 32);
        }
...
{
    u32 v0 = MoveTable_LoadAttribute(param1, 1);
