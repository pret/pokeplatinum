...
void sub_02095380(const UnkStruct_ov6_02248BE8 *param0, Pokemon *param1, int heapID)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++) {
        v1 = param0->unk_0C[i];
        Pokemon_SetData(param1, MON_DATA_MOVE1 + i, &v1);
    }

    {
        ...
        Pokemon_SetData(param1, MON_DATA_NICKNAME_STRING, v3);
        Pokemon_SetData(param1, MON_DATA_OT_NAME_STRING, v4);
...

    {
        ...
        Pokemon_SetData(param1, MON_DATA_COOL, &cool);
        Pokemon_SetData(param1, MON_DATA_BEAUTY, &beauty);
        Pokemon_SetData(param1, MON_DATA_CUTE, &cute);
        Pokemon_SetData(param1, MON_DATA_SMART, &smart);
        Pokemon_SetData(param1, MON_DATA_TOUGH, &tough);
        Pokemon_SetData(param1, MON_DATA_SHEEN, &sheen);
    }
}
