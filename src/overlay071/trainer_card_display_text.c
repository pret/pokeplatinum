...
static const WindowTemplate sTrainerCardWindowTemplates[] = {
    [TRAINER_CARD_WINDOW_ID] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 4, .width = TRAINER_CARD_WINDOW_PARTIAL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x6F },
    [TRAINER_CARD_WINDOW_NAME] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 6, .width = TRAINER_CARD_WINDOW_PARTIAL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x91 },
    [TRAINER_CARD_WINDOW_MONEY] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 9, .width = TRAINER_CARD_WINDOW_PARTIAL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0xB3 },
    [TRAINER_CARD_WINDOW_POKEDEX] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 12, .width = TRAINER_CARD_WINDOW_PARTIAL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0xD5 },
    [TRAINER_CARD_WINDOW_SCORE] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 15, .width = TRAINER_CARD_WINDOW_PARTIAL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0xF7 },
    [TRAINER_CARD_WINDOW_TIME] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 18, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x119 },
    [TRAINER_CARD_WINDOW_ADVENTURE_STARTED] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 20, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x151 },
    [TRAINER_CARD_WINDOW_HOF_DEBUT] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 2, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT * 2, .palette = 0xF, .baseTile = 0xC1 },
    [TRAINER_CARD_WINDOW_TIMES_LINKED] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 7, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x131 },
    [TRAINER_CARD_WINDOW_LINK_BATTLES] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 9, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x169 },
    [TRAINER_CARD_WINDOW_LINK_TRADES] = { .bgLayer = BG_LAYER_SUB_3, .tilemapLeft = 2, .tilemapTop = 11, .width = TRAINER_CARD_WINDOW_FULL_WIDTH, .height = TRAINER_CARD_WINDOW_HEIGHT, .palette = 0xF, .baseTile = 0x1A1 }
};
