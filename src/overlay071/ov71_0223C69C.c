...
void ov71_0223C6F0 (Window * param0, const TrainerCard * param1)
{
    ...
    v1 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 616, HEAP_ID_25);
...
void ov71_0223CDE8 (Window * param0, const TrainerCard * param1, Strbuf *param2)
{
    ...
    {
        u32 v1;
        MessageLoader * v2 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 616, HEAP_ID_25);
        Strbuf* v3 = Strbuf_Init(32, HEAP_ID_25);
