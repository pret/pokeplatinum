...
void ov71_0223C6F0 (UnkStruct_0205AA50 * param0, const UnkStruct_02072014 * param1)
{
    ...
    for (v0 = 0; v0 < 7; v0++) {
        if ((v0 != 3) || (v0 == 3) && (param1->unk_04_3)) {
            MessageFormatter_LoadStrbuf(v1, Unk_ov71_0223D644[v0], v2);
...

    {
...

        {
            ...
            MessageFormatter_LoadStrbuf(v1, 14, v3);
        ...
        if (param1->unk_04_3) {
            ...
            MessageFormatter_LoadStrbuf(v1, 21, v3);
            sub_0200C388(v4, v2, v3);
...

        {
            ...
            MessageFormatter_LoadStrbuf(v1, 17, v3);
            sub_0200C388(v4, v2, v3);
...
void ov71_0223CDE8 (UnkStruct_0205AA50 * param0, const UnkStruct_02072014 * param1, Strbuf *param2)
{
...

    {
        ...
        MessageFormatter_LoadStrbuf(v2, 16, v4);
