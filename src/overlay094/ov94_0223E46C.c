...
static void ov94_0223F9FC(UnkStruct_0205AA50 * param0, UnkStruct_0205AA50 * param1, MessageLoader * param2);
    ...
    if (Unk_021BF67C.unk_48 & PAD_BUTTON_A) {
        ...
        case 1:
            if (param0->unk_B7A.unk_00 != 0) {
                param0->unk_10E4->unk_20 = GetMonSpeciesPersonalDataAttribute(param0->unk_B7A.unk_00, 18);
