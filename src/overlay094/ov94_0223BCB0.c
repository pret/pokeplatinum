...
static void ov94_0223C03C(UnkStruct_ov94_0223FD4C * param0, UnkStruct_020067E8 * param1);
...
int ov94_0223BCB0 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 0:
        ...
        v0->unk_B90 = MessageFormatter_Init(0, 26, 671, 62);
        v0->unk_B98 = MessageFormatter_Init(0, 26, 674, 62);
        v0->unk_B9C = MessageFormatter_Init(0, 26, 695, 62);
        v0->unk_B94 = MessageFormatter_Init(0, 26, 412, 62);
        v0->unk_BA0 = MessageFormatter_Init(0, 26, 694, 62);
...
int ov94_0223BF54 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    MessageFormatter_Free(v0->unk_B94);
    MessageFormatter_Free(v0->unk_B9C);
    MessageFormatter_Free(v0->unk_B98);
    MessageFormatter_Free(v0->unk_B90);
    MessageFormatter_Free(v0->unk_BA0);
