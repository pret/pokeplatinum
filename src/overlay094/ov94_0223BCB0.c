...
static void ov94_0223C03C(UnkStruct_ov94_0223FD4C *param0, OverlayManager *overlayMan);
...
int ov94_0223BCB0(OverlayManager *overlayMan, int *param1)
{
    ...
    case 0:
        ...
        v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov94_0223FD4C), HEAP_ID_62);
...
{
    UnkStruct_ov94_0223FD4C *v0 = OverlayManager_Data(overlayMan);
...
static void ov94_0223C03C(UnkStruct_ov94_0223FD4C *param0, OverlayManager *overlayMan)
{
    param0->unk_00 = (UnkStruct_0203E0FC *)OverlayManager_Args(overlayMan);
    param0->unk_14 = 0;
