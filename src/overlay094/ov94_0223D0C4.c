...
void ov94_0223D910 (MessageFormatter * param0, MessageFormatter * param1, UnkStruct_0200B358 * param2, UnkStruct_0205AA50 param3[], BoxPokemon * param4, UnkStruct_ov94_0223BA88_sub2 * param5)
{
    Strbuf* v0, * v1, * v2, * v3;
    ...
    v3 = MessageFormatter_AllocStrbuf(param0, 70);
    v1 = MessageFormatter_AllocStrbuf(param0, Unk_ov94_02245FD8[v6]);

    sub_0200B60C(param2, 3, v7, 3, 0, 1);

    v2 = sub_0200B29C(param2, param0, 102, 62);
    v0 = MessageFormatter_AllocStrbuf(param1, v10);
...
void ov94_0223DA78 (MessageFormatter * param0, UnkStruct_0205AA50 param1[], u16 * param2, Pokemon * param3, UnkStruct_0205AA50 param4[])
{
    Strbuf* v0, * v1;
    Strbuf* v2, * v3;
    ...
    v1 = MessageFormatter_AllocStrbuf(param0, 48);
    Strbuf_CopyChars(v0, param2);

    v2 = MessageFormatter_AllocStrbuf(param0, 172);
