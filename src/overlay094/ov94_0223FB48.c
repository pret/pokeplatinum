...
static void ov94_02240EAC(BoxPokemon *boxMon, UnkStruct_02022550 * param1, UnkStruct_02022550 * param2, u16 * param3, int param4, NARC * param5, UnkStruct_ov94_0223BA88_sub2 * param6, UnkStruct_ov94_02240FA0 * param7);
...
static int ov94_0224123C(BoxPokemon *boxMon);
...
{
    param1->unk_03 = sub_02075B40(boxMon);
}
...
static void ov94_02240EAC (BoxPokemon *boxMon, UnkStruct_02022550 * param1, UnkStruct_02022550 * param2, u16 * param3, int param4, NARC * param5, UnkStruct_ov94_0223BA88_sub2 * param6, UnkStruct_ov94_02240FA0 * param7)
{
    ...
    v0 = sub_02074570(boxMon, MON_DATA_172, NULL);
    *param3 = sub_02074570(boxMon, MON_DATA_SPECIES, NULL);

    v3 = sub_02074570(boxMon, MON_DATA_FORM, NULL);
    v2 = sub_02074570(boxMon, MON_DATA_IS_EGG, NULL);
    v1 = sub_02074570(boxMon, MON_DATA_HELD_ITEM, NULL);

    param6->unk_00 = *param3;
    param6->unk_02 = sub_02074570(boxMon, MON_DATA_111, NULL) + 1;

    if (v2) {
        param6->unk_03 = 0;
    }

    sub_02073D48(boxMon, 1);
...
static int ov94_0224123C (BoxPokemon *boxMon)
{
    ...
    for (v0 = 0; v0 < 10; v0++) {
        v1 += sub_02074570(boxMon, Unk_ov94_02245E34[v0], NULL);
    }
...
static int ov94_02241278 (BoxPokemon *boxMon)
{
...

    {
        ...
        v2 = sub_02074570(boxMon, MON_DATA_FORM, NULL);
    }
...
static int ov94_02241384 (BoxPokemon *boxMon, UnkStruct_ov94_0223BA88_sub3 * param1)
{
    ...
    v0.unk_00 = sub_02074570(boxMon, MON_DATA_SPECIES, NULL);
    v0.unk_02 = sub_02074570(boxMon, MON_DATA_111, NULL) + 1;
    v0.unk_03 = sub_02075B40(boxMon);
