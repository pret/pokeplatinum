...
static void ov94_022401E0 (UnkStruct_ov94_0223FD4C * param0)
{
    ...
    if (param0->unk_24 == 5) {
        param0->unk_BB0 = MessageFormatter_AllocStrbuf(param0->unk_B90, 21);
    } else if (param0->unk_24 == 6) {
        param0->unk_BB0 = MessageFormatter_AllocStrbuf(param0->unk_B90, 17);
    }

    param0->unk_BA8 = MessageFormatter_AllocStrbuf(param0->unk_B90, 103);
...
static void ov94_02240D58 (UnkStruct_ov94_0223FD4C * param0, int param1, int param2, int param3, u16 param4, int param5)
{
    ...
    v1 = MessageFormatter_AllocStrbuf(param0->unk_B90, param1);
