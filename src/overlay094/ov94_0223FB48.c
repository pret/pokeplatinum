...
int ov94_0223FB48(UnkStruct_ov94_0223FD4C *param0, int param1)
{
    ...
    if (param0->unk_20 == 8) {
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_62);
    } else {
...
static int ov94_02240A6C(UnkStruct_ov94_0223FD4C *param0)
{
    if ((param0->unk_18 == 0) || (param0->unk_18 == 8)) {
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_62);
        param0->unk_1110 = 1;
    } else {
