...
static void ov94_022415F8(UnkStruct_02018340 * param0);
static void ov94_022416E0(UnkStruct_02018340 * param0);
...
static void ov94_022423FC(MessageFormatter * param0, UnkStruct_0200B358 * param1, UnkStruct_0205AA50 param2[], BoxPokemon * param3, UnkStruct_ov94_0223BA88_sub2 * param4);
...
static int ov94_02242718(UnkStruct_02013A04 ** param0, MessageFormatter * param1, MessageFormatter * param2, u16 * param3, u8 * param4, int param5, int param6, UnkStruct_02026324 * param7);
...
static void ov94_0224158C (UnkStruct_ov94_0223FD4C * param0, int param1, int param2, int param3, u16 param4)
{
    ...
    v0 = MessageFormatter_AllocStrbuf(param0->unk_B90, param1);
...
static void ov94_022417A0 (UnkStruct_ov94_0223FD4C * param0)
{
    ...
    ov94_022458CC(&param0->unk_F7C, param0->unk_BB0, 0, 1, 0, (u32)(((15 & 0xff) << 16) | ((14 & 0xff) << 8) | ((0 & 0xff) << 0)));

    sub_0201A7E8(param0->unk_04, &param0->unk_F5C, 0, 2, 21, 27, 2, 13, (((1 + (18 + 12)) + 9) + 28 * 2));
    sub_0201ADA4(&param0->unk_F5C, 0x0);

    for (v0 = 0; v0 < 6; v0++) {
        sub_0201A7E8(param0->unk_04, &param0->unk_FCC[v0], 0, Unk_ov94_02245FE8[v0][0], Unk_ov94_02245FE8[v0][1], 11, 2, 13, ((((1 + (18 + 12)) + 9) + 28 * 2) + 27 * 2) + (11 * 2) * v0);
...
static void ov94_022418B8 (UnkStruct_ov94_0223FD4C * param0)
{
    ...
    param0->unk_BB0 = MessageFormatter_AllocStrbuf(param0->unk_B90, 90);
...
{
    if (sub_0200F2AC()) {
        ov94_0224158C(param0, 9, 1, 0, 0xf0f);
...
static int ov94_02241990 (UnkStruct_ov94_0223FD4C * param0)
{
    ...
    sub_0201A7E8(param0->unk_04, &param0->unk_F9C[0], 0, 15, 5, 4, 13, 13, (((((1 + (18 + 12)) + 9) + 28 * 2) + 27 * 2) + 11 * 2 * 6));
    sub_0201ADA4(&param0->unk_F9C[0], 0x0);

    sub_0201A7E8(param0->unk_04, &param0->unk_F9C[1], 0, 21, 5, 10, 13, 13, ((((((1 + (18 + 12)) + 9) + 28 * 2) + 27 * 2) + 11 * 2 * 6) + 4 * 13));
...
static int  ov94_02241D08 (UnkStruct_ov94_0223FD4C * param0)
{
    ov94_0224158C(param0, 10, 1, 0, 0xf0f);
    ov94_0223C3F4(param0, 16, 8);

    sub_0201A7E8(param0->unk_04, &param0->unk_F9C[0], 0, 21, 10, 10, 8, 13, ((((((1 + (18 + 12)) + 9) + 28 * 2) + 27 * 2) + 11 * 2 * 6)));
    sub_0201ADA4(&param0->unk_F9C[0], 0x0);
...
static int ov94_02241E8C (UnkStruct_ov94_0223FD4C * param0)
{
    ov94_0224158C(param0, 11, 1, 0, 0xf0f);
    ov94_0223C3F4(param0, 16, 11);

    sub_0201A7E8(param0->unk_04, &param0->unk_F9C[0], 0, 15, 5, 16, 13, 13, ((((((1 + (18 + 12)) + 9) + 28 * 2) + 27 * 2) + 11 * 2 * 6)));
    sub_0201ADA4(&param0->unk_F9C[0], 0x0);
...
static int ov94_02242040 (UnkStruct_ov94_0223FD4C * param0)
{
    ov94_0224158C(param0, 23, 1, 0, 0xf0f);
...
static u32 Unk_ov94_02246920[] = {
    (u32)(((5 & 0xff) << 16) | ((6 & 0xff) << 8) | ((0 & 0xff) << 0)),
    (u32)(((3 & 0xff) << 16) | ((4 & 0xff) << 8) | ((0 & 0xff) << 0))
};

void ov94_02242158 (UnkStruct_0205AA50 * param0, MessageFormatter * param1, int param2, int param3, int param4, u32 param5)
{
    Strbuf* v0;
...
void ov94_0224218C (UnkStruct_0205AA50 * param0, MessageFormatter * param1, MessageFormatter * param2, int param3, int param4, int param5, u32 param6)
{
    Strbuf* v0;

    if (param3 != 0) {
        v0 = MessageFormatter_AllocStrbuf(param1, param3);
        ov94_02245900(param0, v0, 0, param5, param4, param6);
        Strbuf_Free(v0);
    } else {
        v0 = MessageFormatter_AllocStrbuf(param2, 167);
        ov94_02245900(param0, v0, 0, param5, param4, param6);
        Strbuf_Free(v0);
    }
}
...
void ov94_02242204 (UnkStruct_0205AA50 * param0, MessageFormatter * param1, int param2, int param3, int param4, int param5, u32 param6)
{
    Strbuf* v0;
    ...
    v0 = MessageFormatter_AllocStrbuf(param1, Unk_ov94_02245FD8[param2]);
...
asm void ov94_0224226C (UnkStruct_0205AA50 * param0, MessageFormatter * param1, int param2, int param3, int param4, u32 param5, int param6, int param7)
{
    push {r4, r5, r6, lr}
    sub sp, #8
    add r6, r0, #0
...
asm void ov94_022422B8 (UnkStruct_0205AA50 * param0, MessageFormatter * param1, int param2, int param3, int param4, u32 param5, int param6)
{
    push {r4, lr}
    sub sp, #0x10
    ldr r4, [sp, #0x18]
...
void ov94_022422D4 (MessageFormatter * param0, MessageFormatter * param1, UnkStruct_0200B358 * param2, UnkStruct_0205AA50 param3[], int param4, int param5, int param6)
{
    Strbuf* v0;
    int v1;

    v0 = MessageFormatter_AllocStrbuf(param0, 97);
    ov94_02245900(&param3[0], v0, 0, 0, 0, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));

    for (v1 = 1; v1 < 3; v1++) {
        sub_0201ADA4(&param3[v1], 0x0);
    }

    ov94_02242158(&param3[1], param1, param4, 0, 0, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));

    if ((param5 == 1) || (param5 == 2)) {
        ov94_02242204(&param3[1], param0, param5, 0, 0, 70, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));
    } else {
        (void)0;
    }

    ov94_022422B8(&param3[2], param0, param6, 2, 0, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)), 0);
    Strbuf_Free(v0);
}

void ov94_02242368 (MessageFormatter * param0, MessageFormatter * param1, UnkStruct_0200B358 * param2, UnkStruct_0205AA50 param3[], int param4, int param5, int param6)
{
    Strbuf* v0;
    int v1;
...
static void ov94_022423FC (MessageFormatter * param0, UnkStruct_0200B358 * param1, UnkStruct_0205AA50 param2[], BoxPokemon * param3, UnkStruct_ov94_0223BA88_sub2 * param4)
{
    ...
    v0 = MessageFormatter_AllocStrbuf(param0, 100);
    ...
    for (v6 = 0; v6 < 3; v6++) {
        sub_0201ADA4(&param2[v6], 0x0);
    }

    ov94_02245900(&param2[0], v0, 0, 0, 0, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));
    ov94_02245900(&param2[1], v2, 0, 0, 0, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));
    ov94_02245900(&param2[2], v1, 0, 0, 2, (u32)(((15 & 0xff) << 16) | ((2 & 0xff) << 8) | ((0 & 0xff) << 0)));
...
UnkStruct_0200112C * ov94_022426A8 (UnkStruct_ov94_0223FD4C * param0, UnkStruct_02013A04 ** param1, UnkStruct_0205AA50 * param2, MessageFormatter * param3)
{
    ...
    *param1 = sub_02013A04(9, 62);
    ...
    sub_0200DC48(param2, 0, (1 + (18 + 12)), 11);
...
UnkStruct_0200112C * ov94_022427C0 (UnkStruct_ov94_0223FD4C * param0, UnkStruct_02013A04 ** param1, UnkStruct_0205AA50 * param2, MessageFormatter * param3, MessageFormatter * param4, UnkStruct_ov94_0223FD4C_sub3 * param5, UnkStruct_02026324 * param6)
{
    UnkStruct_ov84_02240FA8 v0;
    int v1, v2, v3;

    sub_0201ADA4(param2, 0xf0f);
...
UnkStruct_0200112C * ov94_02242840 (UnkStruct_02013A04 ** param0, UnkStruct_0205AA50 * param1, MessageFormatter * param2)
{
    UnkStruct_ov84_02240FA8 v0;
    int v1;
    ...
    *param0 = sub_02013A04(4, 62);
    ...
    sub_0200DC48(param1, 0, (1 + (18 + 12)), 11);

    return sub_0200112C(&v0, 0, 0, 62);
}

UnkStruct_0200112C * ov94_022428B0 (UnkStruct_02013A04 ** param0, UnkStruct_0205AA50 * param1, MessageFormatter * param2, int param3)
{
    UnkStruct_ov84_02240FA8 v0;
    int v1;
...
UnkStruct_0200112C * ov94_022429B4 (UnkStruct_02013A04 ** param0, UnkStruct_0205AA50 * param1, MessageFormatter * param2, MessageFormatter * param3)
{
    UnkStruct_ov84_02240FA8 v0;
    int v1;
    ...
    *param0 = sub_02013A04(v2, 62);
    ...
    sub_0200DC48(param1, 1, (1 + (18 + 12)), 11);
