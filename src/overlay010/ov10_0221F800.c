...
static u8 ov10_0221FD00 (UnkStruct_ov10_0221FB28 * param0)
{
    ...
    case 2:
        ...
        param0->unk_BA8 = PLString_Init((2 * 160), param0->unk_00->unk_24);
        param0->unk_BB0 = 1;
...
static void ov10_02222720 (UnkStruct_ov10_0221FB28 * param0)
{
    ...
    v3 = PLString_Init(32, param0->unk_00->unk_24);
...
static void ov10_022227A4 (UnkStruct_ov10_0221F800 * param0)
{
    ...
    if (MapHeader_IsUnionRoom(param0->unk_00->unk_134) == 1) {
        ...
        PLString_Dump(param0->unk_14[sub_020362F4(v6 ^ 1)], v1, 8);
        ...
        case 4:
            ...
            if (ov10_02220AD0() == 1) {
                ...
                PLString_Dump(param0->unk_14[1], v1, 8);
                PLString_Dump(param0->unk_14[3], v2, 8);
            } else {
                v3 = sub_020793AC(param0->unk_00->unk_28[0].unk_01);
                v4 = sub_020793AC(param0->unk_00->unk_28[2].unk_01);

                PLString_Dump(param0->unk_14[0], v1, 8);
                PLString_Dump(param0->unk_14[2], v2, 8);
            }
