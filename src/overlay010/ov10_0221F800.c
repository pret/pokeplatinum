...
static void ov10_022210F4(UnkStruct_ov10_0221FB28 *param0)
{
    ...
    SpriteRenderer_LoadCharResObjFromOpenNarc(param0->unk_190, param0->unk_194, v0, ball_status_indicator_player_NCGR_lz, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 47111);
    sub_0200CC9C(param0->unk_190, param0->unk_194, 108, 8, 0, 2, NNS_G2D_VRAM_TYPE_2DMAIN, 47111);
    SpriteRenderer_LoadCellResObjFromOpenNarc(param0->unk_190, param0->unk_194, v0, ball_status_indicator_player_NCER_lz, 1, 47111);
    SpriteRenderer_LoadAnimResObjFromOpenNarc(param0->unk_190, param0->unk_194, v0, ball_status_indicator_player_NANR_lz, 1, 47111);
    NARC_dtor(v0);
}
