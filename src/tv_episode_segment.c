...
static void sub_0206CE38(Pokemon *mon, u16 *species, u8 *gender, u8 *language, u8 *metGame)
{
...
void CaptureAttempt_Init(CaptureAttempt *captureAttempt, Pokemon *mon, int resultMask, int ballsThrown, u32 heapID)
{
    ...
    sub_0206CE38(mon, &captureAttempt->species, &captureAttempt->gender, &captureAttempt->language, &captureAttempt->metGame);
...
void FieldSystem_SaveTVEpisodeSegment_WhatsFishing(FieldSystem *fieldSystem, BOOL caughtFish, u16 fishingRodItemID, Pokemon *mon)
{
    ...
    if (caughtFish) {
        sub_0206CE38(mon, &whatsFishing->species, &whatsFishing->gender, &whatsFishing->language, &whatsFishing->metGame);
    }
...
static void sub_0206D3E4(FieldSystem *fieldSystem, int segmentID)
{
    TVEpisodeSegment segments;
...
{
    sub_0206D3E4(fieldSystem, TV_PROGRAM_SEGMENT_LOVE_THAT_GROUP_CORNER_NEW_GROUP);
}

void sub_0206D430(FieldSystem *fieldSystem)
{
    sub_0206D3E4(fieldSystem, TV_PROGRAM_SEGMENT_LOVE_THAT_GROUP_CORNER_SWITCH_GROUP);
}
...
static BOOL TVEpisodeSegment_IsEligible_TrainerSightingsDummy(FieldSystem *fieldSystem, UnkStruct_ov6_022465F4 *param1)
{
    return FALSE;
}
...
static int TVEpisodeSegment_LoadMessage_CaptureTheFlagDigest_LoseFlag(FieldSystem *fieldSystem, StringTemplate *param1, UnkStruct_ov6_022465F4 *param2)
{
    sub_0206DA84(fieldSystem, param1, param2);
...
static const TVProgramSegment sTrainerSightingsSegments[TV_PROGRAM_TYPE_TRAINER_SIGHTINGS_NUM_SEGMENTS] = {
    ...
    {
        NULL,
        TVEpisodeSegment_IsEligible_TrainerSightingsDummy,
    },
    {
