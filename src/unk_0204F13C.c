...
void sub_0204F3D0(FieldTask *param0, u16 param1, u16 *param2)
{
    UnkStruct_0204F3D0 *v0 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0204F3D0));
...
void sub_0204F470(FieldTask *param0, void **param1, u8 param2)
{
    ...
    UnkStruct_0204F470 *v1 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0204F470));
