...
static void sub_0208D200 (UnkStruct_0208D7BC * param0, Pokemon * param1, UnkStruct_0208D1D4 * param2)
{
    ...
    param2->unk_12_0 = (u8)GetMonData(param1, MON_DATA_LEVEL, NULL);
    ...
    param2->unk_13_0 = GetMonGender(param1);
    ...
    param2->unk_1C = GetMonSpeciesLevelExp(param2->unk_0C, param2->unk_12_0);

    if (param2->unk_12_0 == 100) {
        param2->unk_20 = param2->unk_1C;
    } else {
        param2->unk_20 = GetMonSpeciesLevelExp(param2->unk_0C, param2->unk_12_0 + 1);
    }

    param2->unk_24 = (u16)GetMonData(param1, MON_DATA_CURRENT_HP, NULL);
    param2->unk_26 = (u16)GetMonData(param1, MON_DATA_MAX_HP, NULL);
    param2->unk_28 = (u16)GetMonData(param1, MON_DATA_ATK, NULL);
    param2->unk_2A = (u16)GetMonData(param1, MON_DATA_DEF, NULL);
    param2->unk_2C = (u16)GetMonData(param1, MON_DATA_SP_ATK, NULL);
    param2->unk_2E = (u16)GetMonData(param1, MON_DATA_SP_DEF, NULL);
    param2->unk_30 = (u16)GetMonData(param1, MON_DATA_SPEED, NULL);
    param2->unk_32 = (u8)GetMonData(param1, MON_DATA_ABILITY, NULL);
    param2->unk_33 = GetMonNature(param1);
    ...
    param2->unk_4E = GetMonData(param1, MON_DATA_FORM, NULL);
...
static s8 sub_0208DC1C (UnkStruct_0208D7BC * param0, s8 param1)
{
    ...
    while (TRUE) {
        ...
        v0 = (Pokemon *)((u32)param0->unk_24C->unk_00 + GetPokemonStructSize() * v1);
...
static s8 sub_0208DCE0 (UnkStruct_0208D7BC * param0, s8 param1)
{
    ...
    while (TRUE) {
        ...
        v0 = (BoxPokemon *)((u32)param0->unk_24C->unk_00 + GetBoxPokemonStructSize() * v1);

        if (GetBoxMonData(v0, MON_DATA_SPECIES, NULL) != 0) {
            if (GetBoxMonData(v0, MON_DATA_IS_EGG, NULL) != 0) {
                if (sub_0208DBF4(param0) == 1) {
                    break;
                }
            } else {
...
void * sub_0208DD48 (UnkStruct_0208D7BC * param0)
{
    switch (param0->unk_24C->unk_11) {
    case 0:
        return (void *)((u32)param0->unk_24C->unk_00 + (GetPokemonStructSize() * param0->unk_24C->unk_14));
    case 1:
        return (void *)Party_GetPokemonBySlotIndex(param0->unk_24C->unk_00, param0->unk_24C->unk_14);
    case 2:
        return (void *)((u32)param0->unk_24C->unk_00 + (GetBoxPokemonStructSize() * param0->unk_24C->unk_14));
    }
...
static void sub_0208E0DC (UnkStruct_0208D7BC * param0)
{
    ...
    if (param0->unk_24C->unk_11 == 2) {
        SwapBoxMonMoves(v0, param0->unk_6A5_0, param0->unk_6A5_4);
    } else {
        SwapMonMoves(v0, param0->unk_6A5_0, param0->unk_6A5_4);
    }
