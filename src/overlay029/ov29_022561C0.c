...
static BOOL ov29_022561D4(void **param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    UnkStruct_ov29_0225621C *v0 = (UnkStruct_ov29_0225621C *)Heap_Alloc(HEAP_ID_POKETCH_APP, sizeof(UnkStruct_ov29_0225621C));
...
static BOOL ov29_0225621C(UnkStruct_ov29_0225621C *param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    ...
    if (ov29_022566C8(&(param0->unk_16F4), &(param0->unk_08), param2)) {
        ...
        param0->unk_02 = 0;
        param0->unk_03 = 0;
        param0->buttonManager = PoketchButtonManager_New(Unk_ov29_02256B3C, NELEMS(Unk_ov29_02256B3C), ov29_022562F4, param0, HEAP_ID_POKETCH_APP);
