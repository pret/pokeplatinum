...
static BOOL ov29_02256728(UnkStruct_ov29_022566C8 *param0)
{
    ...
    if (param0->unk_70) {
        ...
        if (AppStorageBuffer_ReadFast(param0->unk_00->unk_16E8, param0->unk_70->pixels, (20 * 19 * 0x20)) == 0) {
...
void ov29_02256770(UnkStruct_ov29_022566C8 *param0)
{
    if (param0 != NULL) {
        ...
        if (param0->unk_70) {
            AppStorageBuffer_WriteFast(param0->unk_00->unk_16E8, param0->unk_70->pixels, (20 * 19 * 0x20));
