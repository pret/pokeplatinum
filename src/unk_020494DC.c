...
BOOL ScrCmd_ShowBPWindow(ScriptContext *param0)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    u8 tilemapLeft = ScriptContext_ReadByte(param0);
    u8 tilemapTop = ScriptContext_ReadByte(param0);
    Window **bpWindow = FieldSystem_GetScriptMemberPtr(fieldSystem, SCRIPT_MANAGER_COIN_BP_WINDOW);
    *bpWindow = FieldMenu_CreateBPWindow(param0->fieldSystem, tilemapLeft, tilemapTop);

    return FALSE;
}

BOOL ScrCmd_CloseBPWindow(ScriptContext *param0)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    Window **bpWindow = FieldSystem_GetScriptMemberPtr(fieldSystem, SCRIPT_MANAGER_COIN_BP_WINDOW);

    FieldMenu_DeleteCoinBPWindow(*bpWindow);
    return FALSE;
}

BOOL ScrCmd_UpdateBPWindow(ScriptContext *param0)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    Window **bpWindow = FieldSystem_GetScriptMemberPtr(fieldSystem, SCRIPT_MANAGER_COIN_BP_WINDOW);
