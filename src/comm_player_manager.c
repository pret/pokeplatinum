...
{
    int v0 = PlayerAvatar_GetState(sCommPlayerManager->fieldSystem->playerAvatar);
    int moveState = PlayerAvatar_GetMoveState(sCommPlayerManager->fieldSystem->playerAvatar);
