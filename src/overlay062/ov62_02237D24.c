...
static const UnkUnion_02022594 Unk_ov62_02248CB0[] = {
    {0x98, 0xB8, 0x20, 0x80},
    {0x98, 0xB8, 0x80, 0xE0}
};

static const UnkUnion_02022594 Unk_ov62_02248CAC[] = {
    {0x98, 0xB8, 0x50, 0xB0}
};

static const UnkUnion_02022594 Unk_ov62_02248CC4[] = {
    {0x18, 0x28, 0x38, 0xC0},
    {0x28, 0x38, 0x38, 0xC0},
    {0x38, 0x48, 0x38, 0xC0},
    {0x48, 0x58, 0x38, 0xC0},
...
static const UnkUnion_02022594 Unk_ov62_02248CB8[] = {
    {0x10, 0x30, 0x38, 0xC8},
    {0x48, 0x68, 0x18, 0x48},
    {0x48, 0x68, 0xB8, 0xE8}
};
...
static BOOL ov62_02238048 (UnkStruct_0208C06C * param0)
{
    ...
    if (sub_02022760(&Unk_ov62_02248CB0[0])) {
        ov62_02234520(param0);
        ov62_0222FB60(param0, 5);
    }

    if (sub_02022760(&Unk_ov62_02248CB0[1])) {
        ov62_02234520(param0);
...
static BOOL ov62_02238610 (UnkStruct_0208C06C * param0)
{
    ...
    case 2:
        ...
        if (sub_02022760(&Unk_ov62_02248CAC[0])
            || (v0->unk_1D4.unk_10 == 1)) {
            ov62_02234520(param0);
            param0->unk_08++;
        }
...
static BOOL ov62_02238E54 (UnkStruct_0208C06C * param0)
{
    ...
    if (sub_02022760(&Unk_ov62_02248CB8[0])) {
        ov62_02234520(param0);
        ov62_0222FB60(param0, 10);
    }

    if (sub_02022760(&Unk_ov62_02248CB8[1])) {
    ...
    if (sub_02022760(&Unk_ov62_02248CB8[2])) {
        v0->unk_230.unk_04++;
...
static void ov62_02239A0C (UnkStruct_0208C06C * param0, int param1)
{
    ...
    v4->unk_1D4.unk_08 = ov62_02231948(102, 0, &v4->unk_1D4.unk_04);
    v0 = ov62_02231948(102, 0, &v4->unk_1D4.unk_04);
    ...
    v4->unk_1D4.unk_0C = MessageFormatter_Init(0, 26, 412, 102);
    v4->unk_1D4.unk_10 = 1;
}
...
static void ov62_02239B7C (UnkStruct_0208C06C * param0)
{
    ...
    MessageFormatter_Free(v0->unk_1D4.unk_0C);
