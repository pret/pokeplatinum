    ...
    case 0:
...

        {
            ...
            for (v1 = 0; v1 < param0->unk_534.unk_1AC; v1++) {
                ...
                Sprite_GetPositionFxXY(param0->unk_534.unk_C8[v1].unk_00, &v0->unk_00[v1].unk_0C, &v2);
                Sprite_SetPositionFxXY(param0->unk_534.unk_C8[v1].unk_00, v0->unk_00[v1].unk_0C, (25 + (36 * (5 - 1)) + (16 * (5 - (param0->unk_534.unk_1AC)))) * FX32_ONE);
    ...
    case 1:
...

        {
            ...
            for (v3 = 0; v3 < param0->unk_534.unk_1AC; v3++) {
                ...
                Sprite_SetPositionFxXY(param0->unk_534.unk_C8[v3].unk_00, v7, v8);
