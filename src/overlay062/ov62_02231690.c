...
static void ov62_022323CC (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1)
{
    ...
    if ((v4 == 0) && (v5 == 0)) {
        v0 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 125);
    } else {
        v2 = ov62_02231690(102);

        if (v5 != 0) {
            v0 = Strbuf_Init(255, 102);
            v1 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 23);
            sub_0200BE08(v2, 0, v4, v5);
            sub_0200C388(v2, v0, v1);
        } else {
            v0 = Strbuf_Init(255, 102);
            v1 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 22);
...
void ov62_022324A0 (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1, const UnkStruct_ov62_02248CDC * param2)
{
    ...
    for (v0 = 0; v0 < param0->unk_10; v0++) {
        v2 = MessageFormatter_AllocStrbuf(param0->unk_34, param2->unk_00[v0].unk_00);
...
void ov62_02232594 (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1, MessageFormatter * param2, const UnkStruct_ov62_02248CDC * param3)
{
    int v0;
    UnkStruct_0205AA50 * v1;
    Strbuf* v2;
    ...
    if (param3->unk_00) {
        for (v0 = 0; v0 < param0->unk_10; v0++) {
            v2 = MessageFormatter_AllocStrbuf(param0->unk_34, param3->unk_00[v0].unk_00);
        ...
        for (v0 = 0; v0 < param0->unk_10; v0++) {
            ...
            v6 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 99);
...
asm void ov62_02232778 (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1, MessageFormatter * param2, const UnkStruct_ov62_02248CDC * param3, int param4, int param5, Strbuf *param6)
{
    push {r4, r5, r6, r7, lr}
    sub sp, #0x1fc
    sub sp, #0xe0
...
int ov62_02232F68 (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1)
{
...

    {
        ...
        for (v0 = v5; v0 < v6; v0++) {
            v3 = MessageFormatter_AllocStrbuf(param0->unk_34, param0->unk_28->unk_00[v0].unk_00);
...
int ov62_02233064 (UnkStruct_ov62_02233310 * param0, UnkStruct_0208C06C * param1)
{
...

    {
        ...
        for (v4 = 0; v4 < param0->unk_10; v4++) {
            ...
            v9 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 99);
...
static void ov62_02233B50 (UnkStruct_ov62_02233F74 * param0, UnkStruct_0208C06C * param1)
{
...

    {
        ...
        for (v0 = 0; v0 < 5; v0++) {
            ...
            v2 = &param0->unk_3C[v0];
            v3 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, v5[v0]);
...

    {
        ...
        v7 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 7);
        v8 = Strbuf_Init(255, 102);
...

        {
            ...
            v10 = &param0->unk_3C[1];
            v8 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 132 + v12);
...

        {
            ...
            if (v13 != 0) {
                ...
                v7 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 9);
                v8 = Strbuf_Init(255, 102);
...

        {
...

            {
                ...
                if ((v20 == 0) && (v14 != 0)) {
                    v7 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 12);
                } else {
                    v7 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 11);
                }
            }
