    ...
    for (v1 = 0; v1 < 5; v1++) {
        for (v2 = 0; v2 < 6; v2++) {
            if (v3->unk_2008.unk_0C[v1][v2].unk_04) {
                CellActorData_SetPositionXY(v3->unk_2008.unk_0C[v1][v2].unk_04, v0[(v1 * 6) + v2][0], v0[(v1 * 6) + v2][1]);
            }
        }
    }
}
...
static void ov62_0223E01C (UnkStruct_0208C06C * param0)
{
    ...
    CellActorData_SetAnim(v0->unk_114[0].unk_08, 0);
    CellActorData_SetAnim(v0->unk_114[1].unk_08, 3);
    CellActorData_SetPositionXY(v0->unk_114[0].unk_08, 32, 232);
    CellActorData_SetPositionXY(v0->unk_114[1].unk_08, 128, 232);
...
static BOOL ov62_0223ED7C (UnkStruct_0208C06C * param0)
{
    ...
    case 1:
        ...
        if (ov62_022315E0(&v0->unk_00, &v0->unk_04, 1, 0)) {
            ...
            CellActorData_SetAnim(v0->unk_114[0].unk_08, 0);
            CellActorData_SetAnim(v0->unk_114[1].unk_08, 1);
...
static void ov62_0223EF60 (UnkStruct_0208C06C * param0)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        ...
        CellActorData_SetPositionXY(v0->unk_114[v1].unk_08, 42 + 8, (25 + (36 * (v1)) + (16 * (5 - 4))) + 64);
        CellActorData_SetAnim(v0->unk_114[v1].unk_08, v3[v1]);
...
static void ov62_0223F038 (UnkStruct_0208C06C * param0)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        ...
        CellActorData_Delete(v0->unk_114[v1].unk_08);
    }
...
static void ov62_0223F06C (UnkStruct_0208C06C * param0)
{
    ...
    CellActorData_Delete(v0->unk_114[0].unk_08);
    CellActorData_Delete(v0->unk_114[1].unk_08);
    ov62_022313BC(param0);
}
...
static void ov62_0223F0A8 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0) {
        CellActorData_DrawSprite(v0->unk_114[1].unk_08, 1);
        sub_020129D0(v0->unk_114[1].unk_0C, 1);
        CellActorData_SetPositionXY(v0->unk_114[0].unk_08, 32, 232);
    } else {
        CellActorData_DrawSprite(v0->unk_114[1].unk_08, 0);
        sub_020129D0(v0->unk_114[1].unk_0C, 0);
        CellActorData_SetPositionXY(v0->unk_114[0].unk_08, 80, 232);
    }
...
asm static BOOL ov62_022403F8 (UnkStruct_0208C06C * param0)
{
 ...
 _022405F6:
    ...
    mov r1, #0x3e
    mov r3, #3
    bl Graphics_LoadTilesToBgLayerFromOpenNARC
    mov r0, #0
    str r0, [sp]
    str r0, [sp, #4]
    str r0, [sp, #8]
 ...
 _02240668:
    ...
    mov r1, #0x50
    mov r3, #3
    bl Graphics_LoadTilemapToBgLayerFromOpenNARC
 _02240698:
    add r0, r4, #0
    mov r1, #0
    bl ov62_02234540
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        for (v1 = 0; v1 < 6; v1++) {
            ...
            if (v3->unk_2008.unk_0C[v0][v1].unk_04) {
                CellActorData_SetPriority(v3->unk_2008.unk_0C[v0][v1].unk_04, 6 - v1);
            }
    ...
    for (v0 = 0; v0 < 5; v0++) {
        for (v1 = 0; v1 < 6; v1++) {
            if (v2->unk_2008.unk_0C[v0][v1].unk_04) {
                CellActorData_DrawSprite(v2->unk_2008.unk_0C[v0][v1].unk_04, param1);
            }
        }
    }
}
...

    {
        ...
        for (v1 = 0; v1 < 6; v1++) {
            ...
            if (v5->unk_2008.unk_0C[v2][v1].unk_04) {
                CellActorData_SetPriority(v5->unk_2008.unk_0C[v2][v1].unk_04, 6 - v1);
            }
