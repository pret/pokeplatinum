    ...
    case 2:
        if (ov61_0222BB48(ov62_0224112C(param0), &v1) == 1) {
        ...
        } else {
            {
                ...
                v0->unk_720.unk_08.unk_00 = Playtime_GetHours(sub_02025E5C(param0->unk_830));
                v0->unk_720.unk_08.unk_02 = Playtime_GetMinutes(sub_02025E5C(param0->unk_830));
                v0->unk_720.unk_08.unk_03 = Playtime_GetSeconds(sub_02025E5C(param0->unk_830));
