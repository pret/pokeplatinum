...
static void ov62_0223D3A8 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0) {
        CellActorData_DrawSprite(v0->unk_A4[0].unk_08, 1);
        sub_020129D0(v0->unk_A4[0].unk_0C, 1);
        CellActorData_SetPositionXY(v0->unk_A4[1].unk_08, 128, 232);
    } else {
        CellActorData_DrawSprite(v0->unk_A4[0].unk_08, 0);
        sub_020129D0(v0->unk_A4[0].unk_0C, 0);
        CellActorData_SetPositionXY(v0->unk_A4[1].unk_08, 80, 232);
    }
...
static void ov62_0223D424 (UnkStruct_0208C06C * param0)
{
    ...
    CellActorData_SetPositionXY(v0->unk_A4[0].unk_08, 32, 232);
    CellActorData_SetPositionXY(v0->unk_A4[1].unk_08, 128, 232);
    sub_020128C4(v0->unk_A4[0].unk_0C, 36, -8);
    sub_020128C4(v0->unk_A4[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_A4[0].unk_0C, 0);
...
static void ov62_0223D4E4 (UnkStruct_0208C06C * param0)
{
    ...
    CellActorData_Delete(v0->unk_A4[0].unk_08);
    CellActorData_Delete(v0->unk_A4[1].unk_08);
