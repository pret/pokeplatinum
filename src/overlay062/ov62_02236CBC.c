...
static void ov62_02236CBC(UnkStruct_0208C06C *param0, int param1)
{
    ...
    if (param1 == 0) {
        CellActorData_SetPositionXY(v0->unk_9C[1].unk_08, 128, 232);
    } else {
        CellActorData_SetPositionXY(v0->unk_9C[1].unk_08, 80, 232);
    }
...
static void ov62_02236CF8(UnkStruct_0208C06C *param0, int param1)
{
    ...
    SpriteRenderer_LoadCharResObjFromOpenNarc(v2, v3, v0, 50, 0, param1, 11924);
    SpriteRenderer_LoadCellResObjFromOpenNarc(v2, v3, v0, 28, 0, 11924);
    SpriteRenderer_LoadAnimResObjFromOpenNarc(v2, v3, v0, 29, 0, 11924);
}
...
static void ov62_02236D48(UnkStruct_0208C06C *param0)
{
    ...
    CellActorData_SetPositionXY(v0->unk_94[1], 220, 160 + 64);
    CellActorData_SetAnim(v0->unk_94[1], 2);
    CellActorData_DrawSprite(v0->unk_94[1], 0);
...
static void ov62_02236DE8(UnkStruct_0208C06C *param0)
{
    ...
    CellActorData_Delete(v0->unk_9C[1].unk_08);
    CellActorData_Delete(v0->unk_94[1]);
...
static void ov62_02236E14(UnkStruct_0208C06C *param0)
{
    ...
    SpriteRenderer_LoadPaletteFromOpenNarc(v5, 3, v3, v4, v1, ov62_02231710(param0, 0), 0, 1, NNS_G2D_VRAM_TYPE_2DSUB, 29292);
    ...
    SpriteRenderer_LoadAnimResObjFromOpenNarc(v3, v4, v1, 72, 0, 29292);
    SpriteRenderer_LoadPaletteFromOpenNarc(v5, 2, v3, v4, v1, ov62_02231710(param0, 1), 0, 6, NNS_G2D_VRAM_TYPE_2DMAIN, 28282);
    SpriteRenderer_LoadCharResObjFromOpenNarc(v3, v4, v1, 64, 0, NNS_G2D_VRAM_TYPE_2DMAIN, 28282);
    SpriteRenderer_LoadCellResObjFromOpenNarc(v3, v4, v1, 38, 0, 28282);
    SpriteRenderer_LoadAnimResObjFromOpenNarc(v3, v4, v1, 39, 0, 28282);

    {
        ...
        for (v6 = 0; v6 < 5; v6++) {
            if (v6 == 3) {
                SpriteRenderer_LoadPaletteFromOpenNarc(v5, 2, v3, v4, v1, 92, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 18181 + v6);
                SpriteRenderer_LoadCharResObjFromOpenNarc(v3, v4, v1, 91, 0, NNS_G2D_VRAM_TYPE_2DMAIN, 18181 + v6);
            } else {
                SpriteRenderer_LoadPalette(v5, 2, v3, v4, 146, v7[v6], 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 18181 + v6);
                sub_0200D888(v3, v4, 146, v8[v6], 0, NNS_G2D_VRAM_TYPE_2DMAIN, 18181 + v6);
            }
        }

        SpriteRenderer_LoadCellResObj(v3, v4, 146, v9, 0, 18181);
        SpriteRenderer_LoadAnimResObj(v3, v4, 146, v10, 0, 18181);
        SpriteRenderer_LoadCellResObjFromOpenNarc(v3, v4, v1, 89, 0, 18181 + 1);
        SpriteRenderer_LoadAnimResObjFromOpenNarc(v3, v4, v1, 90, 0, 18181 + 1);
    }

    {
        ...
        SpriteRenderer_LoadPalette(v5, 2, v3, v4, 146, v11, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 165535);
        SpriteRenderer_LoadCellResObj(v3, v4, 146, v13, 0, 165535);
        SpriteRenderer_LoadAnimResObj(v3, v4, 146, v14, 0, 165535);
...
static void ov62_022371CC(UnkStruct_0208C06C *param0)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        v4->unk_40[v0] = CellActor_LoadResources(param0->unk_14.unk_04, param0->unk_14.unk_08, &v9);
        CellActorData_SetAnim(v4->unk_40[v0], 1);
        CellActorData_UpdateObject(v4->unk_40[v0]);
        CellActorData_SetAffineScaleXYFx32(v4->unk_40[v0], v4->unk_04[v0], v4->unk_04[v0]);
    }
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        v4->unk_54[v0] = CellActor_LoadResources(param0->unk_14.unk_04, param0->unk_14.unk_08, &v9);

        if (v0 == 3) {
            CellActorData_SetAnim(v4->unk_54[v0], 0);
        } else {
            CellActorData_SetAnim(v4->unk_54[v0], 1);
        }

        CellActorData_UpdateObject(v4->unk_54[v0]);
        CellActorData_SetAffineScaleXYFx32(v4->unk_54[v0], v4->unk_04[v0], v4->unk_04[v0]);
        CellActorData_SetExplicitPalette(v4->unk_54[v0], 10 + v0);
    }
    ...
    for (v0 = 0; v0 < 5; v0++) {
        v4->unk_68[v0] = CellActor_LoadResources(param0->unk_14.unk_04, param0->unk_14.unk_08, &v9);

        if (v3[v0] == 0) {
            CellActorData_SetAnim(v4->unk_68[v0], 5);
            CellActorData_SetExplicitPalette(v4->unk_68[v0], 4 + 5);
            CellActorData_DrawSprite(v4->unk_54[v0], 0);
            CellActorData_DrawSprite(v4->unk_40[v0], 0);
        } else {
            int v11[] = { 0, 1, 4, 3, 2 };

            CellActorData_SetAnim(v4->unk_68[v0], v11[v0]);
            CellActorData_SetExplicitPalette(v4->unk_68[v0], 4 + v11[v0]);
        }

        CellActorData_UpdateObject(v4->unk_68[v0]);
        CellActorData_SetAffineScaleXYFx32(v4->unk_68[v0], v4->unk_04[v0], v4->unk_04[v0]);
    }
    ...
    for (v0 = 0; v0 < 4 + 1; v0++) {
        v4->unk_7C[v0] = CellActor_LoadResources(param0->unk_14.unk_04, param0->unk_14.unk_08, &v9);

        if (v2[v0] == 0) {
            if (v0 < v1) {
                CellActorData_DrawSprite(v4->unk_7C[v0], 0);
            }
        }

        CellActorData_SetAnim(v4->unk_7C[v0], v2[v0]);
        ov62_02230E68(v4->unk_7C[v0], 88 + (16 * v0), 72);
        CellActorData_UpdateObject(v4->unk_7C[v0]);
    }

    CellActorData_DrawSprite(v4->unk_7C[4 - 1], 1);
    CellActorData_DrawSprite(v4->unk_7C[4 - 0], 1);
...
static void ov62_022374A8(UnkStruct_0208C06C *param0)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        SpriteGfxHandler_UnloadCharObjById(param0->unk_14.unk_08, 18181 + v0);
        SpriteGfxHandler_UnloadPlttObjById(param0->unk_14.unk_08, 18181 + v0);
        CellActorData_Delete(v1->unk_54[v0]);
    }

    SpriteGfxHandler_UnloadCellObjById(param0->unk_14.unk_08, 18181);
    SpriteGfxHandler_UnloadAnimObjById(param0->unk_14.unk_08, 18181);
    SpriteGfxHandler_UnloadCellObjById(param0->unk_14.unk_08, 18181 + 1);
    SpriteGfxHandler_UnloadAnimObjById(param0->unk_14.unk_08, 18181 + 1);

    for (v0 = 0; v0 < 5; v0++) {
        CellActorData_Delete(v1->unk_40[v0]);
    }

    SpriteGfxHandler_UnloadCharObjById(param0->unk_14.unk_08, 165535);
    SpriteGfxHandler_UnloadPlttObjById(param0->unk_14.unk_08, 165535);
    SpriteGfxHandler_UnloadCellObjById(param0->unk_14.unk_08, 165535);
    SpriteGfxHandler_UnloadAnimObjById(param0->unk_14.unk_08, 165535);

    for (v0 = 0; v0 < 5; v0++) {
        CellActorData_Delete(v1->unk_68[v0]);
    }

    SpriteGfxHandler_UnloadCharObjById(param0->unk_14.unk_08, 28282);
    SpriteGfxHandler_UnloadPlttObjById(param0->unk_14.unk_08, 28282);
    SpriteGfxHandler_UnloadCellObjById(param0->unk_14.unk_08, 28282);
    SpriteGfxHandler_UnloadAnimObjById(param0->unk_14.unk_08, 28282);

    for (v0 = 0; v0 < 4 + 1; v0++) {
        CellActorData_Delete(v1->unk_7C[v0]);
    }

    SpriteGfxHandler_UnloadCharObjById(param0->unk_14.unk_08, 29292);
    SpriteGfxHandler_UnloadPlttObjById(param0->unk_14.unk_08, 29292);
    SpriteGfxHandler_UnloadCellObjById(param0->unk_14.unk_08, 29292);
    SpriteGfxHandler_UnloadAnimObjById(param0->unk_14.unk_08, 29292);
}
...
static BOOL ov62_022375A4(UnkStruct_0208C06C *param0)
{
    ...
    for (v1 = 0; v1 < 5; v1++) {
        if (v0->unk_2C[0] != 0) {
            ...
            CellActorData_SetAffineOverwriteMode(v0->unk_40[v1], 0);
            CellActorData_SetAffineOverwriteMode(v0->unk_54[v1], 0);
            CellActorData_SetAffineOverwriteMode(v0->unk_68[v1], 0);
            v0->unk_04[v1] = 1.0f;
        }
        ...
        CellActorData_SetPositionFx32(v0->unk_68[v1], v4, v5);
        CellActorData_GetPositionXY(v0->unk_68[v1], &v2, &v3);
        CellActorData_SetPositionXY(v0->unk_40[v1], v2 - 32, v3 - 2);
        CellActorData_SetPositionXY(v0->unk_54[v1], v2 + 16, v3 - 2);
        CellActorData_SetAffineScaleXYFx32(v0->unk_68[v1], v0->unk_04[v1], v0->unk_04[v1]);
        CellActorData_SetAffineScaleXYFx32(v0->unk_40[v1], v0->unk_04[v1], v0->unk_04[v1]);
        CellActorData_SetAffineScaleXYFx32(v0->unk_54[v1], v0->unk_04[v1], v0->unk_04[v1]);
    }
...
static BOOL ov62_022376C4(UnkStruct_0208C06C *param0)
{
    ...
    if (v0->unk_2C[0] == 20) {
        for (v1 = 0; v1 < 5; v1++) {
            CellActorData_SetAffineOverwriteMode(v0->unk_40[v1], 2);
            CellActorData_SetAffineOverwriteMode(v0->unk_54[v1], 2);
            CellActorData_SetAffineOverwriteMode(v0->unk_68[v1], 2);
        }
    }
    ...
    for (v1 = 0; v1 < 5; v1++) {
        if (v0->unk_2C[0] != 0) {
            ...
            CellActorData_DrawSprite(v0->unk_68[v1], 0);
            CellActorData_DrawSprite(v0->unk_40[v1], 0);
            CellActorData_DrawSprite(v0->unk_54[v1], 0);
        }
...
static void ov62_02237814(UnkStruct_0208C06C *param0)
{
    ...
    for (v1 = 0; v1 < 5; v1++) {
        ...
        CellActorData_SetPositionFx32(v0->unk_68[v1], v5, v6);
        CellActorData_GetPositionXY(v0->unk_68[v1], &v3, &v4);
        CellActorData_SetPositionXY(v0->unk_40[v1], v3 - 32, v4 - 2);
        CellActorData_SetPositionXY(v0->unk_54[v1], v3 + 16, v4 - 2);
    }
}
