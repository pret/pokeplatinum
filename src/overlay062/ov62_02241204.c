...
typedef struct {
    ...
    UnkStruct_0205AA50 unk_614[12];
    UnkStruct_0205AA50 unk_6D4[12];
    int unk_794;
    int unk_798;
    u8 unk_79C;
    ...
    for (v1 = 0; v1 < 5; v1++) {
        for (v2 = 0; v2 < 6; v2++) {
            if (v3->unk_50C.unk_0C[v1][v2].unk_04) {
                sub_0200D4C4(v3->unk_50C.unk_0C[v1][v2].unk_04, v0[(v1 * 6) + v2][0], v0[(v1 * 6) + v2][1]);
            }
        }
    }
}
    ...
    for (v0 = 0; v0 < 5; v0++) {
        for (v1 = 0; v1 < 6; v1++) {
            if (v2->unk_50C.unk_0C[v0][v1].unk_04) {
                sub_0200D3F4(v2->unk_50C.unk_0C[v0][v1].unk_04, param1);
            }
        }
    }
}
...
static void ov62_022417C0 (UnkStruct_0208C06C * param0, int param1)
{
...

    {
        ...
        int v9 = 256;
        Strbuf* v10;
        UnkStruct_0205AA50 * v11;

        for (v7 = 0; v7 < v0->unk_794; v7++) {
            v11 = &v0->unk_614[v7];

            sub_0201A7A0(v11);
            sub_0201A7E8(param0->unk_14.unk_10, v11, 2, v3[v7][0], v3[v7][1], v3[v7][2], v3[v7][3], 14, v9);
            sub_0201ADA4(v11, 0x0);

            v10 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, v4[v7]);
            v9 += v3[v7][2] * v3[v7][3];
...
static void ov62_022418DC (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0xff) {
        v2 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, 125);
    } else {
        if ((param1 == UnkEnum_0202F510_33) || (param1 == UnkEnum_0202F510_34) || (param1 == UnkEnum_0202F510_35) || (param1 == UnkEnum_0202F510_36)) {
            ...
            v2 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, v3);
        } else {
            v3 = 132 + param1;
            v2 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, v3);
        }
...
static void ov62_022419D4 (UnkStruct_0208C06C * param0, int param1, int param2)
{
    ...
    if ((param1 == 0xff) && (param2 == 0xff)) {
        ...
        if (param2 != 0) {
            v2 = Strbuf_Init(255, 102);
            v3 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, 23);
            sub_0200BE08(v4, 0, param1, param2);
            sub_0200C388(v4, v2, v3);
        } else {
            v2 = Strbuf_Init(255, 102);
            v3 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, 22);
...
static void ov62_02241AA4 (UnkStruct_0208C06C * param0, int param1)
{
...

    {
        ...
        for (v7 = 0; v7 < v0->unk_798; v7++) {
            ...
            sub_0201A7A0(v11);
            sub_0201A7E8(param0->unk_14.unk_10, v11, 6, v3[v7][0], v3[v7][1], v3[v7][2], v3[v7][3], 14, v9);
            sub_0201ADA4(v11, 0x0);
...
static void ov62_02241C38 (UnkStruct_0208C06C * param0)
{
    ...
    v4 = &v0->unk_614[0];
    sub_0201A7A0(v4);
    sub_0201A7E8(param0->unk_14.unk_10, v4, 2, 3, 3, 20, 4, 14, v2);
    sub_0201ADA4(v4, 0x0);

    v3 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, 126);
    ...
    v4 = &v0->unk_6D4[0];
    sub_0201A7A0(v4);
    sub_0201A7E8(param0->unk_14.unk_10, v4, 6, 11, 6, 10, 4, 14, v2);
    sub_0201ADA4(v4, 0x0);
    v3 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, 95);

    {
        u32 v5 = (80 - sub_02002EB4(0, v3, 0)) / 2;
        sub_0201D78C(v4, 0, v3, v5, 0, 0xff, (((u32)(((15 & 0xff) << 16) | ((13 & 0xff) << 8) | ((0 & 0xff) << 0)))), NULL);
    }
...
static void ov62_022427D0 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    v4->unk_4C8.unk_0C = MessageFormatter_Init(0, 26, 412, 102);
    v4->unk_4C8.unk_10 = 1;
}
...
static void ov62_02242938 (UnkStruct_0208C06C * param0)
{
    ...
    MessageFormatter_Free(v0->unk_4C8.unk_0C);
...
static BOOL ov62_02243FA8 (UnkStruct_0208C06C * param0)
{
    ...
    case 0:
    {
        ...
        v2[1] = 5;
        v2[2] = 5;
        v0->unk_4AC = ov62_02246B00(102, 12, v2, sub_02025E44(param0->unk_830));
...
static void ov62_022448E0 (UnkStruct_ov62_022312B0 * param0, UnkStruct_0208C06C * param1, int param2)
{
    ...
    if (param1->unk_88C[param2] == NULL) {
        v0 = MessageFormatter_AllocStrbuf(v1, 8);
    } else {
        v3 = ov62_02231690(102);
        v4 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 7);
...
static void ov62_022449B8 (UnkStruct_0208C06C * param0, int param1, BOOL param2)
{
    ...
    GXLayers_EngineAToggleLayers(GX_PLANEMASK_BG2, 1);
    sub_0201A7A0(v1);
    sub_0201A7E8(param0->unk_14.unk_10, v1, 2, 1, 19, 30, 4, 14, 300);
    ...
    if (param1 == 100) {
        ...
        v5 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, param1);
...
static void ov62_02244AB4 (UnkStruct_0208C06C * param0, int param1, int param2)
{
    ...
    if (param1 == 100) {
        ...
        v9 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, param1);
...
static void ov62_02244BE4 (UnkStruct_0208C06C * param0)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        ...
        sub_0200D4C4(v0->unk_10[v1].unk_08, 42 + 8, (25 + (36 * (v1)) + (16 * (5 - 4))) + 64);
...
static void ov62_022455E4 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    v1 = &v0->unk_6D4[0];
    sub_0201ADA4(v1, 0x0);
    v2 = MessageFormatter_AllocStrbuf(param0->unk_14.unk_34, param1);
...
static void ov62_02245AC8 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0) {
        sub_0200D3F4(v0->unk_10[0].unk_08, 1);
        sub_020129D0(v0->unk_10[0].unk_0C, 1);
        sub_0200D4C4(v0->unk_10[1].unk_08, 128, 232 - 64);
    } else {
        sub_0200D3F4(v0->unk_10[0].unk_08, 0);
        sub_020129D0(v0->unk_10[0].unk_0C, 0);
        sub_0200D4C4(v0->unk_10[1].unk_08, 80, 232 - 64);
    }
...
static void ov62_02245B24 (UnkStruct_0208C06C * param0)
{
    ...
    sub_0200D4C4(v0->unk_10[0].unk_08, 32, 232 - 64);
    sub_0200D4C4(v0->unk_10[1].unk_08, 128, 232 - 64);
    sub_020128C4(v0->unk_10[0].unk_0C, 36, -8);
    sub_020128C4(v0->unk_10[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_10[0].unk_0C, 1);
...
static void ov62_02245C08 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0) {
        sub_0200D3F4(v0->unk_10[1].unk_08, 1);
        sub_020129D0(v0->unk_10[1].unk_0C, 1);
        sub_0200D4C4(v0->unk_10[0].unk_08, 32, 232);
    } else {
        sub_0200D3F4(v0->unk_10[1].unk_08, 0);
        sub_020129D0(v0->unk_10[1].unk_0C, 0);
        sub_0200D4C4(v0->unk_10[0].unk_08, 80, 232);
    }
...
static void ov62_02245C64 (UnkStruct_0208C06C * param0)
{
    ...
    sub_0200D4C4(v0->unk_10[0].unk_08, 32, 232);
    sub_0200D4C4(v0->unk_10[1].unk_08, 128, 232);
    sub_020128C4(v0->unk_10[0].unk_0C, 36, -8);
    sub_020128C4(v0->unk_10[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_10[0].unk_0C, 1);
    sub_020129D0(v0->unk_10[1].unk_0C, 1);
...
static void ov62_022469A0 (UnkStruct_ov62_02241204 * param0, UnkStruct_0208C06C * param1)
{
...

    {
        ...
        v6 /= 100000;
        v7[2] = v6;
        v1 = MessageFormatter_AllocStrbuf(param1->unk_14.unk_34, 295);
        v2 = Strbuf_Init(255, 102);
