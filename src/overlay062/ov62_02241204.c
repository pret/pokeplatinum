...
static void ov62_022457A0(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245800(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245868(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_022458A0(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245968(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245994(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245A28(u32 param0, enum TouchScreenButtonState param1, void *param2);
static void ov62_02245A90(u32 param0, enum TouchScreenButtonState param1, void *param2);
    ...
    for (v1 = 0; v1 < 5; v1++) {
        for (v2 = 0; v2 < 6; v2++) {
            if (v3->unk_50C.unk_0C[v1][v2].unk_04) {
                ManagedSprite_SetPositionXY(v3->unk_50C.unk_0C[v1][v2].unk_04, v0[(v1 * 6) + v2][0], v0[(v1 * 6) + v2][1]);
            }
        }
    }
}
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        for (v1 = 0; v1 < 6; v1++) {
            ...
            if (v3->unk_50C.unk_0C[v0][v1].unk_04) {
                ManagedSprite_SetPriority(v3->unk_50C.unk_0C[v0][v1].unk_04, 6 - v1);
            }
    ...
    for (v0 = 0; v0 < 5; v0++) {
        for (v1 = 0; v1 < 6; v1++) {
            if (v2->unk_50C.unk_0C[v0][v1].unk_04) {
                ManagedSprite_SetDrawFlag(v2->unk_50C.unk_0C[v0][v1].unk_04, param1);
            }
        }
    }
}
...

    {
        ...
        for (v1 = 0; v1 < 6; v1++) {
            ...
            if (v5->unk_50C.unk_0C[v2][v1].unk_04) {
                ManagedSprite_SetPriority(v5->unk_50C.unk_0C[v2][v1].unk_04, 6 - v1);
            }
...
static void ov62_022417C0(UnkStruct_0208C06C *param0, int param1)
{
...

    {
        ...
        for (v7 = 0; v7 < v0->unk_794; v7++) {
            ...
            v10 = MessageLoader_GetNewString(param0->unk_14.unk_34, v4[v7]);
            v9 += v3[v7][2] * v3[v7][3];
...
static void ov62_022418DC(UnkStruct_0208C06C *param0, int param1)
{
    ...
    if (param1 == 0xff) {
        ...
        if ((param1 == UnkEnum_0202F510_33) || (param1 == UnkEnum_0202F510_34) || (param1 == UnkEnum_0202F510_35) || (param1 == UnkEnum_0202F510_36)) {
            ...
            v2 = MessageLoader_GetNewString(param0->unk_14.unk_34, v3);
        } else {
            v3 = 132 + param1;
            v2 = MessageLoader_GetNewString(param0->unk_14.unk_34, v3);
        }
...
static void ov62_02241C38(UnkStruct_0208C06C *param0)
{
    ...
    v3 = MessageLoader_GetNewString(param0->unk_14.unk_34, 126);
    ...
    Window_FillTilemap(v4, 0x0);
    v3 = MessageLoader_GetNewString(param0->unk_14.unk_34, 95);
...
static BOOL ov62_02241D24(UnkStruct_0208C06C *param0)
{
    ...
    case 0:
        ...
        v0->unk_608[0] = TouchScreenActions_RegisterHandler(Unk_ov62_022491AC, NELEMS(Unk_ov62_022491AC), ov62_022458A0, param0, HEAP_ID_102);
        v0->unk_608[1] = TouchScreenActions_RegisterHandler(Unk_ov62_022491F0, NELEMS(Unk_ov62_022491F0), ov62_02245968, param0, HEAP_ID_102);
        param0->unk_08++;
        break;
    case 1:
        ...
        PaletteData_BlendMulti(param0->unk_14.unk_14, PLTTBUF_SUB_OBJ, 0xC, v0->unk_08, param0->unk_14.unk_44);
        break;
    default:
...
static BOOL ov62_02241EB4(UnkStruct_0208C06C *param0)
{
    ...
    TouchScreenActions_HandleAction(v0->unk_608[0]);
    return 0;
}
...
static BOOL ov62_02241ECC(UnkStruct_0208C06C *param0)
{
    ...
    case 0:
        ...
        TouchScreenActions_Free(v0->unk_608[0]);
        TouchScreenActions_Free(v0->unk_608[1]);
        param0->unk_08++;
        break;
    case 1:
    ...
    default:
        ...
        if (ov62_02231664(&v0->unk_08, 0)) {
            ...
            PaletteData_BlendMulti(param0->unk_14.unk_14, PLTTBUF_SUB_BG, 0x2, v0->unk_08, param0->unk_14.unk_44);
            PaletteData_BlendMulti(param0->unk_14.unk_14, PLTTBUF_SUB_OBJ, 0xC, v0->unk_08, param0->unk_14.unk_44);
        }
...
static void ov62_022422C0(UnkStruct_0208C06C *a0)
{
    String *sp2c;
    UnkStruct_0208C06C *sp14 = a0;
    int sp28 = 1;
    UnkStruct_ov62_02241204 *r1 = sp14->unk_860;

    for (u32 r7 = 0; r7 < 9; r7++) {
        Window *r4 = &r1->unk_6D4[r7];
        u8 sp24 = Unk_ov62_022491F0[r7].rect.left / 8;
        u8 sp20 = Unk_ov62_022491F0[r7].rect.top / 8;
        u8 sp1c = (Unk_ov62_022491F0[r7].rect.right / 8) - sp24;
        u8 r6 = (Unk_ov62_022491F0[r7].rect.bottom / 8) - sp20;
        Window_Init(r4);
        Window_Add(sp14->unk_14.unk_10, r4, 6, sp24, sp20, sp1c, r6, 0xe, sp28);
        Window_FillTilemap(r4, 0);
        sp2c = MessageLoader_GetNewString(sp14->unk_14.unk_34, r7 + 0x44);
        int sp30 = ov62_0223429C(r4, sp2c);
        int sp18 = ((r6 * 8) - 0x10) / 2;
        if (ov62_02242748(sp14, r7) == 1) {
            Text_AddPrinterWithParamsAndColor(r4, 0, sp2c, sp30, sp18, 0xff, 0x000f0d00, 0);
        } else {
            Text_AddPrinterWithParamsAndColor(r4, 0, sp2c, sp30, sp18, 0xff, 0x000c0b00, 0);
        }
        Window_ScheduleCopyToVRAM(r4);
        String_Free(sp2c);
        sp28 += sp1c * r6;
    }
}
...
static BOOL ov62_02242400(UnkStruct_0208C06C *param0)
{
    ...
    case 1:
        ...
        break;
    case 2:
        TouchScreenActions_HandleAction(v0->unk_608[1]);
...
static BOOL ov62_02242D90(UnkStruct_0208C06C *param0)
{
    ...
    case 1:
        ...
        PaletteData_BlendMulti(param0->unk_14.unk_14, PLTTBUF_SUB_OBJ, 0xC, v0->unk_08, param0->unk_14.unk_44);
        PaletteData_BlendMulti(param0->unk_14.unk_14, PLTTBUF_MAIN_OBJ, 0xC, v0->unk_08, param0->unk_14.unk_44);
        break;
    default:
    ...
    case 2:
        ...
        if (ov62_022315E0(&v0->unk_00, &v0->unk_04, 1, 0)) {
            ...
            if (v0->unk_0C == 17) {
                ...
                ManagedSprite_SetAnim(v0->unk_10[0].unk_08, 0);
                ManagedSprite_SetAnim(v0->unk_10[1].unk_08, 3);
            }
...
static BOOL ov62_0224324C(UnkStruct_0208C06C *param0)
{
    ...
    case 1:
        ...
        v0->unk_608[0] = TouchScreenActions_RegisterHandler(Unk_ov62_0224919C, NELEMS(Unk_ov62_0224919C), ov62_02245994, param0, HEAP_ID_102);
        v0->unk_608[1] = TouchScreenActions_RegisterHandler(Unk_ov62_0224915C, NELEMS(Unk_ov62_0224915C), ov62_02245A28, param0, HEAP_ID_102);
        v0->unk_608[2] = TouchScreenActions_RegisterHandler(Unk_ov62_0224913C, NELEMS(Unk_ov62_0224913C), ov62_02245A90, param0, HEAP_ID_102);
        param0->unk_08++;
        break;
    case 2:
        v0->unk_1CC = 0;
...
static BOOL ov62_02243410(UnkStruct_0208C06C *param0)
{
    ...
    case 0:
        TouchScreenActions_Free(v0->unk_608[0]);
        TouchScreenActions_Free(v0->unk_608[1]);
        TouchScreenActions_Free(v0->unk_608[2]);
        GXLayers_EngineBToggleLayers(GX_PLANEMASK_BG2, 0);
        GXLayers_EngineAToggleLayers(GX_PLANEMASK_BG2, 0);
    ...
    case 1:
        ...
        if (ov62_022315E0(&v0->unk_00, &v0->unk_04, 1, 0)) {
            ...
            ManagedSprite_SetAnim(v0->unk_10[0].unk_08, 0);
            ManagedSprite_SetAnim(v0->unk_10[1].unk_08, 1);
            ov62_02245C08(param0, 1);
            param0->unk_08++;
        }
...
static BOOL ov62_022438E0(UnkStruct_0208C06C *param0)
{
    ...
    TouchScreenActions_HandleAction(v0->unk_608[2]);
    return 0;
}
...
static BOOL ov62_022444BC(UnkStruct_0208C06C *param0)
{
    ...
    case 1:
        ...
        v0->unk_608[2] = TouchScreenActions_RegisterHandler(Unk_ov62_0224913C, NELEMS(Unk_ov62_0224913C), ov62_02245868, param0, HEAP_ID_102);
        param0->unk_08++;
        break;
    case 2:
        ov62_02234540(param0, 1);
...
static void ov62_022448E0(UnkStruct_ov62_022312B0 *param0, UnkStruct_0208C06C *param1, int param2)
{
    ...
    if (param1->unk_88C[param2] == NULL) {
        v0 = MessageLoader_GetNewString(v1, 8);
    } else {
...
static void ov62_02244BE4(UnkStruct_0208C06C *param0)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        ...
        ManagedSprite_SetPositionXY(v0->unk_10[v1].unk_08, 42 + 8, (25 + (36 * (v1)) + (16 * (5 - 4))) + 64);
        ManagedSprite_SetAnim(v0->unk_10[v1].unk_08, v3[v1]);
        FontOAM_SetXY(v0->unk_10[v1].unk_0C, 36, -8);
...
static void ov62_02244CA4(UnkStruct_0208C06C *param0)
{
    ...
    for (v1 = 0; v1 < 4; v1++) {
        ...
        Sprite_DeleteAndFreeResources(v0->unk_10[v1].unk_08);
    }
...
static void ov62_02245AC8(UnkStruct_0208C06C *param0, int param1)
{
    ...
    if (param1 == 0) {
        ManagedSprite_SetDrawFlag(v0->unk_10[0].unk_08, 1);
        sub_020129D0(v0->unk_10[0].unk_0C, 1);
        ManagedSprite_SetPositionXY(v0->unk_10[1].unk_08, 128, 232 - 64);
    } else {
        ManagedSprite_SetDrawFlag(v0->unk_10[0].unk_08, 0);
        sub_020129D0(v0->unk_10[0].unk_0C, 0);
        ManagedSprite_SetPositionXY(v0->unk_10[1].unk_08, 80, 232 - 64);
    }

    FontOAM_SetXY(v0->unk_10[0].unk_0C, 36, -8);
    FontOAM_SetXY(v0->unk_10[1].unk_0C, 36, -8);
}
...
static void ov62_02245B24(UnkStruct_0208C06C *param0)
{
    ...
    ManagedSprite_SetPositionXY(v0->unk_10[0].unk_08, 32, 232 - 64);
    ManagedSprite_SetPositionXY(v0->unk_10[1].unk_08, 128, 232 - 64);
    FontOAM_SetXY(v0->unk_10[0].unk_0C, 36, -8);
    FontOAM_SetXY(v0->unk_10[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_10[0].unk_0C, 1);
...
static void ov62_02245BD8(UnkStruct_0208C06C *param0)
{
    ...
    Sprite_DeleteAndFreeResources(v0->unk_10[0].unk_08);
    Sprite_DeleteAndFreeResources(v0->unk_10[1].unk_08);
...
static void ov62_02245C08(UnkStruct_0208C06C *param0, int param1)
{
    ...
    if (param1 == 0) {
        ManagedSprite_SetDrawFlag(v0->unk_10[1].unk_08, 1);
        sub_020129D0(v0->unk_10[1].unk_0C, 1);
        ManagedSprite_SetPositionXY(v0->unk_10[0].unk_08, 32, 232);
    } else {
        ManagedSprite_SetDrawFlag(v0->unk_10[1].unk_08, 0);
        sub_020129D0(v0->unk_10[1].unk_0C, 0);
        ManagedSprite_SetPositionXY(v0->unk_10[0].unk_08, 80, 232);
    }
...
static void ov62_02245C64(UnkStruct_0208C06C *param0)
{
    ...
    ManagedSprite_SetPositionXY(v0->unk_10[0].unk_08, 32, 232);
    ManagedSprite_SetPositionXY(v0->unk_10[1].unk_08, 128, 232);
    FontOAM_SetXY(v0->unk_10[0].unk_0C, 36, -8);
    FontOAM_SetXY(v0->unk_10[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_10[0].unk_0C, 1);
    sub_020129D0(v0->unk_10[1].unk_0C, 1);
...
static void ov62_022469A0(UnkStruct_ov62_02241204 *param0, UnkStruct_0208C06C *param1)
{
...

    {
        ...
        String_FormatInt(v10, v7[2], 2, 2, 1);
        StringTemplate_SetString(v3, 2, v8, 0, 1, GAME_LANGUAGE);
        StringTemplate_SetString(v3, 1, v9, 0, 1, GAME_LANGUAGE);
        StringTemplate_SetString(v3, 0, v10, 0, 1, GAME_LANGUAGE);
