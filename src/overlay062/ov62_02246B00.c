...
void ov62_02247574(UnkStruct_ov62_02246BF4 *param0)
{
    ...
    SpriteSystem_LoadPalette(v4, 2, v2, v3, v0, 44, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 1000);
    ...
    SpriteSystem_LoadPalette(v4, 2, v2, v3, v0, 88, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 1001);
