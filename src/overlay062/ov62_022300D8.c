...
void ov62_022300D8(UnkStruct_0208C06C *param0)
{
    ...
    if (param0->unk_00 == 0) {
        ...
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, ov62_02231710(param0, 3), HEAP_ID_102, PLTTBUF_MAIN_BG, PALETTE_SIZE_BYTES * (8 + 1), PLTT_DEST(0));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, ov62_02231710(param0, 3), HEAP_ID_102, PLTTBUF_SUB_BG, PALETTE_SIZE_BYTES * (8 + 1), PLTT_DEST(0));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, ov62_02231710(param0, 0), HEAP_ID_102, PLTTBUF_MAIN_BG, PALETTE_SIZE_BYTES, PLTT_DEST(14));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, ov62_02231710(param0, 0), HEAP_ID_102, PLTTBUF_SUB_BG, PALETTE_SIZE_BYTES, PLTT_DEST(14));
    } else {
        ...
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, 53, HEAP_ID_102, PLTTBUF_MAIN_BG, PALETTE_SIZE_BYTES * (8 + 1), PLTT_DEST(0));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, 53, HEAP_ID_102, PLTTBUF_SUB_BG, PALETTE_SIZE_BYTES * (8 + 1), PLTT_DEST(0));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, 52, HEAP_ID_102, PLTTBUF_MAIN_BG, PALETTE_SIZE_BYTES, PLTT_DEST(14));
        PaletteData_LoadBufferFromFileStart(v4, NARC_INDEX_RESOURCE__ENG__BATT_REC__BATT_REC_GRA, 52, HEAP_ID_102, PLTTBUF_SUB_BG, PALETTE_SIZE_BYTES, PLTT_DEST(14));
    }
