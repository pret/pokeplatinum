...
BOOL sub_0203DBF0 (UnkStruct_020508D4 * param0)
{
    ...
    case 5:
    {
        ...
        if ((v4 = sub_02076B94(NULL, v2->unk_04.unk_40, 1, v3, &v5)) != 0) {
            ...
            v2->unk_60 = sub_0207AE68(NULL, v2->unk_04.unk_40, v4, sub_02025E44(v1->unk_0C), PokemonSummary_ShowContestData(v1->unk_0C), sub_02027560(v1->unk_0C), sub_0207D990(v1->unk_0C), sub_0202CD88(v1->unk_0C), SaveData_GetPoketchData(v1->unk_0C), v5, 0x4, 26);
            v2->unk_00 = 6;
        } else {
            v2->unk_00 = 7;
        }
