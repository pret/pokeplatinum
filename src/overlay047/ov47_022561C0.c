...
static BOOL ov47_0225621C(UnkStruct_ov47_0225621C *param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    ...
    for (v0 = 0; v0 < 6; v0++) {
        ...
        PoketchData_MapMarkerPos(param0->poketch, v0, &(param0->unk_04.unk_0C[v0].unk_00), &(param0->unk_04.unk_0C[v0].unk_01));
...
static void ov47_0225634C(UnkStruct_ov47_0225621C *param0)
{
    ...
    for (v0 = 0; v0 < 6; v0++) {
        PoketchData_SetMapMarker(param0->poketch, v0, (param0->unk_04.unk_0C[v0].unk_00 - 16), (param0->unk_04.unk_0C[v0].unk_01 - 16));
    }
