...
static int sub_0205AA50(UnkStruct_0205A0D8 * param0, const PLString * param1);
...
static int sub_0205AA50 (UnkStruct_0205A0D8 * param0, const PLString * param1)
{
    ...
    return sub_0205D994(v0, (PLString *)param1, sub_02025E44(param0->unk_24->unk_0C), 1);
}
...
void sub_0205AB10 (UnkStruct_0203CDB0 * param0, UnkFuncPtr_0205AB10 * param1)
{
    ...
    v0->unk_0C = PLString_AllocFromHeap((100 * 2), 11);
    v0->unk_10 = PLString_AllocFromHeap((100 * 2), 11);
...
static BOOL sub_0205B140 (UnkStruct_020508D4 * param0)
{
    ...
    case 0:
        ...
        v1->unk_00 = PLString_AllocFromHeap((100 * 2), 4);
        v1->unk_04 = PLString_AllocFromHeap((100 * 2), 4);
    ...
    case 1:
        if (sub_0205DA04(v1->unk_20)) {
            if (Unk_021BF67C.unk_48 & PAD_BUTTON_A) {
                ...
                PLString_FreeToHeap(v1->unk_00);
                PLString_FreeToHeap(v1->unk_04);
