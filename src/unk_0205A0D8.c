...
static void sub_0205A0D8 (UnkStruct_0205A0D8 * param0, UnkStruct_0203CDB0 * param1, UnkStruct_02079FF4 * param2, int param3, int param4, int param5)
{
    ...
    v1 = param1->unk_0C;
    v0 = sub_02018184(param5, sizeof(UnkStruct_02098D38));
...
static BOOL sub_0205A324 (UnkStruct_020508D4 * param0)
{
    ...
    case 16:
        ...
        break;
    case 17:
        sub_0205A0D8(v0, v0->unk_24, sub_0207A268(v0->unk_24->unk_0C), v0->unk_3C, 0, 11);
        v0->unk_34 = 18;
        break;
    case 18:
    ...
    case 32:
        ...
        break;
    case 36:
        sub_0200B538(v0->unk_28, 1, sub_02076B10(sub_0207A0FC(v0->unk_50, v0->unk_84)));
...
void sub_0205AB10 (UnkStruct_0203CDB0 * param0, UnkFuncPtr_0205AB10 * param1)
{
    ...
    v0 = sub_02018184(11, sizeof(UnkStruct_0205A0D8));
    ...
    case 3:
    {
        ...
        v0->unk_4C = sub_02018184(11, v2);
        v0->unk_48 = sub_02018184(11, v2);
        v0->unk_50 = sub_02079FF4(11);

        sub_0207A014(v0->unk_50, 3);
...
{
    if (param0->unk_50) {
        sub_020181C4(param0->unk_50);
    }

    if (param0->unk_4C) {
        sub_020181C4(param0->unk_4C);
    }

    if (param0->unk_48) {
        sub_020181C4(param0->unk_48);
    }
...
static void sub_0205AC80 (UnkStruct_0205A0D8 * param0, BOOL param1)
{
    ...
    v0 = sub_0207A268(param0->unk_24->unk_0C);
    v2 = param0->unk_4C;
    v4 = sub_02076AF0();
    ...
    if (v1->unk_00) {
        for (v3 = 0; v3 < 3; v3++) {
            MI_CpuCopy8(sub_0207A0FC(v0, param0->unk_3D[v3] - 1), v2, v4);
            v2 += v4;
        }
    }
}
...
static void sub_0205AD80 (UnkStruct_0205A0D8 * param0)
{
    ...
    v0 = sub_02076AF0();
    sub_0207A014(param0->unk_50, 3);

    for (v1 = 0; v1 < 3; v1++) {
        sub_0207A048(param0->unk_50, (UnkStruct_02073C74 *)(&param0->unk_48[v1 * v0]));
    }
}
...
static void sub_0205ADAC (UnkStruct_0205A0D8 * param0)
{
    ...
    for (v3 = 0; v3 < 3; v3++) {
        sub_0207A048(param0->unk_50, (UnkStruct_02073C74 *)(&param0->unk_4C[v3 * v0]));
    }
}
...
static void sub_0205ADF8 (UnkStruct_0205A0D8 * param0, int param1)
{
    ...
    if (sub_0201A7CC(v0) == 0) {
        ...
        for (v1 = 0; v1 < 3; v1++) {
            v2 = sub_02074470((UnkStruct_02073C74 *)(&param0->unk_48[v1 * v3]), 5, NULL);
...
void sub_0205B2D4 (UnkStruct_0203CDB0 * param0)
{
    ...
    for (v0 = 0; v0 < sub_02035E18(); v0++) {
        ...
        if ((v2 == sub_02058CA0(v0)) && (v3 == sub_02058CF4(v0))) {
            UnkStruct_0205B2D4 * v4 = sub_02018184(11, sizeof(UnkStruct_0205B2D4));
