...
static void sub_0205A164 (UnkStruct_0205A0D8 * param0, int param1)
{
    ...
    v1->unk_00 = GetPartyFromSavedata(param0->unk_24->unk_0C);
...
static BOOL sub_0205A324 (UnkStruct_020508D4 * param0)
{
    ...
    case 16:
        ...
        break;
    case 17:
        sub_0205A0D8(v0, v0->unk_24, GetPartyFromSavedata(v0->unk_24->unk_0C), v0->unk_3C, 0, 11);
        v0->unk_34 = 18;
        break;
    case 18:
...
static void sub_0205AC80 (UnkStruct_0205A0D8 * param0, BOOL param1)
{
    ...
    v0 = GetPartyFromSavedata(param0->unk_24->unk_0C);
    v2 = param0->unk_4C;
    v4 = sub_02076AF0();
...
static void sub_0205AD80 (UnkStruct_0205A0D8 * param0)
{
    ...
    for (v1 = 0; v1 < 3; v1++) {
        Party_AddPokemon(param0->unk_50, (UnkStruct_02073C74 *)(&param0->unk_48[v1 * v0]));
    }
}
...
static void sub_0205ADAC (UnkStruct_0205A0D8 * param0)
{
    ...
    for (v3 = 0; v3 < 3; v3++) {
        Party_AddPokemon(param0->unk_50, (UnkStruct_02073C74 *)(&param0->unk_4C[v3 * v0]));
    }
}
