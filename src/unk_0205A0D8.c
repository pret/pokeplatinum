...
void sub_0205AB10(FieldSystem *fieldSystem, UnkFuncPtr_0205AB10 *param1)
{
    ...
    v0 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_0205A0D8));
    ...
    case 3: {
        ...
        v0->unk_4C = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, v2);
        v0->unk_48 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, v2);
...
void sub_0205B2D4(FieldSystem *fieldSystem)
{
    ...
    for (v0 = 0; v0 < CommSys_ConnectedCount(); v0++) {
        ...
        if ((v2 == CommPlayer_XPos(v0)) && (v3 == CommPlayer_ZPos(v0))) {
            UnkStruct_0205B2D4 *v4 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_0205B2D4));
