...
{
    UnkStruct_ov6_02247A0C *v0 = Heap_AllocAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_ov6_02247A0C));
...
void *ov6_02247A90(void *param0)
{
    ...
    v0 = Heap_Alloc(HEAP_ID_FIELD2, sizeof(UnkStruct_ov6_02247A90));
    ...
    v3 = String_New(100, HEAP_ID_FIELD2);
