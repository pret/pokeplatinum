...
static VecFx32 HallOfFameHealingAnimation_PokeballOffsets[PARTY_MAX_POKEMON] = {
...
void FieldSystem_PlayHealingAnimation_HallOfFame(FieldSystem *fieldSystem, const u8 pokeballCount)
{
    ...
    if (mapPropFound) {
        HallOfFameHealingAnimation *animation = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD, sizeof(HallOfFameHealingAnimation));
