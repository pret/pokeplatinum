...
void GreatMarshLookout_CreateLookoutMonSprite(GreatMarshLookout_SpriteResources *resources, const int species)
{
    ...
    resources->unk_20 = CharacterSprite_GetSprite(resources->unk_28.narcID, resources->unk_28.character, HEAP_ID_FIELD1);
    resources->unk_24 = CharacterSprite_GetPaletteData(resources->unk_28.narcID, resources->unk_28.palette, HEAP_ID_FIELD1);
