...
#include "terrain_attributes_loader.h"
...
static BOOL GetSimpleTileAttributes(const FieldSystem *fieldSystem, const int tileX, const int tileY, u16 *attributes)
{
    ...
    u16 const *terrainAttributes = TerrainAttributesLoader_GetTerrainAttributes(mapMatrixIndex, fieldSystem->terrainAttributesLoader);
