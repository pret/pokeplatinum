...
int ov17_0224F4D4(OverlayManager *overlayMan, int *param1)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov17_0224FCA0), HEAP_ID_24);
...
int ov17_0224F754(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov17_0224FCA0 *v0 = OverlayManager_Data(overlayMan);
    int v1;
...
int ov17_0224F86C(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov17_0224FCA0 *v0 = OverlayManager_Data(overlayMan);
    int v1;
