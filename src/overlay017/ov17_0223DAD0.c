...
int ov17_0223DAD0(ApplicationManager *appMan, int *param1)
{
    ...
    sub_02039734();
    StartScreenFade(MODE_MAIN_THEN_SUB, FADE_TYPE_UNK_17, FADE_TYPE_UNK_37, FADE_BLACK, 6, 1, HEAP_ID_23);
    ...
    case 1:
        if (sub_02094EDC(v0->unk_00) == 1) {
            ...
            if ((v1 == 1) || (v1 == 2)) {
                ...
                *param1 = 2;
                MI_CpuClear8(&v0->unk_1B1C, sizeof(UnkStruct_ov17_0223E838));
                StartScreenFade(MODE_SUB_THEN_MAIN, FADE_TYPE_UNK_30, FADE_TYPE_UNK_30, FADE_BLACK, 6, 1, HEAP_ID_23);
                break;
            }
        }
