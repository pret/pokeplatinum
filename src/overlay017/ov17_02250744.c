...
void ov17_02250744(UnkStruct_ov17_0224FCA0 *param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        ...
        GF_ASSERT(param0->unk_10.pokemonSpriteRefs[v1].unk_00 == NULL);

        param0->unk_10.pokemonSpriteRefs[v1].unk_00 = Heap_AllocFromHeap(HEAP_ID_24, (32 * 10 * 10));
        param0->unk_10.unk_08[v1] = sub_02095484(param0->unk_10.unk_04, v0, param0->unk_10.unk_00->unk_00[v1], 2, &param0->unk_10.pokemonSpriteRefs[v1], HEAP_ID_24, Unk_ov17_02254BF4[v0][0], Unk_ov17_02254BF4[v0][1], Unk_ov17_02254BF4[v0][2]);
    }
}
...
void ov17_02250FE4(UnkStruct_ov17_0224FCA0 *param0)
{
    ...
    v0 = Heap_AllocFromHeap(HEAP_ID_24, sizeof(UnkStruct_ov17_02250FE4));
...
static void ov17_02251070(UnkStruct_ov17_0224FCA0 *param0)
{
    ...
    v1 = Heap_AllocFromHeap(HEAP_ID_24, sizeof(UnkStruct_ov17_02251070));
...
void ov17_02251598(UnkStruct_ov17_0224FCA0 *param0, int param1, u8 *param2)
{
    ...
    *param2 = 0;
    v0 = Heap_AllocFromHeap(HEAP_ID_24, sizeof(UnkStruct_ov17_02251598));
...
void ov17_02251718(UnkStruct_ov17_0224FCA0 *param0, int param1, int param2, u8 *param3)
{
    ...
    *param3 = 0;
    v0 = Heap_AllocFromHeap(HEAP_ID_24, sizeof(UnkStruct_ov17_02251718));
