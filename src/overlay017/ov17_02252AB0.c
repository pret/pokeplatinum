...
void ov17_02252AB0(SpriteRenderer *param0, SpriteGfxHandler *param1, PaletteData *param2, u32 param3, u32 param4, u32 param5, u32 param6)
{
    ...
    sub_0200CBDC(param0, param1, NARC_INDEX_BATTLE__GRAPHIC__PL_BATT_OBJ, battle_subscreen_cursor_corner_NCGR_lz, 1, NNS_G2D_VRAM_TYPE_2DSUB, param3);
    sub_0200CE0C(param0, param1, NARC_INDEX_BATTLE__GRAPHIC__PL_BATT_OBJ, battle_subscreen_cursor_corner_NCER_lz, 1, param5);
    sub_0200CE3C(param0, param1, NARC_INDEX_BATTLE__GRAPHIC__PL_BATT_OBJ, battle_subscreen_cursor_corner_NANR_lz, 1, param6);
}
