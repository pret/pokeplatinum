...
static void ov17_02247DC8(SysTask *param0, void *param1)
{
    ...
    switch (v0->unk_10) {
    case 0:
        v0->unk_14 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_08[v0->unk_11], 0) << 8;
        v0->unk_18 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_08[v0->unk_11], 1) << 8;
        v0->unk_10++;
        break;
    case 1:
        v1 = Pokemon_DPSpriteYOffset(v0->unk_00->unk_0C.unk_00->unk_00[v0->unk_11], 2);
        ...
        PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_08[v0->unk_11], 0, v0->unk_14 >> 8);
        PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_08[v0->unk_11], 1, v0->unk_18 >> 8);
        break;
    default:
        ov17_0224F26C(v0->unk_0C, &v0->unk_04, NULL, 0);
        Heap_FreeToHeap(v0);
...
static void ov17_02248648(SysTask *param0, void *param1)
{
    ...
    case 0:
        ...
        v0->unk_14 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_18, 0) * 0x100;
        v0->unk_18 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_18, 1) * 0x100;
        v0->unk_10++;
    case 1:
        v0->unk_14 -= 0x400;
        ...
        PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 0, v0->unk_14 / 0x100);
        PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 1, v0->unk_18 / 0x100);
        break;
    default:
        ov17_0224F26C(v0->unk_0C, &v0->unk_04, NULL, 0);
        Heap_FreeToHeap(v0);
...
static void ov17_02248BE0(SysTask *param0, void *param1)
{
    ...
    case 0:
        ...
        break;
    case 1:
        v0->unk_04 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_18, 0) * 0x100;
        v0->unk_08 = PokemonSprite_GetAttribute(v0->unk_00->unk_0C.unk_18, 1) * 0x100;
        v0->unk_0C++;
    case 2:
        if (v0->unk_0E & 1) {
            PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 0, v0->unk_04 / 0x100);
            PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 1, v0->unk_08 / 0x100);
        } else {
            PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 0, v0->unk_04 / 0x100);
            PokemonSprite_SetAttribute(v0->unk_00->unk_0C.unk_18, 1, v0->unk_08 / 0x100 - 3);
        }
