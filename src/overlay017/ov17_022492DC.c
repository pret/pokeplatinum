...
static void ov17_02249D50(UnkFuncPtr_0201CE28 param0, UnkStruct_ov17_022492DC * param1);
static void ov17_02249D80(UnkStruct_ov17_022492DC * param0);
static void ov17_02249DA0(UnkStruct_0201CD38 * param0, void * param1);
static void ov17_0224A038(UnkStruct_0201CD38 * param0, void * param1);
...
void ov17_02249640 (UnkStruct_ov17_022492DC * param0, int param1, int param2, void * param3)
{
    ...
    {
        for (v2 = 0; v2 < 4; v2++) {
            sub_02019060(4 + v2, v0->unk_0C_val2[v2]);
        }
    }
    ...
    if (v1 == 0xffffffff) {
        if (v3->unk_18 == Unk_ov17_02254554) {
            if (Unk_021BF67C.unk_48 & (PAD_BUTTON_A | PAD_KEY_RIGHT)) {
                v1 = 3;
            } else if (Unk_021BF67C.unk_48 & (PAD_BUTTON_B | PAD_KEY_DOWN)) {
                v1 = 1;
            } else if (Unk_021BF67C.unk_48 & (PAD_BUTTON_X | PAD_KEY_UP)) {
                v1 = 0;
            } else if (Unk_021BF67C.unk_48 & (PAD_BUTTON_Y | PAD_KEY_LEFT)) {
                v1 = 2;
            }
        }
    }
...
static void ov17_02249828 (UnkStruct_ov17_022492DC * param0)
{
    ...
    v4 = MessageFormatter_Init(1, 26, 204, 23);
    ...
    v0 = MessageFormatter_AllocStrbuf(v4, v2);
    v1 = MessageFormatter_AllocStrbuf(v4, v3);
...
static void ov17_022498F4 (UnkStruct_ov17_022492DC * param0)
{
    ...
    if (param0->unk_04->unk_A14[param0->unk_04->unk_00->unk_113] == 1) {
        v0 = MessageFormatter_AllocStrbuf(v4, 0);
    } else {
        v0 = MessageFormatter_AllocStrbuf(v4, 1);
    }

    v1 = MessageFormatter_AllocStrbuf(v4, 2);
    v2 = MessageFormatter_AllocStrbuf(v4, 3);
    v3 = MessageFormatter_AllocStrbuf(v4, 4);
