...
{
    UnkStruct_ov17_0224145C *v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_0224145C));
...
void ov17_02241524(UnkStruct_ov17_0223F88C *param0, int param1)
{
    ...
    GF_ASSERT(param0->pokemonSpriteRefs[param1].unk_00 != NULL);
    MI_CpuClear8(param0->pokemonSpriteRefs[param1].unk_00, (32 * 10 * 10));

    param0->unk_08[param1] = sub_02095484(param0->unk_04, param1, param0->unk_00->unk_00[param1], 0, &param0->pokemonSpriteRefs[param1], HEAP_ID_21, (256 - 40) - 32 * param1, (104 + 8) - 32 * param1, -0x200);
...
void ov17_022415E4(UnkStruct_ov17_0223F88C *param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        GF_ASSERT(param0->pokemonSpriteRefs[v0].unk_00 == NULL);

        param0->pokemonSpriteRefs[v0].unk_00 = Heap_AllocFromHeap(HEAP_ID_21, (32 * 10 * 10));
        param0->unk_08[v0] = sub_02095484(param0->unk_04, v0, param0->unk_00->unk_00[v0], 0, &param0->pokemonSpriteRefs[v0], HEAP_ID_21, (256 - 40) - 32 * v0, (104 + 8) - 32 * v0, -0x200);
    ...
    GF_ASSERT(param0->pokemonSpriteData.unk_00 == NULL);

    param0->pokemonSpriteData.unk_00 = Heap_AllocFromHeap(HEAP_ID_21, (32 * 10 * 10));
    param0->pokemonSpriteData.palette = param0->pokemonSpriteRefs[0].palette;
    param0->pokemonSpriteData.narcID = param0->pokemonSpriteRefs[0].narcID;

    MI_CpuClear32(param0->pokemonSpriteData.unk_00, (32 * 10 * 10));
}
...
void ov17_022416E4(UnkStruct_ov17_0223F88C *param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        ...
        Heap_Free(param0->pokemonSpriteRefs[v0].unk_00);
        param0->pokemonSpriteRefs[v0].unk_00 = NULL;
    }

    Heap_Free(param0->pokemonSpriteData.unk_00);
    param0->pokemonSpriteData.unk_00 = NULL;
}
...
{
    UnkStruct_ov17_02241B3C *v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_02241B3C));
...
static void ov17_02242048(ManagedSprite *param0)
{
    UnkStruct_ov17_02242048 *v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_02242048));
...
void ov17_022424D4(UnkStruct_ov17_0223F88C *param0, int param1, int param2)
{
    ...
    for (v1 = 0; v1 < v0; v1++) {
        if (param0->unk_124[param1][v1] == NULL) {
            ...
            v2 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_022422B8));
...
void ov17_022426E8(UnkStruct_ov17_02246F24 *param0, int param1, u8 *param2)
{
    ...
    *param2 = 0;
    ...
    v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_022426E8));
...
void ov17_022431A0(UnkStruct_ov17_02246F24 *param0, int param1, u8 param2, int param3, int param4, u8 *param5)
{
    ...
    *param5 = 0;
    ...
    v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_022431A0));
...
void ov17_0224331C(UnkStruct_ov17_02246F24 *param0, int param1, int param2, u8 *param3, UnkStruct_ov17_0224145C *param4)
{
    ...
    *param3 = 0;
    ...
    for (v7 = 0; v7 < 6; v7++) {
        ...
        v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_0224331C));
...
{
    UnkStruct_ov17_0224365C *v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_0224365C));
...
void ov17_022436D0(UnkStruct_ov17_02246F24 *param0, int param1, int param2, int param3, u8 *param4)
{
    ...
    *param4 = 0;
    ...
    for (v1 = 0; v1 < 5; v1++) {
        ...
        v0 = Heap_AllocFromHeap(HEAP_ID_21, sizeof(UnkStruct_ov17_022436D0));
