...
static CellActorData * ov17_02241720 (UnkStruct_02002F38 * param0, UnkStruct_0200C6E4 * param1, UnkStruct_0200C704 * param2, const UnkStruct_020954F0 * param3, int param4, NARC * param5)
{
    CellActorData * v0;
...
void ov17_022439C8 (UnkStruct_02095C48 * param0, int param1, int param2, UnkStruct_ov17_022439C8 * param3)
{
    ...
    case 174:
    {
        ...
        v0 = Pokemon_GetValue(param0->unk_00.unk_00[param1], MON_DATA_177, NULL);
        v1 = Pokemon_GetValue(param0->unk_00.unk_00[param1], MON_DATA_178, NULL);
