...
void ov17_02241524(UnkStruct_ov17_0223F88C *param0, int param1)
{
    ...
    MI_CpuClear8(param0->pokemonSpriteDataArray[param1].unk_00, (32 * 10 * 10));
...
void ov17_022415E4(UnkStruct_ov17_0223F88C *param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        GF_ASSERT(param0->pokemonSpriteDataArray[v0].unk_00 == NULL);

        param0->pokemonSpriteDataArray[v0].unk_00 = Heap_AllocFromHeap(HEAP_ID_21, (32 * 10 * 10));
...
void ov17_022416E4(UnkStruct_ov17_0223F88C *param0)
{
    ...
    for (v0 = 0; v0 < 4; v0++) {
        ...
        Heap_Free(param0->pokemonSpriteDataArray[v0].unk_00);
