...
static void ov17_022523AC(SysTask *param0, void *param1)
{
    ...
    case 1:
        ...
        break;
    case 2:
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_24);
    ...
    case 5:
        if (Sound_IsFadeActive() == FALSE) {
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_24);
            v0->unk_10++;
        }
        break;
    case 6:
