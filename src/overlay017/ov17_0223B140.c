...
int ov17_0223B140 (UnkStruct_020067E8 * param0, int * param1)
{
...

    {
        ...
        for (v4 = 0; v4 < 4; v4++) {
            v3[v4] = GetMonData(v0->unk_00->unk_00.unk_00[v0->unk_00->unk_00.unk_113], 54 + v4, NULL);
        }
...
static void ov17_0223BA10 (UnkStruct_ov17_02246F24 * param0, NARC * param1)
{
...

    {
        ...
        for (v0 = 0; v0 < 4; v0++) {
            v2 = GetMonData(param0->unk_00->unk_00.unk_00[param0->unk_00->unk_00.unk_113], 54 + v0, NULL);
