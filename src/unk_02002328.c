...
int sub_02002328 (UnkStruct_0201D834 * param0)
{
    ...
    case 0:
        if (((gCoreSys.heldKeys & (PAD_BUTTON_A | PAD_BUTTON_B)) && (v1->unk_00_4)) || ((gCoreSys.unk_62) && (Unk_02101D44.unk_00_4))) {
            param0->unk_2A = 0;
        ...
        if ((param0->unk_2A) && (param0->unk_29_0)) {
            ...
            if (Unk_02101D44.unk_00_0) {
                if ((gCoreSys.pressedKeys & (PAD_BUTTON_A | PAD_BUTTON_B)) || ((gCoreSys.touchInput) && (Unk_02101D44.unk_00_4))) {
                    v1->unk_00_4 = 1;
                    param0->unk_2A = 0;
                }
            }
