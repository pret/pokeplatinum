...
static void ov16_022611DC(SysTask *param0, void *param1)
{
    ...
    case 21: {
        ...
        v18->curHP = Pokemon_GetData(v19, MON_DATA_CURRENT_HP, NULL) - v0->unk_08->unk_04->currentDamage;
        v18->maxHP = Pokemon_GetData(v19, MON_DATA_MAX_HP, NULL);
        v18->damage = v0->unk_08->unk_04->currentDamage;

        if (Pokemon_GetData(v19, MON_DATA_STATUS_CONDITION, NULL) == 0) {
            v18->status = 0;
        }
    ...
    case 29: {
        ...
        if (Pokemon_GetData(v33, MON_DATA_STATUS_CONDITION, NULL) == 0) {
            v27->status = 0;
        }
        ...
        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_SLEEP, 5)) {
            v31 = 0;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_POISON, 5)) {
            v31 = 1;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_BURN, 5)) {
            v31 = 2;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_FREEZE, 5)) {
            v31 = 3;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_PARALYSIS, 5)) {
            v31 = 4;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_CONFUSION, 5)) {
            v31 = 5;
            v32++;
        }

        if (Item_LoadParam(v0->unk_04->selectedBattleBagItem, ITEM_PARAM_HEAL_ATTRACT, 5)) {
            v31 = 6;
            v32++;
        }
    ...
    if (v1 == 6) {
        ...
        if (v1 == 6) {
            ...
            for (v1 = 0; v1 < Party_GetCurrentCount(v2); v1++) {
                ...
                if ((Pokemon_GetData(v3, MON_DATA_CURRENT_HP, NULL)) && (v0->unk_0C[v4] != v1) && (v0->unk_0C[v5] != v1)) {
                    break;
                }
            }
        }
    ...
    if ((!v1) || (v1 > 6)) {
    ...
    } else {
        {
            ...
            if ((v4 == v0->unk_0C[v0->unk_09]) || (v4 == v0->unk_16)) {
                ...
                if (Pokemon_GetData(v3, MON_DATA_CURRENT_HP, NULL) == 0) {
                    ov16_02264730(v0->unk_00);
                }

                if (Pokemon_GetData(v3, MON_DATA_SPECIES_EGG, NULL) == SPECIES_EGG) {
                    ov16_02264730(v0->unk_00);
                }
            }
        }
