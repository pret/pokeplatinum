...
void ov16_0225DA74(BattleSystem *battleSys, BattlerData *param1, HPGaugeUpdateMessage *message)
{
    ...
    healthbar->type = Healthbar_Type(param1->battlerType, BattleSystem_BattleType(battleSys));
...
static void ov16_022604C8(SysTask *param0, void *param1)
{
    ...
    if (v5 != v0->unk_09) {
        healthbar = ov16_0223F35C(v0->unk_00, v5);
    } else {
        healthbar = NULL;
    }
...
static void ov16_02260C00(SysTask *param0, void *param1)
{
    ...
    if (v3 != v0->unk_1D) {
        healthbar = ov16_0223F35C(v0->unk_00, v3);
    } else {
        healthbar = NULL;
    }
...
static void ov16_022611DC(SysTask *param0, void *param1)
{
    ...
    case 21: {
        ...
        healthbar = ov16_0223F35C(v0->unk_00, v20);
        MI_CpuClear8(&healthbar->state, sizeof(u8));
        healthbar->type = Healthbar_Type(BattleSystem_BattlerSlot(v0->unk_00, v20), BattleSystem_BattleType(v0->unk_00));
    ...
    case 22: {
        ...
        healthbar = ov16_0223F35C(v0->unk_00, v23);
    ...
    case 29: {
        ...
        healthbar = ov16_0223F35C(v0->unk_00, v28);
