        ...
        if (PaletteData_GetSelectedBuffersMask(v4) == 0) {
            {
...

                {
                    ...
                    for (v17 = 0; v17 < BattleSystem_MaxBattlers(v2->battleSys); v17++) {
                        ...
                        if (v18->unk_18) {
                            CellActorData_Delete(v18->unk_18);
                            v18->unk_18 = NULL;
                        }
                    }
                }
...
static void BattleScript_LoadPartyLevelUpIcon(BattleSystem *param0, BattleScriptTaskData *param1, Pokemon *param2)
{
    ...
    SpriteRenderer_LoadCharResObj(v1, v2, 27, 256, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 20021);
    SpriteRenderer_LoadPalette(v3, 2, v1, v2, 27, 82, 0, 2, NNS_G2D_VRAM_TYPE_2DMAIN, 20016);
    SpriteRenderer_LoadCellResObj(v1, v2, 27, 257, 1, 20013);
    SpriteRenderer_LoadAnimResObj(v1, v2, 27, 258, 1, 20013);

    param1->cellActorData[0] = CellActor_LoadResources(v1, v2, &Unk_ov16_0226E6C4);

    CellActorData_UpdateObject(param1->cellActorData[0]);
    sub_0200D888(v1, v2, 19, Pokemon_IconSpriteIndex(param2), 0, NNS_G2D_VRAM_TYPE_2DMAIN, 20022);
    SpriteRenderer_LoadPalette(v3, 2, v1, v2, 19, PokeIconPalettesFileIndex(), 0, 3, NNS_G2D_VRAM_TYPE_2DMAIN, 20017);
    SpriteRenderer_LoadCellResObj(v1, v2, 19, PokeIcon64KCellsFileIndex(), 0, 20014);
    SpriteRenderer_LoadAnimResObj(v1, v2, 19, PokeIcon64KAnimationFileIndex(), 0, 20014);

    param1->cellActorData[1] = CellActor_LoadResources(v1, v2, &Unk_ov16_0226E6F8);

    CellActor_SetExplicitPaletteOffsetAutoAdjust(param1->cellActorData[1]->cellActor, Pokemon_IconPaletteIndex(param2));
    CellActorData_UpdateObject(param1->cellActorData[1]);
...
static void BattleScript_FreePartyLevelUpIcon(BattleSystem *param0, BattleScriptTaskData *param1)
{
    ...
    CellActorData_Delete(param1->cellActorData[0]);
    CellActorData_Delete(param1->cellActorData[1]);
