...
void ov16_02268520(UnkStruct_ov16_02268520 *param0)
{
    ...
    PaletteData_LoadBufferFromFileStart(BattleSystem_PaletteSys(param0->unk_04), 27, ov16_BattlePlatformIndexToPaletteMember[param0->unk_09][v9], 5, 0, 0x20, 0x7 * 0x10);
