...
static void Healthbar_DrawLevelNumber(Healthbar *param0)
{
    ...
    BattleFont_DrawBattleText(ov16_0223E054(param0->battleSys), param0->unk_48, 3, 0, v0);
...
static void Healthbar_DrawCurrentHP(Healthbar *param0, u32 param1)
{
    ...
    BattleFont_DrawBattleText(ov16_0223E04C(param0->battleSys), param1, 3, 1, v0);
...
static void Healthbar_DrawMaxHP(Healthbar *param0)
{
    ...
    MI_CpuFill8(v0, 0xf | (0xf << 4), 3 * 0x20);
    BattleFont_DrawBattleText(ov16_0223E04C(param0->battleSys), param0->maxHP, 3, 0, v0);
