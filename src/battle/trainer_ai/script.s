...
Expert_Main:
    ...
    IfCurrentMoveEffectEqualTo BATTLE_EFFECT_SKIP_CHARGE_TURN_IN_SUN, Expert_UnusedThunder
...
Expert_UnusedThunder:
    IfMoveEffectivenessEquals TYPE_MULTI_IMMUNE, Expert_UnusedThunder_TryScoreMinus3
    IfMoveEffectivenessEquals TYPE_MULTI_HALF_DAMAGE, Expert_UnusedThunder_TryScoreMinus3
    IfMoveEffectivenessEquals TYPE_MULTI_QUARTER_DAMAGE, Expert_UnusedThunder_TryScoreMinus3
    LoadCurrentWeather 
    IfLoadedEqualTo AI_WEATHER_SUNNY, Expert_UnusedThunder_TryScoreMinus3
    IfLoadedNotEqualTo AI_WEATHER_RAINING, Expert_UnusedThunder_End
    AddToMoveScore 1
    GoTo Expert_UnusedThunder_End

Expert_UnusedThunder_TryScoreMinus3:
    IfRandomLessThan 50, Expert_UnusedThunder_End
    AddToMoveScore -3

Expert_UnusedThunder_End:
    PopOrEnd 
