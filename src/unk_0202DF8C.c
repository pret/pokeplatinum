...
void sub_0202DFA8(HallOfFame *param0, const Party *param1, const RTCDate *param2)
{
    ...
    for (v4 = 0, v5 = 0; v4 < v3; v4++) {
        ...
        if (Pokemon_GetData(v1, MON_DATA_IS_EGG, NULL) == 0) {
            v0->unk_00[v5].unk_00 = Pokemon_GetData(v1, MON_DATA_SPECIES, NULL);
            v0->unk_00[v5].unk_02 = Pokemon_GetData(v1, MON_DATA_LEVEL, NULL);
            v0->unk_00[v5].unk_03 = Pokemon_GetData(v1, MON_DATA_FORM, NULL);
            v0->unk_00[v5].unk_04 = Pokemon_GetData(v1, MON_DATA_PERSONALITY, NULL);
            v0->unk_00[v5].unk_08 = Pokemon_GetData(v1, MON_DATA_OT_ID, NULL);
            v0->unk_00[v5].unk_32[0] = Pokemon_GetData(v1, MON_DATA_MOVE1, NULL);
            v0->unk_00[v5].unk_32[1] = Pokemon_GetData(v1, MON_DATA_MOVE2, NULL);
            v0->unk_00[v5].unk_32[2] = Pokemon_GetData(v1, MON_DATA_MOVE3, NULL);
            v0->unk_00[v5].unk_32[3] = Pokemon_GetData(v1, MON_DATA_MOVE4, NULL);

            if (v2) {
                Pokemon_GetData(v1, MON_DATA_NICKNAME_STRBUF, v2);
                Strbuf_ToChars(v2, v0->unk_00[v5].unk_0C, MON_NAME_LEN + 1);

                Pokemon_GetData(v1, MON_DATA_OTNAME_STRBUF, v2);
