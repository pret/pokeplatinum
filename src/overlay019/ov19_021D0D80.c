...
static void ov19_GiveItemToSelectedMon(UnkStruct_ov19_021D4DF0 *param0, u16 param1, UnkStruct_ov19_021D5DF8 *param2);
...
int ov19_021D0E58(OverlayManager *param0, int *param1)
{
    ...
    if (Party_HasSpecies(v0->party, SPECIES_CHATOT) == 0) {
        ChatotCry *chatotCry = GetChatotCryDataFromSave(v0->saveData);
...
static void ov19_021D2F14(UnkStruct_ov19_021D5DF8 *param0, u32 *param1)
{
    ...
    case 0:
        ...
        if (ov19_GetCursorLocation(&param0->unk_00) == CURSOR_IN_PARTY) {
            u32 cursorPosition, partyCount;

            cursorPosition = ov19_GetCursorPartyPosition(&param0->unk_00);
            partyCount = Party_GetCurrentCount(param0->party);
...
static void ov19_021D3FB0(UnkStruct_ov19_021D5DF8 *param0, u32 *param1)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (Bag_TryAddItem(SaveData_GetBag(param0->saveData), v0, 1, HEAP_ID_9)) {
...
static void ov19_021D4184(UnkStruct_ov19_021D5DF8 *param0, u32 *param1)
{
    ...
    switch (*param1) {
    case 0:
        v0 = ov19_GetCursorOrPreviewedItem(&param0->unk_00);
...
static void ov19_021D4BE0(UnkStruct_ov19_021D5DF8 *param0, UnkStruct_02042434 *param1)
{
    ...
    param0->party = Party_GetFromSavedata(param1->unk_00);
    param0->options = SaveData_Options(param1->unk_00);
...
static void ov19_GiveItemToSelectedMon(UnkStruct_ov19_021D4DF0 *param0, u16 item, UnkStruct_ov19_021D5DF8 *param2)
{
...

    {
        ...
        if (species == SPECIES_ARCEUS) {
            ...
            ability = BoxPokemon_GetValue(preview->mon, MON_DATA_ABILITY, NULL);
