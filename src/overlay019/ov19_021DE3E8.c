...
static void ov19_021DE59C (UnkStruct_ov19_021DE3E8 * param0)
{
    ...
    if (v0 != 0) {
        ...
        GraphicElementData_SetAnim(param0->unk_1C[v1], 6);
...
static void ov19_021DE5D4 (UnkStruct_ov19_021DE3E8 * param0)
{
    ...
    if (v0 != 0) {
        ...
        GraphicElementData_SetAnim(param0->unk_1C[v3], 0);
    ...
    if (param0->unk_00) {
        ...
        if (v1 != 0) {
            ...
            if (v0 >= 0) {
                ...
                GraphicElementData_SetAnim(param0->unk_1C[v0], 1);
...
BOOL ov19_021DE800 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00 == 0) {
        ...
        if (v0 >= 0) {
            if (GraphicElementData_IsAnimated(param0->unk_1C[v0])) {
                return 0;
            }
        }
...
static void ov19_021DE8E0 (SysTask * param0, void * param1)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (GraphicElementData_IsAnimated(v0->unk_04) == 0) {
...
void ov19_021DE954 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00) {
        ...
        if (v0 >= 0) {
            ...
            GraphicElementData_SetAnim(param0->unk_1C[v0], 3);
...
void ov19_021DEA18 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00) {
        ...
        if (v0 >= 0) {
            ...
            GraphicElementData_SetAnim(param0->unk_1C[v0], 4);
...
void ov19_021DEA74 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00) {
        ...
        if ((v0 >= 0) && (v1 >= 0)) {
            ...
            GraphicElementData_SetAnim(param0->unk_1C[v1], 3);
...
void ov19_021DEB18 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00) {
        ...
        if (v0 >= 0) {
            GraphicElementData_SetAnim(param0->unk_1C[v0], 5);
            param0->unk_38 = v0;
            return;
        }
...
BOOL ov19_021DEB60 (UnkStruct_ov19_021DE3E8 * param0)
{
    if (param0->unk_00) {
        if (param0->unk_38 != -1) {
            if (GraphicElementData_IsAnimated(param0->unk_1C[param0->unk_38])) {
                return 0;
            }
