...
static void ov19_021DE450(UnkStruct_ov19_021DE3E8 *param0)
{
    if (param0->unk_00) {
        ...
        v3 = Graphics_GetCharData(16, Item_FileID(1, 1), 0, &v2, HEAP_ID_BOX_GRAPHICS);
...
static void ov19_021DE5D4(UnkStruct_ov19_021DE3E8 *param0)
{
    ...
    if (item != ITEM_NONE) {
        ...
        Graphics_LoadPalette(16, Item_FileID(item, 2), 1, Unk_ov19_021E04CC[v3].unk_04 * 0x20, 0x20, HEAP_ID_BOX_GRAPHICS);
...
static void ov19_021DE718(UnkStruct_ov19_021DE3E8 *param0, int param1, int param2)
{
    if (param1 >= 0) {
        ...
        Graphics_LoadPalette(16, Item_FileID(param2, 2), 1, Unk_ov19_021E04CC[param1].unk_04 * 0x20, 0x20, HEAP_ID_BOX_GRAPHICS);
