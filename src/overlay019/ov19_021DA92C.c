...
BOOL ov19_021DA92C(UnkStruct_ov19_021DA9E0 *param0, UnkStruct_ov19_021D61B0 *param1, const UnkStruct_ov19_021D4DF0 *param2, BgConfig *param3, CellActorCollection *param4, const MessageLoader *param5, NARC *param6)
{
    ...
    param0->unk_34 = Graphics_GetCellBank(Battle_Obj_GetNARCIndex(), sub_0207C924(), 1, &(param0->unk_38), 10);
...
static void ov19_021DAB44(UnkStruct_ov19_021DA9E0 *param0)
{
    ...
    Graphics_LoadPalette(v2, Battle_Obj_GetPaletteNARCMember(), 1, 10 * 0x20, 0x20 * 3, 10);
...
static void ov19_021DAE60(Window *param0, UnkStruct_ov19_021DA9E0 *param1, u32 param2, u32 param3)
{
    ...
    case 1: {
        ...
        Graphics_LoadObjectTiles(Battle_Obj_GetNARCIndex(), Battle_Obj_TypeIndexToIconNARCMember(param1->unk_10->unk_4C.unk_0C), 0, 1504 * 0x20, 0, 1, 10);
        ...
        if (param1->unk_10->unk_4C.unk_0C != param1->unk_10->unk_4C.unk_0D) {
            Graphics_LoadObjectTiles(Battle_Obj_GetNARCIndex(), Battle_Obj_TypeIndexToIconNARCMember(param1->unk_10->unk_4C.unk_0D), 0, (1504 + 8) * 0x20, 0, 1, 10);
