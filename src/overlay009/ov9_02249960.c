...
typedef struct DistortionWorldSystem DistortionWorldSystem;
...
typedef struct {
    DistortionWorldBounds bounds;
    u16 angleX;
    u16 angleY;
    u16 angleZ;
    s16 playerDirection;
    s32 transitionSteps;
} DistortionWorldCameraAngleTemplate;
...
typedef struct {
    int count;
    DistortionWorldCameraAngleTemplate *templates;
} DistortionWorldCameraAngleTemplates;
...
typedef struct {
    ...
    int unk_10;
} DistortionWorldFileHeader;

typedef struct {
    int count;
    DistortionWorldCameraAngleTemplate *templates;
} DistortionWorldFileCameraAngleSection;

typedef struct {
    u32 mapHeaderID;
    void *unk_04;
    void *unk_08;
    DistortionWorldFileCameraAngleSection *cameraAngleSection;
    void *unk_10;
    void *header;
    void *buffer;
} DistortionWorldFile;
...
typedef struct {
    ...
    DistortionWorldFile distortionWorldFile;
    UnkStruct_ov9_0224C2C4 unk_28;
    UnkStruct_ov9_0224C640 unk_3C;
    DistortionWorldCameraAngleTemplates cameraAngleTemplates;
    UnkStruct_ov9_0224C788 unk_4C;
    DistortionWorldFile unk_58;
...
typedef struct {
    ...
    VecFx32 angleStep;
} DistortionWorldCameraTransition;
...
typedef struct {
    ...
    DistortionWorldCameraTransition transition;
    SysTask *transitionTask;
} DistortionWorldCameraManager;
...
typedef int (*UnkFuncPtr_ov9_02253BE4)(DistortionWorldSystem *, FieldTask *, u16 *, const void *);
...
struct DistortionWorldSystem {
    FieldSystem *fieldSystem;
    DistortionWorldPersistedData *persistedData;
    NARC *distortionWorldNARC;
    NARC *unk_0C;
    NARC *unk_10;
    DistortionWorldCameraManager cameraMan;
...
static void ov9_02249B04(DistortionWorldSystem *param0);
static void ov9_02249B68(DistortionWorldSystem *param0);
static void DistortionWorld_OpenArchives(DistortionWorldSystem *distortionWorldSystem);
static void DistortionWorld_CloseArchives(DistortionWorldSystem *distortionWorldSystem);
static void ov9_02249CC4(DistortionWorldSystem *param0);
static void DistortionWorld_SetPersistedCameraAngles(DistortionWorldSystem *distortionWorldSystem, u16 angleX, u16 angleY, u16 angleZ);
static void DistortionWorld_GetPersistedCameraAngles(DistortionWorldSystem *distortionWorldSystem, u16 *angleX, u16 *angleY, u16 *angleZ);
static BOOL DistortionWorld_IsPersistedDataValid(DistortionWorldSystem *distortionWorldSystem);
static void ov9_02249D44(DistortionWorldSystem *param0, u32 param1);
static u32 ov9_02249D5C(DistortionWorldSystem *param0);
static void ov9_02249D68(DistortionWorldSystem *param0, u32 param1);
static void ov9_02249D70(DistortionWorldSystem *param0, u32 param1);
static void ov9_02249D8C(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_02249DA8(DistortionWorldSystem *param0, u32 param1);
static void ov9_02249DC8(DistortionWorldSystem *param0, u32 param1);
static void ov9_02249DE4(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_02249E00(DistortionWorldSystem *param0, u32 param1);
static void ov9_02249E20(DistortionWorldSystem *param0, u32 param1);
static u32 ov9_02249E44(DistortionWorldSystem *param0);
static void ov9_02249E94(DistortionWorldSystem *param0);
static void ov9_02249EC8(DistortionWorldSystem *param0);
static void ov9_02249EDC(SysTask *param0, void *param1);
static void ov9_02249EF0(DistortionWorldSystem *param0);
static void ov9_02249F18(DistortionWorldSystem *param0);
static void ov9_02249F3C(SysTask *param0, void *param1);
static void ov9_02249F50(DistortionWorldSystem *param0);
static void ov9_02249F84(DistortionWorldSystem *param0);
static void ov9_02249F88(DistortionWorldSystem *param0);
static void ov9_02249F98(DistortionWorldSystem *param0);
static void DistortionWorld_CameraInit(DistortionWorldSystem *distortionWorldSystem);
static void DistortionWorld_CameraFree(DistortionWorldSystem *distortionWorldSystem);
static void DistortionWorld_CameraTransitionTask(SysTask *sysTask, void *sysTaskParam);
static BOOL DistortionWorld_DoCameraTransition(DistortionWorldSystem *distortionWorldSystem, const DistortionWorldCameraAngleTemplate *cameraAngleTemplate);
static void ov9_0224A1E4(DistortionWorldSystem *param0, int param1);
...
static void ov9_0224A334(DistortionWorldSystem *param0);
static void ov9_0224A390(DistortionWorldSystem *param0, MapObject *param1, int param2);
static void ov9_0224A3C4(DistortionWorldSystem *param0, UnkStruct_020216E0 *param1, int param2);
static void ov9_0224A408(DistortionWorldSystem *param0, const UnkStruct_020216E0 *param1);
static void ov9_0224A49C(DistortionWorldSystem *param0);
static void ov9_0224A4C8(UnkStruct_020216E0 *param0, void *param1);
static void ov9_0224A4D0(DistortionWorldSystem *param0, MapObject *param1, int param2, int param3);
static void ov9_0224A570(DistortionWorldSystem *param0);
static void ov9_0224A574(DistortionWorldSystem *param0);
static void *ov9_0224A578(DistortionWorldSystem *param0, int param1);
static void *ov9_0224A598(DistortionWorldSystem *param0);
static BOOL DistortionWorld_ApplyCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir);
static void ov9_0224A8C0(DistortionWorldSystem *param0);
static void ov9_0224A9E8(DistortionWorldSystem *param0);
static BOOL ov9_0224AA00(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4);
static void ov9_0224AA34(DistortionWorldSystem *param0, const UnkStruct_ov9_0224AA00 *param1);
static BOOL ov9_0224AAD4(FieldTask *param0);
static BOOL ov9_0224AC58(UnkStruct_ov9_0224AC58 *param0, MapObject *param1);
static void ov9_0224ADC0(DistortionWorldSystem *param0);
static void ov9_0224AED8(DistortionWorldSystem *param0);
static void ov9_0224AEE4(DistortionWorldSystem *param0, UnkStruct_ov9_0224B064 *param1, NARC *param2);
...
static void ov9_0224B1B4(DistortionWorldSystem *param0, UnkStruct_ov5_021DF47C *param1, UnkStruct_ov9_0224B064 *param2);
static void ov9_0224B3A8(DistortionWorldSystem *param0);
static void ov9_0224B3F4(DistortionWorldSystem *param0);
static void ov9_0224B3F8(DistortionWorldSystem *param0, UnkStruct_ov9_0224B528 *param1, const UnkStruct_ov9_0224B3F8 *param2, const UnkStruct_ov9_0224B6CC *param3, int param4, u32 param5);
static void ov9_0224B45C(DistortionWorldSystem *param0, int param1);
static void ov9_0224B4CC(DistortionWorldSystem *param0);
static void ov9_0224B514(DistortionWorldSystem *param0);
static void ov9_0224B528(UnkStruct_ov9_0224B528 *param0);
static void ov9_0224B560(DistortionWorldSystem *param0);
static void ov9_0224B624(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224B64C(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224B674(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224B698(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224B6BC(DistortionWorldSystem *param0);
static void ov9_0224B6CC(DistortionWorldSystem *param0, UnkStruct_ov9_0224B528 *param1, const UnkStruct_ov9_0224B6CC *param2, int param3);
static UnkStruct_ov101_021D5D90 *ov9_0224B708(DistortionWorldSystem *param0, int param1, int param2, const UnkStruct_ov9_0224B6CC *param3);
static void ov9_0224B748(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4);
static BOOL ov9_0224B7B0(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224B844(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224B8DC(DistortionWorldSystem *param0, int param1);
static void ov9_0224B570(DistortionWorldSystem *param0);
static void ov9_0224B580(DistortionWorldSystem *param0);
static void ov9_0224B590(DistortionWorldSystem *param0);
static void ov9_0224B5A0(DistortionWorldSystem *param0);
static void ov9_0224B5B0(DistortionWorldSystem *param0);
static void ov9_0224B5EC(DistortionWorldSystem *param0);
static u16 ov9_0224B958(UnkStruct_ov101_021D5D90 *param0);
static void ov9_0224BE14(DistortionWorldSystem *param0);
static void ov9_0224BE8C(DistortionWorldSystem *param0);
static void ov9_0224BEB4(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224BF18(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224BF8C(NARC *param0, UnkStruct_ov9_0224BFE0 *param1);
static void ov9_0224BFBC(DistortionWorldSystem *param0);
static void ov9_0224BFE0(UnkStruct_ov9_0224BFE0 *param0);
static void ov9_0224BFFC(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224C034 *ov9_0224C00C(const UnkStruct_ov9_0224BFE0 *param0, int param1);
static const UnkStruct_ov9_0224C034 *ov9_0224C034(DistortionWorldSystem *param0, int param1);
static u32 DistortionWorldFile_FindNARCIndex(DistortionWorldSystem *distortionWorldSystem, int mapHeaderID);
static void ov9_0224C050(const UnkStruct_ov9_0224BFE0 *param0, int param1, int *param2, int *param3, int *param4);
static void ov9_0224C070(DistortionWorldSystem *param0, int param1, int *param2, int *param3, int *param4);
static void DistortionWorldFile_Load(DistortionWorldSystem *distortionWorldSystem, DistortionWorldFile *file, int mapHeaderID);
static void ov9_0224C0F8(DistortionWorldSystem *param0, int param1, int param2);
static void ov9_0224C10C(DistortionWorldSystem *param0, int param1);
static void ov9_0224C120(DistortionWorldSystem *param0, int param1);
static void DistortionWorldFile_Free(DistortionWorldFile *file);
static void ov9_0224C164(DistortionWorldSystem *param0);
static void ov9_0224C174(DistortionWorldSystem *param0);
static void ov9_0224C184(DistortionWorldSystem *param0);
static void ov9_0224C194(DistortionWorldSystem *param0);
static void ov9_0224C1E4(DistortionWorldSystem *param0);
static int ov9_0224C234(DistortionWorldFile *param0);
static int ov9_0224C23C(DistortionWorldFile *param0);
static UnkStruct_ov9_0224C324 *ov9_0224C244(DistortionWorldFile *param0);
static int ov9_0224C24C(DistortionWorldFile *param0);
static int ov9_0224C254(DistortionWorldFile *param0);
static UnkStruct_ov9_0224AA00 *ov9_0224C25C(DistortionWorldFile *param0);
static int DistortionWorldFile_GetCameraAngleSectionSize(DistortionWorldFile *file);
static int DistortionWorldFile_GetCameraAngleCount(DistortionWorldFile *file);
static DistortionWorldCameraAngleTemplate *DistortionWorldFile_GetCameraAngleTemplates(DistortionWorldFile *file);
static int ov9_0224C27C(DistortionWorldSystem *param0);
static int ov9_0224C288(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B3F8 *ov9_0224C2A8(DistortionWorldFile *param0);
static const UnkStruct_ov9_0224B6CC *ov9_0224C2AC(DistortionWorldFile *param0);
static const UnkStruct_ov9_0224B748 *ov9_0224C2B4(DistortionWorldFile *param0);
static void ov9_0224C2C4(DistortionWorldSystem *param0);
static void ov9_0224C300(DistortionWorldSystem *param0);
static void ov9_0224C378(DistortionWorldSystem *param0, int param1, int param2, int param3, s16 param4);
static void ov9_0224C3F8(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224C44C(DistortionWorldSystem *param0);
static u32 ov9_0224C470(DistortionWorldSystem *param0);
static u32 ov9_0224C494(DistortionWorldSystem *param0);
static u32 ov9_0224C4B8(DistortionWorldSystem *param0, int param1, int param2, int param3);
static void ov9_0224C4F4(DistortionWorldSystem *param0, u32 param1);
static u16 ov9_0224C52C(DistortionWorldSystem *param0, int param1, int param2);
static u16 ov9_0224C55C(DistortionWorldSystem *param0, int param1, int param2, int param3);
static void ov9_0224C640(DistortionWorldSystem *param0);
static void ov9_0224C680(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224AA00 *ov9_0224C69C(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4);
static void DistortionWorld_InitCameraAngleTemplates(DistortionWorldSystem *distortionWorldSystem);
static void DistortionWorld_ResetCameraAngleTemplates(DistortionWorldSystem *distortionWorldSystem);
static const DistortionWorldCameraAngleTemplate *DistortionWorld_FindCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir);
static void ov9_0224C788(DistortionWorldFile *param0, UnkStruct_ov9_0224C788 *param1);
static void ov9_0224C7C8(DistortionWorldSystem *param0);
static void ov9_0224C7E8(DistortionWorldSystem *param0);
static void ov9_0224C808(DistortionWorldSystem *param0);
static void ov9_0224C834(DistortionWorldSystem *param0);
static void ov9_0224C854(DistortionWorldSystem *param0);
static void ov9_0224C844(DistortionWorldSystem *param0);
static void ov9_0224C864(DistortionWorldSystem *param0);
static void ov9_0224C888(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B3F8 *ov9_0224C8AC(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B3F8 *ov9_0224C8B8(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B6CC *ov9_0224C8C4(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B6CC *ov9_0224C8D0(DistortionWorldSystem *param0);
static const UnkStruct_ov9_0224B748 *ov9_0224C8DC(DistortionWorldSystem *param0);
static void ov9_0224C8E8(DistortionWorldSystem *param0);
static void ov9_0224C9E8(DistortionWorldSystem *param0);
static void ov9_0224CA98(DistortionWorldSystem *param0);
static void ov9_0224CB30(DistortionWorldSystem *param0);
static void ov9_0224CBD8(DistortionWorldSystem *param0);
static void ov9_0224CBF8(DistortionWorldSystem *param0);
static void ov9_0224CC08(SysTask *param0, void *param1);
static void ov9_0224CC4C(DistortionWorldSystem *param0);
static void ov9_0224CC50(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1, u32 param2);
static BOOL ov9_0224CC7C(DistortionWorldSystem *param0);
static BOOL ov9_0224D040(DistortionWorldSystem *param0, int param1, int param2, int param3);
static void ov9_0224D078(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1);
static BOOL ov9_0224D098(FieldTask *param0);
static const UnkStruct_ov9_022530A4 *ov9_0224D720(int param0);
static void ov9_0224D744(DistortionWorldSystem *param0);
static void ov9_0224D780(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224D7C0(DistortionWorldSystem *param0, u32 param1);
static UnkStruct_02073838 *ov9_0224D7EC(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224D814(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224D874(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224D994(DistortionWorldSystem *param0);
static void ov9_0224D9BC(DistortionWorldSystem *param0, u32 param1, u32 param2, UnkStruct_02073B50 *param3, UnkStruct_02073974 *param4);
static void ov9_0224DA48(DistortionWorldSystem *param0, int param1, UnkStruct_02073B50 *param2, UnkStruct_02073974 *param3);
static void ov9_0224DA64(DistortionWorldSystem *param0, int param1, int param2, int param3);
static void ov9_0224DAAC(DistortionWorldSystem *param0, int param1, int param2);
static void ov9_0224DAB8(DistortionWorldSystem *param0, int param1, int param2);
static BOOL ov9_0224DAEC(int param0);
static BOOL ov9_0224DB04(int param0);
static void ov9_0224DB1C(DistortionWorldSystem *param0);
static UnkStruct_ov9_0224D928 *ov9_0224D8A4(DistortionWorldSystem *param0, u32 param1, int *param2);
static void ov9_0224D928(DistortionWorldSystem *param0, UnkStruct_ov9_0224D928 *param1);
static void ov9_0224D938(DistortionWorldSystem *param0, UnkStruct_ov9_0224D928 *param1);
static void ov9_0224D954(DistortionWorldSystem *param0, int param1);
static BOOL ov9_0224DBE4(DistortionWorldSystem *param0, int param1, VecFx32 *param2);
static void ov9_0224DC34(DistortionWorldSystem *param0);
static void ov9_0224DC4C(DistortionWorldSystem *param0);
static void ov9_0224DC74(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224DCA8(DistortionWorldSystem *param0);
static void ov9_0224DD24(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224DD40(DistortionWorldSystem *param0, const UnkStruct_ov9_02252C38 *param1, u32 param2);
static void ov9_0224DDA0(DistortionWorldSystem *param0, u32 param1, int param2);
static UnkStruct_ov9_0224E0DC *ov9_0224DDDC(DistortionWorldSystem *param0);
static UnkStruct_ov9_0224E0DC *ov9_0224DE08(DistortionWorldSystem *param0, u32 param1, u32 param2);
...
static MapObject *ov9_0224DE94(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4, int param5, u32 param6);
static void ov9_0224DF10(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1, MapObject *param2);
static UnkStruct_ov101_021D5D90 *ov9_0224DFA0(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1);
static void ov9_0224DFF4(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1, const UnkStruct_ov9_0224DF10 *param2, u32 param3);
static void ov9_0224E044(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1);
static void ov9_0224E060(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1);
static void ov9_0224E07C(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1, u32 param2);
static void ov9_0224E0DC(UnkStruct_ov9_0224E0DC *param0, u32 param1);
static BOOL ov9_0224E0E0(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224E120(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224E160(DistortionWorldSystem *param0, int param1);
static UnkStruct_ov9_0224E0DC *ov9_0224E188(DistortionWorldSystem *param0, int param1, int param2, int param3, u32 param4);
static VecFx32 *ov9_0224E330(UnkStruct_ov101_021D5D90 *param0);
static void ov9_0224E33C(DistortionWorldSystem *param0);
static void ov9_0224E34C(DistortionWorldSystem *param0);
static void ov9_0224E350(DistortionWorldSystem *param0, const UnkStruct_ov9_02251438 *param1);
static void *ov9_0224E37C(DistortionWorldSystem *param0, u32 param1);
static void *ov9_0224E39C(DistortionWorldSystem *param0);
static BOOL ov9_0224E3A0(DistortionWorldSystem *param0, FieldTask *param1);
static BOOL ov9_0224E434(DistortionWorldSystem *param0, int param1, int param2, int param3);
static void ov9_0224E498(DistortionWorldSystem *param0, const UnkStruct_ov9_02251438 *param1);
static void ov9_0224E4B0(DistortionWorldSystem *param0, const UnkStruct_ov9_02252044 *param1);
static BOOL ov9_0224E4BC(FieldTask *param0);
static void ov9_0224E8B4(DistortionWorldSystem *param0);
static void ov9_0224E8EC(DistortionWorldSystem *param0);
static void ov9_0224E91C(DistortionWorldSystem *param0, const UnkStruct_ov9_02252414 *param1);
static BOOL ov9_0224E964(DistortionWorldSystem *param0);
static void ov9_0224E984(DistortionWorldSystem *param0);
static void ov9_0224E988(DistortionWorldSystem *param0);
static BOOL ov9_0224E9A4(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224E9CC(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224E9F4(DistortionWorldSystem *param0, int param1);
static void ov9_0224EB68(DistortionWorldSystem *param0);
static void ov9_0224EB94(DistortionWorldSystem *param0);
static void ov9_0224EBB8(UnkStruct_ov9_0224EBB8 *param0);
static void ov9_0224EC10(DistortionWorldSystem *param0, const UnkStruct_ov9_02252548 *param1);
static void ov9_0224EC48(DistortionWorldSystem *param0, u32 param1);
static UnkStruct_ov9_0224EBB8 *ov9_0224EC70(DistortionWorldSystem *param0);
static void ov9_0224EC94(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224ECC0(DistortionWorldSystem *param0, int param1);
static BOOL ov9_0224ECE8(DistortionWorldSystem *param0, u32 param1);
static BOOL ov9_0224ED20(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224EE40(DistortionWorldSystem *param0);
static void ov9_0224EE6C(DistortionWorldSystem *param0);
static void ov9_0224EE70(DistortionWorldSystem *param0, MapObject *param1);
static MapObject **ov9_0224EEA0(DistortionWorldSystem *param0);
static BOOL ov9_0224EF30(DistortionWorldSystem *param0, const UnkStruct_ov9_0224EF30 *param1, u16 param2);
static BOOL ov9_0224EF64(DistortionWorldSystem *param0, MapObject **param1, const UnkStruct_ov9_0224EF30 *param2, u32 param3, u16 param4);
static BOOL ov9_0224F048(DistortionWorldSystem *param0, const UnkStruct_ov9_0224EF30 **param1, u32 param2);
static void ov9_0224F078(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224F0A4(DistortionWorldSystem *param0, u32 param1);
static MapObject *ov9_0224F0D4(DistortionWorldSystem *param0, u32 param1, u16 param2);
static BOOL ov9_0224F1CC(DistortionWorldSystem *param0, MapObject *param1);
static void ov9_0224F724(DistortionWorldSystem *param0);
static void ov9_0224F760(DistortionWorldSystem *param0);
static void ov9_0224F764(DistortionWorldSystem *param0);
static void ov9_0224F804(DistortionWorldSystem *param0);
static void ov9_0224F854(DistortionWorldSystem *param0, u32 param1);
static void ov9_0224F860(DistortionWorldSystem *param0, s16 param1);
static void ov9_0224F86C(u16 param0, u16 param1, u16 param2, u16 *param3);
static BOOL DistortionWorldBounds_AreCoordinatesInBounds(int tileX, int tileY, int tileZ, const DistortionWorldBounds *bounds);
static int DistortionWorld_CalculateCameraAngleDelta(u16 currentAngleComponent, u16 targetAngleComponent);
static void ov9_02250EE8(s16 *param0, s16 param1);
static void ov9_02250F1C(fx32 *param0, fx32 param1);
static void DistortionWorld_GetPlayerPos(DistortionWorldSystem *distortionWorldSystem, int *playerX, int *playerY, int *playerZ);
static u32 DistortionWorld_GetMapHeaderID(DistortionWorldSystem *distortionWorldSystem);
static int ov9_022510D8(u32 param0);
static BOOL ov9_02251104(DistortionWorldSystem *param0, u32 param1, u32 param2);
...
static void (*const Unk_ov9_02251224[1])(DistortionWorldSystem *, const UnkStruct_ov9_0224AA00 *);
...
void DistortionWorld_DynamicMapFeaturesInit(FieldSystem *fieldSystem)
{
    ...
    DistortionWorldSystem *distortionWorldSystem = Heap_AllocFromHeap(HEAP_ID_FIELD, sizeof(DistortionWorldSystem));

    memset(distortionWorldSystem, 0, sizeof(DistortionWorldSystem));

    distortionWorldSystem->fieldSystem = fieldSystem;
    distortionWorldSystem->persistedData = data;

    fieldSystem->unk_04->dynamicMapFeaturesData = distortionWorldSystem;

    DistortionWorld_OpenArchives(distortionWorldSystem);

    if (data->valid == FALSE) {
        ov9_02249CC4(distortionWorldSystem);
    }

    ov9_0224BE14(distortionWorldSystem);
    ov9_02249F50(distortionWorldSystem);
    ov9_02249F88(distortionWorldSystem);
    ov9_0224A1E4(distortionWorldSystem, (4 + 2));
    ov9_0224D744(distortionWorldSystem);
    ov9_0224ADC0(distortionWorldSystem);
    ov9_0224B3A8(distortionWorldSystem);
    ov9_0224AEE4(distortionWorldSystem, &distortionWorldSystem->unk_1A8, distortionWorldSystem->unk_10);
    ov9_0224F724(distortionWorldSystem);
    DistortionWorld_CameraInit(distortionWorldSystem);
    ov9_0224A570(distortionWorldSystem);
    ov9_0224A8C0(distortionWorldSystem);
    ov9_0224EE40(distortionWorldSystem);
    ov9_0224EB68(distortionWorldSystem);
    ov9_0224B514(distortionWorldSystem);
    ov9_0224DC34(distortionWorldSystem);
    ov9_0224E33C(distortionWorldSystem);
    ov9_02249E94(distortionWorldSystem);
    ov9_0224C8E8(distortionWorldSystem);
    ov9_0224CBD8(distortionWorldSystem);
    ov9_0224DCA8(distortionWorldSystem);
    ov9_0224B1B4(distortionWorldSystem, distortionWorldSystem->fieldSystem->unk_40, &distortionWorldSystem->unk_1A8);
    ov9_0224E984(distortionWorldSystem);
    ov5_021F34B8(distortionWorldSystem->fieldSystem->unk_40);
    ov9_02249EF0(distortionWorldSystem);
...
{
    DistortionWorldSystem *v0 = fieldSystem->unk_04->dynamicMapFeaturesData;
    ...
    ov9_02249F84(v0);
    ov9_0224BE8C(v0);
    DistortionWorld_CloseArchives(v0);
...
static void ov9_02249B04(DistortionWorldSystem *param0)
{
    u32 v0 = DistortionWorld_GetMapHeaderID(param0);
...
static void ov9_02249BD4(DistortionWorldSystem *param0, u32 param1)
{
    ov9_0224B570(param0);
    ov9_02249D44(param0, 0);
...
static void ov9_02249C08(DistortionWorldSystem *param0, u32 param1)
{
    ov9_0224B4CC(param0);
...
static void ov9_02249C2C(DistortionWorldSystem *param0, u32 param1)
{
    ov9_0224B580(param0);
    ov9_02249D44(param0, 0);
    ov9_0224EC94(param0, param1);
...
static void ov9_02249C60(DistortionWorldSystem *param0, u32 param1)
{
    ov9_0224B45C(param0, 1);
    ov9_0224EC48(param0, param1);
    ov9_0224DD24(param0, param1);
...
static void DistortionWorld_OpenArchives(DistortionWorldSystem *distortionWorldSystem)
{
    distortionWorldSystem->distortionWorldNARC = NARC_ctor(NARC_INDEX_FIELDDATA__TORNWORLD__TW_ARC, HEAP_ID_FIELD);
    distortionWorldSystem->unk_0C = NARC_ctor(NARC_INDEX_FIELDDATA__TORNWORLD__TW_ARC_ATTR, HEAP_ID_FIELD);
    distortionWorldSystem->unk_10 = NARC_ctor(NARC_INDEX_DATA__TW_ARC_ETC, HEAP_ID_FIELD);
}

static void DistortionWorld_CloseArchives(DistortionWorldSystem *distortionWorldSystem)
{
    NARC_dtor(distortionWorldSystem->distortionWorldNARC);
    NARC_dtor(distortionWorldSystem->unk_0C);
    NARC_dtor(distortionWorldSystem->unk_10);
}

static void ov9_02249CC4(DistortionWorldSystem *param0)
{
    DistortionWorldPersistedData *v0 = param0->persistedData;
...

    {
        ...
        if (DistortionWorld_GetMapHeaderID(param0) == 581) {
...
static void DistortionWorld_SetPersistedCameraAngles(DistortionWorldSystem *distortionWorldSystem, u16 angleX, u16 angleY, u16 angleZ)
{
    DistortionWorldPersistedData *persistedData = distortionWorldSystem->persistedData;
...
{
    DistortionWorldSystem *distortionWorldSystem = fieldSystem->unk_04->dynamicMapFeaturesData;
    u32 mapHeaderID = DistortionWorld_GetMapHeaderID(distortionWorldSystem);
...
static void ov9_02249EDC(SysTask *param0, void *param1)
{
    DistortionWorldSystem *v0 = param1;
...
void DistortionWorld_UpdateCameraAngle(FieldSystem *fieldSystem)
{
    CameraAngle cameraAngle;
    DistortionWorldSystem *distortionWorldSystem = fieldSystem->unk_04->dynamicMapFeaturesData;
    DistortionWorldCameraManager *cameraMan = &distortionWorldSystem->cameraMan;
...
static void DistortionWorld_CameraInit(DistortionWorldSystem *distortionWorldSystem)
{
    ...
    distortionWorldSystem->fieldSystem->unk_20 = 1;
    cameraMan->camera = distortionWorldSystem->fieldSystem->camera;
    ...
    if (DistortionWorld_IsPersistedDataValid(distortionWorldSystem) == TRUE) {
        u16 angleX, angleY, angleZ;
        DistortionWorld_GetPersistedCameraAngles(distortionWorldSystem, &angleX, &angleY, &angleZ);
    ...
    if (DistortionWorld_GetMapHeaderID(distortionWorldSystem) != MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM) {
        Camera_AdjustFOV(DISTORTION_WORLD_NON_GIRATINA_ROOM_FOV_ADJUST, cameraMan->camera);
    }

    cameraMan->transitionTask = SysTask_Start(DistortionWorld_CameraTransitionTask, distortionWorldSystem, 0);
}
...
static void DistortionWorld_CameraFree(DistortionWorldSystem *distortionWorldSystem)
{
    ...
    distortionWorldSystem->fieldSystem->unk_20 = 0;
...
static void DistortionWorld_CameraTransitionTask(SysTask *sysTask, void *sysTaskParam)
{
    DistortionWorldSystem *distortionWorldSystem = sysTaskParam;
    DistortionWorldCameraManager *cameraMan = &distortionWorldSystem->cameraMan;
    DistortionWorldCameraTransition *transition = &cameraMan->transition;

    if (transition->running == FALSE) {
        return;
    }

    transition->stepsLeft--;

    if (transition->stepsLeft <= 0) {
...
static BOOL DistortionWorld_DoCameraTransition(DistortionWorldSystem *distortionWorldSystem, const DistortionWorldCameraAngleTemplate *cameraAngleTemplate)
{
    ...
    DistortionWorld_SetPersistedCameraAngles(distortionWorldSystem, cameraAngleTemplate->angleX, cameraAngleTemplate->angleY, cameraAngleTemplate->angleZ);
    ...
    transition->stepsLeft = cameraAngleTemplate->transitionSteps;
    ...
    int angleDelta = DistortionWorld_CalculateCameraAngleDelta(cameraMan->currentAngle.x, cameraMan->targetAngle.x);
    transition->angleStep.x = (FX32_ONE * angleDelta) / cameraAngleTemplate->transitionSteps;

    angleDelta = DistortionWorld_CalculateCameraAngleDelta(cameraMan->currentAngle.y, cameraMan->targetAngle.y);
    transition->angleStep.y = (FX32_ONE * angleDelta) / cameraAngleTemplate->transitionSteps;

    angleDelta = DistortionWorld_CalculateCameraAngleDelta(cameraMan->currentAngle.z, cameraMan->targetAngle.z);
...
static void ov9_0224A438(DistortionWorldSystem *param0, UnkStruct_ov9_0224A228 *param1, UnkStruct_ov9_0224A294 *param2)
{
    int v0;
...
{
    int v0 = 0;
    DistortionWorldSystem *v1 = fieldSystem->unk_04->dynamicMapFeaturesData;
...
BOOL ov9_0224A59C(FieldSystem *fieldSystem, int param1)
{
    ...
    if (PersistedMapFeatures_GetID(v0) == DYNAMIC_MAP_FEATURES_DISTORTION_WORLD) {
        int v1, v2, v3, v4;
        DistortionWorldSystem *v5 = fieldSystem->unk_04->dynamicMapFeaturesData;

        v4 = sub_02061434(fieldSystem->playerAvatar, param1);
        DistortionWorld_GetPlayerPos(v5, &v1, &v2, &v3);

        if (v4 == 1) {
            ov9_0224B748(v5, v1, v2, v3, param1);
        }

        if (DistortionWorld_ApplyCorrectCameraAngleForPlayer(v5, v1, v2, v3, param1) == 1) {
            (void)0;
        }
        ...
        {
            u32 v6 = DistortionWorld_GetMapHeaderID(v5);
...
{
    DistortionWorldSystem *v0 = fieldSystem->unk_04->dynamicMapFeaturesData;
    u32 v1 = DistortionWorld_GetMapHeaderID(v0);
    ...
    case 581:
        if (param1 == 0) {
            ...
            if (SystemVars_GetDistortionWorldProgress(v2) >= 10) {
                ...
                DistortionWorld_GetPlayerPos(v0, &v3, &v4, &v5);
    ...
    case 582:
        if (param1 == 1) {
            ...
            DistortionWorld_GetPlayerPos(v0, &v6, &v7, &v8);
...
static BOOL DistortionWorld_ApplyCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir)
{
    const DistortionWorldCameraAngleTemplate *cameraAngleTemplate = DistortionWorld_FindCorrectCameraAngleForPlayer(distortionWorldSystem, playerX, playerY, playerZ, playerDir);

    if (cameraAngleTemplate == NULL) {
        return FALSE;
    }

    DistortionWorld_DoCameraTransition(distortionWorldSystem, cameraAngleTemplate);
    return TRUE;
}
...
static void ov9_0224A8C0(DistortionWorldSystem *param0)
{
    ...
    DistortionWorld_GetPlayerPos(param0, &v2, &v3, &v4);
...
static void ov9_0224AA34(DistortionWorldSystem *param0, const UnkStruct_ov9_0224AA00 *param1)
{
    UnkStruct_ov9_0224AC58 *v0 = ov9_0224A578(param0, sizeof(UnkStruct_ov9_0224AC58));
...
static BOOL ov9_0224AAD4(FieldTask *param0)
{
    ...
    DistortionWorldSystem *v1 = FieldTask_GetEnv(param0);
...
static void ov9_0224B1B4(DistortionWorldSystem *param0, UnkStruct_ov5_021DF47C *param1, UnkStruct_ov9_0224B064 *param2)
{
    ...
    if (DistortionWorld_GetMapHeaderID(param0) == 582) {
...
static void ov9_0224B45C(DistortionWorldSystem *param0, int param1)
{
    ...
    v0 = DistortionWorld_GetMapHeaderID(param0);
    v1 = ov9_0224D720(v0);
    ...
    if (ov9_0224C27C(param0)) {
        ...
        if ((param1 == 1) || (DistortionWorld_IsPersistedDataValid(param0) == 0)) {
            v2->unk_00 = ~v3->unk_08;
...
static void ov9_0224B748(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4)
{
    if (ov9_0224C27C(param0)) {
        ...
        if (v0->unk_04) {
            ...
            do {
                if (param4 == v2->unk_04) {
                    if (DistortionWorldBounds_AreCoordinatesInBounds(param1, param2, param3, &v2->unk_08)) {
                        if (v2->unk_06 == 0) {
...
static int ov9_0224B964(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (DistortionWorld_GetMapHeaderID(v3->unk_14) == v3->unk_02) {
...
static void ov9_0224BA6C(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
    ...
    u32 v4 = 0, v5 = DistortionWorld_GetMapHeaderID(v2->unk_14);
...

    {
        ...
        if (DistortionWorld_GetMapHeaderID(v2->unk_14) == v2->unk_02) {
...
static void ov9_0224BD18(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (DistortionWorld_GetMapHeaderID(v1->unk_14) == v1->unk_02) {
...
static void ov9_0224BE14(DistortionWorldSystem *param0)
{
    ...
    mapHeaderID = DistortionWorld_GetMapHeaderID(param0);
    ...
    ov9_0224C2C4(param0);
    ov9_0224C640(param0);
    DistortionWorld_InitCameraAngleTemplates(param0);
    ov9_0224C808(param0);

    if (DistortionWorld_IsPersistedDataValid(param0) == 0) {
        int v2, v3, v4;
...
static void ov9_0224BE8C(DistortionWorldSystem *param0)
{
    DistortionWorld_ResetCameraAngleTemplates(param0);
    ov9_0224C680(param0);
    ov9_0224C300(param0);
    ov9_0224C854(param0);
    ov9_0224C164(param0);
...
static const UnkStruct_ov9_0224C034 *ov9_0224C00C(const UnkStruct_ov9_0224BFE0 *param0, int mapHeaderID)
{
    int v0 = 0;
...
static const UnkStruct_ov9_0224C034 *ov9_0224C034(DistortionWorldSystem *distortionWorldSystem, int mapHeaderID)
{
    return ov9_0224C00C(&distortionWorldSystem->unk_169C.unk_00, mapHeaderID);
}

static u32 DistortionWorldFile_FindNARCIndex(DistortionWorldSystem *distortionWorldSystem, int mapHeaderID)
{
    const UnkStruct_ov9_0224C034 *v0 = ov9_0224C034(distortionWorldSystem, mapHeaderID);
    return v0->unk_04 + 1;
}
...
static void DistortionWorldFile_Load(DistortionWorldSystem *distortionWorldSystem, DistortionWorldFile *file, int mapHeaderID)
{
    ...
    memset(file, 0, sizeof(DistortionWorldFile));
    file->mapHeaderID = mapHeaderID;

    if (mapHeaderID != MAP_HEADER_COUNT) {
        u8 *data;
        u32 narcMemberSize, narcIndex;
        DistortionWorldFileHeader *header;

        narcIndex = DistortionWorldFile_FindNARCIndex(distortionWorldSystem, mapHeaderID);
        narcMemberSize = NARC_GetMemberSize(distortionWorldSystem->distortionWorldNARC, narcIndex);

        file->buffer = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD, narcMemberSize);
        NARC_ReadWholeMember(distortionWorldSystem->distortionWorldNARC, narcIndex, file->buffer);

        header = file->buffer;
        file->header = header;

        data = file->buffer;
        data += sizeof(DistortionWorldFileHeader);

        file->unk_04 = data;
        file->unk_08 = (u8 *)file->unk_04 + header->unk_04;
        file->cameraAngleSection = (DistortionWorldFileCameraAngleSection *)((u8 *)file->unk_08 + header->unk_08);
        file->unk_10 = (u8 *)file->cameraAngleSection + header->cameraAngleSectionSize;
    }
}

static void ov9_0224C0F8(DistortionWorldSystem *param0, int mapHeaderID, int param2)
{
    ov9_0224C10C(param0, mapHeaderID);
    ov9_0224C120(param0, param2);
}

static void ov9_0224C10C(DistortionWorldSystem *param0, int mapHeaderID)
{
    DistortionWorldFile_Load(param0, &param0->unk_169C.distortionWorldFile, mapHeaderID);
}

static void ov9_0224C120(DistortionWorldSystem *param0, int mapHeaderID)
{
    DistortionWorldFile_Load(param0, &param0->unk_169C.unk_58, mapHeaderID);
}

static void DistortionWorldFile_Invalidate(DistortionWorldFile *file)
{
    memset(file, 0, sizeof(DistortionWorldFile));
...
static void DistortionWorldFile_Free(DistortionWorldFile *file)
{
    ...
    DistortionWorldFile_Invalidate(file);
}
...
static void ov9_0224C174(DistortionWorldSystem *param0)
{
    DistortionWorldFile_Free(&param0->unk_169C.distortionWorldFile);
}

static void ov9_0224C184(DistortionWorldSystem *param0)
{
    DistortionWorldFile_Free(&param0->unk_169C.unk_58);
}
...
static void ov9_0224C194(DistortionWorldSystem *param0)
{
    ...
    DistortionWorldFile_Invalidate(&param0->unk_169C.distortionWorldFile);
}
...
static void ov9_0224C1E4(DistortionWorldSystem *param0)
{
    ...
    DistortionWorldFile_Invalidate(&param0->unk_169C.unk_58);
}

static int ov9_0224C234(DistortionWorldFile *param0)
{
    DistortionWorldFileHeader *v0 = param0->header;
    return v0->unk_04;
}
...
static int DistortionWorldFile_GetCameraAngleSectionSize(DistortionWorldFile *file)
{
    DistortionWorldFileHeader *header = file->header;
...
static DistortionWorldCameraAngleTemplate *DistortionWorldFile_GetCameraAngleTemplates(DistortionWorldFile *file)
{
    ...
    return (DistortionWorldCameraAngleTemplate *)templates;
}

static int ov9_0224C27C(DistortionWorldSystem *param0)
{
    DistortionWorldFile *v0 = &param0->unk_169C.distortionWorldFile;
    DistortionWorldFileHeader *v1 = v0->header;
...
{
    int v0 = 0;
    DistortionWorldFile *v1 = &param0->unk_169C.unk_58;

    if (v1->mapHeaderID != MAP_HEADER_COUNT) {
        DistortionWorldFileHeader *v2 = v1->header;
        v0 = v2->unk_10;
    }
...
static BOOL ov9_0224C324(DistortionWorldSystem *param0, int param1, int param2, int param3, s16 param4)
{
    UnkStruct_ov9_0224C2C4 *v0 = &param0->unk_169C.unk_28;
    ...
    do {
        if (DistortionWorldBounds_AreCoordinatesInBounds(param1, param2, param3, &v1->unk_04) == 1) {
...
static u32 ov9_0224C4B8(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
...

    {
        ...
        if (DistortionWorldBounds_AreCoordinatesInBounds(param1, param2, param3, &v2->unk_04) == 0) {
            return 0;
        }
...
static u16 ov9_0224C55C(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
...

    {
        ...
        if (DistortionWorldBounds_AreCoordinatesInBounds(param1, param2, param3, &v4->unk_04) == 0) {
            return 65534;
        }
...
static const UnkStruct_ov9_0224AA00 *ov9_0224C69C(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4)
{
    ...
    while (v2) {
        if (param4 == v1->unk_02) {
            if (DistortionWorldBounds_AreCoordinatesInBounds(param1, param2, param3, &v1->unk_08)) {
                return v1;
            }
        }
...
static void DistortionWorld_InitCameraAngleTemplates(DistortionWorldSystem *distortionWorldSystem)
{
    DistortionWorldFile *file = &distortionWorldSystem->unk_169C.distortionWorldFile;

    GF_ASSERT(distortionWorldSystem->unk_169C.cameraAngleTemplates.templates == NULL);

    if (DistortionWorldFile_GetCameraAngleSectionSize(file)) {
        DistortionWorldCameraAngleTemplates *cameraAngleTemplates = &distortionWorldSystem->unk_169C.cameraAngleTemplates;

        cameraAngleTemplates->count = DistortionWorldFile_GetCameraAngleCount(file);
        cameraAngleTemplates->templates = DistortionWorldFile_GetCameraAngleTemplates(file);
    }
}
...
{
    DistortionWorldCameraAngleTemplates *cameraAngleTemplates = &distortionWorldSystem->unk_169C.cameraAngleTemplates;
    memset(cameraAngleTemplates, 0, sizeof(DistortionWorldCameraAngleTemplates));
}

static const DistortionWorldCameraAngleTemplate *DistortionWorld_FindCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir)
{
    DistortionWorldCameraAngleTemplates *cameraAngleTemplates = &distortionWorldSystem->unk_169C.cameraAngleTemplates;
    DistortionWorldCameraAngleTemplate *cameraAngleTemplateIter = cameraAngleTemplates->templates;
    int i = cameraAngleTemplates->count;

    while (i) {
        if (playerDir == cameraAngleTemplateIter->playerDirection) {
            if (DistortionWorldBounds_AreCoordinatesInBounds(playerX, playerY, playerZ, &cameraAngleTemplateIter->bounds)) {
...
{
    if (ov9_0224C288(param0)) {
        DistortionWorldFile *v0 = &param0->unk_169C.unk_58;
...
static void ov9_0224CA30(DistortionWorldSystem *param0)
{
    UnkStruct_ov9_0224C8E8 *v0 = &param0->unk_1E88;
...
static int (*const Unk_ov9_022514E0[5])(DistortionWorldSystem *, UnkStruct_ov9_0224CBD8 *);
static int (*const Unk_ov9_02251428[4])(DistortionWorldSystem *, UnkStruct_ov9_0224CBD8 *);
...
static void ov9_0224CC08(SysTask *param0, void *param1)
{
    ...
    int (*const *v2)(DistortionWorldSystem *, UnkStruct_ov9_0224CBD8 *) = NULL;
...
static int ov9_0224CC90(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    ov9_0224CBBC(param0->fieldSystem->landDataMan, 0);
    ov9_02249BD4(param0, DistortionWorld_GetMapHeaderID(param0));

    param1->unk_04 = 1;
    return 0;
}

static int ov9_0224CCB8(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    UnkStruct_ov9_0224C8E8 *v1 = &param0->unk_1E88;
    const UnkStruct_ov9_022530A4 *v2 = ov9_0224D720(DistortionWorld_GetMapHeaderID(param0));
...
static int ov9_0224CD84(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    if (param1->unk_20 == 0) {
        int v0, v1, v2;
        NARC *v3;
...
static int ov9_0224CE00(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    UnkStruct_ov9_0224C8E8 *v0 = &param0->unk_1E88;
...
static int ov9_0224CE2C(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
...
static int ov9_0224CE80(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    const UnkStruct_ov9_022530A4 *v0;
    UnkStruct_ov9_0224C8E8 *v1 = &param0->unk_1E88;
    ...
    v0 = ov9_0224D720(DistortionWorld_GetMapHeaderID(param0));
...
static int ov9_0224CEBC(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    UnkStruct_ov9_0224C8E8 *v1 = &param0->unk_1E88;
    const UnkStruct_ov9_022530A4 *v2 = ov9_0224D720(DistortionWorld_GetMapHeaderID(param0));
...
static int ov9_0224CFE0(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
...
static int ov9_0224D008(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
...
static BOOL ov9_0224D040(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    UnkStruct_ov9_0224E0DC *v0 = ov9_0224E188(param0, param1, param2, param3, DistortionWorld_GetMapHeaderID(param0));
...
static int (*const Unk_ov9_02252224[8])(DistortionWorldSystem *, UnkStruct_ov9_0224D078 *);

static void ov9_0224D078(DistortionWorldSystem *param0, UnkStruct_ov9_0224E0DC *param1)
{
    UnkStruct_ov9_0224D078 *v0 = ov9_0224A578(param0, sizeof(UnkStruct_ov9_0224D078));
    v0->unk_64 = param1;
...
static int ov9_0224D0C8(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
    u32 v0;
    MapObject *v1;
...
static int ov9_0224D288(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
    VecFx32 v0;
    PlayerAvatar *playerAvatar = param0->fieldSystem->playerAvatar;
...
static int ov9_0224D374(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
    int v0;
    PlayerAvatar *playerAvatar = param0->fieldSystem->playerAvatar;
    MapObject *v2 = Player_MapObject(playerAvatar);
...
static int ov9_0224D430(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
...
static int ov9_0224D4C4(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
    int v0;
    PlayerAvatar *playerAvatar = param0->fieldSystem->playerAvatar;
    MapObject *v2 = Player_MapObject(playerAvatar);
...
static int ov9_0224D5E8(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
...
static int ov9_0224D69C(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
    int v0;
    MapObject *v1;
...
static int ov9_0224D6E0(DistortionWorldSystem *param0, UnkStruct_ov9_0224D078 *param1)
{
...
static void ov9_0224DCA8(DistortionWorldSystem *param0)
{
    if (DistortionWorld_IsPersistedDataValid(param0) == 1) {
        int v0 = 0;
        ...
        u32 v4 = DistortionWorld_GetMapHeaderID(param0);
...
static MapObject *ov9_0224DE94(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4, int param5, u32 param6)
{
    MapObject *v0 = MapObjectMan_AddMapObject(param0->fieldSystem->mapObjMan, param1, param3, 0, 0x2000, 0x0, DistortionWorld_GetMapHeaderID(param0));
...
static BOOL ov9_0224E434(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    ...
    const UnkStruct_ov9_02252044 *v1 = ov9_0224E410(DistortionWorld_GetMapHeaderID(param0));
...
static BOOL ov9_0224E4BC(FieldTask *param0)
{
    DistortionWorldSystem *v0 = FieldTask_GetEnv(param0);
...
static int ov9_0224E4D8(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_0224E4E8(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    MapObject *v0;
...
static int ov9_0224E520(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    MapObject *v0;
    const UnkStruct_ov9_0224E4E8 *v1 = param3;
    UnkStruct_ov9_0224E4D8 *v2 = ov9_0224E39C(param0);
...
static int ov9_0224E550(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    const UnkStruct_ov9_0224E550 *v0 = param3;
    UnkStruct_ov9_0224E5EC *v1 = ov9_0224E37C(param0, sizeof(UnkStruct_ov9_0224E5EC));

    v1->unk_24 = ov9_0224DE08(param0, v0->unk_00, DistortionWorld_GetMapHeaderID(param0));
...
static int ov9_0224E5EC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    MapObject *v0 = NULL;
...
static int ov9_0224E6B0(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    VecFx32 v0 = { 0, 0, 0 };
    const UnkStruct_ov9_0224E550 *v1 = param3;
    UnkStruct_ov9_0224E5EC *v2 = ov9_0224E39C(param0);
...
static int ov9_0224E798(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    const UnkStruct_ov9_0224E550 *v0 = param3;
...
static int ov9_0224E860(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_0224E870(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static void ov9_0224EB68(DistortionWorldSystem *param0)
{
    ...
    u32 v1 = DistortionWorld_GetMapHeaderID(param0);
...
static void ov9_0224EBCC(DistortionWorldSystem *param0, UnkStruct_ov9_0224EBB8 *param1, const UnkStruct_ov9_0224EC10 *param2, u32 param3)
{
...
static MapObject *ov9_0224EECC(DistortionWorldSystem *param0, const ObjectEvent *param1, u32 param2)
{
    int v0 = 0;
    MapObject *v1;
...
void ov9_0224F16C(FieldSystem *fieldSystem, u16 param1)
{
    ...
    DistortionWorldSystem *v4 = fieldSystem->unk_04->dynamicMapFeaturesData;
...
static void ov9_0224F8C4(DistortionWorldSystem *param0, UnkStruct_ov9_0224F930 *param1, const UnkStruct_ov9_0224F8C4 *param2, const VecFx32 *param3)
{
...
static BOOL ov9_0224F970(DistortionWorldSystem *param0, UnkStruct_ov9_0224F930 *param1)
{
...
static const DistortionWorldCameraAngleTemplate Unk_ov9_02251E40 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0xF5,
    0xEF,
    0x0,
...
static const DistortionWorldCameraAngleTemplate Unk_ov9_02251888 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x0,
    0x0,
    0x0,
...
static void ov9_0224FA94(DistortionWorldSystem *param0, UnkStruct_ov9_0224FA94 *param1)
{
    MapObject *v0 = Player_MapObject(param0->fieldSystem->playerAvatar);
    int v1 = (((param1->unk_40.unk_10.y) >> 4) / FX32_ONE);

    if ((param1->unk_04 == 0) && (v1 == -20)) {
        DistortionWorld_DoCameraTransition(param0, &Unk_ov9_02251E40);
        ov9_0224A4D0(param0, v0, -32, 72);
        param1->unk_04++;
    } else if ((param1->unk_04 == 1) && (v1 == -36)) {
        MapObject_TryFace(v0, 2);
        DistortionWorld_DoCameraTransition(param0, &Unk_ov9_02251888);
...
static int ov9_0224FB3C(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    VecFx32 v0;
...
static int ov9_0224FC2C(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    MapObject *v0 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static int ov9_0224FD74(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    int v0;
...
static int ov9_0224FEDC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    int v0;
    UnkStruct_ov101_021D5D90 *v1 = sub_0205EC04(param0->fieldSystem->playerAvatar);
    MapObject *v2 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static int ov9_022500E0(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    u32 v0[2] = { 0xa, 0x6 };
    UnkStruct_ov9_0224FA94 *v1 = ov9_0224E39C(param0);
    MapObject *v2 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static const DistortionWorldCameraAngleTemplate Unk_ov9_02251C48 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x37,
    0xF0,
    0x0,
...
static void ov9_02250138(DistortionWorldSystem *param0, UnkStruct_ov9_02250138 *param1)
{
    MapObject *v0 = Player_MapObject(param0->fieldSystem->playerAvatar);
    int v1 = (((param1->unk_34.unk_10.y) >> 4) / FX32_ONE);

    if ((param1->unk_04 == 0) && (v1 == 20)) {
        DistortionWorld_DoCameraTransition(param0, &Unk_ov9_02251C48);
        param1->unk_04++;
    }
}

static int ov9_02250170(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    VecFx32 v0;
    UnkStruct_ov9_0224F930 *v1;
    MapObject *v2;
...
static int ov9_02250260(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    MapObject *v0 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static int ov9_02250388(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    int v0;
    UnkStruct_ov101_021D5D90 *v1 = sub_0205EC04(param0->fieldSystem->playerAvatar);
    MapObject *v2 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static int ov9_02250468(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    int v0;
    UnkStruct_ov101_021D5D90 *v1 = sub_0205EC04(param0->fieldSystem->playerAvatar);
    MapObject *v2 = Player_MapObject(param0->fieldSystem->playerAvatar);
...
static int ov9_02250650(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022506AC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022506CC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    return 2;
}
...
static int ov9_022506D0(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022506EC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250704(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250710(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    const UnkStruct_ov9_02250704 *v0 = param3;
...
static int ov9_0225071C(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250730(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022507C4(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022507FC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250854(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022508C0(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_020216E0 *v0;
    NNSG3dResMdl *v1;
...
static int ov9_022508F4(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_0225074C *v0 = ov9_0224E39C(param0);
    v0->unk_14++;
...
static int ov9_02250918(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_0225094C(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250994(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_022509D4(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250918 *v0;
...
static int ov9_02250A58(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250918 *v0 = ov9_0224E39C(param0);
    v0->unk_14.z += (FX32_ONE * 1);
...
static int ov9_02250A90(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250918 *v0 = ov9_0224E39C(param0);
...
static int ov9_02250AFC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250B30(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250B84(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250BAC(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250AFC *v0 = ov9_0224E39C(param0);
...
static int ov9_02250C14(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250C48(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250CD8(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250D10(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250C14 *v0 = ov9_0224E39C(param0);
...
const DistortionWorldCameraAngleTemplate Unk_ov9_02251D68 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x10,
    0x0,
    0x0,
...
static int ov9_02250D78(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250D78 *v0 = ov9_0224E37C(param0, sizeof(UnkStruct_ov9_02250D78));

    DistortionWorld_DoCameraTransition(param0, &Unk_ov9_02251D68);
...
static int ov9_02250DA0(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250DE8(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250E00(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
...
static int ov9_02250E50(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    UnkStruct_ov9_02250DE8 *v0 = ov9_0224E39C(param0);
...
static void DistortionWorld_GetPlayerPos(DistortionWorldSystem *distortionWorldSystem, int *playerX, int *playerY, int *playerZ)
{
    MapObject *mapObj = Player_MapObject(distortionWorldSystem->fieldSystem->playerAvatar);

    *playerX = MapObject_GetX(mapObj);
    *playerY = MapObject_GetY(mapObj) / 2;
    *playerZ = MapObject_GetZ(mapObj);
}
...
BOOL ov9_02251044(FieldSystem *fieldSystem, int param1, int param2, int param3, u32 *param4)
{
    ...
    {
        u16 v1;
        DistortionWorldSystem *v2 = fieldSystem->unk_04->dynamicMapFeaturesData;
...
static u32 DistortionWorld_GetMapHeaderID(DistortionWorldSystem *distortionWorldSystem)
{
    return distortionWorldSystem->fieldSystem->location->mapId;
}
...
BOOL ov9_022511A0(FieldSystem *fieldSystem, int param1, int param2, int param3)
{
    ...
    if (DistortionWorld_GetMapHeaderID(v0) == 582) {
