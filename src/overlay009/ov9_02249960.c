...
static void OpenArchives(DistortionWorldSystem *system);
static void CloseArchives(DistortionWorldSystem *system);
static void ov9_02249CC4(DistortionWorldSystem *param0);
static void SetPersistedCameraAngles(DistortionWorldSystem *system, u16 angleX, u16 angleY, u16 angleZ);
static void GetPersistedCameraAngles(DistortionWorldSystem *system, u16 *angleX, u16 *angleY, u16 *angleZ);
static BOOL IsPersistedDataValid(DistortionWorldSystem *system);
...
static void CameraInit(DistortionWorldSystem *system);
static void CameraFree(DistortionWorldSystem *system);
static void CameraTransitionTask(SysTask *sysTask, void *sysTaskParam);
static BOOL DoCameraTransition(DistortionWorldSystem *system, const DistortionWorldCameraAngleTemplate *cameraAngleTemplate);
...
static BOOL ApplyCameraAngleForPlayerPosition(DistortionWorldSystem *system, int playerX, int playerY, int playerZ, int playerDir);
...
static const UnkStruct_ov9_0224C034 *ov9_0224C034(DistortionWorldSystem *system, enum MapHeader mapHeaderID);
static u32 FindNARCIndex(DistortionWorldSystem *system, enum MapHeader mapHeaderID);
...
static void DistortionWorldFile_Load(DistortionWorldSystem *system, DistortionWorldFile *file, enum MapHeader mapHeaderID);
...
static void InitCameraAngleTemplates(DistortionWorldSystem *system);
static void ResetCameraAngleTemplates(DistortionWorldSystem *system);
static const DistortionWorldCameraAngleTemplate *FindCameraAngleForPlayerPosition(DistortionWorldSystem *system, int playerX, int playerY, int playerZ, int playerDir);
...
static void GetPlayerPos(DistortionWorldSystem *system, int *playerX, int *playerY, int *playerZ);
static u32 DistortionWorldSystem_GetMapHeaderID(DistortionWorldSystem *system);
...
void DistWorld_DynamicMapFeaturesInit(FieldSystem *fieldSystem)
{
    ...
    DistortionWorldSystem *dwSystem = Heap_AllocFromHeap(HEAP_ID_FIELD, sizeof(DistortionWorldSystem));

    memset(dwSystem, 0, sizeof(DistortionWorldSystem));
...
static void ov9_02249B04(DistortionWorldSystem *param0)
{
    u32 v0 = DistortionWorldSystem_GetMapHeaderID(param0);
...
static void ov9_02249CC4(DistortionWorldSystem *param0)
{
...

    {
        ...
        if (DistortionWorldSystem_GetMapHeaderID(param0) == 581) {
...
static void SetPersistedCameraAngles(DistortionWorldSystem *system, u16 angleX, u16 angleY, u16 angleZ)
{
    DistortionWorldPersistedData *persistedData = system->persistedData;
...
{
    DistortionWorldSystem *dwSystem = fieldSystem->unk_04->dynamicMapFeaturesData;
    u32 mapHeaderID = DistortionWorldSystem_GetMapHeaderID(dwSystem);
...
void DistWorld_UpdateCameraAngle(FieldSystem *fieldSystem)
{
    ...
    DistortionWorldSystem *dwSystem = fieldSystem->unk_04->dynamicMapFeaturesData;
    DistortionWorldCameraManager *cameraMan = &dwSystem->cameraMan;
...
static void CameraInit(DistortionWorldSystem *system)
{
    DistortionWorldCameraManager *cameraMan = &system->cameraMan;
    ...
    if (DistortionWorldSystem_GetMapHeaderID(system) != MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM) {
...
static void CameraTransitionTask(SysTask *sysTask, void *sysTaskParam)
{
    DistortionWorldSystem *system = sysTaskParam;
    DistortionWorldCameraManager *cameraMan = &system->cameraMan;
...
BOOL ov9_0224A59C(FieldSystem *fieldSystem, int param1)
{
    ...
    if (PersistedMapFeatures_GetID(v0) == DYNAMIC_MAP_FEATURES_DISTORTION_WORLD) {
        ...
        {
            u32 v6 = DistortionWorldSystem_GetMapHeaderID(v5);
...
{
    DistortionWorldSystem *v0 = fieldSystem->unk_04->dynamicMapFeaturesData;
    u32 v1 = DistortionWorldSystem_GetMapHeaderID(v0);
...
static BOOL ApplyCameraAngleForPlayerPosition(DistortionWorldSystem *system, int playerX, int playerY, int playerZ, int playerDir)
{
    const DistortionWorldCameraAngleTemplate *cameraAngleTemplate = FindCameraAngleForPlayerPosition(system, playerX, playerY, playerZ, playerDir);
...
static void ov9_0224B1B4(DistortionWorldSystem *param0, UnkStruct_ov5_021DF47C *param1, UnkStruct_ov9_0224B064 *param2)
{
    ...
    if (DistortionWorldSystem_GetMapHeaderID(param0) == 582) {
...
static void ov9_0224B45C(DistortionWorldSystem *param0, int param1)
{
    ...
    v0 = DistortionWorldSystem_GetMapHeaderID(param0);
    v1 = ov9_0224D720(v0);
...
static int ov9_0224B964(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (DistortionWorldSystem_GetMapHeaderID(v3->unk_14) == v3->unk_02) {
...
static void ov9_0224BA6C(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
    ...
    u32 v4 = 0, v5 = DistortionWorldSystem_GetMapHeaderID(v2->unk_14);
...

    {
        ...
        if (DistortionWorldSystem_GetMapHeaderID(v2->unk_14) == v2->unk_02) {
...
static void ov9_0224BD18(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (DistortionWorldSystem_GetMapHeaderID(v1->unk_14) == v1->unk_02) {
...
static void ov9_0224BE14(DistortionWorldSystem *param0)
{
    ...
    mapHeaderID = DistortionWorldSystem_GetMapHeaderID(param0);
...
static void InitCameraAngleTemplates(DistortionWorldSystem *system)
{
    DistortionWorldFile *file = &system->unk_169C.distortionWorldFile;

    GF_ASSERT(system->unk_169C.cameraAngleTemplates.templates == NULL);

    if (DistortionWorldFile_GetCameraAngleSectionSize(file)) {
        DistortionWorldCameraAngleTemplates *cameraAngleTemplates = &system->unk_169C.cameraAngleTemplates;
...
static int ov9_0224CC90(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    ...
    ov9_02249BD4(param0, DistortionWorldSystem_GetMapHeaderID(param0));
...
static int ov9_0224CCB8(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    UnkStruct_ov9_0224C8E8 *v1 = &param0->unk_1E88;
    const UnkStruct_ov9_022530A4 *v2 = ov9_0224D720(DistortionWorldSystem_GetMapHeaderID(param0));
...
static int ov9_0224CE80(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    ...
    v0 = ov9_0224D720(DistortionWorldSystem_GetMapHeaderID(param0));
...
static BOOL ov9_0224D040(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    UnkStruct_ov9_0224E0DC *v0 = ov9_0224E188(param0, param1, param2, param3, DistortionWorldSystem_GetMapHeaderID(param0));
...
static void ov9_0224DCA8(DistortionWorldSystem *param0)
{
    if (IsPersistedDataValid(param0) == 1) {
        ...
        u32 v4 = DistortionWorldSystem_GetMapHeaderID(param0);
...
static MapObject *ov9_0224DE94(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4, int param5, u32 param6)
{
    MapObject *v0 = MapObjectMan_AddMapObject(param0->fieldSystem->mapObjMan, param1, param3, 0, 0x2000, 0x0, DistortionWorldSystem_GetMapHeaderID(param0));
...
static BOOL ov9_0224E434(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    ...
    const UnkStruct_ov9_02252044 *v1 = ov9_0224E410(DistortionWorldSystem_GetMapHeaderID(param0));
...
static int ov9_0224E550(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    ...
    v1->unk_24 = ov9_0224DE08(param0, v0->unk_00, DistortionWorldSystem_GetMapHeaderID(param0));
...
static void ov9_0224EB68(DistortionWorldSystem *param0)
{
    ...
    u32 v1 = DistortionWorldSystem_GetMapHeaderID(param0);
...
static void GetPlayerPos(DistortionWorldSystem *system, int *playerX, int *playerY, int *playerZ)
{
    MapObject *mapObj = Player_MapObject(system->fieldSystem->playerAvatar);
...
BOOL ov9_022511A0(FieldSystem *fieldSystem, int param1, int param2, int param3)
{
    ...
    if (DistortionWorldSystem_GetMapHeaderID(v0) == 582) {
