...
#define MAP_OBJECT_LOCAL_ID(offset)     (MAP_OBJECT_BASE_LOCAL_ID + offset)
...
enum MapObjectEvent1FLocalID {
    MAP_OBJECT_1F_CYNTHIA_PORTAL = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_1F_CYNTHIA_ELEVATOR = MAP_OBJECT_LOCAL_ID(1),
};

enum MapObjectEventB1FLocalID {
    MAP_OBJECT_B1F_CYNTHIA_ELEVATOR = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B1F_MESPRIT = MAP_OBJECT_LOCAL_ID(1),
};

enum MapObjectEventB2FLocalID {
    MAP_OBJECT_B2F_CYNTHIA_1 = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B2F_CYNTHIA_2 = MAP_OBJECT_LOCAL_ID(0),
};

enum MapObjectEventB3FLocalID {
    MAP_OBJECT_B3F_CYRUS = MAP_OBJECT_LOCAL_ID(0),
};

enum MapObjectEventB4FLocalID {
    MAP_OBJECT_B4F_CYRUS = MAP_OBJECT_LOCAL_ID(6),
};

enum MapObjectEventB5FLocalID {
    MAP_OBJECT_B5F_MESPRIT_BOULDER = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B5F_AZELF_BOULDER = MAP_OBJECT_LOCAL_ID(1),
    MAP_OBJECT_B5F_UXIE_BOULDER = MAP_OBJECT_LOCAL_ID(2),
    MAP_OBJECT_B5F_UXIE = MAP_OBJECT_LOCAL_ID(3),
    MAP_OBJECT_B5F_AZELF = MAP_OBJECT_LOCAL_ID(4),
    MAP_OBJECT_B5F_MESPRIT = MAP_OBJECT_LOCAL_ID(5),
};

enum MapObjectEventB6FLocalID {
    MAP_OBJECT_B6F_MESPRIT_BOULDER_OUTSIDE = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B6F_AZELF_BOULDER_OUTSIDE = MAP_OBJECT_LOCAL_ID(1),
    MAP_OBJECT_B6F_UXIE_BOULDER_OUTSIDE = MAP_OBJECT_LOCAL_ID(2),
    MAP_OBJECT_B6F_MESPRIT = MAP_OBJECT_LOCAL_ID(3),
    MAP_OBJECT_B6F_UXIE = MAP_OBJECT_LOCAL_ID(4),
    MAP_OBJECT_B6F_AZELF = MAP_OBJECT_LOCAL_ID(5),
    MAP_OBJECT_B6F_CYNTHIA = MAP_OBJECT_LOCAL_ID(6),
    MAP_OBJECT_B6F_CYNTHIA_ELEVATOR = MAP_OBJECT_LOCAL_ID(6),
    MAP_OBJECT_B6F_MESPRIT_BOULDER_PIT_TEXT_1 = MAP_OBJECT_LOCAL_ID(7),
    MAP_OBJECT_B6F_MESPRIT_BOULDER_PIT_TEXT_2 = MAP_OBJECT_LOCAL_ID(8),
    MAP_OBJECT_B6F_MESPRIT_BOULDER_PIT_TEXT_3 = MAP_OBJECT_LOCAL_ID(9),
    MAP_OBJECT_B6F_UXIE_BOULDER_PIT_TEXT_1 = MAP_OBJECT_LOCAL_ID(10),
    MAP_OBJECT_B6F_UXIE_BOULDER_PIT_TEXT_2 = MAP_OBJECT_LOCAL_ID(11),
    MAP_OBJECT_B6F_UXIE_BOULDER_PIT_TEXT_3 = MAP_OBJECT_LOCAL_ID(12),
    MAP_OBJECT_B6F_AZELF_BOULDER_PIT_TEXT_1 = MAP_OBJECT_LOCAL_ID(13),
    MAP_OBJECT_B6F_AZELF_BOULDER_PIT_TEXT_2 = MAP_OBJECT_LOCAL_ID(14),
    MAP_OBJECT_B6F_AZELF_BOULDER_PIT_TEXT_3 = MAP_OBJECT_LOCAL_ID(15),
    MAP_OBJECT_B6F_MESPRIT_BOULDER_IN_PIT = MAP_OBJECT_LOCAL_ID(16),
    MAP_OBJECT_B6F_AZELF_BOULDER_IN_PIT = MAP_OBJECT_LOCAL_ID(17),
    MAP_OBJECT_B6F_UXIE_BOULDER_IN_PIT = MAP_OBJECT_LOCAL_ID(18),
};

enum MapObjectEventB7FLocalID {
    MAP_OBJECT_B7F_CYNTHIA_INITIAL = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B7F_CYNTHIA_TALKING = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B7F_CYNTHIA_POST_BATTLE = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_B7F_CYRUS_INITIAL = MAP_OBJECT_LOCAL_ID(1),
    MAP_OBJECT_B7F_CYRUS_TALKING = MAP_OBJECT_LOCAL_ID(1),
};

enum MapObjectEventGiratinaRoomLocalID {
    MAP_OBJECT_GIRATINA_ROOM_GIRATINA = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_GIRATINA_ROOM_CYNTHIA = MAP_OBJECT_LOCAL_ID(1),
    MAP_OBJECT_GIRATINA_ROOM_CYRUS = MAP_OBJECT_LOCAL_ID(2),
    MAP_OBJECT_GIRATINA_ROOM_PORTAL = MAP_OBJECT_LOCAL_ID(3),
    MAP_OBJECT_GIRATINA_ROOM_CYNTHIA_TEXT = MAP_OBJECT_LOCAL_ID(4),
};

enum MapObjectEventTurnbackCaveLocalID {
    MAP_OBJECT_TURNBACK_CAVE_PORTAL = MAP_OBJECT_LOCAL_ID(0),
    MAP_OBJECT_TURNBACK_CAVE_GRISEOUS_ORB_ITEM = MAP_OBJECT_LOCAL_ID(1),
};
...
static BOOL CheckFlagConditionForObjectEvent(DistWorldSystem *system, const DistWorldObjectEvent *objEvent, BOOL ignoreFlagCondFail);
static BOOL AddMapObjectFromEvent(DistWorldSystem *system, MapObject **mapObj, const DistWorldObjectEvent *objEvent, u32 mapHeaderID, u16 ignoreFlagCondFail);
...
static BOOL CheckFlagConditionForObjectEvent(DistWorldSystem *system, const DistWorldObjectEvent *objEvent, BOOL ignoreFlagCondFail)
{
    ...
    if (flagCond == FLAG_COND_FAIL) {
        if (ignoreFlagCondFail == FALSE) {
            return FALSE;
        }
    } else if (CheckFlagCondition(system, flagCond, flagCondVal) == FALSE) {
        return FALSE;
    }
...
static BOOL AddMapObjectFromEvent(DistWorldSystem *system, MapObject **mapObj, const DistWorldObjectEvent *objEvent, u32 mapHeaderID, u16 ignoreFlagCondFail)
{
    ...
    if (existingMapObj != NULL) {
        ...
        *mapObj = existingMapObj;
        ...
        if (CheckFlagConditionForObjectEvent(system, objEvent, ignoreFlagCondFail) == FALSE || FieldSystem_CheckFlag(system->fieldSystem, objEvent->objEvent.hiddenFlag) != FALSE) {
            return FALSE;
        }
