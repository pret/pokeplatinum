...
static void OpenArchives(DistortionWorldSystem *distortionWorldSystem);
static void CloseArchives(DistortionWorldSystem *distortionWorldSystem);
static void ov9_02249CC4(DistortionWorldSystem *param0);
static void SetPersistedCameraAngles(DistortionWorldSystem *distortionWorldSystem, u16 angleX, u16 angleY, u16 angleZ);
static void GetPersistedCameraAngles(DistortionWorldSystem *distortionWorldSystem, u16 *angleX, u16 *angleY, u16 *angleZ);
static BOOL IsPersistedDataValid(DistortionWorldSystem *distortionWorldSystem);
...
static void CameraInit(DistortionWorldSystem *distortionWorldSystem);
static void CameraFree(DistortionWorldSystem *distortionWorldSystem);
static void CameraTransitionTask(SysTask *sysTask, void *sysTaskParam);
static BOOL DoCameraTransition(DistortionWorldSystem *distortionWorldSystem, const DistortionWorldCameraAngleTemplate *cameraAngleTemplate);
...
static BOOL ApplyCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir);
...
static const UnkStruct_ov9_0224C034 *ov9_0224C034(DistortionWorldSystem *distortionWorldSystem, enum MapHeader mapHeaderID);
static u32 FindNARCIndex(DistortionWorldSystem *distortionWorldSystem, enum MapHeader mapHeaderID);
...
static void DistortionWorldFile_Load(DistortionWorldSystem *distortionWorldSystem, DistortionWorldFile *file, enum MapHeader mapHeaderID);
static void ov9_0224C0F8(DistortionWorldSystem *param0, enum MapHeader mapHeaderID, int param2);
static void ov9_0224C10C(DistortionWorldSystem *param0, enum MapHeader mapHeaderID);
static void ov9_0224C120(DistortionWorldSystem *param0, enum MapHeader mapHeaderID);
...
static void InitCameraAngleTemplates(DistortionWorldSystem *distortionWorldSystem);
static void ResetCameraAngleTemplates(DistortionWorldSystem *distortionWorldSystem);
static const DistortionWorldCameraAngleTemplate *FindCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir);
...
static void GetPlayerPos(DistortionWorldSystem *distortionWorldSystem, int *playerX, int *playerY, int *playerZ);
static u32 GetMapHeaderID(DistortionWorldSystem *distortionWorldSystem);
...
void DistortionWorld_DynamicMapFeaturesInit(FieldSystem *fieldSystem)
{
    ...
    OpenArchives(distortionWorldSystem);
    ...
    CameraInit(distortionWorldSystem);
...
BOOL DistortionWorld_DynamicMapFeaturesCheckCollision(FieldSystem *fieldSystem, const int tileX, const int tileZ, const fx32 height, BOOL *isColliding)
{
    ...
    u32 mapHeaderID = GetMapHeaderID(distortionWorldSystem);
...
static void CameraInit(DistortionWorldSystem *distortionWorldSystem)
{
    ...
    if (IsPersistedDataValid(distortionWorldSystem) == TRUE) {
        u16 angleX, angleY, angleZ;
        GetPersistedCameraAngles(distortionWorldSystem, &angleX, &angleY, &angleZ);
    ...
    if (GetMapHeaderID(distortionWorldSystem) != MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM) {
        Camera_AdjustFOV(DISTORTION_WORLD_NON_GIRATINA_ROOM_FOV_ADJUST, cameraMan->camera);
    }

    cameraMan->transitionTask = SysTask_Start(CameraTransitionTask, distortionWorldSystem, 0);
}
...
static BOOL DoCameraTransition(DistortionWorldSystem *distortionWorldSystem, const DistortionWorldCameraAngleTemplate *cameraAngleTemplate)
{
    ...
    SetPersistedCameraAngles(distortionWorldSystem, cameraAngleTemplate->angleX, cameraAngleTemplate->angleY, cameraAngleTemplate->angleZ);
...
BOOL ov9_0224A59C(FieldSystem *fieldSystem, int param1)
{
    ...
    if (PersistedMapFeatures_GetID(v0) == DYNAMIC_MAP_FEATURES_DISTORTION_WORLD) {
        ...
        if (ApplyCorrectCameraAngleForPlayer(v5, v1, v2, v3, param1) == 1) {
            (void)0;
        }
...
static BOOL ApplyCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir)
{
    const DistortionWorldCameraAngleTemplate *cameraAngleTemplate = FindCorrectCameraAngleForPlayer(distortionWorldSystem, playerX, playerY, playerZ, playerDir);

    if (cameraAngleTemplate == NULL) {
        return FALSE;
    }

    DoCameraTransition(distortionWorldSystem, cameraAngleTemplate);
    return TRUE;
}
...
static int ov9_0224B964(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (GetMapHeaderID(v3->unk_14) == v3->unk_02) {
...
static void ov9_0224BA6C(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
    ...
    u32 v4 = 0, v5 = GetMapHeaderID(v2->unk_14);
...

    {
        ...
        if (GetMapHeaderID(v2->unk_14) == v2->unk_02) {
...
static void ov9_0224BD18(UnkStruct_ov101_021D5D90 *param0, void *param1)
{
...

    {
        ...
        if (GetMapHeaderID(v1->unk_14) == v1->unk_02) {
...
static void ov9_0224BE14(DistortionWorldSystem *param0)
{
    ...
    mapHeaderID = GetMapHeaderID(param0);
...
static void DistortionWorldFile_Load(DistortionWorldSystem *distortionWorldSystem, DistortionWorldFile *file, enum MapHeader mapHeaderID)
{
    ...
    if (mapHeaderID != MAP_HEADER_COUNT) {
        ...
        narcIndex = FindNARCIndex(distortionWorldSystem, mapHeaderID);
...
static int ov9_0224CC90(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    ...
    ov9_02249BD4(param0, GetMapHeaderID(param0));
...
static int ov9_0224CCB8(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    FieldSystem *fieldSystem = param0->fieldSystem;
    UnkStruct_ov9_0224C8E8 *v1 = &param0->unk_1E88;
    const UnkStruct_ov9_022530A4 *v2 = ov9_0224D720(GetMapHeaderID(param0));
...
static int ov9_0224CE80(DistortionWorldSystem *param0, UnkStruct_ov9_0224CBD8 *param1)
{
    ...
    v0 = ov9_0224D720(GetMapHeaderID(param0));
...
static BOOL ov9_0224D040(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    UnkStruct_ov9_0224E0DC *v0 = ov9_0224E188(param0, param1, param2, param3, GetMapHeaderID(param0));
...
static MapObject *ov9_0224DE94(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4, int param5, u32 param6)
{
    MapObject *v0 = MapObjectMan_AddMapObject(param0->fieldSystem->mapObjMan, param1, param3, 0, 0x2000, 0x0, GetMapHeaderID(param0));
...
static BOOL ov9_0224E434(DistortionWorldSystem *param0, int param1, int param2, int param3)
{
    ...
    const UnkStruct_ov9_02252044 *v1 = ov9_0224E410(GetMapHeaderID(param0));
...
static int ov9_0224E550(DistortionWorldSystem *param0, FieldTask *param1, u16 *param2, const void *param3)
{
    ...
    v1->unk_24 = ov9_0224DE08(param0, v0->unk_00, GetMapHeaderID(param0));
