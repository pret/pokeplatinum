...
static void ov13_0221FCAC(SysTask *param0, void *param1)
{
    ...
    ov13_0222537C(v0);
    SpriteGfxHandler_UpdateCellActorCollection(v0->unk_1FB0);
    ov13_0222601C(v0);
}
    ...
    case 0:
        ...
        if (param0->unk_2076 == 5) {
            ...
            if (param0->unk_04[v0->unk_11].unk_17_3 == 7) {
                CellActorData_DrawSprite(param0->unk_1FB4[13 + v0->unk_11], 0);
...
static void ov13_02221A04(UnkStruct_ov13_022213F0 *param0)
{
    CellActorData_DrawSprite(param0->unk_1FB4[26], 0);
