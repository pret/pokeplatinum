...
static void ov13_02220F98 (UnkStruct_ov13_022213F0 * param0)
{
    ...
    for (v0 = 0; v0 < Party_GetCurrentCount(param0->unk_00->unk_00); v0++) {
        ...
        for (v1 = 0; v1 < 4; v1++) {
            ...
            v2->unk_04 = MoveTable_LoadAttribute(v2->unk_00, MOVEATTRIBUTE_TYPE);
            v2->unk_05 = MoveTable_LoadAttribute(v2->unk_00, MOVEATTRIBUTE_CLASS);
            v2->unk_06 = MoveTable_LoadAttribute(v2->unk_00, MOVEATTRIBUTE_ACCURACY);
            v2->unk_07 = MoveTable_LoadAttribute(v2->unk_00, MOVEATTRIBUTE_POWER);
        }
    }
}
...
static void ov13_02221654 (UnkStruct_ov13_022213F0 * param0, u8 param1)
{
    ...
    v0 = MoveTable_LoadAttribute(v2, MOVEATTRIBUTE_CONTEST_EFFECT);
