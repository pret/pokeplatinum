    ...
    if (ov16_0223E30C(v0->unk_08, v0->unk_28, v0->unk_2C[v0->unk_11], 0, v0->unk_22) == 1) {
        if (Item_LoadParam(v0->unk_22, 37, v0->unk_0C) != 0) {
            ...
            if ((ov13_022213F0(param0, v0->unk_11) == 1) && (Item_LoadParam(v0->unk_22, 23, v0->unk_0C) == 0)) {
                ...
                v0->unk_20 = GetMonData(param0->unk_04[v0->unk_11].unk_00, MON_DATA_CURRENT_HP, NULL);
...
static u8 ov13_022208A4 (UnkStruct_ov13_022213F0 * param0)
{
    ...
    case 0:
        ...
        if (param0->unk_2076 == 5) {
            ...
            param0->unk_207A = GetMonData(param0->unk_04[v0->unk_11].unk_00, MON_DATA_CURRENT_HP, NULL);
            param0->unk_2078 = 4;
        }
...
static void ov13_02220F98 (UnkStruct_ov13_022213F0 * param0)
{
    ...
    for (v0 = 0; v0 < Party_GetCurrentCount(param0->unk_00->unk_00); v0++) {
        ...
        param0->unk_04[v0].unk_06 = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_ATK, NULL);
        param0->unk_04[v0].unk_08 = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_DEF, NULL);
        param0->unk_04[v0].unk_0A = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_SPEED, NULL);
        param0->unk_04[v0].unk_0C = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_SP_ATK, NULL);
        param0->unk_04[v0].unk_0E = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_SP_DEF, NULL);
        param0->unk_04[v0].unk_10 = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_CURRENT_HP, NULL);
        param0->unk_04[v0].unk_12 = GetMonData(param0->unk_04[v0].unk_00, MON_DATA_MAX_HP, NULL);
        ...
        param0->unk_04[v0].unk_16_0 = (u8)GetMonData(param0->unk_04[v0].unk_00, MON_DATA_LEVEL, NULL);
        ...
        param0->unk_04[v0].unk_17_0 = GetMonGender(param0->unk_04[v0].unk_00);
        ...
        param0->unk_04[v0].unk_18 = (u16)GetMonData(param0->unk_04[v0].unk_00, MON_DATA_ABILITY, NULL);
        ...
        param0->unk_04[v0].unk_20 = GetMonSpeciesLevelExp(param0->unk_04[v0].unk_04, param0->unk_04[v0].unk_16_0);

        if (param0->unk_04[v0].unk_16_0 == 100) {
            param0->unk_04[v0].unk_24 = param0->unk_04[v0].unk_20;
        } else {
            param0->unk_04[v0].unk_24 = GetMonSpeciesLevelExp(param0->unk_04[v0].unk_04, param0->unk_04[v0].unk_16_0 + 1);
        }
...
static u8 ov13_022217A4 (UnkStruct_ov13_022213F0 * param0)
{
    ...
    if (v0->unk_10 == 0) {
        ...
        sub_0200B5CC(param0->unk_1FA8, 0, GetBoxMon(v0->unk_00));
        sub_0200C388(param0->unk_1FA8, param0->unk_1FAC, v1);
        Strbuf_Free(v1);
        return 0;
    }
