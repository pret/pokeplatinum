...
static const BattleSubMenuButtonDimensions sButtonDimensions[] = {
    ...
    [BUTTON_MENU_SCREEN_LAST_USED_ITEM] = { .xCoord = 0, .yCoord = 19, .width = BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT },
    [BUTTON_MENU_SCREEN_CANCEL] = { .xCoord = 27, .yCoord = 19, .width = BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT },
    ...
    [BUTTON_POCKET_MENU_SCREEN_PREV_PAGE] = { .xCoord = 32, .yCoord = 19, .width = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT },
    [BUTTON_POCKET_MENU_SCREEN_NEXT_PAGE] = { .xCoord = 37, .yCoord = 19, .width = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT },
    [BUTTON_POCKET_MENU_SCREEN_CANCEL] = { .xCoord = 59, .yCoord = 19, .width = BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT },
    [BUTTON_USE_ITEM_SCREEN_USE] = { .xCoord = 0, .yCoord = 51, .width = BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT },
    [BUTTON_USE_ITEM_SCREEN_CANCEL] = { .xCoord = 27, .yCoord = 51, .width = BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT }
};
...
{
    LoadButtonData(battleBag->menuPocketButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, 0, MENU_POCKET_BUTTON_WIDTH, MENU_POCKET_BUTTON_HEIGHT);
    LoadButtonData(battleBag->menuPocketButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, MENU_POCKET_BUTTON_HEIGHT, MENU_POCKET_BUTTON_WIDTH, MENU_POCKET_BUTTON_HEIGHT);
    LoadButtonData(battleBag->menuPocketButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, MENU_POCKET_BUTTON_HEIGHT * 2, MENU_POCKET_BUTTON_WIDTH, MENU_POCKET_BUTTON_HEIGHT);

    LoadButtonData(battleBag->useItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, USE_ITEM_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->useItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, USE_ITEM_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->useItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, USE_ITEM_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT * 2, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->useItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, 0, USE_ITEM_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT * 2, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);

    LoadButtonData(battleBag->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, CANCEL_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);
    LoadButtonData(battleBag->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, CANCEL_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);
    LoadButtonData(battleBag->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH * 2, CANCEL_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);

    LoadButtonData(battleBag->pocketItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, POCKET_ITEM_BUTTON_DATA_X_OFFSET, 0, POCKET_ITEM_BUTTON_WIDTH, POCKET_ITEM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, POCKET_ITEM_BUTTON_DATA_X_OFFSET, POCKET_ITEM_BUTTON_HEIGHT, POCKET_ITEM_BUTTON_WIDTH, POCKET_ITEM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, POCKET_ITEM_BUTTON_DATA_X_OFFSET, POCKET_ITEM_BUTTON_HEIGHT * 2, POCKET_ITEM_BUTTON_WIDTH, POCKET_ITEM_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketItemButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, POCKET_ITEM_BUTTON_DATA_X_OFFSET, POCKET_ITEM_BUTTON_HEIGHT * 3, POCKET_ITEM_BUTTON_WIDTH, POCKET_ITEM_BUTTON_HEIGHT);

    LoadButtonData(battleBag->pocketPrevPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, POCKET_MENU_PREV_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketPrevPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, POCKET_MENU_PREV_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketPrevPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 2, POCKET_MENU_PREV_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketPrevPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 3, POCKET_MENU_PREV_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);

    LoadButtonData(battleBag->pocketNextPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, POCKET_MENU_NEXT_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketNextPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, POCKET_MENU_NEXT_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketNextPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 2, POCKET_MENU_NEXT_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleBag->pocketNextPageButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 3, POCKET_MENU_NEXT_PAGE_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);

    LoadButtonData(battleBag->menuScreenRecoverHPPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET, MENU_POCKET_ICON_DATA_Y_OFFSET, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenRecoverHPPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_DATA_Y_OFFSET, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenRecoverHPPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH * 2, MENU_POCKET_ICON_DATA_Y_OFFSET, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);

    LoadButtonData(battleBag->menuScreenRecoverStatusPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenRecoverStatusPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenRecoverStatusPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH * 2, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);

    LoadButtonData(battleBag->menuScreenPokeBallsPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 2, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenPokeBallsPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 2, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenPokeBallsPocketIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH * 2, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 2, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);

    LoadButtonData(battleBag->menuScreenBattleItemsIconData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 3, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenBattleItemsIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 3, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
    LoadButtonData(battleBag->menuScreenBattleItemsIconData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, MENU_POCKET_ICON_DATA_X_OFFSET + MENU_POCKET_ICON_WIDTH * 2, MENU_POCKET_ICON_DATA_Y_OFFSET + MENU_POCKET_ICON_HEIGHT * 3, MENU_POCKET_ICON_WIDTH, MENU_POCKET_ICON_HEIGHT);
}
