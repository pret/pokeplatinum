...
static void ov13_02222AF4(UnkStruct_ov13_022213F0 *param0, u32 param1)
{
    ...
    v0 = &param0->unk_04[param1];
    v3 = 22 * param0->unk_2071;
    v1 = MessageLoader_Init(MESSAGE_LOADER_NARC_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 612, param0->unk_00->heapID);
...
static void ov13_02222DCC(UnkStruct_ov13_022213F0 *param0, u32 param1, u32 param2)
{
    ...
    v0 = MessageLoader_Init(MESSAGE_LOADER_NARC_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 646, param0->unk_00->heapID);
...
static void ov13_02222E2C(UnkStruct_ov13_022213F0 *param0, u32 param1, u32 param2)
{
    ...
    v4 = sub_0209577C(v3);
    v0 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 210, param0->unk_00->heapID);
