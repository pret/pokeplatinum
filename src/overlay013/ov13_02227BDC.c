...
static void ov13_02227D10(BattleBagTask *param0, u16 param1, u32 param2);
static void ov13_02227D48(BattleBagTask *param0, u16 param1, u16 param2, u32 param3);
static void ov13_02227DE8(BattleBagTask *param0);
static void ov13_02227EAC(BattleBagTask *param0);
static void ov13_02227EE0(BattleBagTask *param0);
static void ov13_02227F38(BattleBagTask *param0);
...
static void ov13_02227D48(BattleBagTask *param0, u16 param1, u16 param2, u32 param3)
{
    PaletteData_LoadBufferFromFileStart(param0->palette, 16, Item_FileID(param1, 2), param0->battleInfo->heapID, 3, 0x20, param2 * 16);
}
...
static void ov13_02227F38(BattleBagTask *param0)
{
    u16 v0 = GetBattleBagItem(param0, param0->battleInfo->pocketCurrentPagePositions[param0->currentBattlePocket]);
...
static void ov13_02227F7C(BattleBagTask *param0)
{
    ...
    v0 = ov16_0223E010(param0->battleInfo->battleSystem);
    ov16_0226DB7C(v0, param0->spriteManager, param0->palette, param0->battleInfo->heapID, 46270, 46270, 46265, 46265);
    v1 = ov16_0226DC24(v0, param0->spriteManager, param0->battleInfo->heapID, 46270, 46270, 46265, 46265, 0, 1);
...
static void ov13_02228070(BattleBagTask *param0)
{
    ...
    ov16_0226DE44(v0, param0->spriteManager, param0->battleInfo->heapID, param0->palette, 46269, 46269, 46264, 46264);
    param0->unk_38 = ov16_0226DEEC(v0, param0->spriteManager, param0->battleInfo->heapID, 46269, 46269, 46264, 46264, 0, 0);
}
