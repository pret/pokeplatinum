...
static void ov13_0222754C (UnkStruct_ov13_02227244 * param0, u32 param1, u32 param2, u32 param3, u32 param4, u32 param5, u32 param6)
{
    ...
    if (param0->unk_3C[param0->unk_114D][param1].quantity != 0) {
        ...
        StringTemplate_FormatNumber(param0->unk_14, 0, param0->unk_3C[param0->unk_114D][param1].quantity, 3, 0, 1);
...
void ov13_02227698 (UnkStruct_ov13_02227244 * param0)
{
    ...
    StringTemplate_FormatNumber(param0->unk_14, 0, param0->unk_1154[param0->unk_114D] + 1, 2, 0, 1);
    StringTemplate_Format(param0->unk_14, param0->unk_18, v1);
    ...
    StringTemplate_FormatNumber(param0->unk_14, 0, param0->unk_00->unk_2C[param0->unk_114D] + 1, 2, 0, 1);
    StringTemplate_Format(param0->unk_14, param0->unk_18, v1);
