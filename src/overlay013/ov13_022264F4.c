...
static u8 ov13_0222668C(UnkStruct_ov13_02227244 *param0)
{
    ...
    param0->currentBattlePocket = (u8)BagCursor_GetBattleCurrentCategory(BattleSystem_BagCursor(param0->unk_00->unk_00));
...

    {
        ...
        case 4:
            if (param0->unk_00->lastUsedItem != ITEM_NONE) {
                Sound_PlayEffect(SEQ_SE_DP_DECIDE);
                param0->currentBattlePocket = param0->unk_00->lastUsedItemPocket;
                param0->unk_114B = 6;
...
{
    {
        ...
        case 5:
            if (GetBattleBagItem(param0, v0) != ITEM_NONE) {
                Sound_PlayEffect(SEQ_SE_DP_DECIDE);
                param0->unk_00->pocketCurrentPagePositions[param0->currentBattlePocket] = (u8)v0;
                param0->unk_114B = 6;
...
static u8 ov13_02226948(UnkStruct_ov13_02227244 *param0)
{
    s8 v0 = param0->unk_00->pocketCurrentPages[param0->currentBattlePocket];

    param0->unk_00->pocketCurrentPagePositions[param0->currentBattlePocket] = 0;
    v0 += param0->unk_114E;

    if (v0 > param0->numBattlePocketPages[param0->currentBattlePocket]) {
        param0->unk_00->pocketCurrentPages[param0->currentBattlePocket] = 0;
    } else if (v0 < 0) {
        param0->unk_00->pocketCurrentPages[param0->currentBattlePocket] = param0->numBattlePocketPages[param0->currentBattlePocket];
    } else {
        param0->unk_00->pocketCurrentPages[param0->currentBattlePocket] = v0;
    }
...
{
    {
        ...
        case 0:
            Sound_PlayEffect(SEQ_SE_DP_DECIDE);
            param0->unk_00->unk_1C = GetBattleBagItem(param0, param0->unk_00->pocketCurrentPagePositions[param0->currentBattlePocket]);
            param0->unk_00->unk_1E = param0->currentBattlePocket;
...
static u8 ov13_02226A5C(UnkStruct_ov13_02227244 *param0)
{
    ...
    if (param0->currentBattlePocket == ITEM_BATTLE_CATEGORY_BATTLE_ITEMS) {
        ...
        if (BattleSystem_UseBagItem(v0->unk_00, v0->unk_10, v1, 0, v0->unk_1C) == 1) {
            ov13_02227260(v0->unk_00, v0->unk_1C, param0->currentBattlePocket, v0->heapID);
            return 13;
        } else if (v2 == 3) {
...
static void ov13_0222717C(UnkStruct_ov13_02227244 *param0, u8 param1)
{
    ...
    Bg_ChangeTilemapRectPalette(param0->unk_04, 6, 2, 35, 28, 4, 8 + param0->currentBattlePocket);
    Bg_ChangeTilemapRectPalette(param0->unk_04, 6, 2, 40, 28, 8, 8 + param0->currentBattlePocket);
}
