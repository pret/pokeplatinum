...
static const BattleSubMenuButtonDimensions sButtonDimensions[] = {
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_1] = { .xCoord = 0, .yCoord = 0, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_2] = { .xCoord = 16, .yCoord = 1, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_3] = { .xCoord = 0, .yCoord = 6, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_4] = { .xCoord = 16, .yCoord = 7, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_5] = { .xCoord = 0, .yCoord = 12, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_POKEMON_PARTY_SCREEN_POKEMON_6] = { .xCoord = 16, .yCoord = 13, .width = PARTY_POKEMON_BUTTON_WIDTH, .height = PARTY_POKEMON_BUTTON_HEIGHT },
    [BUTTON_CANCEL] = { .xCoord = 27, .yCoord = 19, .width = BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT },
    [BUTTON_SELECT_POKEMON_SCREEN_SHIFT] = { .xCoord = 1, .yCoord = 1, .width = SHIFT_POKEMON_BUTTON_WIDTH, .height = SHIFT_POKEMON_BUTTON_HEIGHT },
    [BUTTON_SELECT_POKEMON_SCREEN_SUMMARY] = { .xCoord = 0, .yCoord = 19, .width = SUMMARY_CHECK_MOVES_BUTTON_WIDTH, .height = SUMMARY_CHECK_MOVES_BUTTON_HEIGHT },
    [BUTTON_POKEMON_MOVES_SCREEN_SUMMARY] = { .xCoord = 12, .yCoord = 19, .width = SUMMARY_CHECK_MOVES_BUTTON_WIDTH, .height = SUMMARY_CHECK_MOVES_BUTTON_HEIGHT },
    [BUTTON_SELECT_POKEMON_SCREEN_CHECK_MOVES] = { .xCoord = 13, .yCoord = 19, .width = SUMMARY_CHECK_MOVES_BUTTON_WIDTH, .height = SUMMARY_CHECK_MOVES_BUTTON_HEIGHT },
    [BUTTON_POKEMON_SUMMARY_SCREEN_CHECK_MOVES] = { .xCoord = 12, .yCoord = 19, .width = SUMMARY_CHECK_MOVES_BUTTON_WIDTH, .height = SUMMARY_CHECK_MOVES_BUTTON_HEIGHT },
    [BUTTON_PREV_POKEMON] = { .xCoord = 0, .yCoord = 19, .width = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT },
    [BUTTON_NEXT_POKEMON] = { .xCoord = 5, .yCoord = 19, .width = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT },
    [BUTTON_POKEMON_MOVES_SCREEN_MOVE_1] = { .xCoord = 0, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_POKEMON_MOVES_SCREEN_MOVE_2] = { .xCoord = 16, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_POKEMON_MOVES_SCREEN_MOVE_3] = { .xCoord = 0, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_POKEMON_MOVES_SCREEN_MOVE_4] = { .xCoord = 16, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_CONTEST_STATS] = { .xCoord = 23, .yCoord = 0, .width = CONTEST_STATS_BUTTON_WIDTH, .height = CONTEST_STATS_BUTTON_HEIGHT },
    [BUTTON_RESTORE_MOVE_PP_SCREEN_MOVE_1] = { .xCoord = 0, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_RESTORE_MOVE_PP_SCREEN_MOVE_2] = { .xCoord = 16, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_RESTORE_MOVE_PP_SCREEN_MOVE_3] = { .xCoord = 0, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_RESTORE_MOVE_PP_SCREEN_MOVE_4] = { .xCoord = 16, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_LEARN_MOVE_SCREEN_MOVE_1] = { .xCoord = 0, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_LEARN_MOVE_SCREEN_MOVE_2] = { .xCoord = 16, .yCoord = 6, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_LEARN_MOVE_SCREEN_MOVE_3] = { .xCoord = 0, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_LEARN_MOVE_SCREEN_MOVE_4] = { .xCoord = 16, .yCoord = 12, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_LEARN_MOVE_SCREEN_MOVE_TO_LEARN] = { .xCoord = 8, .yCoord = 18, .width = MOVE_BUTTON_WIDTH, .height = MOVE_BUTTON_HEIGHT },
    [BUTTON_CONFIRM_LEARN_MOVE_SCREEN_CONFIRM] = { .xCoord = 0, .yCoord = 19, .width = BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT },
    [BUTTON_CONFIRM_LEARN_MOVE_CONTEST_STATS_SCREEN_CONFIRM] = { .xCoord = 0, .yCoord = 19, .width = BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, .height = BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT },
    [BUTTON_MOVE_SUMMARY_SCREEN_MOVE_1] = { .xCoord = 11, .yCoord = 19, .width = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, .height = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT },
    [BUTTON_MOVE_SUMMARY_SCREEN_MOVE_2] = { .xCoord = 16, .yCoord = 19, .width = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, .height = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT },
    [BUTTON_MOVE_SUMMARY_SCREEN_MOVE_3] = { .xCoord = 11, .yCoord = 21, .width = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, .height = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT },
    [BUTTON_MOVE_SUMMARY_SCREEN_MOVE_4] = { .xCoord = 16, .yCoord = 21, .width = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, .height = MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT }
};
...
{
    LoadButtonData(battleParty->partyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, 0, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->partyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, PARTY_POKEMON_BUTTON_HEIGHT, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->partyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, PARTY_POKEMON_BUTTON_HEIGHT * 2, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->partyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, 0, PARTY_POKEMON_BUTTON_HEIGHT * 3, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);

    LoadButtonData(battleParty->altPartyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, ALT_PARTY_POKEMON_BUTTON_DATA_X_OFFSET, 0, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->altPartyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, ALT_PARTY_POKEMON_BUTTON_DATA_X_OFFSET, PARTY_POKEMON_BUTTON_HEIGHT, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->altPartyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, ALT_PARTY_POKEMON_BUTTON_DATA_X_OFFSET, PARTY_POKEMON_BUTTON_HEIGHT * 2, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->altPartyPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, ALT_PARTY_POKEMON_BUTTON_DATA_X_OFFSET, PARTY_POKEMON_BUTTON_HEIGHT * 3, PARTY_POKEMON_BUTTON_WIDTH, PARTY_POKEMON_BUTTON_HEIGHT);

    LoadButtonData(battleParty->summaryCheckMovesButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, SUMMARY_CHECK_MOVES_BUTTON_DATA_Y_OFFSET, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_HEIGHT);
    LoadButtonData(battleParty->summaryCheckMovesButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, SUMMARY_CHECK_MOVES_BUTTON_DATA_Y_OFFSET + SUMMARY_CHECK_MOVES_BUTTON_HEIGHT, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_HEIGHT);
    LoadButtonData(battleParty->summaryCheckMovesButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_DATA_Y_OFFSET, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_HEIGHT);
    LoadButtonData(battleParty->summaryCheckMovesButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_DATA_Y_OFFSET + SUMMARY_CHECK_MOVES_BUTTON_HEIGHT, SUMMARY_CHECK_MOVES_BUTTON_WIDTH, SUMMARY_CHECK_MOVES_BUTTON_HEIGHT);

    LoadButtonData(battleParty->prevPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, PREV_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->prevPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, PREV_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->prevPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 2, PREV_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->prevPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 3, PREV_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);

    LoadButtonData(battleParty->nextPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, NEXT_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->nextPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, NEXT_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->nextPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 2, NEXT_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);
    LoadButtonData(battleParty->nextPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH * 3, NEXT_POKEMON_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_WIDTH, BATTLE_SUB_MENU_PREV_NEXT_BUTTON_HEIGHT);

    LoadButtonData(battleParty->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, CANCEL_BUTTON_DATA_X_OFFSET, CANCEL_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);
    LoadButtonData(battleParty->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, CANCEL_BUTTON_DATA_X_OFFSET, CANCEL_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);
    LoadButtonData(battleParty->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, CANCEL_BUTTON_DATA_X_OFFSET, CANCEL_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT * 2, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);
    LoadButtonData(battleParty->cancelButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, CANCEL_BUTTON_DATA_X_OFFSET, CANCEL_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT * 3, BATTLE_SUB_MENU_CANCEL_BUTTON_WIDTH, BATTLE_SUB_MENU_CANCEL_BUTTON_HEIGHT);

    LoadButtonData(battleParty->learnMoveConfirmButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, LEARN_MOVE_CONFIRM_BUTTON_DATA_Y_OFFSET, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);
    LoadButtonData(battleParty->learnMoveConfirmButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, LEARN_MOVE_CONFIRM_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);
    LoadButtonData(battleParty->learnMoveConfirmButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, LEARN_MOVE_CONFIRM_BUTTON_DATA_Y_OFFSET + BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT * 2, BATTLE_SUB_MENU_CONFIRM_BUTTON_WIDTH, BATTLE_SUB_MENU_CONFIRM_BUTTON_HEIGHT);

    LoadButtonData(battleParty->contestStatsButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, CONTEST_STATS_BUTTON_DATA_X_OFFSET, CONTEST_STATS_BUTTON_DATA_Y_OFFSET, CONTEST_STATS_BUTTON_WIDTH, CONTEST_STATS_BUTTON_HEIGHT);
    LoadButtonData(battleParty->contestStatsButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, CONTEST_STATS_BUTTON_DATA_X_OFFSET, CONTEST_STATS_BUTTON_DATA_Y_OFFSET + CONTEST_STATS_BUTTON_HEIGHT, CONTEST_STATS_BUTTON_WIDTH, CONTEST_STATS_BUTTON_HEIGHT);
    LoadButtonData(battleParty->contestStatsButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, CONTEST_STATS_BUTTON_DATA_X_OFFSET, CONTEST_STATS_BUTTON_DATA_Y_OFFSET + CONTEST_STATS_BUTTON_HEIGHT * 2, CONTEST_STATS_BUTTON_WIDTH, CONTEST_STATS_BUTTON_HEIGHT);

    LoadButtonData(battleParty->moveSummaryScreenMoveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_DATA_Y_OFFSET, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT);
    LoadButtonData(battleParty->moveSummaryScreenMoveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_DATA_Y_OFFSET, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT);
    LoadButtonData(battleParty->moveSummaryScreenMoveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH * 2, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_DATA_Y_OFFSET, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_WIDTH, MOVE_SUMMARY_SCREEN_MOVE_BUTTON_HEIGHT);
}

void BattlePartyButtons_InitializeAdditionalButtonData(BattleParty *battleParty, u16 *screenData)
{
    LoadButtonData(battleParty->shiftPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, 0, SHIFT_POKEMON_BUTTON_WIDTH, SHIFT_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->shiftPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, 0, SHIFT_POKEMON_BUTTON_HEIGHT, SHIFT_POKEMON_BUTTON_WIDTH, SHIFT_POKEMON_BUTTON_HEIGHT);
    LoadButtonData(battleParty->shiftPokemonButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, SHIFT_POKEMON_BUTTON_HEIGHT * 2, SHIFT_POKEMON_BUTTON_WIDTH, SHIFT_POKEMON_BUTTON_HEIGHT);

    LoadButtonData(battleParty->moveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_UNPRESSED], screenData, 0, MOVE_BUTTON_DATA_Y_OFFSET, MOVE_BUTTON_WIDTH, MOVE_BUTTON_HEIGHT);
    LoadButtonData(battleParty->moveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSING], screenData, MOVE_BUTTON_WIDTH, MOVE_BUTTON_DATA_Y_OFFSET, MOVE_BUTTON_WIDTH, MOVE_BUTTON_HEIGHT);
    LoadButtonData(battleParty->moveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_PRESSED], screenData, 0, MOVE_BUTTON_DATA_Y_OFFSET + MOVE_BUTTON_HEIGHT, MOVE_BUTTON_WIDTH, MOVE_BUTTON_HEIGHT);
    LoadButtonData(battleParty->moveButtonData[BATTLE_SUB_MENU_BUTTON_STATE_DISABLED], screenData, MOVE_BUTTON_WIDTH, MOVE_BUTTON_DATA_Y_OFFSET + MOVE_BUTTON_HEIGHT, MOVE_BUTTON_WIDTH, MOVE_BUTTON_HEIGHT);
}
