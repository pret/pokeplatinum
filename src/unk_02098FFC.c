...
UnkStruct_0209903C * sub_02098FFC (int param0, u16 param1, u16 param2, u16 param3, int param4)
{
    ...
    v0 = sub_02018144(param0, sizeof(UnkStruct_0209903C));
...
static void sub_02099058 (UnkStruct_0209903C * param0)
{
    ...
    param0->unk_1C4 = sub_02018144(param0->unk_00, sizeof(UnkStruct_0209903C_sub1));
...
UnkStruct_0209916C * sub_0209916C (UnkStruct_0209903C * param0, int param1, u16 param2, u16 param3, u16 param4, u8 param5, u8 param6, int param7)
{
    ...
    v3 = sub_02018144(param0->unk_00, sizeof(UnkStruct_0209916C));
    ...
    v4 = sub_02018144(param0->unk_00, sizeof(UnkStruct_0200D0F4));

    v4->unk_08 = sub_02018144(param0->unk_00, sizeof(UnkStruct_02009508));
    v4->unk_08->unk_00 = sub_02018144(param0->unk_00, sizeof(UnkStruct_ov19_021DA864));
...
static void sub_020993A8 (UnkStruct_0209903C * param0)
{
    ...
    v4 = sub_02006C24(88, param0->unk_00);
