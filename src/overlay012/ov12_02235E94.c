...
void ov12_02236030 (UnkStruct_ov12_02235FE0 * param0, const UnkStruct_ov12_02236030 * param1)
{
    ...
    param0->unk_9C = GetMonData(param0->unk_04.unk_08, 162, NULL);
    ...
    if (param0->unk_9C == 0) {
        ...
        if (param0->unk_04.unk_04 != 0) {
            ...
            param0->unk_98 = GetMonData(param0->unk_04.unk_08, 155, NULL);
        }
    } else {
        param0->unk_94 = 1;
        GetMonData(param0->unk_04.unk_08, 171, &param0->unk_A0);
    }
}
