...
void ov12_0222D7C0(UnkStruct_ov12_0221FCDC *param0, SpriteSystem *param1, SpriteManager *param2, CellActorData *param3)
{
    ...
    if (ov12_0223525C(param0, ov12_02220248(param0)) == 0x3) {
        if ((ov12_0223525C(param0, ov12_02220248(param0)) == 0x3) && (ov12_0223525C(param0, ov12_02220240(param0)) == 0x3)) {
            Sprite_SetAnim(v1->unk_14[0], 0);
        } else {
            Sprite_SetAnim(v1->unk_14[0], 1);
        }

        Sprite_SetPositionXY2(v1->unk_14[0], 128, 80);
    } else {
    ...
    for (v0 = 0; v0 < v1->unk_05; v0++) {
        ...
        if (ov12_0221FDD4(v1->unk_08) == 1) {
            Sprite_SetAffineScale(v1->unk_14[v0], -1.0f, 1.0f);
        }
    }
...
static void ov12_0222D934(SysTask *param0, void *param1)
{
    ...
    case 1:
        ...
        case 0:
            ...
            Sprite_SetDrawFlag2(v2->unk_34, 1);
            Sprite_SetDrawFlag2(v2->unk_38, 1);
            break;
        case 1:
...

        {
            ...
            Sprite_GetPositionXY2(v2->unk_34, &v3, &v4);
            ...
            Sprite_GetPositionXY2(v2->unk_38, &v3, &v4);
    ...
    case 2: {
        ...
        if (v5 >= 2) {
            if (v2->unk_30 <= 3) {
                Sprite_SetDrawFlag2(v2->unk_34, 0);
                Sprite_SetDrawFlag2(v2->unk_38, 0);
                v2->unk_00--;
            } else {
                v2->unk_00++;
            }
...
void ov12_0222DB60(UnkStruct_ov12_0221FCDC *param0, SpriteSystem *param1, SpriteManager *param2, CellActorData *param3)
{
    ...
    Sprite_SetAnim(v1->unk_18[0], 0);
    Sprite_SetAnim(v1->unk_18[1], 0);
    Sprite_SetAnim(v1->unk_18[2], 1);
    Sprite_SetAnim(v1->unk_18[3], 1);
    Sprite_SetAnim(v1->unk_18[4], 2);
    Sprite_SetAnim(v1->unk_18[5], 3);
    Sprite_SetFlipMode2(v1->unk_18[0], 1);
    Sprite_SetFlipMode2(v1->unk_18[3], 1);

    for (v0 = 0; v0 < v1->unk_08; v0++) {
        Sprite_SetAnimateFlag(v1->unk_18[v0], 1);
        Sprite_SetPositionXY2(v1->unk_18[v0], Unk_ov12_0223A162[v0].unk_00, Unk_ov12_0223A162[v0].unk_02);
        Sprite_SetExplicitOamMode2(v1->unk_18[v0], GX_OAM_MODE_XLU);
    }

    Sprite_SetDrawFlag2(v1->unk_18[1], 0);
    Sprite_SetDrawFlag2(v1->unk_18[2], 0);
    Sprite_SetDrawFlag2(v1->unk_18[4], 0);
    Sprite_SetDrawFlag2(v1->unk_18[5], 0);
...
static void ov12_0222DC98(SysTask *param0, void *param1)
{
    ...
    case 2:
        if ((++v0->unk_0D) <= 3) {
            v0->unk_38 += 0.1f;
            Sprite_SetAffineScale(v0->unk_10, v0->unk_38, v0->unk_38);
        } else {
            v0->unk_0D = 0;
            v0->unk_0C++;
        }
    ...
    case 6: {
        ...
        Sprite_GetPositionXY2(v0->unk_10, &v1.unk_00, &v1.unk_02);
...
void ov12_0222E1A8(UnkStruct_ov12_0221FCDC *param0)
{
    ...
    Sprite_SetExplicitOamMode2(v0->unk_20, GX_OAM_MODE_OBJWND);
...
{
    if (Sprite_GetDrawFlag2(param0) == 1) {
        Sprite_TickOneFrame(param0);
    }
}
...
static void ov12_0222E25C(SysTask *param0, void *param1)
{
...

    {
        ...
        for (v1 = 0; v1 < 4; v1++) {
            ...
            if (v0->unk_1E[v1] >= 40) {
                Sprite_SetDrawFlag2(v0->unk_28[v1], 0);
                v2++;
            }
        }
...
void ov12_0222E2F8(UnkStruct_ov12_0221FCDC *param0, SpriteSystem *param1, SpriteManager *param2, CellActorData *param3)
{
...

    {
        ...
        Sprite_SetFlipMode2(v0->unk_28[0], 1);
        Sprite_SetFlipMode2(v0->unk_28[1], 1);

        {
            UnkStruct_ov12_02235350 v3;
        }

        Sprite_OffsetPositionXY2(v0->unk_28[0], -32, 0);
        Sprite_OffsetPositionXY2(v0->unk_28[1], -32, +32);
        Sprite_OffsetPositionXY2(v0->unk_28[2], +32, 0);
        Sprite_OffsetPositionXY2(v0->unk_28[3], +32, +32);
    }
...

    {
        ...
        for (v1 = 0; v1 < 4; v1++) {
            ...
            if (v0->unk_22[0] == 110) {
                ...
                Sprite_SetExplicitOamMode2(v0->unk_2C[0], GX_OAM_MODE_XLU);
                Sprite_SetExplicitOamMode2(v0->unk_2C[1], GX_OAM_MODE_XLU);
                Sprite_SetExplicitOamMode2(v0->unk_2C[2], GX_OAM_MODE_XLU);
                Sprite_SetExplicitOamMode2(v0->unk_2C[3], GX_OAM_MODE_XLU);
...
void ov12_0222E61C(UnkStruct_ov12_0221FCDC *param0, SpriteSystem *param1, SpriteManager *param2, CellActorData *param3)
{
...

    {
        ...
        Sprite_SetFlipMode2(v0->unk_2C[1], 1);
        Sprite_SetFlipMode2(v0->unk_2C[2], 1);

        {
            ...
            for (v1 = 0; v1 < 4; v1++) {
                Sprite_SetPositionXY2(v0->unk_2C[v1], v5, v6);
            }
        }
        ...
        if (ov12_0223525C(param0, ov12_02220240(param0)) == 0x3) {
            ...
            Sprite_SetPriority(v0->unk_2C[0], 10);
            Sprite_SetPriority(v0->unk_2C[2], 10);
            Sprite_SetPriority(v0->unk_2C[1], 18);
            Sprite_SetPriority(v0->unk_2C[3], 18);
        } else {
            v3 = 0;
            v2 = 8;

            Sprite_SetPriority(v0->unk_2C[0], 18);
            Sprite_SetPriority(v0->unk_2C[2], 18);
            Sprite_SetPriority(v0->unk_2C[1], 10);
            Sprite_SetPriority(v0->unk_2C[3], 10);
        }

        v2 = 4;
        v3 = 0;

        Sprite_OffsetPositionXY2(v0->unk_2C[0], -32, +v3);
        Sprite_OffsetPositionXY2(v0->unk_2C[3], -40, +v2);
        Sprite_OffsetPositionXY2(v0->unk_2C[2], +32, +v3);
        Sprite_OffsetPositionXY2(v0->unk_2C[1], +40, +v2);
    }

    v0->unk_1C = Sprite_GetExplicitPaletteOffset(v0->unk_2C[0]);
