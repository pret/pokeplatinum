...
void ov12_0222EAA0(UnkStruct_ov12_0221FCDC *param0)
{
...

    {
        ...
        v1 = v0->unk_1C.unk_0C;
        CellActorData_SetExplicitPriority(v1, ov12_0222339C(v0->unk_00.unk_04) + 1);
        v2 = sub_0201FAB4(CellActor_GetPaletteProxy(v1->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
        ...
        CellActorData_SetExplicitOAMMode(v1, GX_OAM_MODE_XLU);
...
static void ov12_0222EC18(SysTask *param0, void *param1)
{
...

    {
        ...
        for (v1 = 0; v1 < 8; v1++) {
            ...
            if (v0->unk_1E[v1] >= 160) {
                CellActorData_DrawSprite(v0->unk_30[v1], 0);
                v2++;
            }
        }
        ...
        if (v2 == 8) {
            for (v1 = 0; v1 < 8; v1++) {
                CellActorData_Delete(v0->unk_30[v1]);
            }
...
void ov12_0222EC90(UnkStruct_ov12_0221FCDC *param0, SpriteRenderer *param1, SpriteGfxHandler *param2, CellActorData *param3)
{
...

    {
...

        {
            ...
            for (v1 = 1; v1 < 8; v1++) {
                v0->unk_30[v1] = CellActor_LoadResources(v0->unk_00.unk_08, v0->unk_00.unk_10, &v4);

                if (v1 % 2) {
                    CellActorData_SetFlipMode(v0->unk_30[v1], 1);
                }
            }
        }
...

        {
            ...
            do {
                ...
                if (v11 % 2) {
                    if (v13 == 0) {
                        if (v12 < 8) {
                            CellActorData_SetPositionXY(v0->unk_30[v12], v0->unk_50.unk_00, v0->unk_50.unk_02);
                            v12++;
                        }
                    } else {
                        v13 = 0;
            ...
            for (v1 = 0; v1 < 8; v1++) {
                ...
                if (ov12_0221FDD4(v0->unk_00.unk_04) == 0) {
                    if (ov12_0223525C(v0->unk_00.unk_04, ov12_02220240(v0->unk_00.unk_04)) == 0x3) {
                        if (v1 < 4) {
                            CellActorData_SetExplicitPriority(v0->unk_30[v1], v15);
                        } else {
                            CellActorData_SetExplicitPriority(v0->unk_30[v1], v14);
                        }
                    } else {
                        if (v1 >= 4) {
                            CellActorData_SetExplicitPriority(v0->unk_30[v1], v15);
                    ...
                    CellActorData_SetPriority(v0->unk_30[v1], 8 - v1);
                } else {
                    CellActorData_SetPriority(v0->unk_30[v1], v1);
                    CellActorData_SetExplicitPriority(v0->unk_30[v1], v15);
                }
            }
        }
...
static void ov12_0222EE50(SysTask *param0, void *param1)
{
    ...
    case 0:
        if (v0->unk_28 > 14) {
            ...
            if (v0->unk_30 <= 0.2) {
                v0->unk_00.unk_00++;
                CellActorData_DrawSprite(v0->unk_1C[0], 0);
            } else {
                CellActorData_SetAffineScaleXYFx32(v0->unk_1C[0], v0->unk_2C * v0->unk_36, v0->unk_30);
            }
        } else {
            v0->unk_34++;
            v0->unk_35--;
    ...
    case 1:
        if (ov12_02226848(v0->unk_38[1]) == 0) {
            ...
            v1 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_1C[2]->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
    ...
    default:
        if (ov12_02226848(v0->unk_38[1]) == 0) {
            CellActorData_UpdateObject(v0->unk_1C[1]);
            ov12_02226858(v0->unk_38[1]);
            ov12_02220220(v0->unk_00.unk_04, param0);
            Heap_FreeToHeap(v0);
            return;
    ...
    CellActorData_UpdateObject(v0->unk_1C[0]);
    CellActorData_UpdateObject(v0->unk_1C[1]);
    CellActorData_UpdateObject(v0->unk_1C[2]);
    SpriteGfxHandler_UpdateCellActorCollection(v0->unk_00.unk_0C);
}
...
void ov12_0222EFB0(UnkStruct_ov12_0221FCDC *param0)
{
...

    {
        ...
        CellActorData_GetPositionXY(v0->unk_1C[1], &v2, &v3);
        CellActorData_SetPositionXY(v0->unk_1C[0], v2 + v4, v3);
        CellActorData_SetAffineOverwriteMode(v0->unk_1C[0], 2);
        CellActorData_SetAffineScaleXYFx32(v0->unk_1C[0], v0->unk_2C * v0->unk_36, v0->unk_30);
    }

    {
        ...
        v6 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_1C[0]->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
        v0->unk_38[0] = ov12_02226870(v0->unk_00.unk_18, ov12_0221FDE4(param0), 2, v6 * 16, 16, 0, 1, 0, 15, 0xFFFFFF, 1100);

        v6 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_1C[2]->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
...

    {
        ...
        CellActorData_GetPositionXY(v0->unk_1C[0], &v12.unk_00, &v12.unk_02);

        {
            ...
            if (ov12_0223525C(v0->unk_00.unk_04, v8) == 0x3) {
                v13 = 0;
                CellActorData_SetExplicitPriority(v0->unk_1C[0], 1);
                CellActorData_SetPriority(v0->unk_1C[0], 0);
            } else {
                CellActorData_SetExplicitPriority(v0->unk_1C[0], 2);
                CellActorData_SetPriority(v0->unk_1C[0], 0);
                v13 = 2;
            }
        ...
        CellActorData_SetPositionXY(v0->unk_1C[0], v12.unk_00, v11.unk_02 + v7);
    }

    CellActorData_DrawSprite(v0->unk_1C[0], 1);
