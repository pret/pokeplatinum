...
void ov12_0222B68C (UnkStruct_ov12_0221FCDC * param0)
{
...

    {
        ...
        if (ov12_0223525C(v0->unk_0C, ov12_02220240(v0->unk_0C)) == 0x3) {
            ...
            v2 = sub_0201FAB4(GraphicElementData_GetPaletteProxy(v0->unk_18[0]->unk_00), NNS_G2D_VRAM_TYPE_2DMAIN);
            sub_02003B08(ov12_0222332C(v0->unk_0C), v5, v3, ov12_0221FDE4(param0), 2, 0x20, v2 * 16, 128, 128, 128);

            v2 = sub_0201FAB4(GraphicElementData_GetPaletteProxy(v0->unk_18[2]->unk_00), NNS_G2D_VRAM_TYPE_2DMAIN);
...
void ov12_0222C0C0 (UnkStruct_ov12_0221FCDC * param0)
{
...

    {
        ...
        v1 = sub_0201FAB4(GraphicElementData_GetPaletteProxy(v0->unk_0C->unk_00), NNS_G2D_VRAM_TYPE_2DMAIN);
