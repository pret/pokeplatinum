...
static void ov12_0222AC70(SysTask *param0, void *param1)
{
    ...
    case 0:
        ...
        for (v0 = 0; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
            {
                s16 v2, v3;
                CellActorData_GetPositionXY(v1->unk_14[v0], &v2, &v3);
            }
            ...
            if (v1->unk_04 >= Unk_ov12_0223A09E[v0][0]) {
                ...
                if (v1->unk_01[v0] >= Unk_ov12_0223A09E[v0][1]) {
                    ...
                    if (CellActorData_GetDrawFlag(v1->unk_14[v0]) == 1) {
                        CellActorData_DrawSprite(v1->unk_14[v0], 0);
                    } else {
                        CellActorData_DrawSprite(v1->unk_14[v0], 1);
                    }
                }
            } else {
                CellActorData_DrawSprite(v1->unk_14[v0], 0);
    ...
    case 2:
        if (ov12_02225F6C(&v1->unk_20) == 1) {
            for (v0 = 0; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
                ...
                CellActorData_SetAffineScaleXYFx32(v1->unk_14[v0], v4, v5);
            }
        } else {
            if (++v1->unk_04 >= 45) {
                v1->unk_00++;
    ...
    default:
        for (v0 = 0; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
            CellActorData_Delete(v1->unk_14[v0]);
        }
    ...
    for (v0 = 0; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
        CellActor_UpdateObject(v1->unk_14[v0]->cellActor);
    }

    SpriteGfxHandler_UpdateCellActorCollection(v1->unk_10);
}
...
void ov12_0222AE68(UnkStruct_ov12_0221FCDC *param0, SpriteRenderer *param1, SpriteGfxHandler *param2, CellActorData *param3)
{
...

    {
        ...
        for (v0 = 1; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
            v1->unk_14[v0] = CellActor_LoadResources(v1->unk_0C, v1->unk_10, &v2);
            CellActorData_SetPositionXY(v1->unk_14[v0], v3.unk_00, v3.unk_02);
        }

        CellActorData_SetPositionXY(v1->unk_14[0], v3.unk_00, v3.unk_02);
    }

    for (v0 = 0; v0 < ov12_02220280(v1->unk_08, 0); v0++) {
        v1->unk_01[v0] = 0;
        CellActorData_SetAffineOverwriteMode(v1->unk_14[v0], 2);
        CellActorData_AddPositionXY(v1->unk_14[v0], 0, 32 - (v0 * 4));
        CellActorData_SetExplicitOAMMode(v1->unk_14[v0], GX_OAM_MODE_XLU);
    }
...
static void ov12_0222B4C8(SysTask *param0, void *param1)
{
    ...
    case 1:
        ...
        for (v0 = 0; v0 < 4; v0++) {
            if (ov12_02225C14(&v2->unk_28[v0]) == 0) {
                ...
                CellActorData_SetPositionXY(v2->unk_18[v0], v2->unk_28[v0].unk_00, v2->unk_28[v0].unk_02);
            }

            CellActorData_UpdateObject(v2->unk_18[v0]);
        }
    ...
    SpriteGfxHandler_UpdateCellActorCollection(v2->unk_14);
}
...
void ov12_0222B68C(UnkStruct_ov12_0221FCDC *param0)
{
...

    {
        ...
        if (ov12_0223525C(v0->unk_0C, ov12_02220240(v0->unk_0C)) == 0x3) {
            CellActorData_SetPriority(v0->unk_18[0], 10);
            CellActorData_SetPriority(v0->unk_18[1], 10);
            CellActorData_SetPriority(v0->unk_18[2], 20);
            CellActorData_SetPriority(v0->unk_18[3], 20);
            CellActorData_SetExplicitPriority(v0->unk_18[0], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[1], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[2], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[3], v4);

            v2 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_18[0]->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
            PaletteData_LoadBufferFromFileStartWithTint(ov12_0222332C(v0->unk_0C), v5, v3, ov12_0221FDE4(param0), 2, 0x20, v2 * 16, 128, 128, 128);

            v2 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_18[2]->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
            PaletteData_LoadBufferFromFileStartWithTint(ov12_0222332C(v0->unk_0C), v5, v3, ov12_0221FDE4(param0), 2, 0x20, v2 * 16, 196, 196, 196);
        } else {
            CellActorData_SetPriority(v0->unk_18[0], 20);
            CellActorData_SetPriority(v0->unk_18[1], 20);
            CellActorData_SetPriority(v0->unk_18[2], 10);
            CellActorData_SetPriority(v0->unk_18[3], 10);
            CellActorData_SetExplicitPriority(v0->unk_18[0], v4 + 1);
            CellActorData_SetExplicitPriority(v0->unk_18[1], v4 + 1);
            CellActorData_SetExplicitPriority(v0->unk_18[2], v4 + 1);
            CellActorData_SetExplicitPriority(v0->unk_18[3], v4 + 1);
            CellActorData_SetExplicitPriority(v0->unk_18[0], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[1], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[2], v4);
            CellActorData_SetExplicitPriority(v0->unk_18[3], v4);
...
static void ov12_0222BFF4(SysTask *param0, void *param1)
{
    ...
    case 0:
        ...
        break;
    case 1:
        CellActorData_DrawSprite(v0->unk_0C, 1);
        CellActorData_DrawSprite(v0->unk_10, 1);
        CellActorData_SetExplicitOAMMode(v0->unk_10, GX_OAM_MODE_OBJWND);
        v0->unk_00++;
        break;
    case 2:
        if ((++v0->unk_01) >= 10) {
            ...
            CellActorData_DrawSprite(v0->unk_0C, 0);
    ...
    CellActorData_UpdateObject(v0->unk_0C);
    CellActorData_UpdateObject(v0->unk_10);
    SpriteGfxHandler_UpdateCellActorCollection(v0->unk_08);
}
...
void ov12_0222C0C0(UnkStruct_ov12_0221FCDC *param0)
{
...

    {
        ...
        v1 = sub_0201FAB4(CellActor_GetPaletteProxy(v0->unk_0C->cellActor), NNS_G2D_VRAM_TYPE_2DMAIN);
...
static void ov12_0222C1A4(SysTask *param0, void *param1)
{
    ...
    case 1:
        ...
        for (v0 = 0; v0 < 3; v0++) {
            ...
            CellActorData_UpdateObject(v2->unk_18[v0].unk_04);
        }
                ...
                for (v0 = 0; v0 < 3; v0++) {
                    {
                        ...
                        CellActorData_GetPositionXY(v2->unk_18[v0].unk_04, &v5, &v6);
                        CellActorData_SetPositionXY(v2->unk_18[v0].unk_04, v5, v2->unk_02);
                        CellActorData_SetAffineScaleXYFx32(v2->unk_18[v0].unk_04, 1.0f * v2->unk_08, 1.0f);
                    }
    ...
    case 2:
        for (v0 = 0; v0 < 3; v0++) {
            CellActorData_SetExplicitOAMMode(v2->unk_18[v0].unk_04, GX_OAM_MODE_NORMAL);
    ...
    case 3:
        ...
        for (v0 = 0; v0 < 3; v0++) {
            if (ov12_02225F6C(&v2->unk_18[v0].unk_08) == 0) {
                ...
                CellActorData_SetAffineScaleXYFx32(v2->unk_18[v0].unk_04, v7 * v2->unk_08, v8);
                ov12_0222605C(v2->unk_18[v0].unk_04, v2->unk_02, v2->unk_04, v2->unk_18[v0].unk_08.unk_04[4], 0);
            }
        }
...
void ov12_0222C3C0(UnkStruct_ov12_0221FCDC *param0)
{
...

    {
        ...
        for (v1 = 0; v1 < 3; v1++) {
            ...
            CellActorData_SetAffineOverwriteMode(v0->unk_18[v1].unk_04, 2);
            CellActorData_SetExplicitOAMMode(v0->unk_18[v1].unk_04, GX_OAM_MODE_XLU);
            CellActorData_SetPriority(v0->unk_18[v1].unk_04, v1 + 1);
        }
    }
...

    {
        ...
        for (v2 = 0; v2 < 3; v2++) {
            CellActorData_SetAffineScaleXYFx32(v0->unk_18[v2].unk_04, 1.0f * v0->unk_08, 1.0f);
        }
    }
...
static void ov12_0222C678(SysTask *param0, void *param1)
{
    ...
    case 0:
        ...
        CellActorData_SetPositionXY(v0->unk_18, v0->unk_40.unk_00, v0->unk_40.unk_02);
        CellActorData_UpdateObject(v0->unk_18);
        SpriteGfxHandler_UpdateCellActorCollection(v0->unk_10);
        break;
    default:
        ov12_02220220(v0->unk_0C, param0);
        Heap_FreeToHeap(v0);
...
void ov12_0222C6D4(UnkStruct_ov12_0221FCDC *param0)
{
    ...
    CellActorData_SetExplicitOAMMode(v0->unk_18, GX_OAM_MODE_XLU);
...
static void ov12_0222CACC(SysTask *param0, void *param1)
{
    ...
    case 1:
        if (ov12_02226138(&v1->unk_40[0]) == 0) {
            ...
            CellActorData_SetPositionXY(v1->unk_38[0], +v1->unk_28[1].unk_00 + v1->unk_40[0].unk_00, v1->unk_28[1].unk_02 + v1->unk_40[0].unk_02);
            CellActorData_SetPositionXY(v1->unk_38[1], -v1->unk_28[1].unk_00 + v1->unk_40[0].unk_00, v1->unk_28[1].unk_02 + v1->unk_40[0].unk_02);
            CellActorData_UpdateObject(v1->unk_38[0]);
            CellActorData_UpdateObject(v1->unk_38[1]);
        }

        SpriteGfxHandler_UpdateCellActorCollection(v1->unk_00.unk_0C);
        break;
    default:
        ov12_02220220(v1->unk_00.unk_04, param0);
        Heap_FreeToHeap(v1);
...
static void ov12_0222CBFC(SysTask *param0, void *param1)
{
    ...
    if (ov12_02225D2C(&v1->unk_8C[0], &v1->unk_8C[1], v1->unk_38) == 0) {
        CellActorData_Delete(v1->unk_38);
    ...
    if (ov12_02225DA0(&v1->unk_D4) == 1) {
        CellActorData_SetAffineZRotation(v1->unk_38, v1->unk_D4.unk_00);
    }

    CellActorData_UpdateObject(v1->unk_38);
    SpriteGfxHandler_UpdateCellActorCollection(v1->unk_10.unk_10);
}
...
void ov12_0222CC54(UnkStruct_ov12_0221FCDC *param0, SpriteRenderer *param1, SpriteGfxHandler *param2, CellActorData *param3)
{
    ...
    CellActorData_SetAffineOverwriteMode(v2->unk_38, 2);
    ...
    CellActorData_SetAffineZRotation(v2->unk_38, v2->unk_D4.unk_00);
    ov12_02225D2C(&v2->unk_8C[0], &v2->unk_8C[1], v2->unk_38);

    CellActorData_UpdateObject(v2->unk_38);
...
static void ov12_0222CDF0(SysTask *param0, void *param1)
{
    ...
    case 1:
        if (ov12_02225F6C(&v0->unk_9C) == 0) {
            ...
            CellActorData_SetAffineScaleXYFx32(v0->unk_40, v1, v2);
            v3 = ov12_02225FD4(v0->unk_14.unk_02, 16, v0->unk_9C.unk_04[4]);
            CellActorData_SetPositionXY(v0->unk_40, v0->unk_14.unk_00, v0->unk_14.unk_02 + v3);
    ...
    case 3:
        if (ov12_02225F6C(&v0->unk_9C) == 0) {
            ...
            CellActorData_SetAffineScaleXYFx32(v0->unk_40, v4, v5);
            v6 = ov12_02225FD4(v0->unk_14.unk_02, 16, v0->unk_9C.unk_04[4]);
            CellActorData_SetPositionXY(v0->unk_40, v0->unk_14.unk_00, v0->unk_14.unk_02 + v6);
        ...
        break;
    default:
        CellActorData_Delete(v0->unk_44[0]);
        CellActorData_Delete(v0->unk_44[1]);
    ...
    CellActorData_UpdateObject(v0->unk_40);
    SpriteGfxHandler_UpdateCellActorCollection(v0->unk_18.unk_10);
}
...
void ov12_0222CFA0(UnkStruct_ov12_0221FCDC *param0)
{
    ...
    if (ov12_0221FDD4(param0) == 1) {
        ...
        CellActorData_DrawSprite(v0->unk_44[1], 0);
        CellActorData_SetAnim(v0->unk_40, 0);
        v0->unk_14.unk_00 = 255 - 76;
        v0->unk_14.unk_02 = 120;
        CellActorData_SetExplicitPriority(v0->unk_40, ov12_0222339C(param0) + 1);
        v0->unk_12 = -1;
    } else {
        if (ov12_0223525C(param0, ov12_02220240(param0)) == 0x4) {
            v0->unk_40 = v0->unk_44[1];
            CellActorData_DrawSprite(v0->unk_44[0], 0);
            CellActorData_SetAnim(v0->unk_40, 1);
    ...
    CellActorData_SetPositionXY(v0->unk_40, v0->unk_14.unk_00, v0->unk_14.unk_02);
    CellActorData_SetAffineOverwriteMode(v0->unk_40, 2);
    CellActorData_SetExplicitOAMMode(v0->unk_40, GX_OAM_MODE_XLU);
...
static void ov12_0222D128(SysTask *param0, void *param1)
{
    ...
    case 3: {
        ...
        CellActorData_GetPositionXY(v1->unk_30[0].unk_00, &v3, &v4);

        if (v4 <= ((40 - 16 + 20 + 10) + 50)) {
            CellActorData_AddPositionXY(v1->unk_30[0].unk_00, 0, 2);
            CellActorData_AddPositionXY(v1->unk_30[1].unk_00, 0, 2);
        } else {
            v1->unk_00++;
        }
    } break;
    case 4: {
        ...
        CellActorData_GetPositionXY(v1->unk_30[0].unk_00, &v5, &v6);
        ...
        if (v1->unk_01 == 10) {
            CellActorData_AddPositionXY(v1->unk_30[0].unk_00, 0, 16);
        }

        if (v1->unk_01 == 12) {
            CellActorData_AddPositionXY(v1->unk_30[1].unk_00, 0, 16);
        }
        break;
    case 5:
        if ((++v1->unk_01) < 1) {
...

        {
            ...
            CellActorData_GetPositionXY(v1->unk_30[0].unk_00, &v7, &v8);
            CellActorData_GetPositionXY(v1->unk_30[1].unk_00, &v9, &v10);
    ...
    case 6: {
        ...
        CellActorData_GetPositionXY(v1->unk_30[0].unk_00, &v11, &v12);
        CellActorData_GetPositionXY(v1->unk_30[1].unk_00, &v13, &v14);
    ...
    default:
        for (v0 = 0; v0 < ov12_02220280(v1->unk_10, 0); v0++) {
            CellActorData_Delete(v1->unk_30[v0].unk_00);
        }
...

    {
        ...
        for (v0 = 0; v0 < ov12_02220280(v1->unk_10, 0); v0++) {
            CellActorData_GetPositionXY(v1->unk_30[v0].unk_00, &v18, &v19);

            if (v19 < 80) {
                CellActorData_SetExplicitPriority(v1->unk_30[v0].unk_00, ov12_0222339C(v1->unk_10));
            } else {
                if (v18 > 128) {
                    CellActorData_SetExplicitPriority(v1->unk_30[v0].unk_00, ov12_0222339C(v1->unk_10));
                } else {
                    CellActorData_SetExplicitPriority(v1->unk_30[v0].unk_00, ov12_0222339C(v1->unk_10) + 1);
                }
            }
        }
    }
    ...
    for (v0 = 0; v0 < ov12_02220280(v1->unk_10, 0); v0++) {
        CellActorData_UpdateObject(v1->unk_30[v0].unk_00);
    }

    SpriteGfxHandler_UpdateCellActorCollection(v1->unk_18);
}
...
void ov12_0222D56C(UnkStruct_ov12_0221FCDC *param0, SpriteRenderer *param1, SpriteGfxHandler *param2, CellActorData *param3)
{
...

    {
        for (v0 = 1; v0 < ov12_02220280(v1->unk_10, 0); v0++) {
            v1->unk_30[v0].unk_00 = CellActor_LoadResources(v1->unk_14, v1->unk_18, &v2);
        }
    }

    for (v0 = 0; v0 < ov12_02220280(v1->unk_10, 0); v0++) {
        CellActorData_SetExplicitOAMMode(v1->unk_30[v0].unk_00, GX_OAM_MODE_XLU);
        CellActorData_SetExplicitPriority(v1->unk_30[v0].unk_00, ov12_0222339C(v1->unk_10) + 1);
    }

    if (ov12_0221FDD4(param0) == 1) {
        CellActorData_SetPositionXY(v1->unk_30[0].unk_00, 180 - 20, (40 - 16 + 20 + 10));
        CellActorData_SetPositionXY(v1->unk_30[1].unk_00, 100 - 20, (25 - 16 + 20 + 10));
    } else {
        CellActorData_SetPositionXY(v1->unk_30[0].unk_00, 100, (40 - 16 + 20 + 10));
        CellActorData_SetPositionXY(v1->unk_30[1].unk_00, 180, (25 - 16 + 20 + 10));
    }
