...
static void sub_02083AD0 (GameWindowLayout * param0, int * param1)
{
    ...
    GraphicElementData_SetAnim(param0->unk_5B0[7], sub_020805D0(param0->unk_5A4->unk_21, param0->unk_B0F_0) + 2);
    GraphicElementData_SetDrawFlag(param0->unk_5B0[7], 1);
...
int sub_02084780 (GameWindowLayout * param0)
{
    ...
    if (Pokemon_GetValue(v0, MON_DATA_MAIL_ID, NULL) == 0) {
        ...
        GraphicElementData_SetDrawFlag(param0->unk_5B0[22 + param0->unk_B11], 1);
    } else {
