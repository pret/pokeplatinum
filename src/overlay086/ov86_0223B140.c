...
static BOOL ov86_0223B3C8(UnkStruct_ov86_0223B3C8 *param0)
{
    ...
    case 0:
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 16, 1, HEAP_ID_63);
        param0->unk_00++;
        break;
    case 1:
        if (IsScreenFadeDone()) {
...
static BOOL ov86_0223B40C(UnkStruct_ov86_0223B3C8 *param0)
{
    switch (param0->unk_00) {
    case 0:
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 2, 1, HEAP_ID_63);
