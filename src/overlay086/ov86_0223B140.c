...
static void ov86_0223C54C(UnkStruct_ov86_0223C3E4 *param0)
{
    ...
    case 0:
    case 1:
        StringTemplate_SetLocationName(param0->unk_14, 0, Pokemon_GetValue(param0->unk_24, MON_DATA_MET_LOCATION, NULL));
        break;
    }
...
static int ov86_0223D2A8(UnkStruct_ov86_0223B3C8 *param0, Pokemon *param1, const TrainerInfo *param2)
{
    ...
    do {
...

        {
            ...
            Pokemon_GetValue(param1, MON_DATA_OT_NAME_STRING, param0->unk_1C4C);
