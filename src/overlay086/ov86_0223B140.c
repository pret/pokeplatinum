...
int ov86_0223B140(OverlayManager *overlayMan, int *param1)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov86_0223B3C8), HEAP_ID_63);

    v0->unk_0C = OverlayManager_Args(overlayMan);
...
int ov86_0223B2E4(OverlayManager *overlayMan, int *param1)
{
    switch (*param1) {
    case 0: {
        UnkStruct_ov86_0223B3C8 *v0 = OverlayManager_Data(overlayMan);
...
int ov86_0223B394(OverlayManager *overlayMan, int *param1)
{
    ...
    UnkStruct_ov86_0223B3C8 *v1 = OverlayManager_Data(overlayMan);
