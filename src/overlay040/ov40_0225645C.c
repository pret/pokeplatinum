...
static void ov40_02256604(PoketchTaskManager *param0);
...
{
    UnkStruct_ov40_0225645C *v0 = (UnkStruct_ov40_0225645C *)Heap_Alloc(HEAP_ID_POKETCH_APP, sizeof(UnkStruct_ov40_0225645C));
...
{
    PoketchTask_Start(Unk_ov40_02256A60, param1, param0, param0->unk_00, param0->unk_08, 2, 8);
}
...
static void ov40_02256604(PoketchTaskManager *param0)
{
    UnkStruct_ov40_0225645C *v0 = PoketchTask_GetTaskData(param0);
...
static void ov40_02256618(SysTask *param0, void *param1)
{
    ...
    Graphics_LoadTilesToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 81, v2->unk_04, BG_LAYER_SUB_2, 0, 0, 1, HEAP_ID_POKETCH_APP);
    Graphics_LoadTilemapToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 80, v2->unk_04, BG_LAYER_SUB_2, 0, 0, 1, HEAP_ID_POKETCH_APP);
