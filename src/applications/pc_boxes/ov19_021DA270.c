...
void ov19_021DA428(UnkStruct_ov19_021DA384 *param0, BoxPokemon *boxMon, s32 param2, s32 param3, u32 param4, u32 param5, u32 param6, UnkStruct_ov19_021DCD18 *param7)
{
    ...
    u8 isEgg;
    u8 form;
    u8 reencrypt = BoxPokemon_UnlockEncryption(boxMon);
    ...
    param7->unk_30 = BoxPokemon_GetData(boxMon, MON_DATA_HELD_ITEM, NULL);
    param7->unk_2E = BoxPokemon_GetData(boxMon, MON_DATA_MARKINGS, NULL);
...
void ov19_021DA548(UnkStruct_ov19_021DA384 *param0, BoxPokemon *boxMon, u32 param2, u32 param3, u8 *param4, s32 param5, s32 param6, u32 param7, u32 param8, u32 param9, UnkStruct_ov19_021DCD18 *param10)
{
    ...
    u8 isEgg = BoxPokemon_GetData(boxMon, MON_DATA_IS_EGG, NULL);
    ...
    param10->unk_30 = BoxPokemon_GetData(boxMon, MON_DATA_HELD_ITEM, NULL);
    param10->unk_2E = BoxPokemon_GetData(boxMon, MON_DATA_MARKINGS, NULL);
