...
static const u8 sFlavorPreferences[][2] = {
    [NATURE_HARDY]   = { FLAVOR_COUNT, FLAVOR_COUNT },
    ...
    [NATURE_DOCILE]  = { FLAVOR_COUNT, FLAVOR_COUNT },
    ...
    [NATURE_SERIOUS] = { FLAVOR_COUNT, FLAVOR_COUNT },
    ...
    [NATURE_BASHFUL] = { FLAVOR_COUNT, FLAVOR_COUNT },
    ...
    [NATURE_QUIRKY]  = { FLAVOR_COUNT, FLAVOR_COUNT }
};
// clang-format on
...
PoffinCaseAppData *PoffinCaseAppData_New(SaveData *saveData, int heapID)
{
    ...
    appData->flavorFilter = FLAVOR_COUNT;
