...
static void PartyMenu_SelectItemTake(PartyMenuApplication *application, int *param1)
{
    ...
    if (application->partyMembers[application->currPartySlot].heldItem == ITEM_NONE) {
        ...
        MessageLoader_GetStrbuf(application->messageLoader, pl_msg_00000453_00081, application->tmpFormat);
        ...
        MessageLoader_GetStrbuf(application->messageLoader, pl_msg_00000453_00082, application->tmpFormat);
        StringTemplate_SetNickname(application->template, 0, Pokemon_GetBoxPokemon(mon));
...
static void PartyMenu_SelectMail(PartyMenuApplication *application, int *param1)
{
    ...
    StringList_AddFromStrbuf(application->contextMenuChoices, application->menuStrings[6], PartyMenu_GetAction(6));
    StringList_AddFromStrbuf(application->contextMenuChoices, application->menuStrings[7], PartyMenu_GetAction(7));
    StringList_AddFromStrbuf(application->contextMenuChoices, application->menuStrings[9], PartyMenu_GetAction(9));
...
int sub_02084780(PartyMenuApplication *application)
{
    ...
    if (Pokemon_GetValue(v0, MON_DATA_BALL_CAPSULE_ID, NULL) == 0) {
        MessageLoader_GetStrbuf(application->messageLoader, pl_msg_00000453_00129, application->tmpString);
        Sprite_SetDrawFlag(application->sprites[22 + application->currPartySlot], TRUE);
    } else {
        MessageLoader_GetStrbuf(application->messageLoader, pl_msg_00000453_00130, application->tmpString);
