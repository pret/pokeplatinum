...
int ov64_0222DCE0(OverlayManager *overlayMan, int *param1)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov64_0222DFD0), HEAP_ID_52);
    memset(v0, 0, sizeof(UnkStruct_ov64_0222DFD0));

    ov64_0222E040(&v0->unk_28C, OverlayManager_Args(overlayMan), HEAP_ID_52);
...
int ov64_0222DDAC(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov64_0222DFD0 *v0 = OverlayManager_Data(overlayMan);
    int v1;
...
int ov64_0222DEA4(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov64_0222DFD0 *v0 = OverlayManager_Data(overlayMan);
...
// clang-format off
asm static void ov64_0222EC94 (UnkStruct_ov64_0222F038 * param0, UnkStruct_ov64_0222E060 * param1, UnkStruct_ov64_0222E21C * param2, u32 heapID)
{
...
// clang-format off
asm static void ov64_0222F414 (UnkStruct_ov64_0222F0C4 * param0, UnkStruct_ov64_0222E060 * param1, UnkStruct_ov64_0222E21C * param2, u32 heapID)
{
    push {r3, r4, r5, r6, r7, lr}
    sub sp, #0x58
...
static int ov64_0223044C (UnkStruct_ov64_02230444 * param0, UnkStruct_ov64_0222DFD0 * param1, UnkStruct_ov64_0222E060 * param2, UnkStruct_ov64_0222E21C * param3, u32 heapID)
{
    ...
    case 0:
        ...
        param0->overlayMan = OverlayManager_New(&Unk_020F2DAC, param0->unk_04, heapID);
        param2->unk_04 = 1;
        break;
    case 1:
        ...
        if (param0->unk_04->unk_14 == 0) {
            param0->overlayMan = OverlayManager_New(&Unk_020F2DBC, param0->unk_08, heapID);
            param2->unk_04 = 2;
        } else {
...
// clang-format off
asm static void ov64_02230680 (UnkStruct_ov64_02230620 * param0, UnkStruct_ov64_0222E060 * param1, UnkStruct_ov64_0222E21C * param2, u32 heapID)
{
    push {r3, r4, r5, r6, r7, lr}
    sub sp, #0x28
    add r5, r0, #0
