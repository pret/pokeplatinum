...
int ov65_02236548(ApplicationManager *appMan, int *param1)
{
    ...
    switch (*param1) {
    case 0:
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_96);
        (*param1)++;
        break;
    case 1:
        if (IsScreenFadeDone()) {
    ...
    case 2:
        ...
        break;
    case 3:
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_96);
        (*param1)++;
        break;
    case 4:
        if (IsScreenFadeDone()) {
...
static BOOL ov65_022387E8(UnkStruct_ov65_022367A8 *param0, UnkStruct_0207DE04 *param1, u32 heapID)
{
    ...
    if ((sub_020380E4() == 1) && (CommSys_IsPlayerConnected(0) == 1)) {
        ...
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, heapID);
        param0->unk_00.unk_05 = 27;
    }
...
static BOOL ov65_02238838(UnkStruct_ov65_022367A8 *param0, UnkStruct_0207DE04 *param1, u32 heapID)
{
    if (IsScreenFadeDone()) {
        ...
        StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, heapID);
