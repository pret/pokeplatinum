...
static void ov65_0222E90C(UnkStruct_02018340 * param0, UnkStruct_ov65_0222E99C * param1, NARC * param2, u32 param3);
...
{
    Party * v0 = GetPartyFromSavedata(param0->unk_160);
...
int ov65_0222E2A8 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 0:
        ...
        GX_EngineBToggleLayers(GX_PLANEMASK_BG0 | GX_PLANEMASK_BG1 | GX_PLANEMASK_BG2 | GX_PLANEMASK_BG3, 0);
...
static void ov65_0222F4C4 (UnkStruct_ov65_0222EBE0 * param0, int param1)
{
    ...
    Party * v2 = GetPartyFromSavedata(param0->unk_160);
