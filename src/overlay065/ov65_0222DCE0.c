...
static void ov65_0222E01C(UnkStruct_ov65_0222EBE0 *param0)
{
    ...
    param0->unk_168 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 674, HEAP_ID_54);
    param0->unk_16C = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 695, HEAP_ID_54);
