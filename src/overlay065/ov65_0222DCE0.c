...
static int ov65_0222DF88(UnkStruct_ov65_0222EBE0 *param0)
{
    ...
    for (v3 = 0; v3 < v2; v3++) {
        ...
        if (Pokemon_GetData(v1, MON_DATA_HP, NULL) == 0) {
            continue;
        }
...
static void ov65_0222F4C4(UnkStruct_ov65_0222EBE0 *param0, int param1)
{
    ...
    for (v5 = 0; v5 < v4; v5++) {
        ...
        param0->unk_04->unk_00.unk_00[v5] = Pokemon_GetData(v6, MON_DATA_SPECIES, NULL);
        param0->unk_04->unk_00.unk_0C[v5] = Pokemon_GetData(v6, MON_DATA_HELD_ITEM, NULL);
    }
