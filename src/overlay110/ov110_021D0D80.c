...
int ov110_021D0D80(OverlayManager *overlayMan, int * param1);
int ov110_021D0E9C(OverlayManager *overlayMan, int * param1);
int ov110_021D0EF0(OverlayManager *overlayMan, int * param1);
...
int ov110_021D0D80 (OverlayManager *overlayMan, int * param1)
{
    ...
    v1 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov110_021D0F78), HEAP_ID_114);
    memset(v1, 0, sizeof(UnkStruct_ov110_021D0F78));

    v1->overlayMan = overlayMan;
    v1->unk_0C = BgConfig_New(HEAP_ID_114);

    v2 = (UnkStruct_0203E564 *)OverlayManager_Args(overlayMan);
...
int ov110_021D0E9C (OverlayManager *overlayMan, int * param1)
{
    UnkStruct_ov110_021D0F78 * v0 = OverlayManager_Data(overlayMan);
...
{
    int v0;
    UnkStruct_ov110_021D0F78 * v1 = OverlayManager_Data(overlayMan);
