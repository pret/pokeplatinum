...
BOOL ScrCmd_0D0 (ScriptContext * param0)
{
    Pokemon * v0;
    FieldSystem * fieldSystem = param0->fieldSystem;
    StringTemplate ** v2 = FieldSystem_GetScriptMember(fieldSystem, SCRIPT_MANAGER_STR_TEMPLATE);
...
BOOL ScrCmd_251 (ScriptContext * param0)
{
    ...
    StringTemplate ** v3 = FieldSystem_GetScriptMember(fieldSystem, SCRIPT_MANAGER_STR_TEMPLATE);
    u8 v4 = ScriptContext_ReadByte(param0);
