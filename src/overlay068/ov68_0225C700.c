...
int ov68_0225C798(ApplicationManager *appMan, int *param1)
{
    ...
    switch (*param1) {
    case 0:
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_122);
    ...
    case 2:
        ...
        break;
    case 3:
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 6, 1, HEAP_ID_122);
        (*param1)++;
        break;
    case 4:
        v2 = IsScreenFadeDone();
...
static void ov68_0225C9A0(UnkStruct_ov68_0225C91C *param0, Options *param1, u32 param2)
{
...

    {
        ...
        for (v0 = 0; v0 < 4; v0++) {
            ...
            Bg_ClearTilesRange(Unk_ov68_0225DD68[v0], 32, 0, param2);
