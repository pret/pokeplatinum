...
static void ov68_0225CB70 (UnkStruct_ov68_0225CB70 * param0, UnkStruct_ov66_0222DFF8 * param1, u32 param2)
{
    ...
    param0->unk_28 = PLString_Init(256, param2);
    param0->unk_2C = PLString_Init(256, param2);
}
...
static void ov68_0225D128 (UnkStruct_ov68_0225D128 * param0, UnkStruct_ov68_0225C91C * param1, UnkStruct_021C0794 * param2, u32 param3)
{
    ...
    param0->unk_18 = PLString_Init(256, param3);
...
static void ov68_0225D1B4 (UnkStruct_ov68_0225D128 * param0, const PLString * param1)
{
    ...
    sub_0201ADA4(&param0->unk_08, 15);
    PLString_Copy(param0->unk_18, param1);
...
static void ov68_0225DB8C (UnkStruct_ov68_0225DB8C * param0, BOOL param1, u32 param2)
{
    ...
    param0->unk_10 = PLString_Init(256, param2);

    for (v3 = 0; v3 < 3; v3++) {
        param0->unk_14[v3] = PLString_Init(256, param2);
    }
    ...
    if (param0->unk_0C == 1) {
        ...
        GF_ASSERT(v2);
        PLString_FillWithChars(param0->unk_10, v2);

        for (v3 = 0; v3 < 3; v3++) {
            v2 = ov66_02233538(v1 + UnkEnum_ov66_02233538_01 + v3);
            GF_ASSERT(v2);
            PLString_FillWithChars(param0->unk_14[v3], v2);
        }
    }
}
