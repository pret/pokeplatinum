...
static void ov68_0225C9A0(UnkStruct_ov68_0225C91C *param0, Options *options, u32 param2);
...
static void ov68_0225C9A0(UnkStruct_ov68_0225C91C *param0, Options *options, u32 param2)
{
    ...
    for (i = 0; i < 4; i++) {
        ...
        Bg_ClearTilesRange(Unk_ov68_0225DD68[i], 32, 0, param2);
        Bg_ClearTilemap(param0->unk_00, Unk_ov68_0225DD68[i]);
    }

    Font_LoadScreenIndicatorsPalette(0, 4 * 0x20, param2);

    LoadMessageBoxGraphics(param0->unk_00, 1, 1, 5, Options_Frame(options), param2);
