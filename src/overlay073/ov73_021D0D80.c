...
int ov73_021D3250(UnkStruct_020067E8 * param0, int * param1);
...
static BOOL ov73_021D0FFC (void)
{
    ...
    if (Unk_021BF67C.unk_60) {
        if ((Unk_021BF67C.unk_5C < 256) && (Unk_021BF67C.unk_5E < 192)) {
            if (Unk_021BF67C.unk_5C < 128) {
                v1 = 128 - Unk_021BF67C.unk_5C;
            } else {
                v1 = Unk_021BF67C.unk_5C - 128;
            }

            if (Unk_021BF67C.unk_5E < 100) {
                v2 = 100 - Unk_021BF67C.unk_5E;
            } else {
                v2 = Unk_021BF67C.unk_5E - 100;
            }
...
static void ov73_021D12C4 (UnkStruct_ov73_021D1058 * param0)
{
    ...
    param0->unk_64 = sub_0200B358(param0->unk_00);
    param0->unk_50 = 0;
    param0->unk_54 = 0;
    param0->unk_2C = 0;
}
...
static BOOL ov73_021D1510 (UnkStruct_ov73_021D1058 * param0, u32 param1, int param2)
{
    ...
    case 0:
        ...
        {
            PLString * v1 = PLString_AllocFromHeap(0x400, param0->unk_00);

            param0->unk_5C = PLString_AllocFromHeap(0x400, param0->unk_00);
    ...
    case 1:
        ...
        break;
    case 2:
        if ((param2 != 0) || ((Unk_021BF67C.unk_48 & PAD_BUTTON_A) == PAD_BUTTON_A)) {
...
static BOOL ov73_021D1648 (UnkStruct_ov73_021D1058 * param0, int param1, int param2)
{
    ...
    case 0:
        ...
        sub_0200DC48(v1.unk_0C, 1, ((0x400 - ((18 + 12))) - 9), 3);
...
static BOOL ov73_021D1784 (UnkStruct_ov73_021D1058 * param0, u32 param1, int param2, int param3, int param4)
{
    ...
    case 0:
        ...
        if (param2 == 1) {
            ...
            sub_0201AE78(&param0->unk_1C, 0, 0, 0, 24 * 8, 24 * 8);
    ...
    case 2:
        ...
        break;
    case 3:
        if (((Unk_021BF67C.unk_48 & PAD_BUTTON_A) == PAD_BUTTON_A) || ((Unk_021BF67C.unk_48 & PAD_BUTTON_B) == PAD_BUTTON_B)) {
            sub_02005748(1500);
            param0->unk_54 = 4;
        }
        break;
...
static BOOL ov73_021D2318 (UnkStruct_ov73_021D1058 * param0)
{
    ...
    case 66:
        ...
        break;
    case 67:
        if ((Unk_021BF67C.unk_48 & PAD_BUTTON_A) == PAD_BUTTON_A) {
            param0->unk_7C = 6;
            param0->unk_80 = 10;
            param0->unk_78 = 2;
        ...
        if ((Unk_021BF67C.unk_48 & PAD_KEY_LEFT) == PAD_KEY_LEFT || (Unk_021BF67C.unk_48 & PAD_KEY_RIGHT) == PAD_KEY_RIGHT) {
            if (param0->unk_84 == 0) {
                param0->unk_84 = 1;
            } else {
                param0->unk_84 = 0;
    ...
    case 80:
        if (ov73_021D1648(param0, 0, 0) == 1) {
            ...
            case 2:
            case 0xfffffffe:
                PLString_Zero(param0->unk_70->unk_18);
                param0->unk_10 = 63;
                param0->unk_0C = 81;
                break;
            }
    ...
    case 90:
        if (ov73_021D1648(param0, 2, 1) == 1) {
            ...
            case 5:
            {
                ...
                {
                    PLString * v10 = sub_0200B1EC(param0->unk_4C, v9);

                    PLString_CopyInto(param0->unk_74->unk_18, v10);
    ...
    case 96:
        if (ov73_021D1648(param0, 0, 0) == 1) {
            ...
            case 2:
            case 0xfffffffe:
                PLString_Zero(param0->unk_74->unk_18);
                param0->unk_0C = 88;
                break;
            }
        }
