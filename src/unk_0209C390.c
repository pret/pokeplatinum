...
{
    CommCmdManager_Init(sub_02039A58(), sub_02039A60(), param0);
}

void sub_0209C3AC(void)
{
    CommCmdManager_Init(sub_02039A58(), sub_02039A60(), NULL);
}
...
void CommCmd_WaitingRoom_22(int param0, int param1, void *param2, void *param3)
{
...
void CommCmd_WaitingRoom_23(int param0, int param1, void *param2, void *param3)
{
    UnkStruct_ov65_02236744 *v0 = param3;
...
void CommCmd_WaitingRoom_24(int param0, int param1, void *param2, void *param3)
{
    UnkStruct_ov65_02236744 *v0 = param3;
