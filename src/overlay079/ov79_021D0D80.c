...
int ov79_021D0D80(UnkStruct_020067E8 * param0, int * param1);
int ov79_021D0DC4(UnkStruct_020067E8 * param0, int * param1);
int ov79_021D0DDC(UnkStruct_020067E8 * param0, int * param1);
...
int ov79_021D0DC4 (UnkStruct_020067E8 * param0, int * param1)
{
    UnkStruct_ov79_021D0E1C * v0 = (UnkStruct_ov79_021D0E1C *)sub_0200682C(param0);
...
static int ov79_021D11C0 (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    if ((Unk_021BF67C.unk_48 & (PAD_BUTTON_A | PAD_BUTTON_B)) == 0) {
        return 0;
    }
...
static void ov79_021D14A4 (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    for (v0 = 0; v0 < 13; v0++) {
        sub_0201A7E8(param0->unk_24, &param0->unk_E8[v0], v1[v0].unk_00, v1[v0].unk_01, v1[v0].unk_02, v1[v0].unk_03, v1[v0].unk_04, v1[v0].unk_05, v1[v0].unk_06);
        sub_0201ADA4(&(param0->unk_E8[v0]), 0);
    }
...
static void ov79_021D1568 (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    param0->unk_2C = MessageFormatter_Init(0, 26, 463, param0->unk_00);
    ...
    param0->unk_30.unk_08 = MessageFormatter_AllocStrbuf(param0->unk_2C, 6);
    param0->unk_30.unk_0C = MessageFormatter_AllocStrbuf(param0->unk_2C, 22);
    param0->unk_30.unk_10 = MessageFormatter_AllocStrbuf(param0->unk_2C, 4);
    param0->unk_30.unk_14 = MessageFormatter_AllocStrbuf(param0->unk_2C, 7);
    param0->unk_30.unk_18 = MessageFormatter_AllocStrbuf(param0->unk_2C, 8);
    param0->unk_30.unk_1C = MessageFormatter_AllocStrbuf(param0->unk_2C, 0);

    for (v0 = 0; v0 < 6; v0++) {
        param0->unk_30.unk_20[v0] = MessageFormatter_AllocStrbuf(param0->unk_2C, 11 + v0);

        if (v0 >= 5) {
            break;
        }

        param0->unk_30.unk_38[v0] = MessageFormatter_AllocStrbuf(param0->unk_2C, 17 + v0);
    }
...
static void ov79_021D167C (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    for (v0 = 0; v0 < 6; v0++) {
        ...
        sub_0200D494(param0->unk_1E0[v0], v3[v0].unk_00, v3[v0].unk_02);
    }
