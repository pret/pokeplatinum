...
static void ov79_021D1568 (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    param0->unk_30.unk_04 = PLString_Init(64, param0->unk_00);
...
static void ov79_021D1618 (UnkStruct_ov79_021D0E1C * param0)
{
    ...
    for (v0 = 0; v0 < 6; v0++) {
        PLString_Free(param0->unk_30.unk_20[v0]);

        if (v0 >= 5) {
            break;
        }

        PLString_Free(param0->unk_30.unk_38[v0]);
    }

    PLString_Free(param0->unk_30.unk_1C);
    PLString_Free(param0->unk_30.unk_18);
    PLString_Free(param0->unk_30.unk_14);
    PLString_Free(param0->unk_30.unk_10);
    PLString_Free(param0->unk_30.unk_0C);
    PLString_Free(param0->unk_30.unk_08);
    PLString_Free(param0->unk_30.unk_04);
