...
int ov79_021D22AC(OverlayManager *overlayMan, int *param1);
int ov79_021D22E4(OverlayManager *overlayMan, int *param1);
int ov79_021D2460(OverlayManager *overlayMan, int *param1);
...
int ov79_021D22AC(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_02098DE8 *v0 = OverlayManager_Args(overlayMan);
    UnkStruct_ov79_021D2928 *v1;

    Heap_Create(HEAP_ID_APPLICATION, HEAP_ID_46, 0x10000);

    v1 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov79_021D2928), HEAP_ID_46);
...
int ov79_021D22E4(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov79_021D2928 *v0 = (UnkStruct_ov79_021D2928 *)OverlayManager_Data(overlayMan);
