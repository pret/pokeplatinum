...
int ov96_0223B6A0(OverlayManager *param0, int *param1)
{
    ...
    case 0:
        ...
        v0->unk_BD0 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 670, HEAP_ID_68);
        v0->unk_BD4 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 674, HEAP_ID_68);
        v0->unk_BD8 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 695, HEAP_ID_68);
