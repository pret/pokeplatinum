...
static void ov96_0223B980(UnkStruct_ov96_0223BF40 *param0, OverlayManager *overlayMan);
...
int ov96_0223B6A0(OverlayManager *overlayMan, int *param1)
{
    ...
    case 0:
        ...
        v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov96_0223BF40), HEAP_ID_68);
...
int ov96_0223B7F8(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov96_0223BF40 *v0 = OverlayManager_Data(overlayMan);
    int v1;
...
int ov96_0223B8CC(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov96_0223BF40 *v0 = OverlayManager_Data(overlayMan);
    int v1;
...
static void ov96_0223B980(UnkStruct_ov96_0223BF40 *param0, OverlayManager *overlayMan)
{
    param0->unk_00 = (UnkStruct_0206BC70 *)OverlayManager_Args(overlayMan);
    param0->unk_10 = 0;
