...
int ov96_0223BCE0(UnkStruct_ov96_0223BF40 *param0, int param1)
{
    ...
    StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 8, 1, HEAP_ID_68);
...
static int ov96_0223D528(UnkStruct_ov96_0223BF40 *param0)
{
    sub_02039794();
    sub_0203848C();
    StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 8, 1, HEAP_ID_68);
