...
static BOOL ov50_022561D4(void **param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    UnkStruct_ov50_022561D4 *v0 = (UnkStruct_ov50_022561D4 *)Heap_Alloc(HEAP_ID_POKETCH_APP, sizeof(UnkStruct_ov50_022561D4));
...
static BOOL ov50_0225621C(UnkStruct_ov50_022561D4 *param0, PoketchSystem *poketchSys, BgConfig *param2, u32 param3)
{
    ...
    if (ov50_02256510(&(param0->unk_90), &(param0->unk_04), param2)) {
        ...
        param0->unk_01 = 0;
        param0->unk_02 = 0;
        param0->buttonManager = PoketchButtonManager_New(v0, NELEMS(v0), ov50_02256360, param0, HEAP_ID_POKETCH_APP);
        param0->unk_A0 = 0;
