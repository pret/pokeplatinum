...
static void sub_0204AE20(UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1, int param2);
...
BOOL sub_02049EC4 (u16 param0, UnkStruct_021C0794 * param1, u8 param2)
{
    u8 v0, v1, v2, v3;
    u16 v4, v5;
...
void sub_02049FA8 (UnkStruct_0203CDB0 * param0)
{
    ...
    sub_0206AD9C(sub_020507E4(param0->unk_0C));
...
{
    sub_0206ADAC(sub_020507E4(param0->unk_0C));
}

u16 sub_02049FF8 (UnkStruct_021C0794 * param0, u16 param1)
{
    u16 v0;
...
void sub_0204A030 (UnkStruct_021C0794 * param0, u8 param1)
{
...
u16 sub_0204A050 (UnkStruct_021C0794 * param0)
{
    UnkStruct_0202D750 * v0 = sub_0202D750(param0);
    return (u16)sub_0202D414(v0, 5, 0);
}

u16 sub_0204A064 (UnkStruct_021C0794 * param0)
{
    u8 v0;
    int v1;
...
u16 sub_0204A100 (UnkStruct_021C0794 * param0)
{
...
UnkStruct_0204AFC4 * sub_0204A124 (UnkStruct_021C0794 * param0, u16 param1, u16 param2)
{
    u8 v0;
    u16 v1, v2;
    ...
    if (v3->unk_0F != 5) {
        ...
        if (v3->unk_0F == 6) {
            v2 = sub_0206B6FC(sub_020507E4(param0));
        } else {
...
BOOL sub_0204A378 (UnkStruct_0204AFC4 * param0, void ** param1, UnkStruct_021C0794 * param2)
{
    u16 v0 = 0;
    ...
    v2 = sub_0207A268(param2);

    for (v0 = 0; v0 < param0->unk_0E; v0++) {
        param0->unk_2A[v0] = v1->unk_2C[v0] - 1;
        v3 = sub_0207A0FC(v2, param0->unk_2A[v0]);
        param0->unk_2E[v0] = sub_02074470(v3, 5, NULL);
...
int sub_0204A410 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    u16 v0 = 0, v1 = 0;
    u16 v2[4], v3[4];
    ...
    v4 = sub_0207A268(param1);

    for (v0 = 0; v0 < param0->unk_0E; v0++) {
        v5 = sub_0207A0FC(v4, param0->unk_2A[v0]);
        v2[v0] = sub_02074470(v5, 5, NULL);
        v3[v0] = sub_02074470(v5, 6, NULL);
...
void sub_0204A4C8 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    int v0;
    u16 v1, v2;
...
static void sub_0204A5A0 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1, u16 param2)
{
    ...
    if (param0->unk_0F == 0) {
        sub_0206DBB0(param1, param2, sub_0207A0FC(v0, param0->unk_2A[0]), 1);
    } else {
        sub_0206DBB0(param1, param2, sub_0207A0FC(v0, param0->unk_2A[0]), 0);
    }
}

static void sub_0204A5EC (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1, u8 param2, u16 param3)
{
    u8 v0;
...
void sub_0204A660 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    u32 v0 = 0;
    int v1;
    u16 v2, v3, v4;
...
void sub_0204A7A4 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1, UnkStruct_0202B628 * param2)
{
    u32 v0 = 0;
    int v1;
    void * v2;
...
u16 sub_0204AA7C (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    u8 v0, v1;
    u16 v2, v3, v4;
...
u16 sub_0204AABC (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1, u8 param2)
{
    u8 v0, v1;
...
u16 sub_0204AB68 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    if (param0->unk_0F != 0) {
        return 0;
    }
...
u16 sub_0204ABA0 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    u8 v0, v1;
    u16 v2, v3, v4;
...
u16 sub_0204ABF4 (UnkStruct_0204AFC4 * param0, UnkStruct_021C0794 * param1)
{
    u8 v0;
...
static u16 sub_0204AC54 (UnkStruct_021C0794 * param0, u8 param1, UnkStruct_0204AFC4 * param2)
{
    ...
    v3 = sub_0207A268(param0);
    v1 = 0;

    for (v2 = 0; v2 < param2->unk_0E; v2++) {
        v4 = sub_0207A0FC(v3, param2->unk_2A[v2]);

        if (sub_02074470(v4, param1, NULL)) {
            continue;
        }
...
static void sub_0204ACFC (UnkStruct_ov104_0223A348_sub2 * param0, UnkStruct_02073C74 * param1)
{
    int v0;

    param0->unk_00_val1_0 = sub_02074470(param1, 5, NULL);
    param0->unk_00_val1_11 = sub_02074470(param1, 112, NULL);
    param0->unk_02 = sub_02074470(param1, 6, NULL);

    for (v0 = 0; v0 < 4; v0++) {
        param0->unk_04[v0] = sub_02074470(param1, 54 + v0, NULL);
        param0->unk_1E_val2 |= ((sub_02074470(param1, 62 + v0, NULL)) << (v0 * 2));
    }

    param0->unk_1F = sub_02074470(param1, 12, NULL);
    param0->unk_0C = sub_02074470(param1, 7, NULL);
    param0->unk_10 = sub_02074470(param1, 0, NULL);
    param0->unk_14_val2 = sub_02074470(param1, 175, NULL);

    for (v0 = 0; v0 < 6; v0++) {
        param0->unk_18_val2[v0] = sub_02074470(param1, 13 + v0, NULL);
    }

    param0->unk_20 = sub_02074470(param1, 10, NULL);
    param0->unk_21 = sub_02074470(param1, 9, NULL);

    sub_02074470(param1, 117, param0->unk_22);
}
