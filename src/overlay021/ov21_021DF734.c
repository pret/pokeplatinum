...
static void ov21_021DFE0C (UnkStruct_ov21_021DFFF8 * param0, UnkStruct_ov21_021DF858 * param1, const UnkStruct_ov21_021DF844 * param2, int param3)
{
    ...
    for (v5 = 0; v5 < 4; v5++) {
        ...
        if ((v5 % 2) == 0) {
            GraphicElementData_SetAnim(param0->unk_00[v5], 0);
        } else {
            GraphicElementData_SetAnim(param0->unk_00[v5], 2);
        }
    }
    ...
    GraphicElementData_SetAnim(param0->unk_BC, 1);
...
static void ov21_021DFFF8 (UnkStruct_ov21_021DFFF8 * param0)
{
    ...
    GraphicElementData_SetExplicitOAMMode(param0->unk_BC, GX_OAM_MODE_XLU);
...
static void ov21_021E0038 (UnkStruct_ov21_021DFFF8 * param0)
{
    ...
    GraphicElementData_SetExplicitOAMMode(param0->unk_BC, GX_OAM_MODE_NORMAL);
