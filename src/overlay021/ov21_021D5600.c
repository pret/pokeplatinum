...
static PLString * ov21_021D5724(int param0, int param1, int param2);
...
asm PLString * ov21_021D561C (int param0, int param1, int param2)
{
    push {r4, r5, r6, lr}
    sub sp, #0x28
    add r4, r2, #0
...
asm PLString * ov21_021D566C (int param0, int param1, int param2)
{
    push {r4, r5, r6, lr}
    sub sp, #0x28
    add r4, r2, #0
...
asm PLString * ov21_021D56BC (int param0, int param1, int param2, int param3)
{
    push {r4, r5, r6, lr}
    sub sp, #0x28
    add r4, r2, #0
...
static PLString * ov21_021D5724 (int param0, int param1, int param2)
{
    ...
    if (v0) {
        PLString * v1 = PLString_Init(256, param2);
