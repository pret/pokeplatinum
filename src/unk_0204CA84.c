...
BOOL ScrCmd_1AE (ScriptContext * param0)
{
    ...
    SaveData * v1 = fieldSystem->saveData;
    UnkStruct_02026310 * v2;
    StringTemplate ** v3 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_STR_TEMPLATE);
    u16 * v4 = ScriptContext_GetVarPointer(param0);
...
BOOL ScrCmd_1AF (ScriptContext * param0)
{
    FieldSystem * fieldSystem = param0->fieldSystem;
    Party * v1;
    StringTemplate ** v2 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_STR_TEMPLATE);
