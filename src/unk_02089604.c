...
BOOL sub_02089820(UnkStruct_02089688 *param0)
{
    ...
    StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_IN, FADE_TYPE_BRIGHTNESS_IN, FADE_TO_BLACK, 6, 1, HEAP_ID_101);
...
BOOL sub_020898DC(UnkStruct_02089688 *param0)
{
    ...
    case 0:
        StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_OUT, FADE_TYPE_BRIGHTNESS_OUT, FADE_TO_BLACK, 6, 1, HEAP_ID_101);
        param0->unk_2C8++;
        break;
    case 1:
