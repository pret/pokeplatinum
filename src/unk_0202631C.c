...
{
    u8 v0 = GetMonData(param2, 112, NULL);
    u32 v1;
...
{
    u16 v0 = GetMonData(param1, 5, NULL);
    u32 v1 = GetMonData(param1, 0, NULL);
...
{
    u16 v0 = GetMonData(param1, 5, NULL);
    u32 v1 = GetMonData(param1, 12, NULL);
    u32 v2 = GetMonData(param1, 0, NULL);
