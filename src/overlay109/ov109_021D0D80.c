...
static void ov109_021D24F8 (UnkStruct_ov109_021D0F70 * param0)
{
    ...
    v1->unk_6C = PLString_Init(0x100, 95);

    for (v0 = 0; v0 < 5; v0++) {
        param0->unk_2C.unk_6C[v0] = PLString_Init(7 + 1, 95);
    }
...
static void ov109_021D25E8 (UnkStruct_ov109_021D0F70 * param0)
{
    ...
    PLString_Free(v1->unk_6C);

    for (v0 = 0; v0 < 5; v0++) {
        PLString_Free(param0->unk_2C.unk_6C[v0]);
    }
}
