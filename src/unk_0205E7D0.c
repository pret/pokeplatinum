...
void sub_0205EB38 (PlayerAvatar * param0, UnkStruct_02061AB4 * param1)
{
    param0->unk_30 = param1;
}

UnkStruct_02061AB4 * sub_0205EB3C (PlayerAvatar * param0)
{
...
const UnkStruct_02061AB4 * sub_0205EB54 (const PlayerAvatar * param0)
{
    return param0->unk_30;
}
