...
static void ov106_022423E8 (UnkStruct_ov106_02243118 * param0)
{
    ...
    for (v0 = 0; v0 < 2; v0++) {
        PLString_Free(param0->unk_30[v0]);
    }
...
static void ov106_02242500 (UnkStruct_ov106_02243118 * param0)
{
    ...
    param0->unk_28 = PLString_Init(600, 98);
    param0->unk_2C = PLString_Init(600, 98);

    for (v0 = 0; v0 < 2; v0++) {
        param0->unk_30[v0] = PLString_Init(32, 98);
    }
