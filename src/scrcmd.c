...
static BOOL ScrCmd_2A1(ScriptContext *ctx)
{
    ...
    MapObjectAnimCmd *v10 = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(MapObjectAnimCmd) * 64);
...
static void sub_02040F28(FieldSystem *fieldSystem, SysTask *param1, MapObjectAnimCmd *param2)
{
    ...
    v0 = Heap_AllocFromHeap(HEAP_ID_FIELD1, sizeof(UnkStruct_02040F28));
...
static BOOL ScrCmd_0AA(ScriptContext *ctx)
{
    ...
    *v1 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0203D8AC));
...
static BOOL ScrCmd_1D9(ScriptContext *ctx)
{
    ...
    *v3 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_ov90_021D0D80));
...
{
    void **v0 = FieldSystem_GetScriptMemberPtr(ctx->fieldSystem, SCRIPT_MANAGER_PARTY_MANAGEMENT_DATA);
    UnkStruct_02042434 *v1 = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_02042434));
...
static BOOL ScrCmd_StartChooseStarterScene(ScriptContext *ctx)
{
    ...
    *fieldSysDataPtr = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(ChooseStarterData));
...
static BOOL ScrCmd_2C4(ScriptContext *ctx)
{
    void **v0 = FieldSystem_GetScriptMemberPtr(ctx->fieldSystem, SCRIPT_MANAGER_PARTY_MANAGEMENT_DATA);
    u8 v1 = ScriptContext_ReadByte(ctx);
    UnkStruct_ov104_02230BE4 *v2 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_ov104_02230BE4));
...
static BOOL ScrCmd_313(ScriptContext *ctx)
{
    FieldSystem *fieldSystem = ctx->fieldSystem;
    u16 v1 = ScriptContext_GetVar(ctx);
    u32 v2 = Heap_FndGetTotalFreeSizeForExpHeap(HEAP_ID_FIELD2);
    u32 v3 = Heap_FndGetTotalFreeSizeForExpHeap(HEAP_ID_FIELD1);
    u32 v4 = Heap_FndGetTotalFreeSizeForExpHeap(HEAP_ID_FIELD3);
