...
static BOOL ScrCmd_AddMenuEntryImmediate(ScriptContext *ctx);
...
static BOOL ScrCmd_SetMenuHorizAnchor(ScriptContext *ctx);
static BOOL ScrCmd_ShowMenuVertAnchor(ScriptContext *ctx);
...
const ScrCmdFunc Unk_020EAC58[] = {
    ...
    ScrCmd_070,
    ScrCmd_071,
    ScrCmd_ShowMoneyWindow,
    ScrCmd_CloseMoneyWindow,
    ScrCmd_UpdateMoneyWindow,
    ScrCmd_ShowCoinWindow,
    ScrCmd_CloseCoinWindow,
    ScrCmd_UpdateCoinWindow,
    ScrCmd_078,
    ScrCmd_079,
    ScrCmd_07A,
    ScrCmd_AddItem,
    ...
    ScrCmd_ShowBPWindow,
    ScrCmd_CloseBPWindow,
    ScrCmd_UpdateBPWindow,
    ScrCmd_297,
    ScrCmd_298,
    ScrCmd_299,
    ScrCmd_29A,
    ...
    ScrCmd_338,
    ScrCmd_339,
    ScrCmd_SetMenuHorizAnchor,
    ScrCmd_ShowMenuVertAnchor,
    ScrCmd_33C,
    ScrCmd_33D,
    ScrCmd_33E,
    ScrCmd_33F,
...
static BOOL ScrCmd_SetMenuHorizAnchor(ScriptContext *ctx)
{
    ...
    FieldMenuManager_SetHorizontalAnchor(*fieldMenuMan, horizontalAnchor);
    return TRUE;
}
...
static BOOL ScrCmd_ShowMenuVertAnchor(ScriptContext *ctx)
{
    ...
    FieldMenuManager_SetVerticalAnchor(*fieldMenuMan, verticalAnchor);
    return TRUE;
}
