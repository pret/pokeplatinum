...
const ScrCmdFunc Unk_020EAC58[] = {
    ...
    ScrCmd_GetPokemonPotential,
    ScrCmd_SetFavoritePokemon,
    ScrCmd_GetFavoritePokemon,
    ...
    ScrCmd_30D,
    ScrCmd_30E,
    ScrCmd_CheckAchievementRequirements,
    ScrCmd_310,
    ScrCmd_311,
    ScrCmd_312,
    ...
    ScrCmd_IncrementSecretBaseProgress,
    ScrCmd_ElevateAllMapObjects,
    ScrCmd_ResetAllMapObjectElevation,
    ScrCmd_CheckPartyHasHeldItem,
    ScrCmd_ClearWiFiHistory,
    ScrCmd_ElevateSpecificMapObjects,
    ScrCmd_ResetSpecificMapObjectElevation,
    ScrCmd_SetPlayerVolume,
    ScrCmd_AddToGameRecord,
    ScrCmd_AddToGameRecordBigValue,
    ScrCmd_336,
    ScrCmd_CheckHasSeenSpecies,
    ScrCmd_ElevateMapObjectByPosition,
    ScrCmd_ResetMapObjectElevation,
