...
static BOOL SetPlayerHeightCalculationEnabled(ScriptContext *ctx);
...
static BOOL TriggerPlatformLift(ScriptContext *ctx);
static BOOL CheckPlatformLiftNotUsedWhenEnteredMap(ScriptContext *ctx);
