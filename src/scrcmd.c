...
static BOOL ScrCmd_0BB(ScriptContext *ctx)
{
    ...
    sub_0203DFE8(ctx->task, 1, Pokemon_GetData(v1, MON_DATA_SPECIES, NULL), 10, v3, v0, ScriptContext_GetVarPointer(ctx));
...
static BOOL ScrCmd_233(ScriptContext *ctx)
{
    ...
    v3[0] = Pokemon_GetData(mon, MON_DATA_HP_EV, NULL);
    v3[1] = Pokemon_GetData(mon, MON_DATA_ATK_EV, NULL);
    v3[2] = Pokemon_GetData(mon, MON_DATA_DEF_EV, NULL);
    v3[3] = Pokemon_GetData(mon, MON_DATA_SPEED_EV, NULL);
    v3[4] = Pokemon_GetData(mon, MON_DATA_SPATK_EV, NULL);
    v3[5] = Pokemon_GetData(mon, MON_DATA_SPDEF_EV, NULL);
