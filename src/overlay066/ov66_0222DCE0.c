...
int ov66_0222DCE0(OverlayManager *overlayMan, int *param1)
{
    ...
    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov66_0222DD90), HEAP_ID_104);
...
int ov66_0222DD6C(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov66_0222DD90 *v0;
    int v1;
...
int ov66_0222DD90(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov66_0222DD90 *v0 = OverlayManager_Data(overlayMan);
