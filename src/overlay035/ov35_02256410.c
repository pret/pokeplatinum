...
struct UnkStruct_ov35_02256410_t {
    ...
    PoketchAnimation_AnimatedSpriteData *unk_28[4];
    PoketchAnimation_SpriteData unk_38;
    PoketchAnimation_SpriteData unk_4C;
};
...
static void ov35_02256460(UnkStruct_ov35_02256410 *param0, const UnkStruct_ov35_02256410_1 *param1)
{
    ...
    PoketchAnimation_LoadSpriteFromNARC(&param0->unk_38, 12, 45, 46, 8);
    PoketchAnimation_LoadSpriteFromNARC(&param0->unk_4C, 12, 3, 4, 8);

    param0->unk_24 = PoketchAnimation_SetupNewAnimatedSprite(param0->unk_20, &v0, &param0->unk_38);

    PoketchAnimation_SetSpriteCharNo(param0->unk_24, 80);

    for (v2 = 0; v2 < 4; v2++) {
        param0->unk_28[v2] = PoketchAnimation_SetupNewAnimatedSprite(param0->unk_20, &v1, &param0->unk_4C);
        PoketchAnimation_SetSpritePosition(param0->unk_28[v2], 360448 + 65536 * v2, 262144);
    }
...
static void ov35_02256514(UnkStruct_ov35_02256410 *param0)
{
    ...
    PoketchAnimation_FreeSpriteData(&(param0->unk_38));
    PoketchAnimation_FreeSpriteData(&(param0->unk_4C));
}
...
static void ov35_02256598(SysTask *param0, void *param1)
{
    ...
    Graphics_LoadTilesToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 44, v2->unk_04, 6, 0, 0, 1, HEAP_ID_POKETCH_APP);
    Graphics_LoadTilemapToBgLayer(NARC_INDEX_GRAPHIC__POKETCH, 43, v2->unk_04, 6, 0, 0, 1, HEAP_ID_POKETCH_APP);
