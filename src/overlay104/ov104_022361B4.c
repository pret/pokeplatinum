...
static void ov104_02236528(UnkStruct_ov104_0223BA10 *param0)
{
    ...
    for (int i = 0; i < v0; i++) {
        ...
        param0->unk_394[i][0] = Pokemon_GetData(mon, MON_DATA_MOVE1_PP, NULL);
        param0->unk_394[i][1] = Pokemon_GetData(mon, MON_DATA_MOVE2_PP, NULL);
        param0->unk_394[i][2] = Pokemon_GetData(mon, MON_DATA_MOVE3_PP, NULL);
        param0->unk_394[i][3] = Pokemon_GetData(mon, MON_DATA_MOVE4_PP, NULL);
    }
...
static void ov104_022366A4(UnkStruct_ov104_0223BA10 *param0)
{
    ...
    for (v4 = 0; v4 < v0; v4++) {
        ...
        Pokemon_SetData(v5, MON_DATA_MOVE1_PP, &v3);

        v3 = (u8)sub_02030398(param0->unk_08, 3, v4, 1, NULL);
        Pokemon_SetData(v5, MON_DATA_MOVE2_PP, &v3);

        v3 = (u8)sub_02030398(param0->unk_08, 3, v4, 2, NULL);
        Pokemon_SetData(v5, MON_DATA_MOVE3_PP, &v3);

        v3 = (u8)sub_02030398(param0->unk_08, 3, v4, 3, NULL);
        Pokemon_SetData(v5, MON_DATA_MOVE4_PP, &v3);
...
void ov104_02236848(UnkStruct_ov104_0223BA10 *param0, u8 param1)
{
    ...
    for (v0 = 0; v0 < v8; v0++) {
        ...
        v4[0] = Pokemon_GetData(v11, MON_DATA_MOVE1_PP, NULL);
        sub_02030308(param0->unk_08, 3, v0, 0, v4);

        v4[0] = Pokemon_GetData(v11, MON_DATA_MOVE2_PP, NULL);
        sub_02030308(param0->unk_08, 3, v0, 1, v4);

        v4[0] = Pokemon_GetData(v11, MON_DATA_MOVE3_PP, NULL);
        sub_02030308(param0->unk_08, 3, v0, 2, v4);

        v4[0] = Pokemon_GetData(v11, MON_DATA_MOVE4_PP, NULL);
...
void ov104_02236C50(UnkStruct_ov104_0223BA10 *param0)
{
    ...
    for (v2 = v0; v2 < (v1 + v0); v2++) {
        ...
        param0->unk_394[v2 - v0][0] = Pokemon_GetData(v4, MON_DATA_MOVE1_PP, NULL);
        param0->unk_394[v2 - v0][1] = Pokemon_GetData(v4, MON_DATA_MOVE2_PP, NULL);
        param0->unk_394[v2 - v0][2] = Pokemon_GetData(v4, MON_DATA_MOVE3_PP, NULL);
        param0->unk_394[v2 - v0][3] = Pokemon_GetData(v4, MON_DATA_MOVE4_PP, NULL);
    }
...
int ov104_02236D10(UnkStruct_ov104_0223BA10 *param0)
{
    ...
    for (v5 = v2; v5 < (v0 + v2); v5++) {
        ...
        v8 += Pokemon_GetData(v9, MON_DATA_MOVE1_PP, NULL);
        v8 += Pokemon_GetData(v9, MON_DATA_MOVE2_PP, NULL);
        v8 += Pokemon_GetData(v9, MON_DATA_MOVE3_PP, NULL);
        v8 += Pokemon_GetData(v9, MON_DATA_MOVE4_PP, NULL);
    }
