...
UnkStruct_0204B184 * ov104_0222DD04 (UnkStruct_ov104_0223A348_sub1 * param0, int param1, int param2, int param3)
{
    ...
    MessageFormatter * v1 = MessageFormatter_Init(1, 26, 21, param2);
    Strbuf* v2;
    ...
    v2 = MessageFormatter_AllocStrbuf(v1, param1);
...
void ov104_0222DF40 (const UnkStruct_ov104_0223A348_sub2 * param0, Pokemon * param1, u8 param2)
{
    ...
    if (param0->unk_14_val1_30) {
        ...
        v7 = MessageFormatter_Init(1, 26, 412, 4);
        v8 = MessageFormatter_AllocStrbuf(v7, param0->unk_00_val1_0);
...
void ov104_0222E134 (UnkStruct_021C0794 * param0, Pokemon * param1)
{
    ...
    v2 = MessageFormatter_Init(0, 26, 363, 11);
    v1 = MessageFormatter_AllocStrbuf(v2, 0);
