...
void ov104_0222DF40(const UnkStruct_ov104_0223A348_sub2 *param0, Pokemon *param1, u8 param2)
{
    ...
    if (param0->unk_14_val1_30) {
        ...
        v7 = MessageLoader_Init(MESSAGE_LOADER_NARC_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 412, HEAP_ID_FIELD);
...
void ov104_0222E134(SaveData *param0, Pokemon *param1)
{
    ...
    v2 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 363, HEAP_ID_FIELDMAP);
