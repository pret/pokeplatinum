...
void ov104_02234148 (UnkStruct_ov104_0223ADA0 * param0, u8 param1)
{
    ...
    for (v0 = 0; v0 < v9; v0++) {
        ...
        v5[0] = GetMonData(v12, 71, NULL);
        sub_0202FF84(param0->unk_4F4, 5, v0, v5);

        v7[0] = GetMonData(v12, 0, NULL);
...
void ov104_02234570 (UnkStruct_ov104_0223ADA0 * param0)
{
    ...
    for (v0 = 0; v0 < v1; v0++) {
        ...
        v4[v0] = GetMonData(v6, 5, NULL);
        v5[v0] = GetMonData(v6, 6, NULL);
    }
    ...
    for (v0 = 0; v0 < v1; v0++) {
        ...
        v4[v0 + v2] = GetMonData(v6, 5, NULL);
        v5[v0 + v2] = GetMonData(v6, 6, NULL);
