...
BOOL ov104_02237460 (UnkStruct_ov104_0222E930 * param0)
{
    ...
    if (v9->unk_13 == 17) {
        ...
        for (v1 = 0; v1 < v0; v1++) {
            ...
            v7 = GetMonData(v11, 161, NULL);
            v7 -= 3;
            v6 = sub_02075AD0(GetMonData(v11, 5, NULL), v7);
    ...
    for (v1 = 0; v1 < v4; v1++) {
        ...
        v5 = v9->unk_94[v1];
        sub_02074B30(v11, 164, &v5);
        sub_02074B30(v11, 163, &v5);

        v5 = v9->unk_A4[v1];
        sub_02074B30(v11, 165, &v5);

        v5 = v9->unk_B4[v1];
        sub_02074B30(v11, 166, &v5);

        v5 = v9->unk_C4[v1];
        sub_02074B30(v11, 167, &v5);

        v5 = v9->unk_D4[v1];
        sub_02074B30(v11, 168, &v5);

        v5 = v9->unk_E4[v1];
        sub_02074B30(v11, 169, &v5);
    }
...
static void ov104_02237634 (UnkStruct_ov104_02238240 * param0, UnkStruct_ov104_0223BFFC * param1)
{
    ...
    for (v0 = 0; v0 < v1; v0++) {
        ...
        param1->unk_94[v0] = GetMonData(v2, 164, NULL);
        param1->unk_A4[v0] = GetMonData(v2, 165, NULL);
        param1->unk_B4[v0] = GetMonData(v2, 166, NULL);
        param1->unk_C4[v0] = GetMonData(v2, 167, NULL);
        param1->unk_D4[v0] = GetMonData(v2, 168, NULL);
        param1->unk_E4[v0] = GetMonData(v2, 169, NULL);
    }
...
BOOL ov104_02237748 (UnkStruct_ov104_0222E930 * param0)
{
    ...
    case 18:
        ...
        for (v11 = 0; v11 < 3; v11++) {
            ...
            sub_02074B30(v1, 6, &v3->unk_412[v11]);
        }
        break;
    case 19:
