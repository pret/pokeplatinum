...
BOOL ov104_02237460(UnkStruct_ov104_0222E930 *param0)
{
    ...
    if (v9->unk_13 == 17) {
        ...
        for (v1 = 0; v1 < v0; v1++) {
            ...
            Pokemon_SetData(v11, MON_DATA_EXP, &v6);
    ...
    for (v1 = 0; v1 < v4; v1++) {
        ...
        v5 = v9->unk_B4[v1];
        Pokemon_SetData(v11, MON_DATA_DEF, &v5);

        v5 = v9->unk_C4[v1];
        Pokemon_SetData(v11, MON_DATA_SPEED, &v5);

        v5 = v9->unk_D4[v1];
        Pokemon_SetData(v11, MON_DATA_SP_ATK, &v5);

        v5 = v9->unk_E4[v1];
        Pokemon_SetData(v11, MON_DATA_SP_DEF, &v5);
    }
...
BOOL ov104_02237748(UnkStruct_ov104_0222E930 *param0)
{
    ...
    case 18:
        ...
        for (v11 = 0; v11 < 3; v11++) {
            ...
            Pokemon_SetData(v1, MON_DATA_HELD_ITEM, &v3->unk_412[v11]);
        }
        break;
    case 19:
