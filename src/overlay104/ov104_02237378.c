...
static void ov104_02237634 (UnkStruct_ov104_02238240 * param0, UnkStruct_ov104_0223BFFC * param1)
{
    ...
    v1 = sub_0207A0F8(param1->unk_70);

    for (v0 = 0; v0 < v1; v0++) {
        v2 = sub_0207A0FC(param1->unk_70, v0);
...
BOOL ov104_02237748 (UnkStruct_ov104_0222E930 * param0)
{
    ...
    case 15:
        if (v18 == 0) {
            v1 = sub_0207A0FC(v3->unk_70, 0);
        } else {
            v1 = sub_0207A0FC(v3->unk_74, 0);
        }
    ...
    case 16:
        *v20 = v3->unk_13;
        break;
    case 18:
        v2 = sub_0207A268(v14->unk_08);

        for (v11 = 0; v11 < 3; v11++) {
            v1 = sub_0207A0FC(v2, v3->unk_2C[v11]);
