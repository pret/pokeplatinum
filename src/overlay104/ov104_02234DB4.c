...
UnkStruct_ov104_0223B5C0 * ov104_02234DB4 (UnkStruct_021C0794 * param0, u16 param1, u8 param2, u8 param3, u8 param4)
{
    ...
    v10 = sub_02018144(11, sizeof(UnkStruct_ov104_0223B5C0));
    ...
    for (v5 = 0; v5 < v4; v5++) {
        v9 = sub_0207A0FC(sub_0207A268(v10->unk_6FC), v10->unk_260[v5]);
...
static void ov104_022350B8 (UnkStruct_ov104_0223B5C0 * param0)
{
    ...
    v6 = sub_0207A0FC(param0->unk_264, 0);
...
void ov104_02235190 (UnkStruct_ov104_0223B5C0 * param0)
{
    ...
    if (param0->unk_264 != NULL) {
        sub_020181C4(param0->unk_264);
    }

    if (param0->unk_D8C != NULL) {
        sub_020181C4(param0->unk_D8C);
    }
...
void ov104_0223526C (UnkStruct_ov104_0223B5C0 * param0, u8 param1)
{
    ...
    v10 = sub_0207A0FC(sub_0207A268(param0->unk_6FC), param0->unk_260[0]);
