...
UnkStruct_ov104_0223B5C0 * ov104_02234DB4 (UnkStruct_021C0794 * param0, u16 param1, u8 param2, u8 param3, u8 param4)
{
    ...
    for (v5 = 0; v5 < v4; v5++) {
        ...
        v10->unk_728[v5] = GetMonData(v9, 6, NULL);
    }
...
static void ov104_022350B8 (UnkStruct_ov104_0223B5C0 * param0)
{
    ...
    ov104_0223B0C8(1, param0->unk_6F4, v0, param0->unk_05, GetMonData(v6, 5, NULL), param0->unk_268, v3);
...
void ov104_0223526C (UnkStruct_ov104_0223B5C0 * param0, u8 param1)
{
    ...
    sub_020306E4(v4, sub_0205E55C(param0->unk_04), sub_0205E6A8(sub_0205E55C(param0->unk_04)), GetMonData(v10, 5, NULL));
    return;
}
