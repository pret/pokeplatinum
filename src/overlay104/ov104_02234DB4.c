...
UnkStruct_ov104_0223B5C0 *ov104_02234DB4(SaveData *param0, u16 param1, u8 param2, u8 param3, u8 param4)
{
    ...
    for (v5 = 0; v5 < v4; v5++) {
        v9 = Party_GetPokemonBySlotIndex(SaveData_GetParty(v10->unk_6FC), v10->unk_260[v5]);
...
void ov104_0223526C(UnkStruct_ov104_0223B5C0 *param0, u8 param1)
{
    ...
    v10 = Party_GetPokemonBySlotIndex(SaveData_GetParty(param0->unk_6FC), param0->unk_260[0]);
