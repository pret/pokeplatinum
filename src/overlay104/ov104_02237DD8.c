...
void ov104_02238764(UnkStruct_ov104_0223BFFC *param0, UnkStruct_ov104_0223C4CC *param1, u16 param2)
{
    ...
    if (param2 == 0) {
        for (v2 = 0; v2 < v0; v2++) {
            ...
            CellActor_SetAnimateFlag(param0->unk_30[v2]->sprite, 0);
        }
    } else {
        for (v2 = 0; v2 < v1; v2++) {
            ...
            CellActor_SetAnimateFlag(param0->unk_40[v2]->sprite, 0);
        }
    }
...
void ov104_0223886C(UnkStruct_ov104_0223BFFC *param0, UnkStruct_ov104_0223C4CC *param1, u16 param2, u16 param3)
{
    ...
    if (param2 == 1) {
        CellActor_SetDrawFlag(param0->unk_30[param3]->sprite, 1);
    } else {
        CellActor_SetDrawFlag(param0->unk_30[param3]->sprite, 0);
    }
...
void ov104_022388A4(UnkStruct_ov104_0223BFFC *param0, UnkStruct_ov104_0223C4CC *param1, u16 param2, u16 param3)
{
    ...
    if (param2 == 1) {
        CellActor_SetDrawFlag(param0->unk_40[param3]->sprite, 1);
    } else {
        CellActor_SetDrawFlag(param0->unk_40[param3]->sprite, 0);
    }
    ...
    if (param2 == 0) {
        for (v2 = 0; v2 < v0; v2++) {
            ...
            if (Pokemon_GetValue(v3, MON_DATA_HELD_ITEM, NULL) == 0) {
                CellActor_SetDrawFlag(param0->unk_50[v2]->sprite, 0);
            }
        }
    } else {
        for (v2 = 0; v2 < v1; v2++) {
            ...
            if (Pokemon_GetValue(v3, MON_DATA_HELD_ITEM, NULL) == 0) {
                CellActor_SetDrawFlag(param0->unk_60[v2]->sprite, 0);
            }
        }
    }
...
void ov104_022389F4(UnkStruct_ov104_0223BFFC *param0, UnkStruct_ov104_0223C4CC *param1, u16 param2, u16 param3, u16 param4)
{
    ...
    if (param2 == 0) {
        ...
        if (param4 == 1) {
            if (v0 == 0) {
                CellActor_SetDrawFlag(param0->unk_50[param3]->sprite, 0);
            } else {
                CellActor_SetDrawFlag(param0->unk_50[param3]->sprite, 1);
            }
        } else {
            CellActor_SetDrawFlag(param0->unk_50[param3]->sprite, 0);
        }
        ...
        if (param4 == 1) {
            if (v0 == 0) {
                CellActor_SetDrawFlag(param0->unk_60[param3]->sprite, 0);
            } else {
                CellActor_SetDrawFlag(param0->unk_60[param3]->sprite, 1);
            }
        } else {
            CellActor_SetDrawFlag(param0->unk_60[param3]->sprite, 0);
        }
