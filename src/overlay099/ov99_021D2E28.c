...
static void ov99_021D2ED8(UnkStruct_ov99_021D2CB0 *param0, UnkStruct_ov99_021D2E28 *param1)
{
    ...
    for (v0 = 2; v0 <= 3; v0++, v1++) {
        ...
        CellActorData_SetPositionWithOffsetFx32(param0->unk_10E0[v0], param1->unk_94[v1].unk_00 + param1->unk_94[v1].unk_28, param1->unk_94[v1].unk_04 + param1->unk_94[v1].unk_2C, ((192 + 80) << FX32_SHIFT));
...
static void ov99_021D2FD4(UnkStruct_ov99_021D2CB0 *param0, UnkStruct_ov99_021D2E28 *param1, CellActorData *param2, int param3)
{
    ...
    if (v0->unk_38 == 0) {
        CellActorData_AddAffineZRotation(param2, v1->unk_4C);
    } else {
        CellActorData_AddAffineZRotation(param2, -v1->unk_4C);
    }
    ...
    v0->unk_04 -= v1->unk_48;
    CellActorData_SetPositionWithOffsetFx32(param2, v0->unk_00 + v0->unk_28, v0->unk_04 + v0->unk_2C, ((192 + 80) << FX32_SHIFT));
}
