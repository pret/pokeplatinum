...
static void ov99_021D2CB0(UnkStruct_ov99_021D2CB0 *param0, UnkStruct_ov99_021D2C08 *param1)
{
    ...
    for (v0 = 2; v0 <= 4; v0++, v1++) {
        CellActorData_SetPositionWithOffsetFx32(param0->unk_10E0[v0], Unk_ov99_021D4B70[v1].unk_04, Unk_ov99_021D4B70[v1].unk_08, ((192 + 80) << FX32_SHIFT));
...
static void ov99_021D2D18(UnkStruct_ov99_021D2CB0 *param0, UnkStruct_ov99_021D2C08 *param1, CellActorData *param2, int param3)
{
    ...
    if (v0->unk_12 == 0) {
        CellActorData_AddAffineScaleFx32(param2, v1->unk_1C, v1->unk_1C);
    } else {
        CellActorData_AddAffineScaleFx32(param2, -v1->unk_1C, -v1->unk_1C);
    }
