...
typedef struct {
    ...
    UnkStruct_02018340 * unk_D0;
    UnkStruct_0205AA50 unk_D4;
    UnkStruct_0205AA50 unk_E4;
    UnkStruct_0205AA50 unk_F4;
    UnkStruct_0205AA50 unk_104[3];
    UnkStruct_ov5_021D30A8 unk_134;
    UnkStruct_0200D0F4 * unk_2FC[2];
...
static int sub_0206F658 (UnkStruct_0206F7F8 * param0)
{
    ...
    case 0:
        sub_0201ADA4(&param0->unk_E4, (((15 << 4) | 15)));
...
static void sub_0206FA08 (UnkStruct_0206F7F8 * param0)
{
    ...
    param0->unk_2C.unk_08 = PLString_AllocFromHeap((38 * 2), param0->unk_00);
    ...
    param0->unk_2C.unk_18 = sub_0200B1EC(param0->unk_2C.unk_00, 14);

    for (v0 = 0; v0 < param0->unk_18; v0++) {
        param0->unk_2C.unk_38[v0] = sub_0200B1EC(param0->unk_2C.unk_00, 0 + param0->unk_19 + v0);
        param0->unk_2C.unk_50[v0] = sub_0200B1EC(param0->unk_2C.unk_00, 23 + param0->unk_19 + v0);
    }

    for (v0 = 0; v0 < 7; v0++) {
        param0->unk_2C.unk_1C[v0] = sub_0200B1EC(param0->unk_2C.unk_00, 15 + v0);
    }

    for (v0 = 0; v0 < 3; v0++) {
        param0->unk_2C.unk_68[v0] = sub_0200B1EC(param0->unk_2C.unk_00, 37 + v0);
    }
}
...
static void sub_0206FAC0 (UnkStruct_0206F7F8 * param0)
{
    ...
    for (v0 = 0; v0 < 3; v0++) {
        PLString_FreeToHeap(param0->unk_2C.unk_68[v0]);
    }

    for (v0 = 0; v0 < 7; v0++) {
        PLString_FreeToHeap(param0->unk_2C.unk_1C[v0]);
    }

    for (v0 = 0; v0 < param0->unk_18; v0++) {
        PLString_FreeToHeap(param0->unk_2C.unk_38[v0]);
        PLString_FreeToHeap(param0->unk_2C.unk_50[v0]);
    }

    PLString_FreeToHeap(param0->unk_2C.unk_18);
    PLString_FreeToHeap(param0->unk_2C.unk_14);
    PLString_FreeToHeap(param0->unk_2C.unk_10);
    PLString_FreeToHeap(param0->unk_2C.unk_0C);
    PLString_FreeToHeap(param0->unk_2C.unk_08);
...
static void sub_0206FB38 (UnkStruct_0206F7F8 * param0)
{
    ...
    sub_0201A7E8(param0->unk_D0, &param0->unk_E4, 3, 2, 19, 27, 4, 12, ((1024 - (18 + 12) - 9) - 27 * 4));
    sub_0201ADA4(&param0->unk_E4, (((15 << 4) | 15)));
}
...
static void sub_0206FC4C (UnkStruct_0206F7F8 * param0)
{
    ...
    sub_0201A8FC(&param0->unk_E4);
    sub_02019690(1, 32 * (24 * (12 + 2) + 9 + 1), 0, param0->unk_00);
    sub_02019CB8(param0->unk_D0, 1, 0x0, 0, 0, 32, 32, 17);
    sub_0201C3C0(param0->unk_D0, 1);
    sub_02019120(1, 0);
    sub_02019060(0, param0->unk_10);
    sub_02019060(1, param0->unk_12);
}
...
static void sub_0206FDC0 (UnkStruct_0206F7F8 * param0, u16 param1, u16 param2)
{
    ...
    sub_0201A7E8(param0->unk_D0, &param0->unk_D4, 1, 4, 1, 24, v1 * 2, 13, 1);
    sub_0201ADA4(&param0->unk_D4, (((15 << 4) | 15)));
    ...
    sub_0200DC48(&param0->unk_D4, 0, (1024 - (18 + 12) - 9), 11);
...
static void sub_0206FF10 (UnkStruct_0206F7F8 * param0)
{
    ...
    sub_0200DC9C(&(param0->unk_D4), 0);
    sub_0201A8FC(&(param0->unk_D4));
...
static void sub_020701DC (UnkStruct_0206F7F8 * param0, u16 param1)
{
    sub_0201A7E8(param0->unk_D0, &param0->unk_D4, 1, 4, 1, 24, 12, 13, 1);
    sub_0200DC48(&param0->unk_D4, 1, (1024 - (18 + 12) - 9), 11);
    sub_02070050(param0, 0);
    sub_0200D3F4(param0->unk_2FC[1], 1);
    sub_0201A7E8(param0->unk_D0, &param0->unk_F4, 3, 8, 14, 8, 2, 13, (((((1024 - (18 + 12) - 9) - 27 * 4) - 6 * 4)) - (8 * 2)));
    sub_0201ADA4(&param0->unk_F4, (((0 << 4) | 0)));
