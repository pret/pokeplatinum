...
static const RibbonData sRibbonDataTable[] = {
    [RIBBON_HOENN_CHAMPION] = {
        .monDataParam = MON_DATA_HOENN_CHAMPION_RIBBON,
    ...
    [RIBBON_HOENN_WINNING] = {
        .monDataParam = MON_DATA_HOENN_WINNING_RIBBON,
    ...
    [RIBBON_HOENN_VICTORY] = {
        .monDataParam = MON_DATA_HOENN_VICTORY_RIBBON,
    ...
    [RIBBON_HOENN_ARTIST] = {
        .monDataParam = MON_DATA_HOENN_ARTIST_RIBBON,
    ...
    [RIBBON_HOENN_EFFORT] = {
        .monDataParam = MON_DATA_HOENN_EFFORT_RIBBON,
    ...
    [RIBBON_HOENN_MARINE] = {
        .monDataParam = MON_DATA_HOENN_MARINE_RIBBON,
    ...
    [RIBBON_HOENN_LAND] = {
        .monDataParam = MON_DATA_HOENN_LAND_RIBBON,
        .spriteID = hoenn_marine_land_sky_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_HOENN_SKY] = {
        .monDataParam = MON_DATA_HOENN_SKY_RIBBON,
        .spriteID = hoenn_marine_land_sky_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_HOENN_COUNTRY] = {
        .monDataParam = MON_DATA_HOENN_COUNTRY_RIBBON,
    ...
    [RIBBON_HOENN_NATIONAL] = {
        .monDataParam = MON_DATA_HOENN_NATIONAL_RIBBON,
        .spriteID = hoenn_country_national_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_HOENN_EARTH] = {
        .monDataParam = MON_DATA_HOENN_EARTH_RIBBON,
    ...
    [RIBBON_HOENN_WORLD] = {
        .monDataParam = MON_DATA_HOENN_WORLD_RIBBON,
        .spriteID = hoenn_earth_world_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_COOL] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_COOL_RIBBON,
    ...
    [RIBBON_COOL_GREAT] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_COOL_RIBBON_GREAT,
    ...
    [RIBBON_COOL_ULTRA] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_COOL_RIBBON_ULTRA,
    ...
    [RIBBON_COOL_MASTER] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_COOL_RIBBON_MASTER,
    ...
    [RIBBON_BEAUTY] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_BEAUTY_RIBBON,
        .spriteID = sinnoh_contest_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_BEAUTY_GREAT] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_BEAUTY_RIBBON_GREAT,
        .spriteID = sinnoh_contest_great_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_BEAUTY_ULTRA] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_BEAUTY_RIBBON_ULTRA,
        .spriteID = sinnoh_contest_ultra_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_BEAUTY_MASTER] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_BEAUTY_RIBBON_MASTER,
        .spriteID = sinnoh_contest_master_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_CUTE] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_CUTE_RIBBON,
        .spriteID = sinnoh_contest_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_CUTE_GREAT] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_CUTE_RIBBON_GREAT,
        .spriteID = sinnoh_contest_great_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_CUTE_ULTRA] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_CUTE_RIBBON_ULTRA,
        .spriteID = sinnoh_contest_ultra_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_CUTE_MASTER] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_CUTE_RIBBON_MASTER,
        .spriteID = sinnoh_contest_master_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_SMART] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_SMART_RIBBON,
        .spriteID = sinnoh_contest_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_SMART_GREAT] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_SMART_RIBBON_GREAT,
        .spriteID = sinnoh_contest_great_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_SMART_ULTRA] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_SMART_RIBBON_ULTRA,
        .spriteID = sinnoh_contest_ultra_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_SMART_MASTER] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_SMART_RIBBON_MASTER,
        .spriteID = sinnoh_contest_master_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_TOUGH] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_TOUGH_RIBBON,
        .spriteID = sinnoh_contest_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_TOUGH_GREAT] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_TOUGH_RIBBON_GREAT,
        .spriteID = sinnoh_contest_great_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_TOUGH_ULTRA] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_TOUGH_RIBBON_ULTRA,
        .spriteID = sinnoh_contest_ultra_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_TOUGH_MASTER] = {
        .monDataParam = MON_DATA_SINNOH_SUPER_TOUGH_RIBBON_MASTER,
        .spriteID = sinnoh_contest_master_NCGR,
        .paletteNum = 4,
    ...
    [RIBBON_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_ABILITY_RIBBON,
    ...
    [RIBBON_GREAT_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_GREAT_ABILITY_RIBBON,
    ...
    [RIBBON_DOUBLE_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_DOUBLE_ABILITY_RIBBON,
    ...
    [RIBBON_MULTI_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_MULTI_ABILITY_RIBBON,
    ...
    [RIBBON_PAIR_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_PAIR_ABILITY_RIBBON,
    ...
    [RIBBON_WORLD_ABILITY] = {
        .monDataParam = MON_DATA_SINNOH_WORLD_ABILITY_RIBBON,
    ...
    [RIBBON_ALERT] = {
        .monDataParam = MON_DATA_SINNOH_ALERT_RIBBON,
        .spriteID = alert_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_SHOCK] = {
        .monDataParam = MON_DATA_SINNOH_SHOCK_RIBBON,
        .spriteID = shock_NCGR,
        .paletteNum = 0,
    ...
    [RIBBON_DOWNCAST] = {
        .monDataParam = MON_DATA_SINNOH_DOWNCAST_RIBBON,
    ...
    [RIBBON_CARELESS] = {
        .monDataParam = MON_DATA_SINNOH_CARELESS_RIBBON,
    ...
    [RIBBON_RELAX] = {
        .monDataParam = MON_DATA_SINNOH_RELAX_RIBBON,
        .spriteID = relax_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_SNOOZE] = {
        .monDataParam = MON_DATA_SINNOH_SNOOZE_RIBBON,
    ...
    [RIBBON_SMILE] = {
        .monDataParam = MON_DATA_SINNOH_SMILE_RIBBON,
        .spriteID = smile_NCGR,
        .paletteNum = 2,
    ...
    [RIBBON_GORGEOUS] = {
        .monDataParam = MON_DATA_SINNOH_GORGEOUS_RIBBON,
    ...
    [RIBBON_ROYAL] = {
        .monDataParam = MON_DATA_SINNOH_ROYAL_RIBBON,
        .spriteID = royal_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_GORGEOUS_ROYAL] = {
        .monDataParam = MON_DATA_SINNOH_GORGEOUS_ROYAL_RIBBON,
    ...
    [RIBBON_FOOTPRINT] = {
        .monDataParam = MON_DATA_SINNOH_FOOTPRINT_RIBBON,
    ...
    [RIBBON_RECORD] = {
        .monDataParam = MON_DATA_SINNOH_RECORD_RIBBON,
    ...
    [RIBBON_HISTORY] = {
        .monDataParam = MON_DATA_SINNOH_HISTORY_RIBBON,
    ...
    [RIBBON_LEGEND] = {
        .monDataParam = MON_DATA_SINNOH_LEGEND_RIBBON,
    ...
    [RIBBON_RED] = {
        .monDataParam = MON_DATA_SINNOH_RED_RIBBON,
        .spriteID = red_NCGR,
        .paletteNum = 0,
    ...
    [RIBBON_GREEN] = {
        .monDataParam = MON_DATA_SINNOH_GREEN_RIBBON,
        .spriteID = green_NCGR,
        .paletteNum = 3,
    ...
    [RIBBON_BLUE] = {
        .monDataParam = MON_DATA_SINNOH_BLUE_RIBBON,
        .spriteID = blue_NCGR,
        .paletteNum = 1,
    ...
    [RIBBON_FESTIVAL] = {
        .monDataParam = MON_DATA_SINNOH_FESTIVAL_RIBBON,
    ...
    [RIBBON_CARNIVAL] = {
        .monDataParam = MON_DATA_SINNOH_CARNIVAL_RIBBON,
    ...
    [RIBBON_CLASSIC] = {
        .monDataParam = MON_DATA_SINNOH_CLASSIC_RIBBON,
    ...
    [RIBBON_PREMIER] = {
        .monDataParam = MON_DATA_SINNOH_PREMIER_RIBBON,
