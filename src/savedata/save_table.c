...
const SaveTableEntry gSaveTable[] = {
    ...
    { SAVE_TABLE_ENTRY_TRAINER_CARD_SIGNATURE, SAVE_BLOCK_ID_NORMAL, (SaveEntrySizeFunc)TrainerCardSignature_SaveSize, (SaveEntryInitFunc)TrainerCardSignature_Init },
