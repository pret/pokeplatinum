...
BOOL ScrCmd_0FA(ScriptContext *param0)
{
    ...
    v8.unk_04 = PokedexData_IsNationalDexObtained(SaveData_Pokedex(param0->fieldSystem->saveData));
    v8.unk_05 = v7;
    v8.unk_08 = v1;
    v8.unk_0C = v0;
    v8.unk_10 = v3;
...
BOOL ScrCmd_0FB(ScriptContext *param0)
{
    ...
    sub_02094C44(*v1, param0->fieldSystem->saveData, v3, param0->fieldSystem->journalEntry);
    sub_02093AD4(*v1);
