...
BOOL ScrCmd_0F8 (ScriptContext * param0)
{
    void ** v0 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_DATA_PTR);
...
BOOL ScrCmd_0FA (ScriptContext * param0)
{
    Strbuf* v0;
    Pokemon * v1;
    void ** v2 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_DATA_PTR);
...
{
    Pokemon * v0;
    void ** v1 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_DATA_PTR);
...
{
    void ** v0 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_DATA_PTR);
    StringTemplate ** v1 = FieldSystem_GetScriptMember(param0->fieldSystem, SCRIPT_MANAGER_STR_TEMPLATE);
    u16 v2 = ScriptContext_GetVar(param0);
