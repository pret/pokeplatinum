...
#define BALL_TARGET_ORBIT_RADIUS_X  75776
#define BALL_TARGET_ORBIT_RADIUS_Y  101376
#define BALL_INITIAL_ROTATION_ANGLE 55408
#define BALL_ROTATION_SPEED         62800
#define BALL_INITIAL_CENTER_Y       0xFFF50E00
#define BALL_INITIAL_CENTER_Z       925696
#define BALL_TARGET_CENTER_Y        4025344
#define BALL_TARGET_CENTER_Z        (int)0xFFE44000
#define BALL_FLYBY_DURATION         60
#define BALL_INITIAL_ROTATION_X     8192

#define BALL_EXIT_ORBIT_RADIUS_X      2048
#define BALL_EXIT_ORBIT_RADIUS_Y      2048
#define BALL_EXIT_SCALE               512
#define BALL_EXIT_TRANSITION_DURATION 12
