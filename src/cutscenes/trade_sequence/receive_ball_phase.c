...
#define BALL_INITIAL_ORBIT_RADIUS_X 2048
#define BALL_INITIAL_ORBIT_RADIUS_Y 2048
#define BALL_INITIAL_SCALE          512
#define BALL_TRANSITION_DURATION    12
#define BALL_INITIAL_ROTATION_ANGLE 55408
#define BALL_ROTATION_SPEED         62800
#define BALL_TARGET_ORBIT_CENTER_Y  (int)0xFFF3CE00
#define BALL_TARGET_ORBIT_CENTER_Z  823296
#define BALL_INITIAL_ORBIT_CENTER_Y 4025344
#define BALL_INITIAL_ORBIT_CENTER_Z 0xFFE44000
#define BALL_ENTRY_DURATION         70
