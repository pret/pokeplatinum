...
int ov108_02241AE0(OverlayManager *param0, int *param1)
{
    ...
    v1 = OverlayManager_NewData(param0, sizeof(UnkStruct_ov108_02241DB0), HEAP_ID_103);
...
static void ov108_0224237C(UnkStruct_ov108_02241DB0 *param0)
{
    ...
    param0->unk_68 = MessageLoader_Init(MESSAGE_LOADER_NARC_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, 536, HEAP_ID_103);
