...
static BOOL ov108_02241DB0(UnkStruct_ov108_02241DB0 *param0)
{
    ...
    case 7:
        if (ov104_0223C000(param0->unk_09) == 1) {
            ...
            StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_IN, FADE_TYPE_BRIGHTNESS_IN, FADE_TO_BLACK, 6, 1 * 3, HEAP_ID_103);
            param0->unk_08++;
        }
        break;
    case 8:
...
static BOOL ov108_022421F0(UnkStruct_ov108_02241DB0 *param0)
{
    ...
    switch (param0->unk_08) {
    case 0:
        StartScreenFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_OUT, FADE_TYPE_BRIGHTNESS_OUT, FADE_TO_BLACK, 6, 1, HEAP_ID_103);
        param0->unk_08++;
        break;
    case 1:
        if (IsScreenFadeDone() == TRUE) {
