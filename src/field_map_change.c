...
static void FieldMapChange_InitTerrainCollisionManager(FieldSystem *fieldSystem)
{
    ...
    if (fieldSystem->mapLoadMode->useTerrainAttributesLoader) {
        TerrainAttributesLoader_New(fieldSystem, fieldSystem->mapLoadMode->terrainAttributesLoaderBlockCount);
    }
}
...
static void FieldMapChange_RemoveTerrainCollisionManager(FieldSystem *fieldSystem)
{
    ...
    if (fieldSystem->mapLoadMode->useTerrainAttributesLoader) {
        TerrainAttributesLoader_Free(fieldSystem);
    }
