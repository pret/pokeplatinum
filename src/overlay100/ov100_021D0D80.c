...
int ov100_021D0D80(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov100_021D4DD8 *v0;

    Heap_Create(HEAP_ID_APPLICATION, HEAP_ID_111, 0xC0000);

    v0 = OverlayManager_NewData(overlayMan, sizeof(UnkStruct_ov100_021D4DD8), HEAP_ID_111);
    memset(v0, 0, sizeof(UnkStruct_ov100_021D4DD8));
    v0->unk_D0 = OverlayManager_Args(overlayMan);
...
int ov100_021D0EA8(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov100_021D4DD8 *v0 = OverlayManager_Data(overlayMan);
...
int ov100_021D0F44(OverlayManager *overlayMan, int *param1)
{
    UnkStruct_ov100_021D4DD8 *v0 = OverlayManager_Data(overlayMan);
