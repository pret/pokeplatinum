...
void *ov100_021D13E4(UnkStruct_ov100_021D4DD8 *param0)
{
...

    {
        ...
        #ifdef SDK_BUILD_ARM
        ov100_021D4E70(&v0->unk_0C.unk_00, 0, 191, (0xffff / 192) * 2, FX32_CONST(2), 1 * 100, (u32)REG_DB_BG1HOFS_ADDR, 0, 0x1000, 1);
        #else
        ov100_021D4E70(&v0->unk_0C.unk_00, 0, 191, (0xffff / 192) * 2, FX32_CONST(2), 1 * 100, (u64)REG_DB_BG1HOFS_ADDR, 0, 0x1000, 1);
        #endif
    }
    {
