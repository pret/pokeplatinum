...
BOOL ov100_021D14A8(void *param0)
{
    ...
    switch (v0->unk_00) {
    case 0:
        StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 6, 1, HEAP_ID_111);
        v0->unk_00++;
    case 1:
    ...
    case 6:
        ...
        if ((++v0->unk_7C4->unk_50.unk_03) != (+16)) {
            ...
            StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_WHITE, 1, 1, HEAP_ID_111);
            v0->unk_00 = 0;
            return 0;
        }
    }
