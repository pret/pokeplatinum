...
{
    CameraAngle v0 = Camera_GetAngle(param0->unk_18);
    VecFx32 v1 = Camera_GetPosition(param0->unk_18);

    Camera_SetPosition(&v1, param0->unk_18);
    Camera_SetAngleAroundTarget(&v0, param0->unk_18);
}
...
void ov100_021D4890 (UnkStruct_ov100_021D4890 * param0)
{
    ...
    v0 = Camera_GetAngle(param0->unk_00);
...
{
    BOOL v0 = 0;
    CameraAngle v1 = Camera_GetAngle(param0->unk_00);
    ...
    Camera_SetAngleAroundTarget(&v1, param0->unk_00);
