...
void sub_02030AA0(UnkStruct_02030A80 *param0, SaveData *saveData)
{
    ...
    const MiscSaveBlock *miscSave = SaveData_MiscSaveBlockConst(saveData);
    ...
    MiscSaveBlock_FavoriteMon(miscSave, &species, &form, &isEgg);
    ...
    param0->unk_1C = species;
    param0->unk_1B_1 = form;
    param0->unk_1B_0 = isEgg;
    ...
    MiscSaveBlock_IntroMsg(miscSave, &param0->unk_20_val1);
