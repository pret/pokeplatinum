...
{
    return sub_0201CE14(coresys.unk_1C, param0, param1, param2);
}

UnkStruct_0201CD38 * sub_0200DA20 (UnkFuncPtr_0201CE28 param0, void * param1, u32 param2)
{
    return sub_0201CE14(coresys.unk_24, param0, param1, param2);
}

UnkStruct_0201CD38 * sub_0200DA3C (UnkFuncPtr_0201CE28 param0, void * param1, u32 param2)
{
    return sub_0201CE14(coresys.unk_20, param0, param1, param2);
}
