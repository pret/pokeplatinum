...
void ov77_021D6CFC(UnkStruct_ov77_021D6CFC *param0)
{
    ...
    for (v0 = 0; v0 < 3; v0++) {
        BuildPokemonSpriteTemplate(&v1, v5[v0], 0, 2, 0, 0, 0);
    ...
    #else
    param0->unk_14 = Heap_Alloc(HEAP_ID_76, 0x4800*2);
    param0->unk_18 = ParticleSystem_New(ov77_021D6C70, ov77_021D6C94, param0->unk_14, 0x4800*2, 1, HEAP_ID_76);
    #endif
