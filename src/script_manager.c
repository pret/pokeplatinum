...
static ScriptManager *ScriptManager_New()
{
    ScriptManager *scriptManager = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(ScriptManager));
...
{
    ScriptContext *ctx = Heap_AllocFromHeap(HEAP_ID_FIELD2, sizeof(ScriptContext));
