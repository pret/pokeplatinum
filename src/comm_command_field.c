...
static const CommCmdTable Unk_020F68A4[] = {
    ...
    [COMM_CMD_REMOVE_BURIED_TRAP_INDEX_UNUSED - COMM_CMD_MAX_COMMON] = { CommCmd_RemoveBuriedTrapAtIndex_Unused, CommPacketSizeOf_2Bytes_Unused, NULL }, // corresponding cmd never sent
    [COMM_CMD_PLACE_TRAP_RESULT - COMM_CMD_MAX_COMMON] = { CommCmd_PlaceTrapResult, CommPacketSizeOf_PlaceTrapResult, NULL },
    [COMM_CMD_LOAD_LINK_TRAPS - COMM_CMD_MAX_COMMON] = { CommCmd_LoadLinkPlacedTraps, CommPacketSizeOf_AllTrapsPlacedPlayer, NULL }, // 35
    ...
    [COMM_CMD_START_SLIDE_ANIM_UNUSED - COMM_CMD_MAX_COMMON] = { CommCmd_StartSlideAnimation_Unused, CommPacketSizeOf_3Bytes_Unused, NULL }, // corresponding cmd never sent
    ...
    [COMM_CMD_QUEUE_SEND_TRAP_RADAR_RESULTS - COMM_CMD_MAX_COMMON] = { CommCmd_QueueSendTrapRadarResults, CommPacketSizeOf_Nothing, NULL },
    ...
    [COMM_CMD_ENTER_BASE - COMM_CMD_MAX_COMMON] = { CommCmd_RecvSecretBaseEnter, CommPacketSizeOf_SecretBaseInfo, NULL },
    ...
    [COMM_CMD_CLEAR_TRANSITION_STATUS - COMM_CMD_MAX_COMMON] = { CommCmd_ClearSecretBaseTransitioningStatus, CommPacketSizeOf_Nothing, NULL },
    ...
    [COMM_CMD_RECV_MINING_END - COMM_CMD_MAX_COMMON] = { CommCmd_RecvMiningGameEnd, CommPacketSizeOf_NetId, NULL },
    ...
    [COMM_CMD_FIELD_94 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_94, CommPacketSizeOf_NetId, NULL },
