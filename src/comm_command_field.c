...
static const CommCmdTable Unk_020F68A4[] = {
    ...
    [COMM_CMD_FIELD_108 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    ...
    [COMM_CMD_FIELD_131 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099508, NULL },
