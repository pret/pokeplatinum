...
static const CommCmdTable Unk_020F68A4[] = {
    ...
    [COMM_CMD_FIELD_DUMMY_START - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_109 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_110 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_111 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_112 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099548, NULL },
    [COMM_CMD_FIELD_113 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_114 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_115 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_116 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099530, NULL },
    [COMM_CMD_FIELD_117 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_118 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099538, NULL },
    [COMM_CMD_FIELD_119 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099540, NULL },
    [COMM_CMD_FIELD_120 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099544, NULL },
    [COMM_CMD_FIELD_121 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_122 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_123 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_NetId, NULL },
    [COMM_CMD_FIELD_124 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_125 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_126 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_0209954C, NULL },
    [COMM_CMD_FIELD_127 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_128 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_129 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, CommPacketSizeOf_Nothing, NULL },
    [COMM_CMD_FIELD_130 - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099504, NULL },
    [COMM_CMD_FIELD_DUMMY_END - COMM_CMD_MAX_COMMON] = { CommCmd_Field_Dummy, sub_02099508, NULL },
