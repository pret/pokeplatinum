...
static int sub_02098304 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 0:
...

        {
            ...
            v1 = sub_02074470(v0->unk_00->unk_0C.unk_00, 5, NULL);
...
static BOOL sub_0209843C (UnkStruct_020508D4 * param0)
{
    ...
    case 3:
    {
        ...
        v9 = sub_02074470(v0->unk_0C.unk_00, 5, 0);

        v0->unk_08 = sub_0208712C(11, 1, v9, 10, sub_02025E44(sub_0203D174(v8)));
        v0->unk_08->unk_10 = sub_02074470(v0->unk_0C.unk_00, 111, NULL);
        v0->unk_08->unk_08 = sub_02074470(v0->unk_0C.unk_00, 112, NULL);
...
void sub_020985AC (UnkStruct_020508D4 * param0, void * param1)
{
    ...
    v0 = sub_02018184(11, sizeof(UnkStruct_0209843C));
