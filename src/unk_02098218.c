...
static BOOL sub_0209843C(FieldTask *param0)
{
    ...
    case 3: {
        ...
        v0->unk_08 = sub_0208712C(HEAP_ID_FIELD2, 1, v9, 10, SaveData_GetOptions(FieldSystem_GetSaveData(fieldSystem)));
...
void sub_020985AC(FieldTask *param0, void *param1)
{
    ...
    v0 = Heap_AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_0209843C));
