...
int ov101_021D0D80(ApplicationManager *appMan, int *param1)
{
    ...
    ov101_021D18C0(v1);
    StartScreenFade(MODE_BOTH_SCREENS, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 8, 1, HEAP_ID_79);
...
int ov101_021D0E40(ApplicationManager *appMan, int *param1)
{
    ...
    case 1:
        if (ov101_021D1AAC(v1) == 1) {
            (*param1)++;
            StartScreenFade(MODE_SUB_THEN_MAIN, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 8, 1, HEAP_ID_79);
