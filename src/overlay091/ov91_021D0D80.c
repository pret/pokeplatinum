...
int ov91_021D0E08(OverlayManager *param0, int *param1)
{
    ...
    ov91_021D20E8(v0);
    SpriteGfxHandler_UpdateCellActorCollection(v0->unk_114);
...
static void ov91_021D1498(UnkStruct_ov91_021D0ED8 *param0)
{
    ...
    if (param0->unk_00->unk_14 == 0) {
        ...
        CellActorData_DrawSprite(param0->unk_118[5], 0);
    }
...
static void ov91_021D18C8(UnkStruct_ov91_021D0ED8 *param0, u32 param1)
{
    ...
    if (param1 != 0xfffffffe) {
        ...
        CellActorData_DrawSprite(param0->unk_118[5], 1);
...
static void ov91_021D2014(UnkStruct_ov91_021D0ED8 *param0)
{
    ...
    param0->unk_110 = SpriteRenderer_Create(67);
    param0->unk_114 = SpriteRenderer_CreateGfxHandler(param0->unk_110);

    {
        ...
        SpriteRenderer_CreateOamCharPlttManagers(param0->unk_110, &v1, &v2, 32);
    }

    SpriteRenderer_CreateCellActorList(param0->unk_110, param0->unk_114, 13);
    SpriteRenderer_InitGfxResourceList(param0->unk_110, param0->unk_114, &v0);
...
static void ov91_021D20B4(UnkStruct_ov91_021D0ED8 *param0)
{
    ...
    for (v0 = 0; v0 < 13; v0++) {
        CellActorData_Delete(param0->unk_118[v0]);
    }

    SpriteRenderer_UnloadResourcesAndRemoveGfxHandler(param0->unk_110, param0->unk_114);
    SpriteRenderer_Free(param0->unk_110);
}
...
static void ov91_021D20E8(UnkStruct_ov91_021D0ED8 *param0)
{
    ...
    for (v0 = 0; v0 < 13; v0++) {
        CellActor_UpdateAnim(param0->unk_118[v0]->cellActor, FX32_ONE);
    }
}
...
static void ov91_021D2110(UnkStruct_ov91_021D0ED8 *param0, NARC *param1)
{
    ...
    SpriteRenderer_LoadPaletteResObjFromOpenNarc(param0->unk_110, param0->unk_114, param1, 9, 0, 2, NNS_G2D_VRAM_TYPE_2DMAIN, 47272);
...
static void ov91_021D2314(UnkStruct_ov91_021D0ED8 *param0)
{
    ...
    for (v0 = 0; v0 < 7; v0++) {
        ...
        if (param0->unk_00->unk_12 + v0 >= param0->unk_184 - 1) {
            CellActorData_DrawSprite(param0->unk_118[6 + v0], 0);
        } else {
            CellActorData_DrawSprite(param0->unk_118[6 + v0], 1);
...
static void ov91_021D237C(UnkStruct_ov91_021D0ED8 *param0, u16 param1, u16 param2)
{
    ...
    if (param1 < param2) {
        for (v0 = 0; v0 < 7; v0++) {
            ...
            CellActorData_SetPositionXY(param0->unk_118[6 + v0], v1, v2);
        }
...
static void ov91_021D2508(UnkStruct_ov91_021D0ED8 *param0, NARC *param1)
{
    ...
    for (v0 = 0; v0 < 13; v0++) {
        param0->unk_118[v0] = CellActor_LoadResources(param0->unk_110, param0->unk_114, &Unk_ov91_021D28FC[v0]);
    }
}

static void ov91_021D2548(UnkStruct_ov91_021D0ED8 *param0, u8 param1, u8 param2)
{
    CellActorData_SetPositionXY(param0->unk_118[4], 196, 32 + 16 * param1);
    CellActorData_SetExplicitPalette(param0->unk_118[4], param2);
}

static void ov91_021D2574(UnkStruct_ov91_021D0ED8 *param0, u8 param1)
{
    CellActorData_DrawSprite(param0->unk_118[0], param1);
    CellActorData_DrawSprite(param0->unk_118[1], param1);
}

static void ov91_021D2594(UnkStruct_ov91_021D0ED8 *param0)
{
    if (param0->unk_00->unk_12 != 0) {
        CellActorData_DrawSprite(param0->unk_118[2], 1);
    } else {
        CellActorData_DrawSprite(param0->unk_118[2], 0);
    }

    if (param0->unk_00->unk_12 + 7 < param0->unk_184) {
        CellActorData_DrawSprite(param0->unk_118[3], 1);
    } else {
        CellActorData_DrawSprite(param0->unk_118[3], 0);
    }
}
