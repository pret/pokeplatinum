...
static BOOL FieldMoves_CutTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 8, taskData->mapObj);
...
static BOOL FieldMoves_SurfTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 12, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_StrengthTask(FieldTask *param0)
{
    ...
    ScriptManager_Change(param0, SCRIPT_ID_OFFSET_FIELD_MOVES + 10, taskData->mapObj);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_DefogTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 14, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_RockSmashTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 9, taskData->mapObj);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_WaterfallTask(FieldTask *param0)
{
    ...
    ScriptManager_Change(param0, SCRIPT_ID_OFFSET_FIELD_MOVES + 13, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_RockClimbTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 11, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_FlashTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_FIELD_MOVES + 15, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
...
static BOOL FieldMoves_ChatterTask(FieldTask *taskMan)
{
    ...
    ScriptManager_Change(taskMan, SCRIPT_ID_OFFSET_RECORD_CHATOT_CRY + 0, NULL);
    FieldSystem_SetScriptParameters(fieldSystem, taskData->fieldMoveMon.fieldMonId, 0, 0, 0);
    FieldMoves_FreeTaskData(taskData);
