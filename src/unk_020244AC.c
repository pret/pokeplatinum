...
UnkStruct_021C0794 * sub_020244AC (void)
{
    ...
    v0 = sub_02018144(1, sizeof(UnkStruct_021C0794));
...
static int sub_02024ABC (UnkStruct_021C0794 * param0)
{
    ...
    v2 = sub_02018184(3, 0x1000 * 32);
    v3 = sub_02018184(3, 0x1000 * 32);
