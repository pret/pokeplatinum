...
static int DeterminePokemonStatus(Pokemon *param0, BOOL param1, int param2)
{
    ...
    if (Pokemon_GetValue(param0, MON_DATA_IS_EGG, NULL) == 0) {
        if (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == 0) {
            ...
            if (Pokemon_GetValue(param0, MON_DATA_FATEFUL_ENCOUNTER, NULL) == 1) {
                if (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 2)) {
                    if (param1 == 1) {
                        v0 = 13;
                    } else {
                        v0 = 14;
                    }
                } else if (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(2, 1)) {
                    if (param1 == 1) {
                        v0 = 11;
                    } else {
                        v0 = 12;
                ...
                if ((Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 1)) || (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 0)) || (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 9)) || (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 10)) || (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == SpecialMetLoc_GetId(1, 11))) {
                    if (param1 == 1) {
                        v0 = 5;
                    } else {
                        v0 = 6;
        ...
        if (param1 == 1) {
            if (Pokemon_GetValue(param0, MON_DATA_FATEFUL_ENCOUNTER, NULL) == 1) {
                if (Pokemon_GetValue(param0, MON_DATA_HATCH_LOCATION, NULL) == (SpecialMetLoc_GetId(2, 1))) {
                    v0 = 20;
                } else {
                    v0 = 18;
                }
        ...
        if (sub_0207884C(boxMon, trainerInfo, heapID) == 0) {
            {
                ...
                BoxPokemon_SetValue(boxMon, MON_DATA_HATCH_LOCATION, &v0);

                v0 = BoxPokemon_GetValue(boxMon, MON_DATA_MET_YEAR, NULL);
                BoxPokemon_SetValue(boxMon, MON_DATA_HATCH_YEAR, &v0);

                v0 = BoxPokemon_GetValue(boxMon, MON_DATA_MET_MONTH, NULL);
                BoxPokemon_SetValue(boxMon, MON_DATA_HATCH_MONTH, &v0);

                v0 = BoxPokemon_GetValue(boxMon, MON_DATA_MET_DAY, NULL);
                BoxPokemon_SetValue(boxMon, MON_DATA_HATCH_DAY, &v0);
            }
        }
