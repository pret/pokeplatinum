...
static int ov95_0224B520(UnkStruct_ov95_0224B4D4 *param0, int *param1)
{
    ...
    StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_1, FADE_TYPE_UNK_1, FADE_BLACK, 16, 1, HEAP_ID_58);
...
static int ov95_0224B81C(UnkStruct_ov95_0224B4D4 *param0, int *param1)
{
    ...
    case 4:
        if (++(param0->unk_08) > 10) {
            StartScreenFade(MODE_MAIN_ONLY, FADE_TYPE_UNK_0, FADE_TYPE_UNK_0, FADE_BLACK, 16, 1, HEAP_ID_58);
            (*param1)++;
        }
        break;
    case 5:
