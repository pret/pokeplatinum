...
static BOOL ov95_02246DEC(UnkStruct_02073C74_sub1 * param0);
...
int ov95_02246C20 (UnkStruct_020067E8 * param0, int * param1)
{
    if (sub_0200F2AC()) {
        ...
        CreateHeap(3, 57, 98304);
        CreateHeap(3, 58, 98304);
        ov95_02247688();
        ...
        if (v0) {
            ...
            case 1:
                sub_0200B5CC(v0->unk_0C, 0, (UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_00));
                sub_0200B5CC(v0->unk_0C, 1, (UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_04));
                sub_0200B498(v0->unk_0C, 2, v0->unk_00->unk_08);
                v0->unk_1AC = ov95_02246DEC((UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_04));
                break;
            case 2:
                sub_0200B5CC(v0->unk_0C, 0, (UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_00));
                break;
            ...
            v0->unk_1B0 = sub_02074570((UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_00), 5, NULL);
            v0->unk_1B2 = sub_02074570((UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_00), 112, NULL);
            v0->unk_1B4 = sub_02074570((UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_04), 5, NULL);
            v0->unk_1B6 = sub_02074570((UnkStruct_02073C74_sub1 *)(v0->unk_00->unk_04), 112, NULL);
            v0->unk_1B8 = NULL;
...
static BOOL ov95_02246DEC (UnkStruct_02073C74_sub1 * param0)
{
    int v0 = sub_02074570(param0, 5, NULL);
    int v1 = sub_02074570(param0, 112, NULL);
...
{
    UnkStruct_ov95_02247004 * v0 = AllocFromHeap(57, sizeof(UnkStruct_ov95_02247004));
...
static void ov95_02247170 (UnkStruct_ov95_02247004 * param0)
{
    if (param0->unk_C4[param0->unk_F8] == NULL) {
        UnkStruct_ov95_02247170 * v0 = AllocFromHeap(57, sizeof(UnkStruct_ov95_02247170));
...
static void ov95_02247224 (UnkStruct_ov95_02247004 * param0, int param1)
{
    if (param0->unk_C4[param1]) {
        FreeToHeap(sub_0201CED0(param0->unk_C4[param1]));
...
{
    UnkStruct_ov95_022472C4 * v0 = AllocFromHeap(57, sizeof(UnkStruct_ov95_022472C4));
...
void ov95_022473E8 (UnkStruct_ov95_02247628 * param0, int param1, u32 param2, u32 param3, BOOL param4)
{
    ...
    v3 = AllocFromHeapAtEnd(57, v2);

    if (v3) {
        UnkStruct_02013610 v4 = {
            0, 0, 10, 10,
        };
        UnkStruct_02073C74_sub1 * v5;
        BOOL v6;
        u32 v7;
        u16 v8;

        v5 = (UnkStruct_02073C74_sub1 *)((param1 == 0) ? param0->unk_00->unk_00 : param0->unk_00->unk_04);
        v6 = sub_02073D20(v5);

        sub_02075F0C(&v0, v5, 2, 0);

        v7 = sub_02074570(v5, 0, NULL);
        v8 = sub_02074570(v5, 5, NULL);
...
static void ov95_02247694 (void)
{
    if (Unk_ov95_0224C2E0) {
        ...
        for (i = 0; i < Unk_ov95_0224C2E0; i++) {
            FreeToHeap(Unk_ov95_0224C2E4[i]);
        }
