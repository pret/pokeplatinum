...
static PLString * ov84_0223DC9C(UnkStruct_ov84_0223B5A0 * param0, u16 param1);
...
int ov84_0223B900 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    PLString_FreeToHeap(v0->unk_3F8);
...
static void ov84_0223BDB4 (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    param0->unk_3F8 = PLString_AllocFromHeap(256, 6);
}
...
static void ov84_0223BE84 (UnkStruct_0200B144 * param0, PLString * param1, u16 param2, u32 param3)
{
    sub_0200B1B8(param0, param2, param1);
}

static void ov84_0223BE94 (UnkStruct_0200B144 * param0, PLString * param1, u16 param2, u32 param3)
{
...
static void ov84_0223C158 (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    for (v0 = 0; v0 < 165; v0++) {
        param0->unk_164[v0] = PLString_AllocFromHeap(18, 6);
    }
}
...
static void ov84_0223C178 (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    for (v0 = 0; v0 < 165; v0++) {
        PLString_FreeToHeap(param0->unk_164[v0]);
    }
}
...
static int ov84_0223DA14 (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    case 1:
        ...
        if ((Unk_021BF67C.unk_48 & (PAD_BUTTON_A | PAD_BUTTON_B)) || Unk_021BF67C.unk_60) {
            PLString * v1 = sub_0200B1EC(param0->unk_114, 60);
...
static int ov84_0223E01C (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    case 0:
    {
        PLString * v1 = sub_0200B1EC(param0->unk_114, 53);
...
static int ov84_0223E7CC (UnkStruct_ov84_0223B5A0 * param0)
{
    ...
    case 0:
    {
        PLString * v1 = sub_0200B1EC(param0->unk_114, 77);
