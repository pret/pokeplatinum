...
static BOOL sub_02044F24 (UnkStruct_0203E724 * param0)
{
    ...
    v5 = GetMonData(v0, MON_DATA_112, NULL);
...
static u32 sub_0204676C (UnkStruct_021C0794 * param0)
{
...

    {
        ...
        for (v0 = 0; v0 < v5; v0++) {
            ...
            if ((GetMonData(v1, MON_DATA_SPECIES, NULL) == 479) && (GetMonData(v1, MON_DATA_IS_EGG, NULL) == 0)) {
                v3 |= 1 << GetMonData(v1, MON_DATA_112, NULL);
            }
        }
    }

    {
        ...
        for (v0 = 0; v0 < 2; v0++) {
            ...
            if ((sub_02074570(v2, MON_DATA_SPECIES, NULL) == SPECIES_ROTOM) && (sub_02074570(v2, MON_DATA_IS_EGG, NULL) == 0)) {
                v3 |= 1 << sub_02074570(v2, MON_DATA_112, NULL);
            }
        }
    }
