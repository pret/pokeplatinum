...
static BOOL sub_02041F14 (UnkStruct_0203E724 * param0)
{
    ...
    mon = Party_GetPokemonBySlotIndex(Party_GetFromSavedata(param0->unk_34->unk_0C), v2);
    sub_0200DAA4(param0->unk_34->unk_08, 3, 1024 - (18 + 12) - 9, 11, 0, 4);

    *v1 = sub_0200EC48(param0->unk_34->unk_08, 3, 10, 5, 11, 1024 - (18 + 12) - 9, mon, 4);
    sub_020451B4(param0->unk_34, GetMonData(mon, MON_DATA_SPECIES, NULL));
...
static BOOL sub_02042718 (UnkStruct_0203E724 * param0)
{
    ...
    mon = Party_GetPokemonBySlotIndex(Party_GetFromSavedata(v2->unk_0C), v3);

    GetMonData(mon, MON_DATA_117, v0);
    sub_0203DFE8(param0->unk_28, 1, GetMonData(mon, MON_DATA_SPECIES, NULL), 10, v3, v0, inline_0204FCAC(param0));
...
static BOOL sub_02042AE0 (UnkStruct_0203E724 * param0)
{
    sub_02069434(param0->unk_34->unk_94);
...
static BOOL sub_020434EC (UnkStruct_0203E724 * param0)
{
    ...
    if (sub_020247E0(v0)) {
        *v1 = 0;
    } else if (sub_020247C0(v0) == 0) {
        *v1 = 1;
    } else if (sub_02024800(v0)) {
        *v1 = 2;
    } else {
        *v1 = 3;
    }
...
static BOOL sub_02044F24 (UnkStruct_0203E724 * param0)
{
    ...
    mon = Party_GetPokemonBySlotIndex(Party_GetFromSavedata(param0->unk_34->unk_0C), v3);
    species = GetMonData(mon, MON_DATA_SPECIES, NULL);
    form = GetMonData(mon, MON_DATA_FORM, NULL);
    *v1 = ov5_021F0E90(species, form);
    *v2 = ov5_021F0E84(species);
...
static BOOL sub_02045404 (UnkStruct_0203E724 * param0)
{
    ...
    for (v1 = 0; v1 < v9; v1++) {
        mon = Party_GetPokemonBySlotIndex(v8, v1);
        species = GetMonData(mon, MON_DATA_SPECIES, NULL);
        v6 = GetMonData(mon, MON_DATA_111, NULL);
...
static u32 sub_0204676C (UnkStruct_021C0794 * param0)
{
...

    {
        ...
        for (v0 = 0; v0 < v5; v0++) {
            ...
            if ((GetMonData(v1, MON_DATA_SPECIES, NULL) == SPECIES_ROTOM) && (GetMonData(v1, MON_DATA_IS_EGG, NULL) == FALSE)) {
...

    {
        ...
        for (v0 = 0; v0 < 2; v0++) {
            ...
            if ((sub_02074570(v2, MON_DATA_SPECIES, NULL) == SPECIES_ROTOM) && (sub_02074570(v2, MON_DATA_IS_EGG, NULL) == FALSE)) {
...
static BOOL sub_020469D0 (UnkStruct_0203E724 * param0)
{
    ...
    sub_02077A9C(v1, v2);
    {
        ...
        for (v3 = 0; v3 < v4; v3++) {
            ...
            if ((GetMonData(v5, MON_DATA_IS_EGG, NULL) == FALSE) && (GetMonData(v5, MON_DATA_SPECIES, NULL) == SPECIES_GIRATINA)) {
